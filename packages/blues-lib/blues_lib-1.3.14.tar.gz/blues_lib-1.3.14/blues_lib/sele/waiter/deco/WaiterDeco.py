...
class WaiterDeco(ABC):
  ...
  def __init__(self,caller_method,timeout):
    '''
    Create a special decorator for class waiter.EC 
    Parameter:
      caller_method {str} : the wrappered func's name
      timeout {int} : the func's default timeout parameter value
    '''
  ...
  def wrapper(self,func,*args,**kwargs):
    ...
    BluesConsole.info(self.get_start_msg(args))
