...
class EC():
  ...
  @ECElementDeco('to_be_presence',10)
  ...
  @ECElementDeco('all_to_be_presence',10)
  ...
  @ECElementDeco('to_be_visible',10)
  ...
  @ECElementDeco('all_to_be_visible',10)
  ...
  @ECElementDeco('any_to_be_visible',10)
  ...
  @ECElementDeco('to_be_invisible',10)
  ...
  @ECElementTextDeco('value_contains',10)
  ...
  @ECElementTextDeco('text_contains',10)
  ...
  @ECElementDeco('to_be_clickable',10)
  ...
  @ECElementDeco('to_be_selected',10)
  ...
  @ECBaseDeco('alert_to_be_presence',10)
  ...
  @ECBaseDeco('alert_to_be_closed',10)
  ...
  @ECElementDeco('frame_to_be_presence',10)
  ...
  @ECTextDeco('window_to_be_presence',10)
