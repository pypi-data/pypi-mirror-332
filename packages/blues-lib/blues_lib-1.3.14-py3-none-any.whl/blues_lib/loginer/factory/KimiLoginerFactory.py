...
from schema.loginer.factory.KimiLoginerSchemaFactory import KimiLoginerSchemaFactory
...
class KimiLoginerFactory(LoginerFactory):

  def create_once_mac(self):
    factory = KimiLoginerSchemaFactory()
