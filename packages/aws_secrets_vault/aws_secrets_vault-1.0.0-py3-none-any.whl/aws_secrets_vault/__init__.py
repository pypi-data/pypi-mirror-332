...
def main():
    ...
    sso_url = os.environ.get("AWS_SSO_URL")
    sso_role_name = os.environ.get("AWS_SSO_ROLE_NAME")
    sso_account_id = os.environ.get("AWS_SSO_ACCOUNT_ID")
    ...
    if key_description:
        ...
        # Get caller identity.
        caller_arn = get_caller_identity(session)["Arn"]
