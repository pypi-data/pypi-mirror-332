...
class FontAtlas:
    ...
    def add_font_from_memory_ttf(self, font_data: bytes, size_pixels: float, font_cfg: Optional[FontConfig] = None) -> Font: ...
...
def collapsing_header(label: str, visible: Optional[object] = None, flags: TreeNodeFlags = TreeNodeFlags.NONE) -> tuple[bool, Optional[bool]]: ...
...
def create_context(shared_font_atlas: Optional[FontAtlas] = None) -> Context:
    """create context"""
...
def plot_histogram(label: str, values: Annotated[ArrayLike, dict(dtype='float32', shape=(None), device='cpu', writable=False)], overlay_text: Optional[str] = None, scale_min: float = 3.4028234663852886e+38, scale_max: float = 3.4028234663852886e+38, graph_size: tuple[float, float] = (0.0, 0.0)) -> None: ...

def plot_lines(label: str, values: Annotated[ArrayLike, dict(dtype='float32', shape=(None), device='cpu', writable=False)], overlay_text: Optional[str] = None, scale_min: float = 3.4028234663852886e+38, scale_max: float = 3.4028234663852886e+38, graph_size: tuple[float, float] = (0.0, 0.0)) -> None: ...
...
def push_font(font: Optional[Font]) -> None: ...
