...
class ZmSystem:
    ...
    Attributes:
        ...
        _token_manager (Optional[TokenManager]): The TokenManager instance for managing authentication tokens.
    ...
    _token_manager: Optional[TokenManager] = dataclasses.field(default=None)
    ...
    def token_manager(self, value: TokenManager):
        """
        Sets the token manager instance.

        Args:
            value (TokenManager): The token manager instance to set.
        """
