...
class ZmpOpenAPI(OpenAPI):
    ...
    def generate_models_by_path_and_method(
        ...
        *,
        ...
        if operation.requestBody:
            schema_ = operation.requestBody.content["application/json"].schema_
        ...
        if schema_.type:
            if schema_.type == SchemaType.ARRAY.value:
                ...
                if ref:
                    ...
                    request_body_model = create_model(schema_.title, **fields)
            else:
                ref = schema_.ref
                if ref:
    ...
    def _generate_model_from_properties(
        ...
        *,
        ...
        logger.info(f"Model for request body: {class_name} will be created")
