...
from zmp_zcp_toolkit.models.mixed_spec import MixedAPISpecConfig
from zmp_zcp_toolkit.openapi.openapi_helper import OpenAPIHelper
...
class ZmpAPIWrapper:
    ...
    def run(
        ...
        *,
        ...
        logger.debug(
            f"Query params: {query_params.model_dump(exclude_none=True, mode='json') if query_params else None}"
        ...
        response = self.client.request(
            ...
            json=request_body.model_dump_json(exclude_none=True)
            if request_body
            else None,
        )
