...
from localecmd.func import Function, programfunction, BRAILLE_PATTERN_BLANK
...
def test_func():
    ...
    assert f() == func()
    assert f.module.__name__ == __name__
...
def test_translation():
    ...
    f.call_translated(A=10, B=20, C=30, D=40) == f(10, 20, 30, 40)
