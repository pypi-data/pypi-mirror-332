...
class UsersApi:
    ...
    def delete_user(
        self,
        user_uid: Annotated[StrictStr, Field(description="The unique identifier, represented as a UUID, of the user in Security Cloud Control.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param user_uid: The unique identifier, represented as a UUID, of the user in Security Cloud Control. (required)
        :type user_uid: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
