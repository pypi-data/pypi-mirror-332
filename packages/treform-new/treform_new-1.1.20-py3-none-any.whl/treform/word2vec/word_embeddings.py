...
class WordEmbeddings:
    ...
    def preprocessing(self, mode, path, stopword_file, files, is_mecab=False, is_directory=False,
                      doc_index=-1, max=-1):
        util = ptm.Utility()
...
class Word2Vec(WordEmbeddings):
    ...
    def preprocessing(self, mode, mecab_path, stopword_file, files, is_mecab=False, is_directory=False, doc_index=-1, max=-1):
        super().preprocessing(mode, mecab_path, stopword_file, files, is_mecab, is_directory, doc_index, max)
