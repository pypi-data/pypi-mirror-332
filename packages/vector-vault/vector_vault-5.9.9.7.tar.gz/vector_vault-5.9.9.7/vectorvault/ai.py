...
class OpenAIPlatform(LLMPlatform):
    def __init__(self):
        ...
        self.img_capable = ['o1', 'gpt-4o', 'gpt-4o-mini', 'gpt-4.5-preview', 'gpt-4.5-preview-2025-02-27']
        self.no_stream_list = ['o1-2024-12-17', 'o1-preview-2024-09-12', 'o1-mini-2024-09-12']
        self.no_temperature_list = ['o1', 'o1-mini', 'o1-2024-12-17', 'o1-preview-2024-09-12', 'o1-mini-2024-09-12',
