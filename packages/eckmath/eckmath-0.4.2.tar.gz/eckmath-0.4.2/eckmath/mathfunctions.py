def point2D(pointone: int | float, pointtwo: int | float) -> tuple:

    if not isinstance(pointone, (int, float)) or not isinstance(pointtwo, (int, float)):
        raise TypeError("Os valores devem ser números inteiros ou de ponto flutuante")
    
    return (pointone,pointtwo)

def point3D(pointone: int | float, pointtwo: int | float, pointthree: int | float) -> tuple:

    if not isinstance(pointone, (int, float)) or not isinstance(pointtwo, (int, float)) or not isinstance(pointthree, (int, float)):
        raise TypeError("Os valores devem ser números inteiros ou de ponto flutuante")
