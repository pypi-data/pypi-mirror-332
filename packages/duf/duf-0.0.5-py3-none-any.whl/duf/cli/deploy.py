"""
todo: setup supervisor conf

[program:fansauth]
command=/root/fansauth/serve.sh
directory=/root/fansauth
autostart=true
autorestart=true
stderr_logfile=/var/log/fansauth.err.log
stdout_logfile=/var/log/fansauth.out.log
stopasgroup=true
killasgroup=True
