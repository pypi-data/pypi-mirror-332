...
class IOptions:
    ...
    def NamedValue(self, name: int) -> func_adl_servicex_xaodr22.str.str:
        "A method"
        ...
    ...
    def GetNamedValue(self, noname_arg: int, noname_arg_1: func_adl_servicex_xaodr22.str.str) -> bool:
        "A method"
        ...
