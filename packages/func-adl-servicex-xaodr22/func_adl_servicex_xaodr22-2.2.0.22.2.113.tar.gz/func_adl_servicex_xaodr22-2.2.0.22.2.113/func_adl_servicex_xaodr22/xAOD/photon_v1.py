...
class Photon_v1:
    ...
    def vertexCaloMatchValue(self, value: float, information: func_adl_servicex_xaodr22.xAOD.egammaparameters.EgammaParameters.VertexCaloMatchType) -> bool:
        "A method"
        ...

    def setVertexCaloMatchValue(self, value: float, information: func_adl_servicex_xaodr22.xAOD.egammaparameters.EgammaParameters.VertexCaloMatchType) -> bool:
        "A method"
        ...

    def conversionType(self) -> func_adl_servicex_xaodr22.xAOD.egammaparameters.EgammaParameters.ConversionType:
        "A method"
        ...
