...
class MinimizerOptions:
    ...
    def Default(self, name: char) -> func_adl_servicex_xaodr22.ROOT.Math.ioptions.IOptions:
        "A method"
        ...

    def FindDefault(self, name: char) -> func_adl_servicex_xaodr22.ROOT.Math.ioptions.IOptions:
        "A method"
        ...
