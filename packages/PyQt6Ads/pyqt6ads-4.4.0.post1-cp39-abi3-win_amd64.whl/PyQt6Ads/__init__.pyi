...
class SideBarLocation(enum.Enum):
    SideBarTop = ... # type: SideBarLocation
    SideBarLeft = ... # type: SideBarLocation
    SideBarRight = ... # type: SideBarLocation
    SideBarBottom = ... # type: SideBarLocation
    SideBarNone = ... # type: SideBarLocation


class eBitwiseOperator(enum.Enum):
    BitwiseAnd = ... # type: eBitwiseOperator
    BitwiseOr = ... # type: eBitwiseOperator


class eIcon(enum.Enum):
    TabCloseIcon = ... # type: eIcon
    AutoHideIcon = ... # type: eIcon
    DockAreaMenuIcon = ... # type: eIcon
    DockAreaUndockIcon = ... # type: eIcon
    DockAreaCloseIcon = ... # type: eIcon
    DockAreaMinimizeIcon = ... # type: eIcon
    IconCount = ... # type: eIcon


class eDragState(enum.Enum):
    DraggingInactive = ... # type: eDragState
    DraggingMousePressed = ... # type: eDragState
    DraggingTab = ... # type: eDragState
    DraggingFloatingWidget = ... # type: eDragState


class TitleBarButton(enum.Enum):
    TitleBarButtonTabsMenu = ... # type: TitleBarButton
    TitleBarButtonUndock = ... # type: TitleBarButton
    TitleBarButtonClose = ... # type: TitleBarButton
    TitleBarButtonAutoHide = ... # type: TitleBarButton
    TitleBarButtonMinimize = ... # type: TitleBarButton


class eTabIndex(enum.Enum):
    TabDefaultInsertIndex = ... # type: eTabIndex
    TabInvalidIndex = ... # type: eTabIndex


class DockWidgetArea(enum.Enum):
    NoDockWidgetArea = ... # type: DockWidgetArea
    LeftDockWidgetArea = ... # type: DockWidgetArea
    RightDockWidgetArea = ... # type: DockWidgetArea
    TopDockWidgetArea = ... # type: DockWidgetArea
    BottomDockWidgetArea = ... # type: DockWidgetArea
    CenterDockWidgetArea = ... # type: DockWidgetArea
    LeftAutoHideArea = ... # type: DockWidgetArea
    RightAutoHideArea = ... # type: DockWidgetArea
    TopAutoHideArea = ... # type: DockWidgetArea
    BottomAutoHideArea = ... # type: DockWidgetArea
    InvalidDockWidgetArea = ... # type: DockWidgetArea
    OuterDockAreas = ... # type: DockWidgetArea
    AutoHideDockAreas = ... # type: DockWidgetArea
    AllDockAreas = ... # type: DockWidgetArea


class internal(PyQt6.sip.simplewrapper):

    class eRepolishChildOptions(enum.Enum):
        RepolishIgnoreChildren = ... # type: internal.eRepolishChildOptions
        RepolishDirectChildren = ... # type: internal.eRepolishChildOptions
        RepolishChildrenRecursively = ... # type: internal.eRepolishChildOptions
    ...
    def repolishStyle(self, w: typing.Optional[QtWidgets.QWidget], Options: 'internal.eRepolishChildOptions' = ...) -> None: ...
    def setButtonIcon(self, Button: typing.Optional[QtWidgets.QAbstractButton], StandarPixmap: QtWidgets.QStyle.StandardPixmap, CustomIconId: 'eIcon') -> None: ...
    ...
    def replaceSplitterWidget(self, Splitter: typing.Optional[QtWidgets.QSplitter], From: typing.Optional[QtWidgets.QWidget], To: typing.Optional[QtWidgets.QWidget]) -> None: ...


class CAutoHideDockContainer(QtWidgets.QFrame):

    def __init__(self, DockWidget: typing.Optional['CDockWidget'], area: 'SideBarLocation', parent: typing.Optional['CDockContainerWidget']) -> None: ...
...
class CAutoHideSideBar(QtWidgets.QScrollArea):
    ...
    def orientation(self) -> QtCore.Qt.Orientation: ...
    def addAutoHideWidget(self, AutoHideWidget: typing.Optional['CAutoHideDockContainer'], Index: int) -> None: ...
    def removeAutoHideWidget(self, AutoHideWidget: typing.Optional['CAutoHideDockContainer']) -> None: ...
    def insertDockWidget(self, Index: int, DockWidget: typing.Optional['CDockWidget']) -> typing.Optional['CAutoHideDockContainer']: ...
...
class CPushButton(QtWidgets.QPushButton):
    ...
    class Orientation(enum.Enum):
        Horizontal = ... # type: CPushButton.Orientation
        VerticalTopToBottom = ... # type: CPushButton.Orientation
        VerticalBottomToTop = ... # type: CPushButton.Orientation
...
class CDockWidget(QtWidgets.QFrame):
    ...
    class eToggleViewActionMode(enum.Enum):
        ActionModeToggle = ... # type: CDockWidget.eToggleViewActionMode
        ActionModeShow = ... # type: CDockWidget.eToggleViewActionMode

    class eMinimumSizeHintMode(enum.Enum):
        MinimumSizeHintFromDockWidget = ... # type: CDockWidget.eMinimumSizeHintMode
        MinimumSizeHintFromContent = ... # type: CDockWidget.eMinimumSizeHintMode
        MinimumSizeHintFromDockWidgetMinimumSize = ... # type: CDockWidget.eMinimumSizeHintMode
        MinimumSizeHintFromContentMinimumSize = ... # type: CDockWidget.eMinimumSizeHintMode

    class eInsertMode(enum.Enum):
        AutoScrollArea = ... # type: CDockWidget.eInsertMode
        ForceScrollArea = ... # type: CDockWidget.eInsertMode
        ForceNoScrollArea = ... # type: CDockWidget.eInsertMode

    class eToolBarStyleSource(enum.Enum):
        ToolBarStyleFromDockManager = ... # type: CDockWidget.eToolBarStyleSource
        ToolBarStyleFromDockWidget = ... # type: CDockWidget.eToolBarStyleSource

    class eState(enum.Enum):
        StateHidden = ... # type: CDockWidget.eState
        StateDocked = ... # type: CDockWidget.eState
        StateFloating = ... # type: CDockWidget.eState

    class DockWidgetFeature(enum.Enum):
        DockWidgetClosable = ... # type: CDockWidget.DockWidgetFeature
        DockWidgetMovable = ... # type: CDockWidget.DockWidgetFeature
        DockWidgetFloatable = ... # type: CDockWidget.DockWidgetFeature
        DockWidgetDeleteOnClose = ... # type: CDockWidget.DockWidgetFeature
        CustomCloseHandling = ... # type: CDockWidget.DockWidgetFeature
        DockWidgetFocusable = ... # type: CDockWidget.DockWidgetFeature
        DockWidgetForceCloseWithArea = ... # type: CDockWidget.DockWidgetFeature
        NoTab = ... # type: CDockWidget.DockWidgetFeature
        DeleteContentOnClose = ... # type: CDockWidget.DockWidgetFeature
        DockWidgetPinnable = ... # type: CDockWidget.DockWidgetFeature
        DefaultDockWidgetFeatures = ... # type: CDockWidget.DockWidgetFeature
        AllDockWidgetFeatures = ... # type: CDockWidget.DockWidgetFeature
        DockWidgetAlwaysCloseAndDelete = ... # type: CDockWidget.DockWidgetFeature
        GloballyLockableFeatures = ... # type: CDockWidget.DockWidgetFeature
        NoDockWidgetFeatures = ... # type: CDockWidget.DockWidgetFeature

    @typing.overload
    def __init__(self, title: typing.Optional[str], parent: typing.Optional[QtWidgets.QWidget] = ...) -> None: ...
    @typing.overload
    def __init__(self, manager: typing.Optional['CDockManager'], title: typing.Optional[str], parent: typing.Optional[QtWidgets.QWidget] = ...) -> None: ...
    ...
    def setWidget(self, widget: typing.Optional[QtWidgets.QWidget], InsertMode: 'CDockWidget.eInsertMode' = ...) -> None: ...
    def minimumSizeHint(self) -> QtCore.QSize: ...
    ...
    @staticmethod
    def emitTopLevelEventForWidget(TopLevelDockWidget: typing.Optional['CDockWidget'], Floating: bool) -> None: ...
...
class CTitleBarButton(QtWidgets.QToolButton):
    ...
    def __init__(self, ShowInTitleBar: bool, HideWhenDisabled: bool, ButtonId: 'TitleBarButton', parent: typing.Optional[QtWidgets.QWidget] = ...) -> None: ...
...
class CDockAreaTitleBar(QtWidgets.QFrame):
    ...
    tabBarClicked: typing.ClassVar[QtCore.pyqtSignal]
    def buildContextMenu(self, menu: typing.Optional[QtWidgets.QMenu] = ...) -> typing.Optional[QtWidgets.QMenu]: ...
    def isAutoHide(self) -> bool: ...
...
class CDockAreaWidget(QtWidgets.QFrame):
    ...
    class eDockAreaFlag(enum.Enum):
        HideSingleWidgetTitleBar = ... # type: CDockAreaWidget.eDockAreaFlag
        DefaultFlags = ... # type: CDockAreaWidget.eDockAreaFlag

    def __init__(self, DockManager: typing.Optional['CDockManager'], parent: typing.Optional['CDockContainerWidget']) -> None: ...
    ...
    @staticmethod
    def restoreState(Stream: 'CDockingStateReader', Testing: bool, ParentContainer: typing.Optional['CDockContainerWidget']) -> typing.Tuple[bool, typing.Optional['CDockAreaWidget']]: ...
    def saveState(self, Stream: QtCore.QXmlStreamWriter) -> None: ...
    ...
    def nextOpenDockWidget(self, DockWidget: typing.Optional['CDockWidget']) -> typing.Optional['CDockWidget']: ...
    ...
    def addDockWidget(self, DockWidget: typing.Optional['CDockWidget']) -> None: ...
    def insertDockWidget(self, index: int, DockWidget: typing.Optional['CDockWidget'], Activate: bool = ...) -> None: ...
...
class CDockComponentsFactory(PyQt6.sip.simplewrapper):
    ...
    def createDockAreaTitleBar(self, DockArea: typing.Optional['CDockAreaWidget']) -> typing.Optional['CDockAreaTitleBar']: ...
    def createDockAreaTabBar(self, DockArea: typing.Optional['CDockAreaWidget']) -> typing.Optional['CDockAreaTabBar']: ...
    def createDockWidgetSideTab(self, DockWidget: typing.Optional['CDockWidget']) -> typing.Optional['CAutoHideTab']: ...
    def createDockWidgetTab(self, DockWidget: typing.Optional['CDockWidget']) -> typing.Optional['CDockWidgetTab']: ...


class CDockContainerWidget(QtWidgets.QFrame):

    def __init__(self, DockManager: typing.Optional['CDockManager'], parent: typing.Optional[QtWidgets.QWidget] = ...) -> None: ...
    ...
    def removeDockWidget(self, Dockwidget: typing.Optional['CDockWidget']) -> None: ...
    def addDockWidget(self, area: 'DockWidgetArea', Dockwidget: typing.Optional['CDockWidget'], DockAreaWidget: typing.Optional['CDockAreaWidget'] = ..., Index: int = ...) -> typing.Optional['CDockAreaWidget']: ...
    def handleAutoHideWidgetEvent(self, e: typing.Optional[QtCore.QEvent], w: typing.Optional[QtWidgets.QWidget]) -> None: ...
    def removeAutoHideWidget(self, AutoHideWidget: typing.Optional['CAutoHideDockContainer']) -> None: ...
    ...
    def addDockArea(self, DockAreaWidget: typing.Optional['CDockAreaWidget'], area: 'DockWidgetArea' = ...) -> None: ...
    def dropWidget(self, Widget: typing.Optional[QtWidgets.QWidget], DropArea: 'DockWidgetArea', TargetAreaWidget: typing.Optional['CDockAreaWidget'], TabIndex: int = ...) -> None: ...
    def dropFloatingWidget(self, FloatingWidget: typing.Optional['CFloatingDockContainer'], TargetPos: QtCore.QPoint) -> None: ...
    def createRootSplitter(self) -> None: ...
    def createAndSetupAutoHideContainer(self, area: 'SideBarLocation', DockWidget: typing.Optional['CDockWidget'], TabIndex: int = ...) -> typing.Optional['CAutoHideDockContainer']: ...
...
class CDockManager('CDockContainerWidget'):
    ...
    class eConfigParam(enum.Enum):
        AutoHideOpenOnDragHoverDelay_ms = ... # type: CDockManager.eConfigParam
        ConfigParamCount = ... # type: CDockManager.eConfigParam

    class eAutoHideFlag(enum.Enum):
        AutoHideFeatureEnabled = ... # type: CDockManager.eAutoHideFlag
        DockAreaHasAutoHideButton = ... # type: CDockManager.eAutoHideFlag
        AutoHideButtonTogglesArea = ... # type: CDockManager.eAutoHideFlag
        AutoHideButtonCheckable = ... # type: CDockManager.eAutoHideFlag
        AutoHideSideBarsIconOnly = ... # type: CDockManager.eAutoHideFlag
        AutoHideShowOnMouseOver = ... # type: CDockManager.eAutoHideFlag
        AutoHideCloseButtonCollapsesDock = ... # type: CDockManager.eAutoHideFlag
        AutoHideHasCloseButton = ... # type: CDockManager.eAutoHideFlag
        AutoHideHasMinimizeButton = ... # type: CDockManager.eAutoHideFlag
        AutoHideOpenOnDragHover = ... # type: CDockManager.eAutoHideFlag
        AutoHideCloseOnOutsideMouseClick = ... # type: CDockManager.eAutoHideFlag
        DefaultAutoHideConfig = ... # type: CDockManager.eAutoHideFlag

    class eConfigFlag(enum.Enum):
        ActiveTabHasCloseButton = ... # type: CDockManager.eConfigFlag
        DockAreaHasCloseButton = ... # type: CDockManager.eConfigFlag
        DockAreaCloseButtonClosesTab = ... # type: CDockManager.eConfigFlag
        OpaqueSplitterResize = ... # type: CDockManager.eConfigFlag
        XmlAutoFormattingEnabled = ... # type: CDockManager.eConfigFlag
        XmlCompressionEnabled = ... # type: CDockManager.eConfigFlag
        TabCloseButtonIsToolButton = ... # type: CDockManager.eConfigFlag
        AllTabsHaveCloseButton = ... # type: CDockManager.eConfigFlag
        RetainTabSizeWhenCloseButtonHidden = ... # type: CDockManager.eConfigFlag
        DragPreviewIsDynamic = ... # type: CDockManager.eConfigFlag
        DragPreviewShowsContentPixmap = ... # type: CDockManager.eConfigFlag
        DragPreviewHasWindowFrame = ... # type: CDockManager.eConfigFlag
        AlwaysShowTabs = ... # type: CDockManager.eConfigFlag
        DockAreaHasUndockButton = ... # type: CDockManager.eConfigFlag
        DockAreaHasTabsMenuButton = ... # type: CDockManager.eConfigFlag
        DockAreaHideDisabledButtons = ... # type: CDockManager.eConfigFlag
        DockAreaDynamicTabsMenuButtonVisibility = ... # type: CDockManager.eConfigFlag
        FloatingContainerHasWidgetTitle = ... # type: CDockManager.eConfigFlag
        FloatingContainerHasWidgetIcon = ... # type: CDockManager.eConfigFlag
        HideSingleCentralWidgetTitleBar = ... # type: CDockManager.eConfigFlag
        FocusHighlighting = ... # type: CDockManager.eConfigFlag
        EqualSplitOnInsertion = ... # type: CDockManager.eConfigFlag
        FloatingContainerForceNativeTitleBar = ... # type: CDockManager.eConfigFlag
        FloatingContainerForceQWidgetTitleBar = ... # type: CDockManager.eConfigFlag
        MiddleMouseButtonClosesTab = ... # type: CDockManager.eConfigFlag
        DisableTabTextEliding = ... # type: CDockManager.eConfigFlag
        ShowTabTextOnlyForActiveTab = ... # type: CDockManager.eConfigFlag
        DoubleClickUndocksWidget = ... # type: CDockManager.eConfigFlag
        DefaultDockAreaButtons = ... # type: CDockManager.eConfigFlag
        DefaultBaseConfig = ... # type: CDockManager.eConfigFlag
        DefaultOpaqueConfig = ... # type: CDockManager.eConfigFlag
        DefaultNonOpaqueConfig = ... # type: CDockManager.eConfigFlag
        NonOpaqueWithWindowFrame = ... # type: CDockManager.eConfigFlag

    class eViewMenuInsertionOrder(enum.Enum):
        MenuSortedByInsertion = ... # type: CDockManager.eViewMenuInsertionOrder
        MenuAlphabeticallySorted = ... # type: CDockManager.eViewMenuInsertionOrder
    ...
    def setDockWidgetToolBarStyle(self, Style: QtCore.Qt.ToolButtonStyle, State: 'CDockWidget.eState') -> None: ...
    @staticmethod
    def floatingContainersTitle() -> str: ...
    @staticmethod
    def setFloatingContainersTitle(Title: typing.Optional[str]) -> None: ...
    def setSplitterSizes(self, ContainedArea: typing.Optional['CDockAreaWidget'], sizes: collections.abc.Iterable[int]) -> None: ...
    ...
    def addToggleViewActionToMenu(self, ToggleViewAction: typing.Optional[QtGui.QAction], Group: typing.Optional[str] = ..., GroupIcon: QtGui.QIcon = ...) -> typing.Optional[QtGui.QAction]: ...
    def setCentralWidget(self, widget: typing.Optional['CDockWidget']) -> typing.Optional['CDockAreaWidget']: ...
    ...
    def addDockWidgetFloating(self, DockWidget: typing.Optional['CDockWidget']) -> typing.Optional['CFloatingDockContainer']: ...
    def addDockWidgetTabToArea(self, Dockwidget: typing.Optional['CDockWidget'], DockAreaWidget: typing.Optional['CDockAreaWidget'], Index: int = ...) -> typing.Optional['CDockAreaWidget']: ...
    def addDockWidgetTab(self, area: 'DockWidgetArea', Dockwidget: typing.Optional['CDockWidget']) -> typing.Optional['CDockAreaWidget']: ...
    ...
    def addDockWidgetToContainer(self, area: 'DockWidgetArea', Dockwidget: typing.Optional['CDockWidget'], DockContainerWidget: typing.Optional['CDockContainerWidget'] = ...) -> typing.Optional['CDockAreaWidget']: ...
    def addDockWidget(self, area: 'DockWidgetArea', Dockwidget: typing.Optional['CDockWidget'], DockAreaWidget: typing.Optional['CDockAreaWidget'] = ..., Index: int = ...) -> typing.Optional['CDockAreaWidget']: ...
    @staticmethod
    ...
    def createDockWidget(self, title: typing.Optional[str], parent: typing.Optional[QtWidgets.QWidget] = ...) -> typing.Optional['CDockWidget']: ...
...
class CDockOverlay(QtWidgets.QFrame):
    ...
    class eMode(enum.Enum):
        ModeDockAreaOverlay = ... # type: CDockOverlay.eMode
        ModeContainerOverlay = ... # type: CDockOverlay.eMode

    def __init__(self, parent: typing.Optional[QtWidgets.QWidget], Mode: 'CDockOverlay.eMode' = ...) -> None: ...
...
class CDockOverlayCross(QtWidgets.QWidget):
    ...
    class eIconColor(enum.Enum):
        FrameColor = ... # type: CDockOverlayCross.eIconColor
        WindowBackgroundColor = ... # type: CDockOverlayCross.eIconColor
        OverlayColor = ... # type: CDockOverlayCross.eIconColor
        ArrowColor = ... # type: CDockOverlayCross.eIconColor
        ShadowColor = ... # type: CDockOverlayCross.eIconColor
    ...
    def setIconColor(self, ColorIndex: 'CDockOverlayCross.eIconColor', Color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setIconBackgroundColor(self, Color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
...
class CDockWidgetTab(QtWidgets.QFrame):
    ...
    def __init__(self, DockWidget: typing.Optional['CDockWidget'], parent: typing.Optional[QtWidgets.QWidget] = ...) -> None: ...
...
class CElidingLabel(QtWidgets.QLabel):
    ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtWidgets.QWidget] = ..., f: QtCore.Qt.WindowType = ...) -> None: ...
    @typing.overload
    def __init__(self, text: typing.Optional[str], parent: typing.Optional[QtWidgets.QWidget] = ..., f: QtCore.Qt.WindowType = ...) -> None: ...
...
class IFloatingWidget(PyQt6.sip.simplewrapper):
    ...
    def startFloating(self, DragStartMousePos: QtCore.QPoint, Size: QtCore.QSize, DragState: 'eDragState', MouseEventHandler: typing.Optional[QtWidgets.QWidget]) -> None: ...
...
class CFloatingDockContainer(QtWidgets.QWidget, 'IFloatingWidget'):
    ...
    def hasTopLevelDockWidget(self) -> bool: ...
    def isClosable(self) -> bool: ...
    def startDragging(self, DragStartMousePos: QtCore.QPoint, Size: QtCore.QSize, MouseEventHandler: typing.Optional[QtWidgets.QWidget]) -> None: ...
    def dockContainer(self) -> typing.Optional['CDockContainerWidget']: ...
    def nativeEvent(self, eventType: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview], message: typing.Optional[PyQt6.sip.voidptr], result: typing.Optional[PyQt6.sip.voidptr]) -> bool: ...
    def showEvent(self, event: typing.Optional[QtGui.QShowEvent]) -> None: ...
...
class CFloatingDragPreview(QtWidgets.QWidget, 'IFloatingWidget'):
    ...
    @typing.overload
    def __init__(self, Content: typing.Optional[QtWidgets.QWidget], parent: typing.Optional[QtWidgets.QWidget]) -> None: ...
    @typing.overload
...
class CResizeHandle(QtWidgets.QFrame):
    ...
    def __init__(self, HandlePosition: QtCore.Qt.Edge, parent: typing.Optional[QtWidgets.QWidget]) -> None: ...
