...
class Hauptprogramm(tk.Tk):
    ...
    def baueWidgets(self):
        ...
        def FactoryPersonListe():
            ...
            form.addWidget(
                'kontaktdaten',
                scrolledtext.ScrolledText(self.frmPersonListeInhalt.innerFrame, width=20, height=2),
                'text',
        ...
        def FactoryFamListe():
            ...
            form.addWidget(
                'kontaktdaten',
                scrolledtext.ScrolledText(self.frmFamListeInhalt.innerFrame, width=20, height=2),
                'text',
        ...
        with Form() as form:
            ...
            form.addWidget(
                'bemerkung',
                scrolledtext.ScrolledText(self.frmGruppenDaten, width=50, height=5),
                'text',
        ...
        with Form() as form:
            ...
            form.addWidget(
                'bemerkung',
                scrolledtext.ScrolledText(self.frmVersandartenDaten, width=50, height=5),
                'text',
    ...
    def baueLayout(self):
        ...
        #
        # Frames in Notebooks
        self.pndPersonenEinzelheiten = ttk.PanedWindow(
            self.frmNbkPersonen,
            orient=tk.HORIZONTAL)
        self.nbkPersonen.add(self.pndPersonenEinzelheiten, text='Einzelheiten')
        ...
        self.pndFamilienEinzelheiten = ttk.PanedWindow(
            self.frmNbkFamilien,
            orient=tk.HORIZONTAL)
        self.nbkFamilien.add(self.pndFamilienEinzelheiten, text='Einzelheiten')
        
        self.frmFamListe = ttk.Frame(self.frmNbkFamilien)
