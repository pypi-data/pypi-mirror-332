...
class Channel():
    ...
    async def update_channel(self, server_id: int, name: str=None, icon: str=None, content: str=None) -> 'Channel':
        ...
        api_endpoint = f"https://bloyid.com/api/servers/{server_id}/channels/{self.id}"
        ...
        async with aiohttp.ClientSession() as session:
            ...
            if content is not None:
                api_endpoint = f"https://bloyid.com/api/servers/{server_id}/channels/{self.id}/notice"
    ...
    async def _get_messages_raw(self, amount: int) -> str:
        ...
        api_endpoint = f"https://bloyid.com/api/channels/{self.id}/messages?limit={amount}"
    ...
    async def set_permissions(self, permission_integer: int, role: Role) -> 'Channel':
        ...
        """
        api_url = f"https://bloyid.com/api/servers/{self.server_id}/channels/{self.id}/permissions/{role.id}"
        headers = {
            "Authorization": GlobalClientInformation.TOKEN,
            "Content-Type": "application/json",
        }
