...
class Post():
    ...
    def __init__(self) -> None:
        from bloyid.member import Member       # Lazy Import :)
    ...
    def get_post(post_id: int) -> 'Post':
        ...
        api_endpoint = f"https://server.bloyid.com/api/posts/{post_id}"
    ...
    def delete_post(self) -> None:
        ...
        api_endpoint = f"https://server.bloyid.com/api/posts/{self.id}"
    ...
    def get_comments(self, limit: int = 30) -> list['Post']:
        ...
        api_endpoint = f"https://server.bloyid.com/api/posts/{self.id}/comments?limit={limit}"
    ...
    def like(self) -> None:
        ...
        api_endpoint = f"https://server.bloyid.com/api/posts/{self.id}/like"
    ...
    def unlike(self) -> None:
        ...
        api_endpoint = f"https://server.bloyid.com/api/posts/{self.id}/unlike"
