...
from bloyid.invite import Invite
from bloyid.member import Member, ServerMember
from bloyid.channel import Channel
from bloyid.roles import Role
...
class Server():
    ...
    def get_ban_list(self) -> list[Member]:
        ...
        api_endpoint = f"https://server.bloyid.com/api/servers/{self.id}/bans/"
    ...
    def get_server_details(self) -> None:
        ...
        api_endpoint = f"https://server.bloyid.com/api/servers/invites/{invite_code.code}"
    ...
    def update_member(self, user_id: int, role_ids: list[int]=None) -> None:
        ...
        api_endpoint = f"https://server.bloyid.com/api/servers/{self.id}/members/{user_id}/"
    ...
    def create_role(self) -> None:
        ...
        api_endpoint = f"https://server.bloyid.com/api/servers/{self.id}/roles"
    ...
    def delete_role(self, role_id: int) -> None:
        ...
        api_endpoint = f"https://server.bloyid.com/api/servers/{self.id}/roles/{role_id}/"
    ...
    def create_channel(self, name: str, type: int) -> None:
        ...
        api_endpoint = f"https://server.bloyid.com/api/servers/{self.id}/channels"
    ...
    def delete_channel(self, channel_id: int) -> None:
        ...
        api_endpoint = f"https://server.bloyid.com/api/servers/{self.id}/channels/{channel_id}/"
    ...
    def update_channel(self, channel_id: int, name: str=None, icon: str=None, content: str=None) -> None:
        ...
        api_endpoint = f"https://server.bloyid.comapi/servers/{self.id}/channels/{channel_id}"
        ...
        if (content != None):
            api_endpoint = f"https://server.bloyid.com/api/servers/{self.id}/channels/{channel_id}/notice"
    ...
    def create_invite(self) -> Invite:
        ...
        api_endpoint = f"https://server.bloyid.com/api/servers/{self.id}/invites"
    ...
    def delete_invite(self, code: str) -> None:
        ...
        api_endpoint = f"https://server.bloyid.com/api/servers/{self.id}/invites/{code}"
