from bloyid.member import Member
...
class Message():
    """
    Represents a message in Bloyid.
    ...
    def delete(self) -> None:
        ...
        api_endpoint = f"https://server.bloyid.com/api/channels/{self.channel_id}/messages/{self.id}"
    ...
    def react(self, emoji: str):
        ...
        api_endpoint = f"https://server.bloyid.com/api/channels/{self.channel_id}/messages/{self.id}/reactions"
    ...
    def unreact(self, emoji: str):
        ...
        api_endpoint = f"https://server.bloyid.com/api/channels/{self.channel_id}/messages/{self.id}/reactions/remove"
