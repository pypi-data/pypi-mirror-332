from bloyid._enums import AttachmentTypes, GlobalClientInformation
import aiohttp
import mimetypes

class Attachment():
    """
    Represents an attachment in Bloyid.
    ...
    async def upload(self):
        ...
        async with aiohttp.ClientSession() as session:
            async with session.post("https://cdn.bloyid.com/upload", headers=headers, data=formdata) as cdn_response:
