...
def _validate_engine_builder_fields(
    ...
    if violations:
        _collect_error(
            f"{definitions.EntityType.ENGINE_BUILDER_MODEL}s don't support these `remote_config` fields: {violations}. Leave them unset (at their defaults) for this chainlet.",
