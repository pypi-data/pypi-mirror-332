...
if sys.version_info >= (3, 10):
    ...
    __version__: str = version("zbyte_polyfile")
    del version
else:
    import pkg_resources
    __version__ = pkg_resources.require("zbyte_polyfile")[0].version
    del pkg_resources
...
log = logger.getStatusLogger("zbyte_polyfile")
