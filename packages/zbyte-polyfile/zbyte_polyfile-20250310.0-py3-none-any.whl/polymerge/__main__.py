...
from zbyte_polyfile import logger, __version__
...
''', formatter_class=RawTextHelpFormatter)
    ...
    parser.add_argument('--type-hierarchy', '-t', type=str, default=None, help='Optional path to output a Graphviz .dot file representing the type hierarchy extracted from zbyte_polyfile')
