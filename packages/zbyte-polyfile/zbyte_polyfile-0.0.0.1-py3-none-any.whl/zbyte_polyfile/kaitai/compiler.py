...
This script is called from zbyte_polyfile's setup.py to compile the entire Kaitai Struct format library at build time.
...
def compile(ksy_path: Union[str, Path], output_directory: Union[str, Path], auto_install: bool = True) -> CompiledKSY:
    ...
    cmd = [
        ...
        "--debug", "--ksc-json-output", "-I", str(Path.cwd()), "--python-package", "zbyte_polyfile.kaitai.parsers"
    ]
