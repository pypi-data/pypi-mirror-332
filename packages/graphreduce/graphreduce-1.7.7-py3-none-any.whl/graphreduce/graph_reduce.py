...
Joins two graph reduce nodes of SQL dialect.
        ...
        parent_node.create_ref(JOIN_SQL, 'join', overwrite=True, schema=self._checkpoint_schema)
        self._mark_merged(parent_node, relation_node)
        ...
        for edge in self.depth_first_generator():
            ...
            if edge_data['reduce']:
                ...
                # Custom `do_reduce` implementation.
                    ...
                    reduce_ref = relation_node.create_ref(reduce_sql, relation_node.do_reduce, schema=self._checkpoint_schema)
            else:
            ...
            pja_ref = parent_node.create_ref(pja_sql, parent_node.do_post_join_annotate, schema=self._checkpoint_schema)
            ...
            if hasattr(parent_node, 'do_post_join_filters'):
                ...
                pjf_ref = parent_node.create_ref(pjf_sql, parent_node.do_post_join_filters, schema=self._checkpoint_schema)
