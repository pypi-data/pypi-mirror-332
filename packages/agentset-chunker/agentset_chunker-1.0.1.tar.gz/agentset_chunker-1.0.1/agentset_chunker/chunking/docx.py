...
def docx(file_path:str, opt:ChunkerOptions)->list[Document] | None:
    """
    Processes a DOCX file and chunks its content based on the provided options.
    ...
    elements = partition_docx(filename=file_path, strategy=partition_strategy)
