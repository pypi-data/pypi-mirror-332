...
def pdf(file_path:str, opt:ChunkerOptions)->list[Document] | None:
    """
    Processes a PDF file and chunks its content based on the provided options.
    ...
    elements = partition_pdf(filename=file_path, strategy=partition_strategy )
