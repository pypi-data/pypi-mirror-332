...
class Connection:
    ...
    def delete_project(self, project_id, delete_images=False, delete_preferences=False):
        ...
        response = self._session.delete(
            self.url(self.path.projects, project_id),
    ...
    def delete_note(self, project_id, trace_uid, note_id, refresh=None):
        ...
        response = self._session.delete(self.url(self.path.projects, project_id, '/traces', trace_uid, '/notes',
                                                 note_id), headers=headers)
        with drain(response):
            return _expect_ok(response) is response
    ...
    def tag(self, project_id, trace_uid, tag, refresh=None):
        ...
        if isinstance(trace_uid, str):
            ...
            response = self._session.put(self.url(self.path.projects, project_id, '/traces', '/tags',
                                                  quote(tag, '')),
                                         json=list(trace_uid),
                                         headers=headers)
    ...
    def delete_tag(self, project_id, trace_uid, tag, refresh=None):
        ...
        if isinstance(trace_uid, str):
            ...
            response = self._session.delete(self.url(self.path.projects, project_id, '/traces', '/tags',
                                                     quote(tag, '')),
                                            json=list(trace_uid),
                                            headers=headers)
        with drain(response):
    ...
    def delete_cleaned_data_trace(self, project_id, trace_uid, data_type=None):
        ...
        """
        response = self._session.delete(self.url(self.path.projects, project_id, '/traces', trace_uid, 'cleandata'),
    ...
    def delete_cleaned_data(self, *, trace_uid=None, image_id=None, data_type=None):
        ...
        * project:   delete all the cleaned data for all images of a project.
        ...
        if trace_uid is not None:
            ...
            self.connection.delete_cleaned_data_trace(project_id=self.project_id, trace_uid=trace_uid,
                                                      data_type=data_type)
