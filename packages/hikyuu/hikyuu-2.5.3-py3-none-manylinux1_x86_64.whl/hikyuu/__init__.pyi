...
from hikyuu.cpp.core38 import Datetime as D
...
from hikyuu.cpp.core38 import Query as Q
...
def set_global_context(stk, query):
    ...
    """
A: cpp.core38.Indicator  # value = Indicator{...
AMO: cpp.core38.Indicator  # value = Indicator{...
C: cpp.core38.Indicator  # value = Indicator{...
CLOSE: cpp.core38.Indicator  # value = Indicator{...
DEBUG: cpp.core38.LOG_LEVEL  # value = <LOG_LEVEL.DEBUG: 1>
DRAWNULL: float  # value = nan
ERROR: cpp.core38.LOG_LEVEL  # value = <LOG_LEVEL.ERROR: 4>
FATAL: cpp.core38.LOG_LEVEL  # value = <LOG_LEVEL.FATAL: 5>
H: cpp.core38.Indicator  # value = Indicator{...
HIGH: cpp.core38.Indicator  # value = Indicator{...
INFO: cpp.core38.LOG_LEVEL  # value = <LOG_LEVEL.INFO: 2>
K = None
KDATA: cpp.core38.Indicator  # value = Indicator{...
L: cpp.core38.Indicator  # value = Indicator{...
LOW: cpp.core38.Indicator  # value = Indicator{...
MAXYEAR: int = 9999
MINYEAR: int = 1
O: cpp.core38.Indicator  # value = Indicator{...
OFF: cpp.core38.LOG_LEVEL  # value = <LOG_LEVEL.OFF: 6>
OPEN: cpp.core38.Indicator  # value = Indicator{...
TRACE: cpp.core38.LOG_LEVEL  # value = <LOG_LEVEL.TRACE: 0>
V: cpp.core38.Indicator  # value = Indicator{...
VOL: cpp.core38.Indicator  # value = Indicator{...
WARN: cpp.core38.LOG_LEVEL  # value = <LOG_LEVEL.WARN: 3>
...
blocksz = None
blockzxb = None
constant: cpp.core38.Constant  # value = <hikyuu.cpp.core38.Constant object>
datetime_CAPI: typing.Any  # value = <capsule object "datetime.datetime_CAPI" at 0x72d17bf6d780>
hku_logger: logging.Logger  # value = <Logger hikyuu (INFO)>
sm: cpp.core38.StockManager  # value = <hikyuu.cpp.core38.StockManager object>
zsbk_a = None
zsbk_bj = None
zsbk_cyb = None
zsbk_hs300 = None
