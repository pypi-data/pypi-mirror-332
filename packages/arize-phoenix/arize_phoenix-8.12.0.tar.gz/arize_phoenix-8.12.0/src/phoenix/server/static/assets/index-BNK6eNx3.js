import{r as t,j as o,bi as z,l as c,O as w,R as P,E as b,cu as k,e9 as S,ea as F,eb as L,ec as l,v as C,ed as E}from"./vendor-Byx9ZW8r.js";import{d as R,H as I,D as j,S as T,U as _}from"./vendor-arizeai-0BoxbU9V.js";import{L as A,r as D,d as O,e as G,F as M,f as N,P as U,h as V,M as m,g as W,D as q,i as H,E as B,j as J,k as K,p as $,l as Y,n as p,o as Q,q as X,s as Z,S as oo,t as lo,v as ao,w as ro,x as co,y as u,z as f,A as y,B as go,C as eo,G as bo,H as no,I as io,J as so,K as to,N as mo,O as po,Q as uo,U as fo,V as yo,W as vo,X as ho,Y as xo,Z as zo,_ as wo,$ as Po,a0 as ko,a1 as So,a2 as Fo,a3 as Lo,a4 as Co,a5 as Eo,a6 as Ro,a7 as Io,a8 as jo,a9 as To,aa as _o,ab as Ao,ac as Do}from"./pages-CyqzCvBY.js";import{W as Oo,dG as Go,ba as Mo,U as No,dH as Uo,dI as Vo}from"./components-CbkVj1OQ.js";import"./vendor-three-C-AGeJYv.js";import"./vendor-codemirror-BX78TDyo.js";import"./vendor-shiki-DpPpUgzv.js";import"./vendor-recharts-BLborQJX.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const g of r)if(g.type==="childList")for(const n of g.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function i(r){const g={};return r.integrity&&(g.integrity=r.integrity),r.referrerPolicy&&(g.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?g.credentials="include":r.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function s(r){if(r.ep)return;r.ep=!0;const g=i(r);fetch(r.href,g)}})();const v="arize-phoenix-feature-flags",d={__RESET__:!1};function Wo(){const a=localStorage.getItem(v);if(!a)return d;try{const e=JSON.parse(a);return Object.assign({},d,e)}catch{return d}}const h=t.createContext(null);function qo(){const a=P.useContext(h);if(a===null)throw new Error("useFeatureFlags must be used within a FeatureFlagsProvider");return a}function Ho(a){const[e,i]=t.useState(Wo()),s=r=>{localStorage.setItem(v,JSON.stringify(r)),i(r)};return o(h.Provider,{value:{featureFlags:e,setFeatureFlags:s},children:o(Bo,{children:a.children})})}function Bo(a){const{children:e}=a,{featureFlags:i,setFeatureFlags:s}=qo(),[r,g]=t.useState(!1);return z("ctrl+shift+f",()=>g(!0)),c(w,{children:[e,o(j,{type:"modal",isDismissable:!0,onDismiss:()=>g(!1),children:r&&o(R,{title:"Feature Flags",children:o(Oo,{height:"size-1000",padding:"size-100",children:Object.keys(i).map(n=>o(I,{isSelected:i[n],onChange:x=>s({...i,[n]:x}),children:n},n))})})})]})}const Jo=b`
  :root {
...
`;function al(){const{theme:a="dark"}=T();return o(k,{styles:b($o,Ko,a==="dark"?Yo:Qo,Xo(a),Jo,Zo,ol,ll)})}const rl=S(F(c(l,{path:"/",errorElement:o(_o,{}),children:[o(l,{path:"/login",element:o(A,{})}),o(l,{path:"/reset-password",element:o(O,{}),loader:D}),o(l,{path:"/reset-password-with-token",element:o(G,{})}),o(l,{path:"/forgot-password",element:o(M,{})}),o(l,{element:o(To,{}),loader:N,children:c(l,{element:o(jo,{}),children:[o(l,{path:"/profile",handle:{crumb:()=>"profile"},element:o(U,{})}),o(l,{index:!0,loader:V}),c(l,{path:"/model",handle:{crumb:()=>"model"},element:o(J,{}),children:[o(l,{index:!0,element:o(m,{})}),o(l,{element:o(m,{}),children:o(l,{path:"dimensions",children:o(l,{path:":dimensionId",element:o(q,{}),loader:W})})}),o(l,{path:"embeddings",children:o(l,{path:":embeddingDimensionId",element:o(B,{}),loader:H,handle:{crumb:a=>a.embedding.name}})})]}),c(l,{path:"/projects",handle:{crumb:()=>"projects"},element:o(ro,{}),children:[o(l,{index:!0,element:o(K,{})}),c(l,{path:":projectId",loader:$,handle:{crumb:a=>a.project.name},children:[o(l,{index:!0,element:o(Y,{})}),c(l,{element:o(ao,{}),children:[o(l,{path:"traces",element:o(Q,{}),children:o(l,{path:":traceId",element:o(p,{})})}),o(l,{path:"spans",element:o(X,{}),children:o(l,{path:":traceId",element:o(p,{})})}),o(l,{path:"sessions",element:o(lo,{}),children:o(l,{path:":sessionId",element:o(oo,{}),loader:Z})})]})]})]}),c(l,{path:"/datasets",handle:{crumb:()=>"datasets"},children:[o(l,{index:!0,element:o(co,{})}),c(l,{path:":datasetId",loader:u,handle:{crumb:a=>a.dataset.name},children:[c(l,{element:o(no,{}),loader:u,children:[o(l,{index:!0,element:o(y,{}),loader:f}),o(l,{path:"experiments",element:o(y,{}),loader:f}),o(l,{path:"examples",element:o(bo,{}),loader:go,children:o(l,{path:":exampleId",element:o(eo,{})})})]}),o(l,{path:"compare",handle:{crumb:()=>"compare"},loader:io,element:o(so,{})})]})]}),c(l,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(l,{index:!0,element:o(to,{})}),o(l,{path:"spans/:spanId",element:o(po,{}),loader:mo,handle:{crumb:a=>a.span.__typename==="Span"?`span ${a.span.spanId}`:"span unknown"}})]}),c(l,{path:"/prompts",handle:{crumb:()=>"prompts"},children:[o(l,{index:!0,element:o(fo,{}),loader:uo}),c(l,{path:":promptId",loader:yo,shouldRevalidate:()=>!0,handle:{crumb:a=>a.prompt.__typename==="Prompt"?a.prompt.name:"unknown"},children:[c(l,{element:o(So,{}),children:[o(l,{index:!0,element:o(vo,{})}),o(l,{path:"versions",loader:ho,element:o(wo,{}),children:o(l,{path:":versionId",loader:xo,element:o(zo,{})})}),o(l,{path:"config",element:o(ko,{}),loader:Po})]}),o(l,{path:"playground",element:o(Lo,{}),loader:Fo,handle:{crumb:()=>"playground"}})]})]}),o(l,{path:"/apis",element:o(Co,{}),handle:{crumb:()=>"APIs"}}),o(l,{path:"/support",element:o(Eo,{}),handle:{crumb:()=>"support"}}),o(l,{path:"/settings",element:o(Io,{}),loader:Ro,handle:{crumb:()=>"settings"}})]})})]})),{basename:window.Config.basename});function cl(){return o(L,{router:rl})}function gl(){return o(Ao,{children:o(Go,{children:o(el,{})})})}function el(){const{theme:a}=Mo();return o(_,{theme:a,mountGlobalStyles:!1,children:c(C.RelayEnvironmentProvider,{environment:No,children:[o(al,{}),o(Ho,{children:o(Uo,{children:o(Do,{children:o(t.Suspense,{children:o(Vo,{children:o(cl,{})})})})})})]})})}const bl=document.getElementById("root"),nl=E.createRoot(bl);nl.render(o(gl,{}));
