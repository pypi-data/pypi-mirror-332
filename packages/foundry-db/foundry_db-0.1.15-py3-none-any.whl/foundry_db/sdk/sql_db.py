...
class SQLDatabase:
    ...
    def get_db_credentials():
        ...
        Credentials can be set in credentials which has priority, otherwise it falls back to parameters,
        where environmnet variables have to be used for username and password.
        Returns:
        ...
        try:
            ...
            db_credentials = conf_loader["parameters"]["postgres"]
