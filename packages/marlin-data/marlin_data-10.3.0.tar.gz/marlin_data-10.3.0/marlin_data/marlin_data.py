...
class MarlinDerivedData(object):
    ...
    def build_derived_data(self, simulation_data : SimulationData = None, f_min : int = 0, f_max : int = 1000, indexing = False):
        ...
        delta_index = int(self.sample_rate * 0.5)
        ...
        while current_idx < len(raw_data):
            ...
            # print (elapsed_s)
            # print (f_power_vector[0:20])
            # print ('---')
            # print (self.librosa_time_disrete_bins)
            # print (self.librosa_f_discrete_bins)
            # exit()
            # plt.plot(self.librosa_f_discrete_bins[2:10],f_power_vector[2:10],color='green', linewidth=0.5, markersize=0.5)
            # plt.xlabel('f (Hz)')
            # plt.ylabel('Amplitude')
            # plt.ylim(0,1)
            # plt.title("Waveform")
