...
class PaymentWebhookEvent(WebhookEvent):
    ...
    amount: str
    currency: str
    fee_paid_by_payer: Annotated[
        int | float,
        Field(validation_alias="feePaidByPayer"),
    ]
    under_paid_cover: Annotated[
        int | float,
        Field(validation_alias="underPaidCover"),
    ]
    ...
    sender_address: Annotated[
        str | None,
        Field(None, validation_alias="senderAddress"),
    ]
