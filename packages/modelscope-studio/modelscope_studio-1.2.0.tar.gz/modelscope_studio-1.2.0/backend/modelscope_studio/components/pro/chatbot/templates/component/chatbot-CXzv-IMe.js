...
function wi(e, t, n) {
  var r, o, i, s, a, l, u = 0, f = !1, d = !1, m = !0;
  if (typeof e != "function")
    throw new TypeError(bi);
  t = Dn(t) || 0, ve(n) && (f = !!n.leading, d = "maxWait" in n, i = d ? Si(Dn(n.maxWait) || 0, t) : i, m = "trailing" in n ? !!n.trailing : m);
  function h(v) {
    var x = r, P = o;
  ...
  function _(v) {
    return a = void 0, m && r ? h(v) : (r = o = void 0, s);
  }
  function E() {
 ...
 */
var _i = c, Ei = Symbol.for("react.element"), Ti = Symbol.for("react.fragment"), $i = Object.prototype.hasOwnProperty, Pi = _i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, Ri = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
...
function Ui(e) {
  ...
  return {
    c() {
      t = Ar("react-portal-target"), n = Di(), i && i.c(), r = Wn(), this.h();
    },
    l(s) {
      t = jr(s, "REACT-PORTAL-TARGET", {
        class: !0
      }), Fr(t).forEach(De), n = Li(s), i && i.l(s), r = Wn(), this.h();
    },
    h() {
      kr(t, "class", "svelte-1rt0kpf");
    },
    ...
    p(s, [a]) {
      ...
      16 && gt(i, 1)) : (i = Un(s), i.c(), gt(i, 1), i.m(r.parentNode, r)) : i && (Ai(), rn(i, 1, 1, () => {
        i = null;
      }), Mi());
    },
    i(s) {
...
function Gi(e, t, n) {
  ...
  const d = dt();
  Vn(e, d, (w) => n(1, o = w));
  const m = [], h = Vi("$$ms-gr-react-wrapper"), {
    slotKey: y,
    slotIndex: g,
    subSlotIndex: p
  } = No() || {}, b = l({
  ...
  return e.$$set = (w) => {
    n(17, t = Hn(Hn({}, t), Xn(w))), "svelteInit" in w && n(5, l = w.svelteInit), "$$scope" in w && n(6, s = w.$$scope);
  }, t = Xn(t), [r, o, f, d, a, l, s, i, _, E];
}
class Ki extends Ii {
  constructor(t) {
    super(), ki(this, t, Gi, Ui, zi, {
      svelteInit: 5
    });
  }
}
...
function rs(e, t) {
  ...
  }), l = te(a, 2), u = l[0], f = l[1], d = o !== void 0 ? o : u, m = s ? s(d) : d, h = Pe(i), y = Ze([d]), g = te(y, 2), p = g[0], b = g[1];
  Qn(function() {
    var E = p[0];
    u !== E && h(u, E);
  }, [p]), Qn(function() {
 ...
 * LICENSE file in the root directory of this source tree.
 */
var Cn = Symbol.for("react.element"), _n = Symbol.for("react.portal"), Tt = Symbol.for("react.fragment"), $t = Symbol.for("react.strict_mode"), Pt = Symbol.for("react.profiler"), Rt = Symbol.for("react.provider"), It = Symbol.for("react.context"), os = Symbol.for("react.server_context"), Mt = Symbol.for("react.forward_ref"), Lt = Symbol.for("react.suspense"), Nt = Symbol.for("react.suspense_list"), Ot = Symbol.for("react.memo"), Ft = Symbol.for("react.lazy"), is = Symbol.for("react.offscreen"), Hr;
...
D.isValidElementType = function(e) {
  return typeof e == "string" || typeof e == "function" || e === Tt || e === Pt || e === $t || e === Lt || e === Nt || e === is || typeof e == "object" && e !== null && (e.$$typeof === Ft || e.$$typeof === Ot || e.$$typeof === Rt || e.$$typeof === It || e.$$typeof === Mt || e.$$typeof === Hr || e.getModuleId !== void 0);
};
D.typeOf = ce;
Dr.exports = D;
...
function Jn(e) {
  ...
  if (c.useEffect(() => {
    ...
    if (s) {
      ...
      return document.addEventListener("dragenter", m), document.addEventListener("dragover", h), document.addEventListener("dragleave", y), document.addEventListener("drop", g), () => {
        document.removeEventListener("dragenter", m), document.removeEventListener("dragover", h), document.removeEventListener("dragleave", y), document.removeEventListener("drop", g);
      };
    }
  }, [!!s]), !(t && s && !i))
    return null;
...
function gs(e) {
  ...
  if (e instanceof c.Component) {
    var n;
    return (n = Fn.findDOMNode) === null || n === void 0 ? void 0 : n.call(Fn, e);
  }
  return null;
}
function hs(e, t) {
...
const Rs = function(e, t, n) {
  ...
  return Qr(function() {
    if (i !== rr && i !== En) {
      var h = m.indexOf(i), y = m[h + 1], g = n(i);
...
function Is(e, t, n, r) {
  var o = r.motionEnter, i = o === void 0 ? !0 : o, s = r.motionAppear, a = s === void 0 ? !0 : s, l = r.motionLeave, u = l === void 0 ? !0 : l, f = r.motionDeadline, d = r.motionLeaveImmediately, m = r.onAppearPrepare, h = r.onEnterPrepare, y = r.onLeavePrepare, g = r.onAppearStart, p = r.onEnterStart, b = r.onLeaveStart, _ = r.onAppearActive, E = r.onEnterActive, w = r.onLeaveActive, C = r.onAppearEnd, v = r.onEnterEnd, x = r.onLeaveEnd, P = r.onVisibleChanged, N = Ze(), F = te(N, 2), I = F[0], T = F[1], k = Ss(Ee), L = te(k, 2), R = L[0], O = L[1], W = Ze(null), X = te(W, 2), Y = X[0], B = X[1], z = R(), K = Q(!1), J = Q(null);
  function U() {
    return n();
  }
  var oe = Q(!1);
  ...
  var ue = Pe(function(re) {
  ...
  }), qe = _s(ue), Oe = te(qe, 1), Fe = Oe[0], je = function(ee) {
    switch (ee) {
      case it:
        return V(V(V({}, de, m), He, g), Be, _);
      case st:
        return V(V(V({}, de, h), He, p), Be, E);
      case at:
        return V(V(V({}, de, y), He, b), Be, w);
      default:
        return {};
    }
  }, be = M.useMemo(function() {
    return je(z);
  }, [z]), Ae = Rs(z, !e, function(re) {
    if (re === de) {
      var ee = be[de];
      return ee ? ee(U()) : to;
    }
    ...
    return H === Be && z !== Ee && (Fe(U()), f > 0 && (clearTimeout(J.current), J.current = setTimeout(function() {
      ue({
        deadline: !0
      });
    }, f))), H === Xr && Ne(), Ps;
  }), $ = te(Ae, 2), G = $[0], H = $[1], Se = no(H);
  oe.current = Se;
  var fe = Q(null);
  Qr(function() {
    if (!(K.current && fe.current === t)) {
      ...
      K.current = !0;
      var ee;
      !re && t && a && (ee = it), re && t && i && (ee = st), (re && !t && u || !re && d && !t && u) && (ee = at);
      var pe = je(ee);
      ee && (e || pe[de]) ? (O(ee), G()) : O(Ee), fe.current = t;
    }
  }, [t]), we(function() {
    // Cancel appear
    (z === it && !a || // Cancel enter
  ...
  var ke = M.useRef(!1);
  we(function() {
    I && (ke.current = !0), I !== void 0 && z === Ee && ((ke.current || I) && (P == null || P(I)), ke.current = !0);
  }, [I, z]);
  var Vt = Y;
...
function Ms(e) {
  ...
  var r = /* @__PURE__ */ M.forwardRef(function(o, i) {
    var s = o.visible, a = s === void 0 ? !0 : s, l = o.removeOnLeave, u = l === void 0 ? !0 : l, f = o.forceRender, d = o.children, m = o.motionName, h = o.leavedClassName, y = o.eventProps, g = M.useContext(ys), p = g.motion, b = n(o, p), _ = Q(), E = Q();
    function w() {
      try {
        return _.current instanceof HTMLElement ? _.current : gs(E.current);
      } catch {
        return null;
      }
    }
    var C = Is(b, a, w, o), v = te(C, 4), x = v[0], P = v[1], N = v[2], F = v[3], I = M.useRef(F);
    F && (I.current = !0);
    ...
    if (!d)
      ...
      F ? k = d(j({}, L), T) : !u && I.current && h ? k = d(j(j({}, L), {}, {
        className: h
      }), T) : f || !u && !h ? k = d(j(j({}, L), {}, {
        style: {
          display: "none"
      ...
      var O = ar(m, "".concat(x, "-").concat(R));
      k = d(j(j({}, L), {}, {
        className: A(ar(m, x), V(V({}, O, O && R), m, typeof m == "string")),
        style: N
      }), T);
    }
    if (/* @__PURE__ */ M.isValidElement(k) && fs(k)) {
      var W = ds(k);
      W || (k = /* @__PURE__ */ M.cloneElement(k, {
        ref: T
      }));
    }
...
var Fs = ["component", "children", "onVisibleChanged", "onAllRemoved"], js = ["status"], As = ["eventProps", "visible", "children", "motionName", "motionAppear", "motionEnter", "motionLeave", "motionLeaveImmediately", "motionDeadline", "removeOnLeave", "leavedClassName", "onAppearPrepare", "onAppearStart", "onAppearActive", "onAppearEnd", "onEnterStart", "onEnterActive", "onEnterEnd", "onLeaveStart", "onLeaveActive", "onLeaveEnd"];
function ks(e) {
    ...
    function i() {
      ...
      return s = o.call.apply(o, [this].concat(l)), V(Ie(s), "state", {
        ...
        s.setState(function(d) {
          ...
          var d = s.state.keyEntities, m = d.filter(function(h) {
            var y = h.status;
            return y !== qt;
          }).length;
          m === 0 && s.props.onAllRemoved && s.props.onAllRemoved();
        });
      }), s;
    }
    return Ge(i, [{
      key: "render",
      value: function() {
        var a = this, l = this.state.keyEntities, u = this.props, f = u.component, d = u.children, m = u.onVisibleChanged;
        u.onAllRemoved;
        var h = tr(u, Fs), y = f || M.Fragment, g = {};
        return As.forEach(function(p) {
          g[p] = h[p], delete h[p];
        }), delete h.keys, /* @__PURE__ */ M.createElement(y, h, l.map(function(p, b) {
          var _ = p.status, E = tr(p, js), w = _ === an || _ === ln;
          return /* @__PURE__ */ M.createElement(t, _e({}, g, {
            key: E.key,
            visible: w,
            eventProps: E,
      ...
      value: function(a, l) {
        var u = a.keys, f = l.keyEntities, d = un(u), m = Os(f, d);
        return {
...
function Ds(e, t) {
  ...
  return c.useImperativeHandle(t, () => i.current), /* @__PURE__ */ c.createElement(Ir, _e({}, r, {
    showUploadList: !1,
    rootClassName: o,
    ref: i
  }), n);
...
function Zs(e) {
  ...
  function l(m, h, y, g) {
    ...
    var _ = (g == null ? void 0 : g.unitless) || {}, E = typeof a == "function" ? a(m) : {}, w = j(j({}, E), {}, V({}, b("zIndexPopup"), !0));
    ...
    var C = j(j({}, g), {}, {
      unitless: w,
      prefixToken: b
    }), v = f(m, h, y, C), x = u(p, y, C);
    return function(P) {
      var N = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : P, F = v(P, N), I = te(F, 2), T = I[1], k = x(N), L = te(k, 2), R = L[0], O = L[1];
      return [R, T, O];
    };
  }
  function u(m, h, y) {
    var g = y.unitless, p = y.injectStyle, b = p === void 0 ? !0 : p, _ = y.prefixToken, E = y.ignore, w = function(x) {
      var P = x.rootCls, N = x.cssVar, F = N === void 0 ? {} : N, I = r(), T = I.realToken;
      return li({
        path: [m],
        prefix: F.prefix,
        key: F.key,
        ...
        var k = dr(m, T, h), L = ur(m, T, k, {
          deprecatedTokens: y == null ? void 0 : y.deprecatedTokens
        });
        return Object.keys(k).forEach(function(R) {
          L[_(R)] = L[R], delete L[R];
        }), L;
      }), null;
    }, C = function(x) {
      var P = r(), N = P.cssVar;
      return [function(F) {
        return b && N ? /* @__PURE__ */ c.createElement(c.Fragment, null, /* @__PURE__ */ c.createElement(w, {
          rootCls: x,
          cssVar: N,
          component: m
        }), F) : F;
  ...
  function f(m, h, y) {
    var g = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, p = Array.isArray(m) ? m : [m, m], b = te(p, 1), _ = b[0], E = p.join("-"), w = e.layer || {
      name: "antd"
    };
    return function(C) {
      var v = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : C, x = r(), P = x.theme, N = x.realToken, F = x.hashId, I = x.token, T = x.cssVar, k = o(), L = k.rootPrefixCls, R = k.iconPrefixCls, O = n(), W = T ? "css" : "js", X = Ys(function() {
        var U = /* @__PURE__ */ new Set();
        return T && Object.keys(g.unitless || {}).forEach(function(oe) {
          U.add(Wt(oe, T.prefix)), U.add(Wt(oe, cr(_, T.prefix)));
        }), Ws(W, U);
      }, [W, _, T == null ? void 0 : T.prefix]), Y = Gs(W), B = Y.max, z = Y.min, K = {
        theme: P,
        token: I,
        hashId: F,
        nonce: function() {
      ...
      var J = kn(j(j({}, K), {}, {
        ...
        if (g.injectStyle === !1)
          return [];
        var U = Us(I), oe = U.token, Ne = U.flush, ue = dr(_, N, y), qe = ".".concat(C), Oe = ur(_, N, ue, {
          deprecatedTokens: g.deprecatedTokens
        });
        T && ue && Z(ue) === "object" && Object.keys(ue).forEach(function(Ae) {
          ue[Ae] = "var(".concat(Wt(Ae, cr(_, T.prefix)), ")");
        });
        var Fe = Ke(oe, {
          componentCls: qe,
          prefixCls: C,
        ...
        Ne(_, Oe);
        var be = typeof s == "function" ? s(Fe, C, v, g.resetFont) : null;
  ...
  function d(m, h, y) {
    var g = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, p = f(m, h, y, j({
      resetStyle: !1,
      // Sub Style should default after root one
      order: -998
    }, g)), b = function(E) {
      var w = E.prefixCls, C = E.rootCls, v = C === void 0 ? w : C;
      return p(w, v), null;
    };
    return b;
  }
...
class ye {
  ...
  fromHsl({
    ...
    const d = r - u / 2;
    this.r = q((i + d) * 255), this.g = q((s + d) * 255), this.b = q((a + d) * 255);
  }
  fromHsv({
    h: t,
    s: n,
    ...
    if (this.r = i, this.g = i, this.b = i, n <= 0)
      return;
    const s = t / 60, a = Math.floor(s), l = s - a, u = q(r * (1 - n) * 255), f = q(r * (1 - n * l) * 255), d = q(r * (1 - n * (1 - l)) * 255);
    switch (a) {
      case 0:
        this.g = d, this.b = u;
        break;
...
function ct(e, t) {
  ...
  for (let u = 0.01; u <= 1; u += 0.01) {
    const f = Math.round((n - s * (1 - u)) / u), d = Math.round((r - a * (1 - u)) / u), m = Math.round((o - l * (1 - u)) / u);
    if (Zt(f) && Zt(d) && Zt(m))
      return new ye({
        r: f,
        g: d,
...
function xa(e, t) {
  const {
    ...
    getPrefixCls: y
  } = $e(), g = y("attachment", n), p = `${g}-list-card`, [b, _, E] = lo(g), [w, C] = c.useMemo(() => {
    const R = u || "", O = R.match(/^(.*)\.[^.]+$/);
    return O ? [O[1], R.slice(O[1].length)] : [R, ""];
  }, [u]), v = c.useMemo(() => gr(C, co), [C]), x = c.useMemo(() => h || (m === "uploading" ? `${d || 0}%` : m === "error" ? r.response || Jt : f ? Sa(f) : Jt), [m, d]), [P, N] = c.useMemo(() => {
    for (const {
      ext: R,
      icon: O,
      color: W
  ...
  c.useEffect(() => {
    if (r.originFileObj) {
      let R = !0;
      return ga(r.originFileObj).then((O) => {
        R && I(O);
      }), () => {
        R = !1;
      };
  ...
  let T = null;
  const k = r.thumbUrl || r.url || F, L = v && (r.originFileObj || k);
  return L ? T = /* @__PURE__ */ c.createElement(c.Fragment, null, /* @__PURE__ */ c.createElement("img", {
    alt: "preview",
    src: k
  }), m !== "done" && /* @__PURE__ */ c.createElement("div", {
    className: `${p}-img-mask`
  }, m === "uploading" && d !== void 0 && /* @__PURE__ */ c.createElement(ya, {
    percent: d,
    prefixCls: p
    ...
    className: `${p}-ellipsis-prefix`
  }, w ?? Jt), /* @__PURE__ */ c.createElement("div", {
...
function wa(e) {
  const {
    ...
    itemClassName: l,
    itemStyle: u
  } = e, f = `${t}-list`, d = c.useRef(null), [m, h] = c.useState(!1), {
    disabled: y
  } = c.useContext(nt);
  c.useEffect(() => (h(!0), () => {
    h(!1);
  }), []);
  const [g, p] = c.useState(!1), [b, _] = c.useState(!1), E = () => {
    const x = d.current;
    x && (o === "scrollX" ? (p(Math.abs(x.scrollLeft) >= hr), _(x.scrollWidth - x.clientWidth - Math.abs(x.scrollLeft) >= hr)) : o === "scrollY" && (p(x.scrollTop !== 0), _(x.scrollHeight - x.clientHeight !== x.scrollTop)));
  };
  c.useEffect(() => {
    E();
  }, [o]);
...
function Ca(e, t) {
  const {
    ...
    disabled: u
  } = c.useContext(nt), [f, d] = c.useState(!1), m = () => {
    d(!0);
  }, h = (p) => {
    p.currentTarget.contains(p.relatedTarget) || d(!1);
  }, y = () => {
    d(!1);
  }, g = /* @__PURE__ */ c.isValidElement(r) ? r : /* @__PURE__ */ c.createElement(Ce, {
    align: "center",
    justify: "center",
    vertical: !0,
    className: `${a}-inner`
  ...
  return /* @__PURE__ */ c.createElement("div", {
    ...
    "aria-hidden": u,
    style: s
  }, /* @__PURE__ */ c.createElement(Ir.Dragger, _e({
    showUploadList: !1
  }, o, {
    ref: t,
    style: {
...
const _a = /* @__PURE__ */ c.forwardRef(Ca);
function Ea(e, t) {
  const {
    prefixCls: n,
    rootClassName: r,
    ...
    getPrefixCls: b,
    direction: _
  } = $e(), E = b("attachment", n), w = _t("attachments"), {
    classNames: C,
    styles: v
  } = w, x = c.useRef(null), P = c.useRef(null);
  ...
  const [N, F, I] = lo(E), T = A(F, I), [k, L] = rs([], {
    value: a
  }), R = Pe((B) => {
    L(B.fileList), d == null || d(B);
  }), O = {
    ...p,
    fileList: k,
    onChange: R
  }, W = (B) => {
    const z = k.filter((K) => K.uid !== B.uid);
    R({
      file: B,
      fileList: z
    });
  ...
  const Y = (B, z, K) => {
    ...
    return /* @__PURE__ */ c.createElement(_a, {
      placeholder: J,
      upload: O,
      prefixCls: E,
      className: A(C.placeholder, y.placeholder),
      style: {
        ...v.placeholder,
        ...g.placeholder,
...
const Oa = ({
  ...
  const {
    direction: x,
    getPrefixCls: P
  } = $e(), N = P("bubble", n), F = _t("bubble"), [I, T, k, L] = Na(m), [R, O] = La(h, I, T, k);
  c.useEffect(() => {
    C == null || C();
  }, [R]);
  const W = c.useRef(!1);
  c.useEffect(() => {
    !O && !f ? W.current || (W.current = !0, b == null || b()) : W.current = !1;
  }, [O, f]);
  const [X, Y, B] = mo(N), z = A(N, o, F.className, r, Y, B, `${N}-${u}`, {
    [`${N}-rtl`]: x === "rtl",
    [`${N}-typing`]: O && !f && !y && !L
  }), K = /* @__PURE__ */ c.isValidElement(l) ? l : /* @__PURE__ */ c.createElement(ni, l), J = y ? y(R) : R;
  let U;
  f ? U = d ? d() : /* @__PURE__ */ c.createElement(Oa, {
    prefixCls: N
  }) : U = /* @__PURE__ */ c.createElement(c.Fragment, null, J, O && L);
  let oe = /* @__PURE__ */ c.createElement("div", {
    style: {
      ...F.styles.content,
      ...a.content
    },
    className: A(`${N}-content`, `${N}-content-${g}`, p && `${N}-content-${p}`, F.classNames.content, s.content)
  }, U);
  return (_ || E) && (oe = /* @__PURE__ */ c.createElement("div", {
    className: `${N}-content-wrapper`
  }, _ && /* @__PURE__ */ c.createElement("div", {
    className: A(`${N}-header`, F.classNames.header, s.header),
    style: {
      ...F.styles.header,
      ...a.header
    }
  }, _), oe, E && /* @__PURE__ */ c.createElement("div", {
    className: A(`${N}-footer`, F.classNames.footer, s.footer),
    style: {
      ...F.styles.footer,
      ...a.footer
    }
  }, E))), X(/* @__PURE__ */ c.createElement("div", _e({
    style: {
      ...F.style,
      ...i
    },
    ...
    className: A(`${N}-avatar`, F.classNames.avatar, s.avatar)
  }, K), oe));
...
const Xa = 1, Ua = (e, t) => {
  const {
    ...
    getPrefixCls: m
  } = $e(), h = m("bubble", n), y = `${h}-list`, [g, p, b] = mo(h), [_, E] = M.useState(!1);
  M.useEffect(() => (E(!0), () => {
    E(!1);
  }), []);
  const w = Wa(i, a), [C, v] = Va(w), [x, P] = M.useState(!0), [N, F] = M.useState(0), I = (L) => {
    const R = L.target;
  ...
  M.useEffect(() => {
    ...
    var L;
    if (s) {
      const R = (L = C[C.length - 2]) == null ? void 0 : L.key, O = d.current[R];
      if (O) {
        const {
          nativeElement: W
        } = O, {
  ...
  return g(/* @__PURE__ */ M.createElement(po.Provider, {
    value: k
  }, /* @__PURE__ */ M.createElement("div", _e({}, u, {
    className: A(y, r, o, p, b, {
      [`${y}-reach-end`]: x
    }),
    ref: f,
    onScroll: I
    ...
    key: L,
    ...R
  }) => /* @__PURE__ */ M.createElement($n, _e({}, R, {
    key: L,
    ref: (O) => {
      O ? d.current[L] = O : delete d.current[L];
    },
    typing: _ ? R.typing : !1,
    onTypingComplete: () => {
      var O;
      (O = R.onTypingComplete) == null || O.call(R), v(L);
    }
  }))))));
...
const Ka = (e) => {
  ...
  const {
    ...
    getPrefixCls: h,
    direction: y
  } = $e(), g = h("prompts", t), p = _t("prompts"), [b, _, E] = Qa(g), w = A(g, p.className, r, l, _, E, {
    [`${g}-rtl`]: y === "rtl"
  }), C = A(`${g}-list`, p.classNames.list, f.list, {
    [`${g}-list-wrap`]: a
  }, {
    [`${g}-list-vertical`]: s
  });
  return b(/* @__PURE__ */ c.createElement("div", _e({}, m, {
    className: w,
    style: {
      ...d,
      ...p.style
    ...
    level: 5,
    className: A(`${g}-title`, p.classNames.title, f.title),
    style: {
      ...p.styles.title,
      ...u.title
    }
    ...
    return /* @__PURE__ */ c.createElement("div", {
      ...
      className: A(`${g}-item`, p.classNames.item, f.item, {
      ...
      className: A(`${g}-content`, p.classNames.itemContent, f.itemContent),
      style: {
...
function nl(e, t) {
  const {
    ...
    direction: h,
    getPrefixCls: y
  } = $e(), g = y("welcome", n), p = _t("welcome"), [b, _, E] = tl(g), w = c.useMemo(() => {
    if (!u)
      return null;
    let x = u;
    return typeof u == "string" && u.startsWith("http") && (x = /* @__PURE__ */ c.createElement("img", {
      ...
      className: A(`${g}-icon`, p.classNames.icon, a.icon),
      style: l.icon
    }, x);
  }, [u]), C = c.useMemo(() => f ? /* @__PURE__ */ c.createElement(Te.Title, {
    level: 4,
    className: A(`${g}-title`, p.classNames.title, a.title),
    style: l.title
  }, f) : null, [f]), v = c.useMemo(() => m ? /* @__PURE__ */ c.createElement("div", {
    className: A(`${g}-extra`, p.classNames.extra, a.extra),
    style: l.extra
  }, m) : null, [m]);
  return b(/* @__PURE__ */ c.createElement(Ce, {
    ref: t,
    className: A(g, p.className, o, r, _, E, `${g}-${s}`, {
      [`${g}-rtl`]: h === "rtl"
    }),
    style: i
  }, w, /* @__PURE__ */ c.createElement(Ce, {
    vertical: !0,
    className: `${g}-content-wrapper`
  }, m ? /* @__PURE__ */ c.createElement(Ce, {
    align: "flex-start",
    className: `${g}-title-wrapper`
  }, C, v) : C, d && /* @__PURE__ */ c.createElement(Te.Text, {
    className: A(`${g}-description`, p.classNames.description, a.description),
    style: l.description
  }, d))));
}
...
const _r = Ro(({
  ...
  return we(() => {
    ...
    function m() {
      let p = d;
      if (d.tagName.toLowerCase() === "svelte-slot" && d.children.length === 1 && d.children[0] && (p = d.children[0], p.tagName.toLowerCase() === "react-portal-target" && p.children[0] && (p = p.children[0])), Cl(i, p), n && p.classList.add(...n.split(" ")), r) {
        const b = xl(r);
    ...
    if (f && window.MutationObserver) {
      let p = function() {
        var w, C, v;
        (w = s.current) != null && w.contains(d) && ((C = s.current) == null || C.removeChild(d));
        const {
          portals: _,
          clonedElement: E
        } = Sn(e);
        d = E, l(_), d.style.display = "contents", y && clearTimeout(y), y = setTimeout(() => {
          m();
        }, 50), (v = s.current) == null || v.appendChild(d);
      };
      p();
      const b = wi(() => {
      ...
      d.style.display = "contents", m(), (g = s.current) == null || g.appendChild(d);
    return () => {
      var p, b;
      d.style.display = "", (p = s.current) != null && p.contains(d) && ((b = s.current) == null || b.removeChild(d)), h == null || h.disconnect();
    };
  ...
  if (r.length !== 0)
    return r.map((o, i) => {
      ...
      Object.keys(o.slots).forEach((f) => {
        ...
        const d = f.split(".");
        d.forEach((b, _) => {
          a[b] || (a[b] = {}), _ !== d.length - 1 && (a = s[b]);
        });
        const m = o.slots[f];
        let h, y, g = (t == null ? void 0 : t.clone) ?? !1, p = t == null ? void 0 : t.forceClone;
        m instanceof Element ? h = m : (h = m.el, y = m.callback, g = m.clone ?? g, p = m.forceClone ?? p), p = p ?? !!y, a[d[d.length - 1]] = h ? y ? (...b) => (y(d[d.length - 1], b), /* @__PURE__ */ S.jsx(An, {
          ...o.ctx,
          params: b,
          forceClone: p,
...
function $l({
  ...
  const o = vl(e), i = ne(t), s = ne(n), {
    ...
    return e || ((f = xo(a, {
      clone: !0,
      forceClone: !0
    })) == null ? void 0 : f.reduce((d, m) => (m.role !== void 0 && (d[m.role] = m), d), {}));
  }, [a, e]), u = ge(() => (f, d) => {
    const m = d ?? f[wo], h = i(f, m) || f;
    if (h.role && (l || {})[h.role])
      return Tl((l || {})[h.role], [h, m]);
    let y;
    return y = s(h, m), y || {
      messageRender(g) {
...
function Pl(e) {
  const [t, n] = Qe(!1), r = Q(0), o = Q(!0), i = Q(!0), {
    ...
    if (!a.current)
      return !1;
    const d = a.current.nativeElement, m = d.scrollHeight, {
      scrollTop: h,
      clientHeight: y
    } = d;
    return m - (h + y) < 100;
  ...
  return we(() => {
    ...
    if (a.current && s) {
      const d = a.current.nativeElement;
      let m = 0, h = 0;
      const y = (g) => {
        const p = g.target;
        i.current ? i.current = !1 : p.scrollTop < m && p.scrollHeight >= h ? o.current = !1 : f() && (o.current = !0), m = p.scrollTop, h = p.scrollHeight, f() && n(!1);
      };
      return d.addEventListener("scroll", y), () => {
...
const Nl = ({
  ...
  return /* @__PURE__ */ S.jsxs(Ce, {
    ...
    children: [/* @__PURE__ */ S.jsx(rl, {
      ...
      className: A(i.elem_classes),
      style: i.elem_style
    }), /* @__PURE__ */ S.jsx(Pn, {
      ...s,
      classNames: s == null ? void 0 : s.class_names,
      className: A(s == null ? void 0 : s.elem_classes),
...
}, Er = Symbol(), Tr = Symbol(), $r = Symbol(), nn = Symbol(), Ol = (e) => e ? typeof e == "string" ? {
  src: e
} : ((n) => !!n.url)(e) ? {
  src: e.url
} : e.src ? {
...
}, _o = (e, t, n) => typeof e == "string" ? e : Array.isArray(e) ? e.map((r) => _o(r, t, n)).filter(Boolean).join(`
`) : ve(e) ? e.copyable ?? !0 ? typeof e.content == "string" ? e.content : e.type === "file" ? JSON.stringify(e.content.map((r) => Co(r, t, n))) : JSON.stringify(e.content) : "" : JSON.stringify(e), Eo = (e, t) => (e || []).map((n) => ({
  ...t(n),
  ...
  const a = ge(() => _o(e, o, i), [e, i, o]), l = Q(null);
  ...
  const u = Q(), d = (() => {
    ...
    switch (h) {
      ...
      case "like":
        return u.current = () => i(!0), /* @__PURE__ */ S.jsx(ie, {
          variant: "text",
          color: ((p = t.meta) == null ? void 0 : p.feedback) === "like" ? "primary" : "default",
          disabled: y,
          size: "small",
      ...
      case "dislike":
        return u.current = () => i(!1), /* @__PURE__ */ S.jsx(ie, {
          variant: "text",
          color: ((b = t.meta) == null ? void 0 : b.feedback) === "dislike" ? "primary" : "default",
          size: "small",
      ...
      case "retry":
        return u.current = s, /* @__PURE__ */ S.jsx(ie, {
          variant: "text",
          color: "default",
          size: "small",
          disabled: y,
      ...
      case "edit":
        return u.current = o, /* @__PURE__ */ S.jsx(ie, {
          variant: "text",
          color: "default",
          size: "small",
          disabled: y,
      ...
      case "delete":
        return u.current = r, /* @__PURE__ */ S.jsx(ie, {
          variant: "text",
          color: "default",
          size: "small",
          disabled: y,
  ...
  if (ve(e)) {
    const h = {
      ...typeof e.popconfirm == "string" ? {
        ...
        ...e.popconfirm,
        title: (m = e.popconfirm) == null ? void 0 : m.title
      },
      onConfirm() {
        var y;
        (y = u.current) == null || y.call(u);
      }
    };
    return c.createElement(e.popconfirm ? ri : c.Fragment, e.popconfirm ? h : void 0, c.createElement(e.tooltip ? oi : c.Fragment, e.tooltip ? typeof e.tooltip == "string" ? {
      title: e.tooltip
    } : e.tooltip : void 0, d));
  }
  return d;
  ...
  align: "center",
  gap: f && (m != null && m.length) ? "small" : void 0,
    ...
    switch (g) {
      ...
      case "actions":
        return /* @__PURE__ */ S.jsx("div", {
          children: (m || []).map((p, b) => /* @__PURE__ */ S.jsx(kl, {
            urlRoot: h,
            urlProxyUrl: y,
            action: p,
            message: u,
  ...
  const u = Q(null), f = () => Fl(n.content).map((m, h) => {
    const y = () => {
      var g;
      if (e && (m.editable ?? !0) && Xl.includes(m.type)) {
        const p = m.content, b = (g = u.current) == null ? void 0 : g.getBoundingClientRect().width;
        return /* @__PURE__ */ S.jsx("div", {
          style: {
            width: b,
            minWidth: 200,
      ...
      switch (m.type) {
        ...
        case "file":
          return /* @__PURE__ */ S.jsx(Bl, {
            ...
            urlRoot: l,
            urlProxyUrl: a,
            options: he(m.options || {}, {
              omitNull: !0
            })
          });
        case "suggestion":
          return /* @__PURE__ */ S.jsx(Vl, {
            value: r ? m.content : Eo(m.content, (p) => ({
              ...p,
        ...
        default:
          return typeof m.content != "string" ? null : /* @__PURE__ */ S.jsx(Pr, {
            value: m.content,
            options: he({
              ...o,
              ...mt(m.options)
  ...
  }, [s]), L = Q(null), [R, O] = Qe(-1), [W, X] = Qe({}), Y = Q(), B = ne(($, G) => {
    X((H) => ({
      ...H,
      [$]: G
    }));
  ...
  const K = ne(($) => {
    ...
    E == null || E($), O(-1), p([...s.slice(0, $.index), {
      ...s[$.index],
      content: $.value
    }, ...s.slice($.index + 1)]);
  }), qe = ne(($) => {
    ...
    preProcess($, G) {
      ...
      return {
        ...$,
        style: $.elem_style,
        className: A($.elem_classes, "ms-gr-pro-chatbot-message"),
        classNames: {
          ...$.class_names,
          avatar: A((H = $.class_names) == null ? void 0 : H.avatar, "ms-gr-pro-chatbot-message-avatar"),
          header: A((Se = $.class_names) == null ? void 0 : Se.header, "ms-gr-pro-chatbot-message-header"),
          footer: A((fe = $.class_names) == null ? void 0 : fe.footer, "ms-gr-pro-chatbot-message-footer", G === R ? "ms-gr-pro-chatbot-message-footer-editing" : void 0),
          content: A((ke = $.class_names) == null ? void 0 : ke.content, "ms-gr-pro-chatbot-message-content")
        }
      };
    },
    postProcess($, G) {
      ...
      switch ($.role) {
        ...
        case "assistant":
          return {
            ...
            className: A($.className, H ? I == null ? void 0 : I.elem_classes : T == null ? void 0 : T.elem_classes),
            header: /* @__PURE__ */ S.jsx(Dl, {
              title: $[Er] ?? (H ? I == null ? void 0 : I.header : T == null ? void 0 : T.header),
              markdownConfig: F
            }),
            avatar: Ol($[$r] ?? (H ? I == null ? void 0 : I.avatar : T == null ? void 0 : T.avatar)),
  ...
  return /* @__PURE__ */ S.jsxs("div", {
    id: e,
    className: A(t, "ms-gr-pro-chatbot"),
    style: {
      height: r,
      minHeight: o,
      maxHeight: i,
