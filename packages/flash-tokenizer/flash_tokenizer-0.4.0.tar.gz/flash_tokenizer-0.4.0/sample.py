...
tokenizer2 = BertTokenizer(vocab_file, do_lower_case=True, strip_accents=False)

for title in titles:
    ids1 = tokenizer1(title)
    ids2 = tokenizer2(title, max_length=256, padding="longest").input_ids
    print(title)
    print(ids1)
    print(ids2)
