...
from etiket_client.local.dao.dataset_utitlity import format_search_query_for_sqlite, format_fts_single_string
...
def gen_search_helper(model : Datasets):
    ...
    return format_fts_single_string(search_helper)
