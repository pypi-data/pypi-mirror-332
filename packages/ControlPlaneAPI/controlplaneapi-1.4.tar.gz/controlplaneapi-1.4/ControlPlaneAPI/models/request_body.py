...
class RequestBody(BaseModel):
    ...
    RequestBody
    """ # noqa: E501
    components: Optional[List[RequestBodyComponentsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "components": [RequestBodyComponentsInner.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None
        })
        return _obj
