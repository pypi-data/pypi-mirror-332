...
class CreditNoteResetToDraft200ResponseObjects(BaseModel):
    """
    CreditNoteResetToDraft200ResponseObjects
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The creditNote id")
    ...
    contact: Optional[ModelCreditNoteResponseContact] = None
    credit_note_date: Optional[datetime] = Field(default=None, description="The credit note date", alias="creditNoteDate")
    ...
    address_country: Optional[ModelCreditNoteResponseAddressCountry] = Field(default=None, alias="addressCountry")
    create_user: Optional[ModelCreditNoteResponseCreateUser] = Field(default=None, alias="createUser")
    sev_client: Optional[ModelCreditNoteResponseSevClient] = Field(default=None, alias="sevClient")
    ...
    contact_person: Optional[ModelCreditNoteResponseContactPerson] = Field(default=None, alias="contactPerson")
    ...
    tax_set: Optional[ModelCreditNoteResponseTaxSet] = Field(default=None, alias="taxSet")
    tax_text: Optional[Any] = Field(default=None, alias="taxText")
    ...
    sum_net: Optional[StrictStr] = Field(default=None, description="Net sum of the creditNote", alias="sumNet")
    sum_tax: Optional[StrictStr] = Field(default=None, description="Tax sum of the creditNote", alias="sumTax")
    sum_gross: Optional[StrictStr] = Field(default=None, description="Gross sum of the creditNote", alias="sumGross")
    sum_discounts: Optional[StrictStr] = Field(default=None, description="Sum of all discounts in the creditNote", alias="sumDiscounts")
    sum_net_foreign_currency: Optional[StrictStr] = Field(default=None, description="Net sum of the creditNote in the foreign currency", alias="sumNetForeignCurrency")
    sum_tax_foreign_currency: Optional[StrictStr] = Field(default=None, description="Tax sum of the creditNote in the foreign currency", alias="sumTaxForeignCurrency")
    sum_gross_foreign_currency: Optional[StrictStr] = Field(default=None, description="Gross sum of the creditNote in the foreign currency", alias="sumGrossForeignCurrency")
    sum_discounts_foreign_currency: Optional[StrictStr] = Field(default=None, description="Discounts sum of the creditNote in the foreign currency", alias="sumDiscountsForeignCurrency")
    customer_internal_note: Optional[Any] = Field(default=None, alias="customerInternalNote")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact": ModelCreditNoteResponseContact.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
            "creditNoteDate": obj.get("creditNoteDate"),
            "status": obj.get("status"),
            "header": obj.get("header"),
            "headText": obj.get("headText"),
            "footText": obj.get("footText"),
            "addressCountry": ModelCreditNoteResponseAddressCountry.from_dict(obj["addressCountry"]) if obj.get("addressCountry") is not None else None,
            "createUser": ModelCreditNoteResponseCreateUser.from_dict(obj["createUser"]) if obj.get("createUser") is not None else None,
            "sevClient": ModelCreditNoteResponseSevClient.from_dict(obj["sevClient"]) if obj.get("sevClient") is not None else None,
            "deliveryDate": obj.get("deliveryDate"),
            "smallSettlement": obj.get("smallSettlement"),
            "contactPerson": ModelCreditNoteResponseContactPerson.from_dict(obj["contactPerson"]) if obj.get("contactPerson") is not None else None,
            ...
            "taxSet": ModelCreditNoteResponseTaxSet.from_dict(obj["taxSet"]) if obj.get("taxSet") is not None else None,
