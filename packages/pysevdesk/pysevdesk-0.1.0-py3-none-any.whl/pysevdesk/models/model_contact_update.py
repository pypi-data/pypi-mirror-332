...
class ModelContactUpdate(BaseModel):
    """
    Contact model
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The organization name.<br> Be aware that the type of contact will depend on this attribute.<br> If it holds a value, the contact will be regarded as an organization.")
    status: Optional[StrictInt] = Field(default=100, description="Defines the status of the contact. 100 <-> Lead - 500 <-> Pending - 1000 <-> Active.")
    customer_number: Optional[StrictStr] = Field(default=None, description="The customer number", alias="customerNumber")
    parent: Optional[ModelContactUpdateParent] = None
    surename: Optional[StrictStr] = Field(default=None, description="The <b>first</b> name of the contact.<br> Yeah... not quite right in literally every way. We know.<br> Not to be used for organizations.")
    familyname: Optional[StrictStr] = Field(default=None, description="The last name of the contact.<br> Not to be used for organizations.")
    titel: Optional[StrictStr] = Field(default=None, description="A non-academic title for the contact. Not to be used for organizations.")
    category: Optional[ModelContactUpdateCategory] = None
    description: Optional[StrictStr] = Field(default=None, description="A description for the contact.")
    academic_title: Optional[StrictStr] = Field(default=None, description="A academic title for the contact. Not to be used for organizations.", alias="academicTitle")
    gender: Optional[StrictStr] = Field(default=None, description="Gender of the contact.<br> Not to be used for organizations.")
    name2: Optional[StrictStr] = Field(default=None, description="Second name of the contact.<br> Not to be used for organizations.")
    birthday: Optional[date] = Field(default=None, description="Birthday of the contact.<br> Not to be used for organizations.")
    vat_number: Optional[StrictStr] = Field(default=None, description="Vat number of the contact.", alias="vatNumber")
    bank_account: Optional[StrictStr] = Field(default=None, description="Bank account number (IBAN) of the contact.", alias="bankAccount")
    bank_number: Optional[StrictStr] = Field(default=None, description="Bank number of the bank used by the contact.", alias="bankNumber")
    default_cashback_time: Optional[StrictInt] = Field(default=None, description="Absolute time in days which the contact has to pay his invoices and subsequently get a cashback.", alias="defaultCashbackTime")
    default_cashback_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Percentage of the invoice sum the contact gets back if he paid invoices in time.", alias="defaultCashbackPercent")
    default_time_to_pay: Optional[StrictInt] = Field(default=None, description="The payment goal in days which is set for every invoice of the contact.", alias="defaultTimeToPay")
    tax_number: Optional[StrictStr] = Field(default=None, description="The tax number of the contact.", alias="taxNumber")
    tax_office: Optional[StrictStr] = Field(default=None, description="The tax office of the contact (only for greek customers).", alias="taxOffice")
    exempt_vat: Optional[StrictBool] = Field(default=None, description="Defines if the contact is freed from paying vat.", alias="exemptVat")
    default_discount_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The default discount the contact gets for every invoice.<br> Depending on defaultDiscountPercentage attribute, in percent or absolute value.", alias="defaultDiscountAmount")
    default_discount_percentage: Optional[StrictBool] = Field(default=None, description="Defines if the discount is a percentage (true) or an absolute value (false).", alias="defaultDiscountPercentage")
    buyer_reference: Optional[StrictStr] = Field(default=None, description="Buyer reference of the contact.", alias="buyerReference")
    government_agency: Optional[StrictBool] = Field(default=None, description="Defines whether the contact is a government agency (true) or not (false).", alias="governmentAgency")
    __properties: ClassVar[List[str]] = ["name", "status", "customerNumber", "parent", "surename", "familyname", "titel", "category", "description", "academicTitle", "gender", "name2", "birthday", "vatNumber", "bankAccount", "bankNumber", "defaultCashbackTime", "defaultCashbackPercent", "defaultTimeToPay", "taxNumber", "taxOffice", "exemptVat", "defaultDiscountAmount", "defaultDiscountPercentage", "buyerReference", "governmentAgency"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if surename (nullable) is None
        # and model_fields_set contains the field
        if self.surename is None and "surename" in self.model_fields_set:
            _dict['surename'] = None

        # set to None if familyname (nullable) is None
        # and model_fields_set contains the field
        if self.familyname is None and "familyname" in self.model_fields_set:
            _dict['familyname'] = None

        # set to None if titel (nullable) is None
        # and model_fields_set contains the field
        if self.titel is None and "titel" in self.model_fields_set:
            _dict['titel'] = None
        ...
        # set to None if academic_title (nullable) is None
        # and model_fields_set contains the field
        if self.academic_title is None and "academic_title" in self.model_fields_set:
            _dict['academicTitle'] = None
        ...
        # set to None if name2 (nullable) is None
        # and model_fields_set contains the field
        if self.name2 is None and "name2" in self.model_fields_set:
            _dict['name2'] = None
        ...
        # set to None if default_cashback_time (nullable) is None
        # and model_fields_set contains the field
        if self.default_cashback_time is None and "default_cashback_time" in self.model_fields_set:
            _dict['defaultCashbackTime'] = None

        # set to None if default_cashback_percent (nullable) is None
        # and model_fields_set contains the field
        if self.default_cashback_percent is None and "default_cashback_percent" in self.model_fields_set:
            _dict['defaultCashbackPercent'] = None

        # set to None if default_time_to_pay (nullable) is None
        # and model_fields_set contains the field
        if self.default_time_to_pay is None and "default_time_to_pay" in self.model_fields_set:
            _dict['defaultTimeToPay'] = None
        ...
        # set to None if exempt_vat (nullable) is None
        # and model_fields_set contains the field
        if self.exempt_vat is None and "exempt_vat" in self.model_fields_set:
            _dict['exemptVat'] = None

        # set to None if default_discount_amount (nullable) is None
        # and model_fields_set contains the field
        if self.default_discount_amount is None and "default_discount_amount" in self.model_fields_set:
            _dict['defaultDiscountAmount'] = None

        # set to None if default_discount_percentage (nullable) is None
        # and model_fields_set contains the field
        if self.default_discount_percentage is None and "default_discount_percentage" in self.model_fields_set:
            _dict['defaultDiscountPercentage'] = None
        ...
        # set to None if government_agency (nullable) is None
        # and model_fields_set contains the field
        if self.government_agency is None and "government_agency" in self.model_fields_set:
            _dict['governmentAgency'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "status": obj.get("status") if obj.get("status") is not None else 100,
            "customerNumber": obj.get("customerNumber"),
            "parent": ModelContactUpdateParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "surename": obj.get("surename"),
            "familyname": obj.get("familyname"),
            "titel": obj.get("titel"),
            "category": ModelContactUpdateCategory.from_dict(obj["category"]) if obj.get("category") is not None else None,
            "description": obj.get("description"),
            "academicTitle": obj.get("academicTitle"),
            ...
            "defaultCashbackTime": obj.get("defaultCashbackTime"),
            "defaultCashbackPercent": obj.get("defaultCashbackPercent"),
            "defaultTimeToPay": obj.get("defaultTimeToPay"),
            "taxNumber": obj.get("taxNumber"),
            "taxOffice": obj.get("taxOffice"),
            "exemptVat": obj.get("exemptVat"),
            "defaultDiscountAmount": obj.get("defaultDiscountAmount"),
            "defaultDiscountPercentage": obj.get("defaultDiscountPercentage"),
            "buyerReference": obj.get("buyerReference"),
            "governmentAgency": obj.get("governmentAgency")
        })
        return _obj
