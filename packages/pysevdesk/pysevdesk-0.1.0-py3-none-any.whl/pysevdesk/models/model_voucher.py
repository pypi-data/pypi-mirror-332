...
class ModelVoucher(BaseModel):
    """
    Voucher model
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The voucher id")
    object_name: StrictStr = Field(description="The voucher object name", alias="objectName")
    ...
    sev_client: Optional[ModelVoucherSevClient] = Field(default=None, alias="sevClient")
    create_user: Optional[ModelVoucherCreateUser] = Field(default=None, alias="createUser")
    ...
    supplier: Optional[ModelVoucherSupplier] = None
    ...
    status: Union[StrictFloat, StrictInt] = Field(description="Please have a look in       <a href='#tag/Voucher/Types-and-status-of-vouchers'>status of vouchers</a>      to see what the different status codes mean")
    sum_net: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Net sum of the voucher", alias="sumNet")
    sum_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax sum of the voucher", alias="sumTax")
    sum_gross: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gross sum of the voucher", alias="sumGross")
    sum_net_accounting: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Net accounting sum of the voucher. Is usually the same as sumNet", alias="sumNetAccounting")
    sum_tax_accounting: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax accounting sum of the voucher. Is usually the same as sumTax", alias="sumTaxAccounting")
    sum_gross_accounting: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gross accounting sum of the voucher. Is usually the same as sumGross", alias="sumGrossAccounting")
    sum_discounts: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Sum of all discounts in the voucher", alias="sumDiscounts")
    sum_discounts_foreign_currency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Discounts sum of the voucher in the foreign currency", alias="sumDiscountsForeignCurrency")
    ...
    tax_rule: ModelVoucherTaxRule = Field(alias="taxRule")
    tax_type: StrictStr = Field(description="**Use this in sevdesk-Update 1.0 (instead of taxRule).**  Tax type of the voucher. There are four tax types: 1. default - Umsatzsteuer ausweisen 2. eu - Steuerfreie innergemeinschaftliche Lieferung (Europäische Union) 3. noteu - Steuerschuldnerschaft des Leistungsempfängers (außerhalb EU, z. B. Schweiz) 4. custom - Using custom tax set 5. ss - Not subject to VAT according to §19 1 UStG Tax rates are heavily connected to the tax type used.", alias="taxType")
    credit_debit: StrictStr = Field(description="Defines if your voucher is a credit (C) or debit (D)", alias="creditDebit")
    voucher_type: StrictStr = Field(description="Type of the voucher. For more information on the different types, check       <a href='#tag/Voucher/Types-and-status-of-vouchers'>this</a>  ", alias="voucherType")
    ...
    property_exchange_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Defines the exchange rate", alias="propertyExchangeRate")
    ...
    tax_set: Optional[ModelVoucherTaxSet] = Field(default=None, alias="taxSet")
    ...
    document: Optional[ModelVoucherDocument] = None
    cost_centre: Optional[ModelVoucherCostCentre] = Field(default=None, alias="costCentre")
    __properties: ClassVar[List[str]] = ["id", "objectName", "mapAll", "create", "update", "sevClient", "createUser", "voucherDate", "supplier", "supplierName", "description", "payDate", "status", "sumNet", "sumTax", "sumGross", "sumNetAccounting", "sumTaxAccounting", "sumGrossAccounting", "sumDiscounts", "sumDiscountsForeignCurrency", "paidAmount", "taxRule", "taxType", "creditDebit", "voucherType", "currency", "propertyForeignCurrencyDeadline", "propertyExchangeRate", "recurringInterval", "recurringStartDate", "recurringNextVoucher", "recurringLastVoucher", "recurringEndDate", "enshrined", "taxSet", "paymentDeadline", "deliveryDate", "deliveryDateUntil", "document", "costCentre"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sevClient": ModelVoucherSevClient.from_dict(obj["sevClient"]) if obj.get("sevClient") is not None else None,
            "createUser": ModelVoucherCreateUser.from_dict(obj["createUser"]) if obj.get("createUser") is not None else None,
            "voucherDate": obj.get("voucherDate"),
            "supplier": ModelVoucherSupplier.from_dict(obj["supplier"]) if obj.get("supplier") is not None else None,
            ...
            "taxSet": ModelVoucherTaxSet.from_dict(obj["taxSet"]) if obj.get("taxSet") is not None else None,
            "paymentDeadline": obj.get("paymentDeadline"),
            "deliveryDate": obj.get("deliveryDate"),
            "deliveryDateUntil": obj.get("deliveryDateUntil"),
            "document": ModelVoucherDocument.from_dict(obj["document"]) if obj.get("document") is not None else None,
            "costCentre": ModelVoucherCostCentre.from_dict(obj["costCentre"]) if obj.get("costCentre") is not None else None
        })
        return _obj
