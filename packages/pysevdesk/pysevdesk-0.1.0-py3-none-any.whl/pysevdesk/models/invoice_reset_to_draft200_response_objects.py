...
class InvoiceResetToDraft200ResponseObjects(BaseModel):
    """
    InvoiceResetToDraft200ResponseObjects
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The invoice id")
    object_name: Optional[StrictStr] = Field(default=None, description="The invoice object name", alias="objectName")
    invoice_number: Optional[StrictStr] = Field(default=None, description="The invoice number", alias="invoiceNumber")
    contact: Optional[ModelInvoiceResponseContact] = None
    create: Optional[datetime] = Field(default=None, description="Date of invoice creation")
    update: Optional[datetime] = Field(default=None, description="Date of last invoice update")
    sev_client: Optional[ModelInvoiceResponseSevClient] = Field(default=None, alias="sevClient")
    invoice_date: Optional[StrictStr] = Field(default=None, description="The invoice date.", alias="invoiceDate")
    header: Optional[StrictStr] = Field(default=None, description="Normally consist of prefix plus the invoice number")
    ...
    time_to_pay: Optional[StrictStr] = Field(default=None, description="The time the customer has to pay the invoice in days", alias="timeToPay")
    discount_time: Optional[StrictStr] = Field(default=None, description="If a value other than zero is used for the discount attribute,      you need to specify the amount of days for which the discount is granted.", alias="discountTime")
    discount: Optional[StrictStr] = Field(default=None, description="If you want to give a discount, define the percentage here. Otherwise provide zero as value")
    address_country: Optional[ModelInvoiceResponseAddressCountry] = Field(default=None, alias="addressCountry")
    pay_date: Optional[Any] = Field(default=None, alias="payDate")
    create_user: Optional[ModelCreditNoteResponseCreateUser] = Field(default=None, alias="createUser")
    ...
    status: Optional[StrictStr] = Field(default=None, description="Please have a look in our       <a href='#tag/Invoice/Types-and-status-of-invoices'>Types and status of invoices</a>       to see what the different status codes mean")
    small_settlement: Optional[StrictBool] = Field(default=None, description="Defines if the client uses the small settlement scheme.      If yes, the invoice must not contain any vat", alias="smallSettlement")
    contact_person: Optional[ModelInvoiceResponseContactPerson] = Field(default=None, alias="contactPerson")
    tax_rate: Optional[StrictStr] = Field(default=None, description="This is not used anymore. Use the taxRate of the individual positions instead.", alias="taxRate")
    ...
    dunning_level: Optional[StrictStr] = Field(default=None, description="Defines how many reminders have already been sent for the invoice.      Starts with 1 (Payment reminder) and should be incremented by one every time another reminder is sent.", alias="dunningLevel")
    tax_type: Optional[StrictStr] = Field(default=None, description="**Use this in sevdesk-Update 1.0 (instead of taxRule).**  Tax type of the invoice. There are four tax types: 1. default - Umsatzsteuer ausweisen 2. eu - Steuerfreie innergemeinschaftliche Lieferung (Europäische Union) 3. noteu - Steuerschuldnerschaft des Leistungsempfängers (außerhalb EU, z. B. Schweiz) 4. custom - Using custom tax set 5. ss - Not subject to VAT according to §19 1 UStG Tax rates are heavily connected to the tax type used.", alias="taxType")
    payment_method: Optional[ModelInvoiceResponsePaymentMethod] = Field(default=None, alias="paymentMethod")
    cost_centre: Optional[ModelInvoiceResponseCostCentre] = Field(default=None, alias="costCentre")
    send_date: Optional[datetime] = Field(default=None, description="The date the invoice was sent to the customer", alias="sendDate")
    origin: Optional[ModelInvoiceResponseOrigin] = None
    invoice_type: Optional[StrictStr] = Field(default=None, description="Type of the invoice. For more information on the different types, check       <a href='#tag/Invoice/Types-and-status-of-invoices'>this</a> section  ", alias="invoiceType")
    account_intervall: Optional[Any] = Field(default=None, alias="accountIntervall")
    account_next_invoice: Optional[Any] = Field(default=None, alias="accountNextInvoice")
    reminder_total: Optional[StrictStr] = Field(default=None, description="Total reminder amount", alias="reminderTotal")
    reminder_debit: Optional[StrictStr] = Field(default=None, description="Debit of the reminder", alias="reminderDebit")
    reminder_deadline: Optional[datetime] = Field(default=None, description="Deadline of the reminder as timestamp", alias="reminderDeadline")
    reminder_charge: Optional[StrictStr] = Field(default=None, description="The additional reminder charge", alias="reminderCharge")
    tax_set: Optional[ModelInvoiceResponseTaxSet] = Field(default=None, alias="taxSet")
    address: Optional[StrictStr] = Field(default=None, description="Complete address of the recipient including name, street, city, zip and country.       * Line breaks can be used and will be displayed on the invoice pdf.")
    currency: Optional[StrictStr] = Field(default=None, description="Currency used in the invoice. Needs to be currency code according to ISO-4217")
    sum_net: Optional[StrictStr] = Field(default=None, description="Net sum of the invoice", alias="sumNet")
    sum_tax: Optional[StrictStr] = Field(default=None, description="Tax sum of the invoice", alias="sumTax")
    sum_gross: Optional[StrictStr] = Field(default=None, description="Gross sum of the invoice", alias="sumGross")
    sum_discounts: Optional[StrictStr] = Field(default=None, description="Sum of all discounts in the invoice", alias="sumDiscounts")
    sum_net_foreign_currency: Optional[StrictStr] = Field(default=None, description="Net sum of the invoice in the foreign currency", alias="sumNetForeignCurrency")
    sum_tax_foreign_currency: Optional[StrictStr] = Field(default=None, description="Tax sum of the invoice in the foreign currency", alias="sumTaxForeignCurrency")
    sum_gross_foreign_currency: Optional[StrictStr] = Field(default=None, description="Gross sum of the invoice in the foreign currency", alias="sumGrossForeignCurrency")
    sum_discounts_foreign_currency: Optional[StrictStr] = Field(default=None, description="Discounts sum of the invoice in the foreign currency", alias="sumDiscountsForeignCurrency")
    sum_net_accounting: Optional[StrictStr] = Field(default=None, description="Net accounting sum of the invoice. Is usually the same as sumNet", alias="sumNetAccounting")
    sum_tax_accounting: Optional[StrictStr] = Field(default=None, description="Tax accounting sum of the invoice. Is usually the same as sumTax", alias="sumTaxAccounting")
    sum_gross_accounting: Optional[StrictStr] = Field(default=None, description="Gross accounting sum of the invoice. Is usually the same as sumGross", alias="sumGrossAccounting")
    paid_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount which has already been paid for this invoice by the customer", alias="paidAmount")
    ...
    show_net: Optional[StrictBool] = Field(default=None, description="If true, the net amount of each position will be shown on the invoice. Otherwise gross amount", alias="showNet")
    enshrined: Optional[Any] = None
    send_type: Optional[StrictStr] = Field(default=None, description="Type which was used to send the invoice. IMPORTANT: Please refer to the invoice section of the       *     API-Overview to understand how this attribute can be used before using it!", alias="sendType")
    delivery_date_until: Optional[StrictStr] = Field(default=None, description="If the delivery date should be a time range, another timestamp can be provided in this attribute       * to define a range from timestamp used in deliveryDate attribute to the timestamp used here.", alias="deliveryDateUntil")
    datev_connect_online: Optional[Dict[str, Any]] = Field(default=None, description="Internal attribute", alias="datevConnectOnline")
    send_payment_received_notification_date: Optional[StrictStr] = Field(default=None, description="Internal attribute", alias="sendPaymentReceivedNotificationDate")
    __properties: ClassVar[List[str]] = ["id", "objectName", "invoiceNumber", "contact", "create", "update", "sevClient", "invoiceDate", "header", "headText", "footText", "timeToPay", "discountTime", "discount", "addressCountry", "payDate", "createUser", "deliveryDate", "status", "smallSettlement", "contactPerson", "taxRate", "taxRule", "taxText", "dunningLevel", "taxType", "paymentMethod", "costCentre", "sendDate", "origin", "invoiceType", "accountIntervall", "accountNextInvoice", "reminderTotal", "reminderDebit", "reminderDeadline", "reminderCharge", "taxSet", "address", "currency", "sumNet", "sumTax", "sumGross", "sumDiscounts", "sumNetForeignCurrency", "sumTaxForeignCurrency", "sumGrossForeignCurrency", "sumDiscountsForeignCurrency", "sumNetAccounting", "sumTaxAccounting", "sumGrossAccounting", "paidAmount", "customerInternalNote", "showNet", "enshrined", "sendType", "deliveryDateUntil", "datevConnectOnline", "sendPaymentReceivedNotificationDate"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['50', '100', '200', '750', '1000']):
            raise ValueError("must be one of enum values ('50', '100', '200', '750', '1000')")
        return value
    ...
    def tax_type_validate_enum(cls, value):
        ...
        if value not in set(['default', 'eu', 'noteu', 'custom']):
            raise ValueError("must be one of enum values ('default', 'eu', 'noteu', 'custom')")
        return value
    ...
    def invoice_type_validate_enum(cls, value):
        ...
        if value not in set(['RE', 'WKR', 'SR', 'MA', 'TR', 'AR', 'ER']):
            raise ValueError("must be one of enum values ('RE', 'WKR', 'SR', 'MA', 'TR', 'AR', 'ER')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of cost_centre
        if self.cost_centre:
            _dict['costCentre'] = self.cost_centre.to_dict()
        ...
        # set to None if pay_date (nullable) is None
        # and model_fields_set contains the field
        if self.pay_date is None and "pay_date" in self.model_fields_set:
            _dict['payDate'] = None

        # set to None if account_intervall (nullable) is None
        # and model_fields_set contains the field
        if self.account_intervall is None and "account_intervall" in self.model_fields_set:
            _dict['accountIntervall'] = None

        # set to None if account_next_invoice (nullable) is None
        # and model_fields_set contains the field
        if self.account_next_invoice is None and "account_next_invoice" in self.model_fields_set:
            _dict['accountNextInvoice'] = None

        # set to None if enshrined (nullable) is None
        # and model_fields_set contains the field
        if self.enshrined is None and "enshrined" in self.model_fields_set:
            _dict['enshrined'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact": ModelInvoiceResponseContact.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
            "create": obj.get("create"),
            "update": obj.get("update"),
            "sevClient": ModelInvoiceResponseSevClient.from_dict(obj["sevClient"]) if obj.get("sevClient") is not None else None,
            "invoiceDate": obj.get("invoiceDate"),
            "header": obj.get("header"),
            "headText": obj.get("headText"),
            "footText": obj.get("footText"),
            "timeToPay": obj.get("timeToPay"),
            "discountTime": obj.get("discountTime"),
            "discount": obj.get("discount"),
            "addressCountry": ModelInvoiceResponseAddressCountry.from_dict(obj["addressCountry"]) if obj.get("addressCountry") is not None else None,
            "payDate": obj.get("payDate"),
            "createUser": ModelCreditNoteResponseCreateUser.from_dict(obj["createUser"]) if obj.get("createUser") is not None else None,
            "deliveryDate": obj.get("deliveryDate"),
            "status": obj.get("status"),
            "smallSettlement": obj.get("smallSettlement"),
            "contactPerson": ModelInvoiceResponseContactPerson.from_dict(obj["contactPerson"]) if obj.get("contactPerson") is not None else None,
            ...
            "paymentMethod": ModelInvoiceResponsePaymentMethod.from_dict(obj["paymentMethod"]) if obj.get("paymentMethod") is not None else None,
            "costCentre": ModelInvoiceResponseCostCentre.from_dict(obj["costCentre"]) if obj.get("costCentre") is not None else None,
            "sendDate": obj.get("sendDate"),
            "origin": ModelInvoiceResponseOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
            "invoiceType": obj.get("invoiceType"),
            "accountIntervall": obj.get("accountIntervall"),
            "accountNextInvoice": obj.get("accountNextInvoice"),
            "reminderTotal": obj.get("reminderTotal"),
            "reminderDebit": obj.get("reminderDebit"),
            "reminderDeadline": obj.get("reminderDeadline"),
            "reminderCharge": obj.get("reminderCharge"),
            "taxSet": ModelInvoiceResponseTaxSet.from_dict(obj["taxSet"]) if obj.get("taxSet") is not None else None,
            ...
            "sumNetAccounting": obj.get("sumNetAccounting"),
            "sumTaxAccounting": obj.get("sumTaxAccounting"),
            "sumGrossAccounting": obj.get("sumGrossAccounting"),
            "paidAmount": obj.get("paidAmount"),
            "customerInternalNote": obj.get("customerInternalNote"),
            "showNet": obj.get("showNet"),
            "enshrined": obj.get("enshrined"),
            "sendType": obj.get("sendType"),
            "deliveryDateUntil": obj.get("deliveryDateUntil"),
            "datevConnectOnline": obj.get("datevConnectOnline"),
            "sendPaymentReceivedNotificationDate": obj.get("sendPaymentReceivedNotificationDate")
        })
        return _obj
