...
class ReportApi:
    ...
    def report_contact(
        ...
        :type sev_query: ReportContactSevQueryParameter
        :param download:
        :type download: bool
        ...
        _param = self._report_contact_serialize(
            sev_query=sev_query,
            download=download,
    ...
    @validate_call
    def report_contact_with_http_info(
        self,
        sev_query: ReportContactSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReportContact200Response]:
        """Export contact list
    ...
    @validate_call
    def report_contact_without_preload_content(
        self,
        sev_query: ReportContactSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _report_contact_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Report/contactlist',
    ...
    def report_invoice(
        ...
        :type view: str
        :param sev_query: (required)
        :type sev_query: ReportInvoiceSevQueryParameter
        :param download:
        :type download: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._report_invoice_serialize(
            view=view,
            sev_query=sev_query,
            download=download,
            _request_auth=_request_auth,
    ...
    @validate_call
    def report_invoice_with_http_info(
        self,
        view: StrictStr,
        sev_query: ReportInvoiceSevQueryParameter,
        download: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReportInvoice200Response]:
        """Export invoice list
    ...
    @validate_call
    def report_invoice_without_preload_content(
        self,
        view: StrictStr,
        sev_query: ReportInvoiceSevQueryParameter,
        download: Optional[StrictBool] = None,
    ...
    def _report_invoice_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Report/invoicelist',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def report_order(
        ...
        :type view: str
        :param sev_query: (required)
        :type sev_query: ReportOrderSevQueryParameter
        :param download:
        :type download: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._report_order_serialize(
            view=view,
            sev_query=sev_query,
            download=download,
            _request_auth=_request_auth,
    ...
    @validate_call
    def report_order_with_http_info(
        self,
        view: StrictStr,
        sev_query: ReportOrderSevQueryParameter,
        download: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReportOrder200Response]:
        """Export order list
    ...
    @validate_call
    def report_order_without_preload_content(
        self,
        view: StrictStr,
        sev_query: ReportOrderSevQueryParameter,
        download: Optional[StrictBool] = None,
    ...
    def _report_order_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Report/orderlist',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def report_voucher(
        ...
        :param sev_query: (required)
        :type sev_query: ReportVoucherSevQueryParameter
        :param download:
        :type download: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._report_voucher_serialize(
            sev_query=sev_query,
            download=download,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def report_voucher_with_http_info(
        self,
        sev_query: ReportVoucherSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReportVoucher200Response]:
        """Export voucher list
    ...
    @validate_call
    def report_voucher_without_preload_content(
        self,
        sev_query: ReportVoucherSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _report_voucher_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Report/voucherlist',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
