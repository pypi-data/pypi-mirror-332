...
class ContactApi:
    ...
    @validate_call
    def contact_customer_number_availability_check(
        self,
        customer_number: Annotated[Optional[StrictStr], Field(description="The customer number to be checked.")] = None,
        ...
        :param customer_number: The customer number to be checked.
        ...
        _param = self._contact_customer_number_availability_check_serialize(
    ...
    @validate_call
    def contact_customer_number_availability_check_with_http_info(
        self,
        customer_number: Annotated[Optional[StrictStr], Field(description="The customer number to be checked.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def contact_customer_number_availability_check_without_preload_content(
        self,
        customer_number: Annotated[Optional[StrictStr], Field(description="The customer number to be checked.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _contact_customer_number_availability_check_serialize(
        self,
        customer_number,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Contact/Mapper/checkCustomerNumberAvailability',
    ...
    def create_contact(
        self,
        model_contact: Annotated[Optional[ModelContact], Field(description="Creation data")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param model_contact: Creation data
        :type model_contact: ModelContact
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def create_contact_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ModelContactResponse]:
        """Create a new contact
    ...
    def delete_contact(
        self,
        contact_id: Annotated[StrictInt, Field(description="Id of contact resource to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param contact_id: Id of contact resource to delete (required)
        :type contact_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def find_contacts_by_custom_field_value(
        self,
        value: Annotated[StrictStr, Field(description="The value to be checked.")],
        custom_field_name: Annotated[StrictStr, Field(description="The ContactCustomFieldSetting name, if no ContactCustomFieldSetting is provided.")],
        custom_field_setting_id: Annotated[Optional[StrictStr], Field(description="ID of ContactCustomFieldSetting for which the value has to be checked.")] = None,
        custom_field_setting_object_name: Annotated[Optional[StrictStr], Field(description="Object name. Only needed if you also defined the ID of a ContactCustomFieldSetting.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param value: The value to be checked. (required)
        :type value: str
        :param custom_field_name: The ContactCustomFieldSetting name, if no ContactCustomFieldSetting is provided. (required)
        :type custom_field_name: str
        :param custom_field_setting_id: ID of ContactCustomFieldSetting for which the value has to be checked.
        :type custom_field_setting_id: str
        :param custom_field_setting_object_name: Object name. Only needed if you also defined the ID of a ContactCustomFieldSetting.
        :type custom_field_setting_object_name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._find_contacts_by_custom_field_value_serialize(
            value=value,
            custom_field_name=custom_field_name,
            custom_field_setting_id=custom_field_setting_id,
            custom_field_setting_object_name=custom_field_setting_object_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FindContactsByCustomFieldValue200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def find_contacts_by_custom_field_value_with_http_info(
        self,
        value: Annotated[StrictStr, Field(description="The value to be checked.")],
        custom_field_name: Annotated[StrictStr, Field(description="The ContactCustomFieldSetting name, if no ContactCustomFieldSetting is provided.")],
        custom_field_setting_id: Annotated[Optional[StrictStr], Field(description="ID of ContactCustomFieldSetting for which the value has to be checked.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FindContactsByCustomFieldValue200Response]:
        """Find contacts by custom field value
    ...
    @validate_call
    def find_contacts_by_custom_field_value_without_preload_content(
        self,
        value: Annotated[StrictStr, Field(description="The value to be checked.")],
        custom_field_name: Annotated[StrictStr, Field(description="The ContactCustomFieldSetting name, if no ContactCustomFieldSetting is provided.")],
        custom_field_setting_id: Annotated[Optional[StrictStr], Field(description="ID of ContactCustomFieldSetting for which the value has to be checked.")] = None,
    ...
    def _find_contacts_by_custom_field_value_serialize(
        self,
        value,
        custom_field_name,
        ...
        if custom_field_setting_id is not None:
            
            _query_params.append(('customFieldSetting[id]', custom_field_setting_id))
            
        if custom_field_setting_object_name is not None:
            
            _query_params.append(('customFieldSetting[objectName]', custom_field_setting_object_name))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Contact/Factory/findContactsByCustomFieldValue',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_contact_by_id(
        self,
        contact_id: Annotated[StrictInt, Field(description="ID of contact to return")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def get_contact_tabs_item_count_by_id(
        self,
        contact_id: Annotated[StrictInt, Field(description="ID of contact to return")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_contact_tabs_item_count_by_id_serialize(
            contact_id=contact_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetContactTabsItemCountById200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def get_contact_tabs_item_count_by_id_with_http_info(
        self,
        contact_id: Annotated[StrictInt, Field(description="ID of contact to return")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetContactTabsItemCountById200Response]:
        """Get number of all items
    ...
    @validate_call
    def get_contact_tabs_item_count_by_id_without_preload_content(
        self,
        contact_id: Annotated[StrictInt, Field(description="ID of contact to return")],
        _request_timeout: Union[
            None,
    ...
    def _get_contact_tabs_item_count_by_id_serialize(
        self,
        contact_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Contact/{contactId}/getTabsItemCount',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_contacts(
        self,
        depth: Annotated[Optional[StrictStr], Field(description="Defines if both organizations <b>and</b> persons should be returned.<br>       '0' -> only organizations, '1' -> organizations and persons")] = None,
        customer_number: Annotated[Optional[StrictStr], Field(description="Retrieve all contacts with this customer number")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param depth: Defines if both organizations <b>and</b> persons should be returned.<br>       '0' -> only organizations, '1' -> organizations and persons
        :type depth: str
        :param customer_number: Retrieve all contacts with this customer number
        :type customer_number: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_next_customer_number(
        ...
        _param = self._get_next_customer_number_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetNextCustomerNumber200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def get_next_customer_number_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetNextCustomerNumber200Response]:
        """Get next free customer number
    ...
    @validate_call
    def get_next_customer_number_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_next_customer_number_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Contact/Factory/getNextCustomerNumber',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_contact(
        self,
        contact_id: Annotated[StrictInt, Field(description="ID of contact to update")],
        model_contact_update: Annotated[Optional[ModelContactUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param contact_id: ID of contact to update (required)
        :type contact_id: int
        :param model_contact_update: Update data
        :type model_contact_update: ModelContactUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_contact_serialize(
            contact_id=contact_id,
            model_contact_update=model_contact_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_contact_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if model_contact_update is not None:
            _body_params = model_contact_update
