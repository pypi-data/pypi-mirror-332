...
class VoucherPosApi:
    ...
    @validate_call
    def get_voucher_positions(
        self,
        voucher_id: Annotated[Optional[StrictInt], Field(description="Retrieve all vouchers positions belonging to this voucher. Must be provided with voucher[objectName]")] = None,
        voucher_object_name: Annotated[Optional[StrictStr], Field(description="Only required if voucher[id] was provided. 'Voucher' should be used as value.")] = None,
        ...
        :param voucher_id: Retrieve all vouchers positions belonging to this voucher. Must be provided with voucher[objectName]
        :type voucher_id: int
        :param voucher_object_name: Only required if voucher[id] was provided. 'Voucher' should be used as value.
        :type voucher_object_name: str
        ...
        _param = self._get_voucher_positions_serialize(
            voucher_id=voucher_id,
            voucher_object_name=voucher_object_name,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetVoucherPositions200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def get_voucher_positions_with_http_info(
        self,
        voucher_id: Annotated[Optional[StrictInt], Field(description="Retrieve all vouchers positions belonging to this voucher. Must be provided with voucher[objectName]")] = None,
        voucher_object_name: Annotated[Optional[StrictStr], Field(description="Only required if voucher[id] was provided. 'Voucher' should be used as value.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetVoucherPositions200Response]:
        """Retrieve voucher positions
    ...
    @validate_call
    def get_voucher_positions_without_preload_content(
        self,
        voucher_id: Annotated[Optional[StrictInt], Field(description="Retrieve all vouchers positions belonging to this voucher. Must be provided with voucher[objectName]")] = None,
        voucher_object_name: Annotated[Optional[StrictStr], Field(description="Only required if voucher[id] was provided. 'Voucher' should be used as value.")] = None,
        _request_timeout: Union[
    ...
    def _get_voucher_positions_serialize(
        self,
        voucher_id,
        voucher_object_name,
        _request_auth,
        ...
        if voucher_id is not None:
            ...
            _query_params.append(('voucher[id]', voucher_id))
            
        if voucher_object_name is not None:
            
            _query_params.append(('voucher[objectName]', voucher_object_name))
