...
class CommunicationWayApi:
    ...
    @validate_call
    def create_communication_way(
        self,
        model_communication_way: Annotated[Optional[ModelCommunicationWay], Field(description="Creation data")] = None,
        ...
        :param model_communication_way: Creation data
        :type model_communication_way: ModelCommunicationWay
        ...
        _param = self._create_communication_way_serialize(
            model_communication_way=model_communication_way,
    ...
    @validate_call
    def create_communication_way_with_http_info(
        self,
        model_communication_way: Annotated[Optional[ModelCommunicationWay], Field(description="Creation data")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ModelCommunicationWayResponse]:
        """Create a new contact communication way
    ...
    @validate_call
    def create_communication_way_without_preload_content(
        self,
        model_communication_way: Annotated[Optional[ModelCommunicationWay], Field(description="Creation data")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_communication_way_serialize(
        self,
        model_communication_way,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if model_communication_way is not None:
            _body_params = model_communication_way
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/CommunicationWay',
    ...
    @validate_call
    def delete_communication_way(
        self,
        communication_way_id: Annotated[StrictInt, Field(description="Id of communication way resource to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param communication_way_id: Id of communication way resource to delete (required)
        :type communication_way_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_communication_way_serialize(
    ...
    @validate_call
    def delete_communication_way_with_http_info(
        self,
        communication_way_id: Annotated[StrictInt, Field(description="Id of communication way resource to delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_communication_way_without_preload_content(
        self,
        communication_way_id: Annotated[StrictInt, Field(description="Id of communication way resource to delete")],
        _request_timeout: Union[
            None,
    ...
    def _delete_communication_way_serialize(
        self,
        ...
        # process the path parameters
        if communication_way_id is not None:
            _path_params['communicationWayId'] = communication_way_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/CommunicationWay/{communicationWayId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_communication_way_by_id(
        self,
        communication_way_id: Annotated[StrictInt, Field(description="ID of communication way to return")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param communication_way_id: ID of communication way to return (required)
        :type communication_way_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_communication_way_by_id_serialize(
            communication_way_id=communication_way_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetCommunicationWays200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def get_communication_way_by_id_with_http_info(
        self,
        communication_way_id: Annotated[StrictInt, Field(description="ID of communication way to return")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCommunicationWays200Response]:
        """Find communication way by ID
    ...
    @validate_call
    def get_communication_way_by_id_without_preload_content(
        self,
        communication_way_id: Annotated[StrictInt, Field(description="ID of communication way to return")],
        _request_timeout: Union[
            None,
    ...
    def _get_communication_way_by_id_serialize(
        self,
        communication_way_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_communication_way_keys(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_communication_way_keys_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetCommunicationWayKeys200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def get_communication_way_keys_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCommunicationWayKeys200Response]:
        """Retrieve communication way keys
    ...
    @validate_call
    def get_communication_way_keys_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_communication_way_keys_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/CommunicationWayKey',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_communication_ways(
        self,
        contact_id: Annotated[Optional[StrictStr], Field(description="ID of contact for which you want the communication ways.")] = None,
        contact_object_name: Annotated[Optional[StrictStr], Field(description="Object name. Only needed if you also defined the ID of a contact.")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Type of the communication ways you want to get.")] = None,
        main: Annotated[Optional[StrictStr], Field(description="Define if you only want the main communication way.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param contact_id: ID of contact for which you want the communication ways.
        :type contact_id: str
        :param contact_object_name: Object name. Only needed if you also defined the ID of a contact.
        ...
        _param = self._get_communication_ways_serialize(
    ...
    @validate_call
    def get_communication_ways_with_http_info(
        self,
        contact_id: Annotated[Optional[StrictStr], Field(description="ID of contact for which you want the communication ways.")] = None,
        contact_object_name: Annotated[Optional[StrictStr], Field(description="Object name. Only needed if you also defined the ID of a contact.")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Type of the communication ways you want to get.")] = None,
    ...
    @validate_call
    def get_communication_ways_without_preload_content(
        self,
        contact_id: Annotated[Optional[StrictStr], Field(description="ID of contact for which you want the communication ways.")] = None,
        contact_object_name: Annotated[Optional[StrictStr], Field(description="Object name. Only needed if you also defined the ID of a contact.")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Type of the communication ways you want to get.")] = None,
    ...
    def _get_communication_ways_serialize(
        self,
        contact_id,
        contact_object_name,
        type,
    ...
    @validate_call
    def update_communication_way(
        self,
        communication_way_id: Annotated[StrictInt, Field(description="ID of CommunicationWay to update")],
        model_communication_way_update: Annotated[Optional[ModelCommunicationWayUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param communication_way_id: ID of CommunicationWay to update (required)
        :type communication_way_id: int
        :param model_communication_way_update: Update data
        :type model_communication_way_update: ModelCommunicationWayUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_communication_way_serialize(
            communication_way_id=communication_way_id,
            model_communication_way_update=model_communication_way_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_communication_way_with_http_info(
        self,
        communication_way_id: Annotated[StrictInt, Field(description="ID of CommunicationWay to update")],
        model_communication_way_update: Annotated[Optional[ModelCommunicationWayUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_communication_way_without_preload_content(
        self,
        communication_way_id: Annotated[StrictInt, Field(description="ID of CommunicationWay to update")],
        model_communication_way_update: Annotated[Optional[ModelCommunicationWayUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
    ...
    def _update_communication_way_serialize(
        self,
        communication_way_id,
        model_communication_way_update,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if model_communication_way_update is not None:
            _body_params = model_communication_way_update
