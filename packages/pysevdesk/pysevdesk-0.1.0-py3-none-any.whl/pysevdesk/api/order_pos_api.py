...
class OrderPosApi:
    ...
    @validate_call
    def delete_order_pos(
        self,
        order_pos_id: Annotated[StrictInt, Field(description="Id of order position resource to delete")],
        ...
        :param order_pos_id: Id of order position resource to delete (required)
        :type order_pos_id: int
        ...
        _param = self._delete_order_pos_serialize(
    ...
    @validate_call
    def delete_order_pos_with_http_info(
        self,
        order_pos_id: Annotated[StrictInt, Field(description="Id of order position resource to delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_order_pos_without_preload_content(
        self,
        order_pos_id: Annotated[StrictInt, Field(description="Id of order position resource to delete")],
        _request_timeout: Union[
            None,
    ...
    def _delete_order_pos_serialize(
        self,
        order_pos_id,
        _request_auth,
        _content_type,
        ...
        if order_pos_id is not None:
            _path_params['orderPosId'] = order_pos_id
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/OrderPos/{orderPosId}',
    ...
    @validate_call
    def get_order_position_by_id(
        self,
        order_pos_id: Annotated[StrictInt, Field(description="ID of order position to return")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_pos_id: ID of order position to return (required)
        :type order_pos_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_order_position_by_id_serialize(
            order_pos_id=order_pos_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_order_position_by_id_with_http_info(
        self,
        order_pos_id: Annotated[StrictInt, Field(description="ID of order position to return")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_order_position_by_id_without_preload_content(
        self,
        order_pos_id: Annotated[StrictInt, Field(description="ID of order position to return")],
        _request_timeout: Union[
            None,
    ...
    def _get_order_position_by_id_serialize(
        self,
        order_pos_id,
        _request_auth,
        _content_type,
    ...
    def get_order_positions(
        self,
        order_id: Annotated[Optional[StrictInt], Field(description="Retrieve all order positions belonging to this order. Must be provided with voucher[objectName]")] = None,
        order_object_name: Annotated[Optional[StrictStr], Field(description="Only required if order[id] was provided. 'Order' should be used as value.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_id: Retrieve all order positions belonging to this order. Must be provided with voucher[objectName]
        :type order_id: int
        :param order_object_name: Only required if order[id] was provided. 'Order' should be used as value.
        ...
        _param = self._get_order_positions_serialize(
            order_id=order_id,
    ...
    @validate_call
    def get_order_positions_with_http_info(
        self,
        order_id: Annotated[Optional[StrictInt], Field(description="Retrieve all order positions belonging to this order. Must be provided with voucher[objectName]")] = None,
        order_object_name: Annotated[Optional[StrictStr], Field(description="Only required if order[id] was provided. 'Order' should be used as value.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_order_positions_without_preload_content(
        self,
        order_id: Annotated[Optional[StrictInt], Field(description="Retrieve all order positions belonging to this order. Must be provided with voucher[objectName]")] = None,
        order_object_name: Annotated[Optional[StrictStr], Field(description="Only required if order[id] was provided. 'Order' should be used as value.")] = None,
        _request_timeout: Union[
    ...
    def _get_order_positions_serialize(
        self,
        order_id,
        order_object_name,
        _request_auth,
    ...
    @validate_call
    def update_order_position(
        self,
        order_pos_id: Annotated[StrictInt, Field(description="ID of order position to update")],
        model_order_pos_update: Annotated[Optional[ModelOrderPosUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_pos_id: ID of order position to update (required)
        :type order_pos_id: int
        :param model_order_pos_update: Update data
        :type model_order_pos_update: ModelOrderPosUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_order_position_serialize(
            order_pos_id=order_pos_id,
            model_order_pos_update=model_order_pos_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_order_position_with_http_info(
        self,
        order_pos_id: Annotated[StrictInt, Field(description="ID of order position to update")],
        model_order_pos_update: Annotated[Optional[ModelOrderPosUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ModelOrderPosResponse]:
        """Update an existing order position
    ...
    @validate_call
    def update_order_position_without_preload_content(
        self,
        order_pos_id: Annotated[StrictInt, Field(description="ID of order position to update")],
        model_order_pos_update: Annotated[Optional[ModelOrderPosUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
    ...
    def _update_order_position_serialize(
        self,
        order_pos_id,
        model_order_pos_update,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if model_order_pos_update is not None:
            _body_params = model_order_pos_update
