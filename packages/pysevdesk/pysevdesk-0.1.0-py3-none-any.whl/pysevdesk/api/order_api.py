...
class OrderApi:
    ...
    @validate_call
    def create_contract_note_from_order(
        self,
        order_id: Annotated[StrictInt, Field(description="the id of the order")],
        order_object_name: Annotated[StrictStr, Field(description="Model name, which is 'Order'")],
        model_create_packing_list_from_order: Annotated[Optional[ModelCreatePackingListFromOrder], Field(description="Create contract note")] = None,
        ...
        :type order_id: int
        :param order_object_name: Model name, which is 'Order' (required)
        :type order_object_name: str
        :param model_create_packing_list_from_order: Create contract note
        :type model_create_packing_list_from_order: ModelCreatePackingListFromOrder
        ...
        _param = self._create_contract_note_from_order_serialize(
            order_id=order_id,
            order_object_name=order_object_name,
            model_create_packing_list_from_order=model_create_packing_list_from_order,
    ...
    @validate_call
    def create_contract_note_from_order_with_http_info(
        self,
        order_id: Annotated[StrictInt, Field(description="the id of the order")],
        order_object_name: Annotated[StrictStr, Field(description="Model name, which is 'Order'")],
        model_create_packing_list_from_order: Annotated[Optional[ModelCreatePackingListFromOrder], Field(description="Create contract note")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ModelOrderResponse]:
        """Create contract note from order
    ...
    @validate_call
    def create_contract_note_from_order_without_preload_content(
        self,
        order_id: Annotated[StrictInt, Field(description="the id of the order")],
        order_object_name: Annotated[StrictStr, Field(description="Model name, which is 'Order'")],
        model_create_packing_list_from_order: Annotated[Optional[ModelCreatePackingListFromOrder], Field(description="Create contract note")] = None,
    ...
    def _create_contract_note_from_order_serialize(
        self,
        order_id,
        order_object_name,
        model_create_packing_list_from_order,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if order_object_name is not None:
            
            _query_params.append(('order[objectName]', order_object_name))
            
        # process the header parameters
        # process the form parameters
        # process the body parameter
        if model_create_packing_list_from_order is not None:
            _body_params = model_create_packing_list_from_order
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Order/Factory/createContractNoteFromOrder',
    ...
    def create_order(
        self,
        save_order: Annotated[Optional[SaveOrder], Field(description="Creation data. Please be aware, that you need to provide at least all required parameter      of the order model!")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param save_order: Creation data. Please be aware, that you need to provide at least all required parameter      of the order model!
        :type save_order: SaveOrder
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _create_order_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if save_order is not None:
            _body_params = save_order
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Order/Factory/saveOrder',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def create_packing_list_from_order(
        self,
        order_id: Annotated[StrictInt, Field(description="the id of the order")],
        order_object_name: Annotated[StrictStr, Field(description="Model name, which is 'Order'")],
        model_create_packing_list_from_order: Annotated[Optional[ModelCreatePackingListFromOrder], Field(description="Create packing list")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_object_name: Model name, which is 'Order' (required)
        :type order_object_name: str
        :param model_create_packing_list_from_order: Create packing list
        :type model_create_packing_list_from_order: ModelCreatePackingListFromOrder
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._create_packing_list_from_order_serialize(
            order_id=order_id,
            order_object_name=order_object_name,
            model_create_packing_list_from_order=model_create_packing_list_from_order,
            _request_auth=_request_auth,
    ...
    @validate_call
    def create_packing_list_from_order_with_http_info(
        self,
        order_id: Annotated[StrictInt, Field(description="the id of the order")],
        order_object_name: Annotated[StrictStr, Field(description="Model name, which is 'Order'")],
        model_create_packing_list_from_order: Annotated[Optional[ModelCreatePackingListFromOrder], Field(description="Create packing list")] = None,
    ...
    @validate_call
    def create_packing_list_from_order_without_preload_content(
        self,
        order_id: Annotated[StrictInt, Field(description="the id of the order")],
        order_object_name: Annotated[StrictStr, Field(description="Model name, which is 'Order'")],
        model_create_packing_list_from_order: Annotated[Optional[ModelCreatePackingListFromOrder], Field(description="Create packing list")] = None,
    ...
    def _create_packing_list_from_order_serialize(
        self,
        order_id,
        order_object_name,
        model_create_packing_list_from_order,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Order/Factory/createPackingListFromOrder',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_order(
        self,
        order_id: Annotated[StrictInt, Field(description="Id of order resource to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_id: Id of order resource to delete (required)
        :type order_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_discounts(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to return the positions")],
        ...
        :param order_id: ID of order to return the positions (required)
        :type order_id: int
    ...
    def get_discounts_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDiscounts200Response]:
        """Find order discounts
    ...
    def _get_discounts_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Order/{orderId}/getDiscounts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_order_positions_by_id(
        ...
        _param = self._get_order_positions_by_id_serialize(
            order_id=order_id,
            limit=limit,
            offset=offset,
            embed=embed,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetOrderPositionsById200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def get_order_positions_by_id_with_http_info(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to return the positions")],
        limit: Annotated[Optional[StrictInt], Field(description="limits the number of entries returned")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="set the index where the returned entries start")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetOrderPositionsById200Response]:
        """Find order positions
    ...
    @validate_call
    def get_order_positions_by_id_without_preload_content(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to return the positions")],
        limit: Annotated[Optional[StrictInt], Field(description="limits the number of entries returned")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="set the index where the returned entries start")] = None,
    ...
    def _get_order_positions_by_id_serialize(
        self,
        order_id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Order/{orderId}/getPositions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_orders(
        self,
        status: Annotated[Optional[StrictInt], Field(description="Status of the order")] = None,
        order_number: Annotated[Optional[StrictStr], Field(description="Retrieve all orders with this order number")] = None,
        start_date: Annotated[Optional[StrictInt], Field(description="Retrieve all orders with a date equal or higher")] = None,
        end_date: Annotated[Optional[StrictInt], Field(description="Retrieve all orders with a date equal or lower")] = None,
        contact_id: Annotated[Optional[StrictInt], Field(description="Retrieve all orders with this contact. Must be provided with contact[objectName]")] = None,
        ...
        :type status: int
        :param order_number: Retrieve all orders with this order number
        :type order_number: str
        :param start_date: Retrieve all orders with a date equal or higher
        :type start_date: int
        :param end_date: Retrieve all orders with a date equal or lower
        :type end_date: int
        :param contact_id: Retrieve all orders with this contact. Must be provided with contact[objectName]
        :type contact_id: int
    ...
    def get_related_objects(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to return the positions")],
        include_itself: Annotated[Optional[StrictBool], Field(description="Define if the related objects include the order itself")] = None,
        sort_by_type: Annotated[Optional[StrictBool], Field(description="Define if you want the related objects sorted by type")] = None,
        embed: Annotated[Optional[List[StrictStr]], Field(description="Get some additional information. Embed can handle multiple values, they must be separated by comma.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param order_id: ID of order to return the positions (required)
        :type order_id: int
        :param include_itself: Define if the related objects include the order itself
        :type include_itself: bool
        :param sort_by_type: Define if you want the related objects sorted by type
        :type sort_by_type: bool
        :param embed: Get some additional information. Embed can handle multiple values, they must be separated by comma.
        :type embed: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._get_related_objects_serialize(
            order_id=order_id,
    ...
    @validate_call
    def get_related_objects_with_http_info(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to return the positions")],
        include_itself: Annotated[Optional[StrictBool], Field(description="Define if the related objects include the order itself")] = None,
        sort_by_type: Annotated[Optional[StrictBool], Field(description="Define if you want the related objects sorted by type")] = None,
    ...
    @validate_call
    def get_related_objects_without_preload_content(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to return the positions")],
        include_itself: Annotated[Optional[StrictBool], Field(description="Define if the related objects include the order itself")] = None,
        sort_by_type: Annotated[Optional[StrictBool], Field(description="Define if you want the related objects sorted by type")] = None,
    ...
    def _get_related_objects_serialize(
        self,
        order_id,
        include_itself,
        sort_by_type,
        ...
        if order_id is not None:
            _path_params['orderId'] = order_id
        # process the query parameters
        if include_itself is not None:
            
            _query_params.append(('includeItself', include_itself))
            
        if sort_by_type is not None:
            
            _query_params.append(('sortByType', sort_by_type))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Order/{orderId}/getRelatedObjects',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def order_get_pdf(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order from which you want the pdf")],
        download: Annotated[Optional[StrictBool], Field(description="If u want to download the pdf of the order.")] = None,
        prevent_send_by: Annotated[Optional[StrictBool], Field(description="Defines if u want to send the order.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_id: ID of order from which you want the pdf (required)
        :type order_id: int
        :param download: If u want to download the pdf of the order.
        :type download: bool
        :param prevent_send_by: Defines if u want to send the order.
        ...
        _param = self._order_get_pdf_serialize(
            order_id=order_id,
            download=download,
    ...
    @validate_call
    def order_get_pdf_with_http_info(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order from which you want the pdf")],
        download: Annotated[Optional[StrictBool], Field(description="If u want to download the pdf of the order.")] = None,
        prevent_send_by: Annotated[Optional[StrictBool], Field(description="Defines if u want to send the order.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrderGetPdf200Response]:
        """Retrieve pdf document of an order
    ...
    @validate_call
    def order_get_pdf_without_preload_content(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order from which you want the pdf")],
        download: Annotated[Optional[StrictBool], Field(description="If u want to download the pdf of the order.")] = None,
        prevent_send_by: Annotated[Optional[StrictBool], Field(description="Defines if u want to send the order.")] = None,
    ...
    def _order_get_pdf_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Order/{orderId}/getPdf',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def order_send_by(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to mark as sent")],
        order_send_by_request: Annotated[Optional[OrderSendByRequest], Field(description="Specify the send type")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_id: ID of order to mark as sent (required)
        :type order_id: int
        :param order_send_by_request: Specify the send type
        :type order_send_by_request: OrderSendByRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._order_send_by_serialize(
            order_id=order_id,
            order_send_by_request=order_send_by_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def order_send_by_with_http_info(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to mark as sent")],
        order_send_by_request: Annotated[Optional[OrderSendByRequest], Field(description="Specify the send type")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def order_send_by_without_preload_content(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to mark as sent")],
        order_send_by_request: Annotated[Optional[OrderSendByRequest], Field(description="Specify the send type")] = None,
        _request_timeout: Union[
    ...
    def _order_send_by_serialize(
        self,
        order_id,
        order_send_by_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if order_send_by_request is not None:
            _body_params = order_send_by_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/Order/{orderId}/sendBy',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def sendorder_via_e_mail(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to be sent via email")],
        sendorder_via_e_mail_request: Annotated[Optional[SendorderViaEMailRequest], Field(description="Mail data")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_id: ID of order to be sent via email (required)
        :type order_id: int
        :param sendorder_via_e_mail_request: Mail data
        :type sendorder_via_e_mail_request: SendorderViaEMailRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._sendorder_via_e_mail_serialize(
            order_id=order_id,
            sendorder_via_e_mail_request=sendorder_via_e_mail_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "SendorderViaEMail201Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def sendorder_via_e_mail_with_http_info(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to be sent via email")],
        sendorder_via_e_mail_request: Annotated[Optional[SendorderViaEMailRequest], Field(description="Mail data")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SendorderViaEMail201Response]:
        """Send order via email
    ...
    @validate_call
    def sendorder_via_e_mail_without_preload_content(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to be sent via email")],
        sendorder_via_e_mail_request: Annotated[Optional[SendorderViaEMailRequest], Field(description="Mail data")] = None,
        _request_timeout: Union[
    ...
    def _sendorder_via_e_mail_serialize(
        self,
        order_id,
        sendorder_via_e_mail_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if sendorder_via_e_mail_request is not None:
            _body_params = sendorder_via_e_mail_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Order/{orderId}/sendViaEmail',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_order(
        self,
        order_id: Annotated[StrictInt, Field(description="ID of order to update")],
        model_order_update: Annotated[Optional[ModelOrderUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_id: ID of order to update (required)
        :type order_id: int
        :param model_order_update: Update data
        :type model_order_update: ModelOrderUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_order_serialize(
            order_id=order_id,
            model_order_update=model_order_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_order_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if model_order_update is not None:
            _body_params = model_order_update
