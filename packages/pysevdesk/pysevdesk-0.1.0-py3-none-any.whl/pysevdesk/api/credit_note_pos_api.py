...
class CreditNotePosApi:
    ...
    @validate_call
    def getcredit_note_positions(
        self,
        credit_note_id: Annotated[Optional[StrictInt], Field(description="Retrieve all creditNote positions belonging to this creditNote. Must be provided with creditNote[objectName]")] = None,
        credit_note_object_name: Annotated[Optional[StrictStr], Field(description="Only required if creditNote[id] was provided. 'creditNote' should be used as value.")] = None,
        ...
        :param credit_note_id: Retrieve all creditNote positions belonging to this creditNote. Must be provided with creditNote[objectName]
        :type credit_note_id: int
        :param credit_note_object_name: Only required if creditNote[id] was provided. 'creditNote' should be used as value.
        :type credit_note_object_name: str
        ...
        _param = self._getcredit_note_positions_serialize(
            credit_note_id=credit_note_id,
            credit_note_object_name=credit_note_object_name,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetcreditNotePositions200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def getcredit_note_positions_with_http_info(
        self,
        credit_note_id: Annotated[Optional[StrictInt], Field(description="Retrieve all creditNote positions belonging to this creditNote. Must be provided with creditNote[objectName]")] = None,
        credit_note_object_name: Annotated[Optional[StrictStr], Field(description="Only required if creditNote[id] was provided. 'creditNote' should be used as value.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetcreditNotePositions200Response]:
        """Retrieve creditNote positions
    ...
    @validate_call
    def getcredit_note_positions_without_preload_content(
        self,
        credit_note_id: Annotated[Optional[StrictInt], Field(description="Retrieve all creditNote positions belonging to this creditNote. Must be provided with creditNote[objectName]")] = None,
        credit_note_object_name: Annotated[Optional[StrictStr], Field(description="Only required if creditNote[id] was provided. 'creditNote' should be used as value.")] = None,
        _request_timeout: Union[
    ...
    def _getcredit_note_positions_serialize(
        self,
        credit_note_id,
        ...
        if credit_note_id is not None:
            ...
            _query_params.append(('creditNote[id]', credit_note_id))
            
        if credit_note_object_name is not None:
            
            _query_params.append(('creditNote[objectName]', credit_note_object_name))
