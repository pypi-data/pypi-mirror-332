...
class PartApi:
    ...
    def create_part(
        self,
        model_part: Annotated[Optional[ModelPart], Field(description="Creation data. Please be aware, that you need to provide at least all required parameter      of the part model!")] = None,
        ...
        :param model_part: Creation data. Please be aware, that you need to provide at least all required parameter      of the part model!
        :type model_part: ModelPart
        ...
        _param = self._create_part_serialize(
    ...
    @validate_call
    def create_part_without_preload_content(
        self,
        model_part: Annotated[Optional[ModelPart], Field(description="Creation data. Please be aware, that you need to provide at least all required parameter      of the part model!")] = None,
        _request_timeout: Union[
            None,
    ...
    def get_part_by_id(
        self,
        part_id: Annotated[StrictInt, Field(description="ID of part to return")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param part_id: ID of part to return (required)
        :type part_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_part_by_id_serialize(
            part_id=part_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_part_by_id_with_http_info(
        self,
        part_id: Annotated[StrictInt, Field(description="ID of part to return")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetParts200Response]:
        """Find part by ID
    ...
    @validate_call
    def get_part_by_id_without_preload_content(
        self,
        part_id: Annotated[StrictInt, Field(description="ID of part to return")],
        _request_timeout: Union[
            None,
    ...
    def get_parts(
        self,
        part_number: Annotated[Optional[StrictStr], Field(description="Retrieve all parts with this part number")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Retrieve all parts with this name")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param part_number: Retrieve all parts with this part number
        :type part_number: str
        :param name: Retrieve all parts with this name
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_parts_serialize(
    ...
    @validate_call
    def get_parts_without_preload_content(
        self,
        part_number: Annotated[Optional[StrictStr], Field(description="Retrieve all parts with this part number")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Retrieve all parts with this name")] = None,
        _request_timeout: Union[
    ...
    def part_get_stock(
        self,
        part_id: Annotated[StrictInt, Field(description="ID of part for which you want the current stock.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param part_id: ID of part for which you want the current stock. (required)
        :type part_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._part_get_stock_serialize(
            part_id=part_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def part_get_stock_with_http_info(
        self,
        part_id: Annotated[StrictInt, Field(description="ID of part for which you want the current stock.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PartGetStock200Response]:
        """Get stock of a part
    ...
    @validate_call
    def part_get_stock_without_preload_content(
        self,
        part_id: Annotated[StrictInt, Field(description="ID of part for which you want the current stock.")],
        _request_timeout: Union[
            None,
    ...
    def _part_get_stock_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Part/{partId}/getStock',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_part(
        self,
        part_id: Annotated[StrictInt, Field(description="ID of part to update")],
        model_part_update: Annotated[Optional[ModelPartUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param part_id: ID of part to update (required)
        :type part_id: int
        :param model_part_update: Update data
        :type model_part_update: ModelPartUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_part_serialize(
            part_id=part_id,
            model_part_update=model_part_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_part_with_http_info(
        self,
        part_id: Annotated[StrictInt, Field(description="ID of part to update")],
        model_part_update: Annotated[Optional[ModelPartUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_part_without_preload_content(
        self,
        part_id: Annotated[StrictInt, Field(description="ID of part to update")],
        model_part_update: Annotated[Optional[ModelPartUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
    ...
    def _update_part_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if model_part_update is not None:
            _body_params = model_part_update
