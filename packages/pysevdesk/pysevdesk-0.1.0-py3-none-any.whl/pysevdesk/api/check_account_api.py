...
class CheckAccountApi:
    ...
    def create_clearing_account(
        self,
        create_clearing_account: Annotated[Optional[CreateClearingAccount], Field(description="Data to create a clearning account")] = None,
        ...
        :param create_clearing_account: Data to create a clearning account
        :type create_clearing_account: CreateClearingAccount
        ...
        _param = self._create_clearing_account_serialize(
            create_clearing_account=create_clearing_account,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CreateClearingAccount201Response",
            '400': None,
            '401': None,
            '422': None,
            '500': None,
    ...
    @validate_call
    def create_clearing_account_with_http_info(
        self,
        create_clearing_account: Annotated[Optional[CreateClearingAccount], Field(description="Data to create a clearning account")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateClearingAccount201Response]:
        """Create a new clearing account
    ...
    @validate_call
    def create_clearing_account_without_preload_content(
        self,
        create_clearing_account: Annotated[Optional[CreateClearingAccount], Field(description="Data to create a clearning account")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_clearing_account_serialize(
        self,
        ...
        if create_clearing_account is not None:
            _body_params = create_clearing_account
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/CheckAccount/Factory/clearingAccount',
    ...
    def create_file_import_account(
        self,
        create_file_import_account: Annotated[Optional[CreateFileImportAccount], Field(description="Data to create a file import account")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param create_file_import_account: Data to create a file import account
        :type create_file_import_account: CreateFileImportAccount
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_file_import_account_serialize(
            create_file_import_account=create_file_import_account,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CreateFileImportAccount201Response",
            '400': None,
            '401': None,
            '422': None,
            '500': None,
    ...
    @validate_call
    def create_file_import_account_with_http_info(
        self,
        create_file_import_account: Annotated[Optional[CreateFileImportAccount], Field(description="Data to create a file import account")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateFileImportAccount201Response]:
        """Create a new file import account
    ...
    @validate_call
    def create_file_import_account_without_preload_content(
        self,
        create_file_import_account: Annotated[Optional[CreateFileImportAccount], Field(description="Data to create a file import account")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_file_import_account_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if create_file_import_account is not None:
            _body_params = create_file_import_account
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/CheckAccount/Factory/fileImportAccount',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_check_account(
        self,
        check_account_id: Annotated[StrictInt, Field(description="Id of check account to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param check_account_id: Id of check account to delete (required)
        ...
        _param = self._delete_check_account_serialize(
    ...
    @validate_call
    def delete_check_account_with_http_info(
        self,
        check_account_id: Annotated[StrictInt, Field(description="Id of check account to delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_check_account_without_preload_content(
        self,
        check_account_id: Annotated[StrictInt, Field(description="Id of check account to delete")],
        _request_timeout: Union[
            None,
    ...
    def _delete_check_account_serialize(
        self,
        check_account_id,
        _request_auth,
        _content_type,
        ...
        if check_account_id is not None:
            _path_params['checkAccountId'] = check_account_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/CheckAccount/{checkAccountId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_balance_at_date(
        self,
        check_account_id: Annotated[StrictInt, Field(description="ID of check account")],
        var_date: Annotated[date, Field(description="Only consider transactions up to this date at 23:59:59")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param check_account_id: ID of check account (required)
        :type check_account_id: int
        :param var_date: Only consider transactions up to this date at 23:59:59 (required)
        :type var_date: date
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_balance_at_date_serialize(
            check_account_id=check_account_id,
            var_date=var_date,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetBalanceAtDate200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def get_balance_at_date_with_http_info(
        self,
        check_account_id: Annotated[StrictInt, Field(description="ID of check account")],
        var_date: Annotated[date, Field(description="Only consider transactions up to this date at 23:59:59")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetBalanceAtDate200Response]:
        """Get the balance at a given date
    ...
    @validate_call
    def get_balance_at_date_without_preload_content(
        self,
        check_account_id: Annotated[StrictInt, Field(description="ID of check account")],
        var_date: Annotated[date, Field(description="Only consider transactions up to this date at 23:59:59")],
        _request_timeout: Union[
    ...
    def _get_balance_at_date_serialize(
        self,
        check_account_id,
        var_date,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/CheckAccount/{checkAccountId}/getBalanceAtDate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_check_account_by_id(
        ...
        _param = self._get_check_account_by_id_serialize(
            check_account_id=check_account_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetCheckAccounts200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def get_check_account_by_id_with_http_info(
        self,
        check_account_id: Annotated[StrictInt, Field(description="ID of check account")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCheckAccounts200Response]:
        """Find check account by ID
    ...
    @validate_call
    def get_check_account_by_id_without_preload_content(
        self,
        check_account_id: Annotated[StrictInt, Field(description="ID of check account")],
        _request_timeout: Union[
            None,
    ...
    def _get_check_account_by_id_serialize(
        self,
        check_account_id,
        _request_auth,
        _content_type,
    ...
    def get_check_accounts(
        ...
        _param = self._get_check_accounts_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_check_accounts_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_check_accounts_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_check_accounts_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def update_check_account(
        self,
        check_account_id: Annotated[StrictInt, Field(description="ID of check account to update")],
        model_check_account_update: Annotated[Optional[ModelCheckAccountUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param check_account_id: ID of check account to update (required)
        :type check_account_id: int
        :param model_check_account_update: Update data
        :type model_check_account_update: ModelCheckAccountUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_check_account_serialize(
            check_account_id=check_account_id,
            model_check_account_update=model_check_account_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_check_account_with_http_info(
        self,
        check_account_id: Annotated[StrictInt, Field(description="ID of check account to update")],
        model_check_account_update: Annotated[Optional[ModelCheckAccountUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ModelCheckAccountResponse]:
        """Update an existing check account
    ...
    @validate_call
    def update_check_account_without_preload_content(
        self,
        check_account_id: Annotated[StrictInt, Field(description="ID of check account to update")],
        model_check_account_update: Annotated[Optional[ModelCheckAccountUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
    ...
    def _update_check_account_serialize(
        self,
        check_account_id,
        model_check_account_update,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if model_check_account_update is not None:
            _body_params = model_check_account_update
