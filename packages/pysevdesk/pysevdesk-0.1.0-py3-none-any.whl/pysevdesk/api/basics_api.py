...
class BasicsApi:
    ...
    @validate_call
    def bookkeeping_system_version(
        self,
        ...
        _param = self._bookkeeping_system_version_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BookkeepingSystemVersion200Response",
            '401': None,
        }
    ...
    @validate_call
    def bookkeeping_system_version_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BookkeepingSystemVersion200Response]:
        """Retrieve bookkeeping system version
    ...
    @validate_call
    def bookkeeping_system_version_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _bookkeeping_system_version_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Tools/bookkeepingSystemVersion',
