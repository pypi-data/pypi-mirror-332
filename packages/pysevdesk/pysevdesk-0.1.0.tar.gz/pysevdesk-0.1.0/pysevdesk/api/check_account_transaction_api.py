...
class CheckAccountTransactionApi:
    ...
    @validate_call
    def check_account_transaction_enshrine(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="ID of the transaction to enshrine")],
        ...
        :param check_account_transaction_id: ID of the transaction to enshrine (required)
        :type check_account_transaction_id: int
        ...
        _param = self._check_account_transaction_enshrine_serialize(
    ...
    @validate_call
    def check_account_transaction_enshrine_with_http_info(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="ID of the transaction to enshrine")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def check_account_transaction_enshrine_without_preload_content(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="ID of the transaction to enshrine")],
        _request_timeout: Union[
            None,
    ...
    def _check_account_transaction_enshrine_serialize(
        self,
        check_account_transaction_id,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if check_account_transaction_id is not None:
            _path_params['checkAccountTransactionId'] = check_account_transaction_id
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/CheckAccountTransaction/{checkAccountTransactionId}/enshrine',
    ...
    def create_transaction(
        self,
        model_check_account_transaction: Annotated[Optional[ModelCheckAccountTransaction], Field(description="Creation data. Please be aware, that you need to provide at least all required parameter      of the CheckAccountTransaction model!")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param model_check_account_transaction: Creation data. Please be aware, that you need to provide at least all required parameter      of the CheckAccountTransaction model!
        :type model_check_account_transaction: ModelCheckAccountTransaction
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def create_transaction_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ModelCheckAccountTransactionResponse]:
        """Create a new transaction
    ...
    def _create_transaction_serialize(
        self,
        model_check_account_transaction,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if model_check_account_transaction is not None:
            _body_params = model_check_account_transaction
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/CheckAccountTransaction',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_check_account_transaction(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="Id of check account transaction to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param check_account_transaction_id: Id of check account transaction to delete (required)
        :type check_account_transaction_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_check_account_transaction_serialize(
            check_account_transaction_id=check_account_transaction_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_check_account_transaction_with_http_info(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="Id of check account transaction to delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_check_account_transaction_without_preload_content(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="Id of check account transaction to delete")],
        _request_timeout: Union[
            None,
    ...
    def _delete_check_account_transaction_serialize(
        self,
        check_account_transaction_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/CheckAccountTransaction/{checkAccountTransactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_check_account_transaction_by_id(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="ID of check account transaction")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param check_account_transaction_id: ID of check account transaction (required)
        :type check_account_transaction_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_check_account_transaction_by_id_serialize(
            check_account_transaction_id=check_account_transaction_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_check_account_transaction_by_id_with_http_info(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="ID of check account transaction")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_check_account_transaction_by_id_without_preload_content(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="ID of check account transaction")],
        _request_timeout: Union[
            None,
    ...
    def _get_check_account_transaction_by_id_serialize(
        self,
        check_account_transaction_id,
        _request_auth,
        _content_type,
    ...
    def get_transactions(
        self,
        check_account_id: Annotated[Optional[StrictInt], Field(description="Retrieve all transactions on this check account. Must be provided with checkAccount[objectName]")] = None,
        check_account_object_name: Annotated[Optional[StrictStr], Field(description="Only required if checkAccount[id] was provided. 'CheckAccount' should be used as value.")] = None,
        is_booked: Annotated[Optional[StrictBool], Field(description="Only retrieve booked transactions")] = None,
        paymt_purpose: Annotated[Optional[StrictStr], Field(description="Only retrieve transactions with this payment purpose")] = None,
        start_date: Annotated[Optional[datetime], Field(description="Only retrieve transactions from this date on")] = None,
        end_date: Annotated[Optional[datetime], Field(description="Only retrieve transactions up to this date")] = None,
        payee_payer_name: Annotated[Optional[StrictStr], Field(description="Only retrieve transactions with this payee / payer")] = None,
        only_credit: Annotated[Optional[StrictBool], Field(description="Only retrieve credit transactions")] = None,
        only_debit: Annotated[Optional[StrictBool], Field(description="Only retrieve debit transactions")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param check_account_id: Retrieve all transactions on this check account. Must be provided with checkAccount[objectName]
        :type check_account_id: int
        :param check_account_object_name: Only required if checkAccount[id] was provided. 'CheckAccount' should be used as value.
        :type check_account_object_name: str
        :param is_booked: Only retrieve booked transactions
        :type is_booked: bool
        :param paymt_purpose: Only retrieve transactions with this payment purpose
        :type paymt_purpose: str
        :param start_date: Only retrieve transactions from this date on
        :type start_date: datetime
        :param end_date: Only retrieve transactions up to this date
        :type end_date: datetime
        :param payee_payer_name: Only retrieve transactions with this payee / payer
        :type payee_payer_name: str
        :param only_credit: Only retrieve credit transactions
        :type only_credit: bool
        :param only_debit: Only retrieve debit transactions
        :type only_debit: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_transactions_serialize(
            ...
            check_account_object_name=check_account_object_name,
            is_booked=is_booked,
    ...
    def _get_transactions_serialize(
        ...
        if check_account_id is not None:
            ...
            _query_params.append(('checkAccount[id]', check_account_id))
            
        if check_account_object_name is not None:
            
            _query_params.append(('checkAccount[objectName]', check_account_object_name))
            
        if is_booked is not None:
            
            _query_params.append(('isBooked', is_booked))
            
        if paymt_purpose is not None:
            
            _query_params.append(('paymtPurpose', paymt_purpose))
        ...
        if payee_payer_name is not None:
            ...
            _query_params.append(('payeePayerName', payee_payer_name))
            
        if only_credit is not None:
            
            _query_params.append(('onlyCredit', only_credit))
            
        if only_debit is not None:
            
            _query_params.append(('onlyDebit', only_debit))
    ...
    def update_check_account_transaction(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="ID of check account to update transaction")],
        model_check_account_transaction_update: Annotated[Optional[ModelCheckAccountTransactionUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param check_account_transaction_id: ID of check account to update transaction (required)
        :type check_account_transaction_id: int
        :param model_check_account_transaction_update: Update data
        :type model_check_account_transaction_update: ModelCheckAccountTransactionUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_check_account_transaction_serialize(
            check_account_transaction_id=check_account_transaction_id,
            model_check_account_transaction_update=model_check_account_transaction_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_check_account_transaction_with_http_info(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="ID of check account to update transaction")],
        model_check_account_transaction_update: Annotated[Optional[ModelCheckAccountTransactionUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_check_account_transaction_without_preload_content(
        self,
        check_account_transaction_id: Annotated[StrictInt, Field(description="ID of check account to update transaction")],
        model_check_account_transaction_update: Annotated[Optional[ModelCheckAccountTransactionUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
    ...
    def _update_check_account_transaction_serialize(
        self,
        check_account_transaction_id,
        model_check_account_transaction_update,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if model_check_account_transaction_update is not None:
            _body_params = model_check_account_transaction_update
