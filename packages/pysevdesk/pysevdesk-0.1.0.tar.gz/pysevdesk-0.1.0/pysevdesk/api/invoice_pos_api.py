...
class InvoicePosApi:
    ...
    def get_invoice_pos(
        self,
        id: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Retrieve all InvoicePos with this InvoicePos id")] = None,
        invoice_id: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Retrieve all invoices positions with this invoice. Must be provided with invoice[objectName]")] = None,
        invoice_object_name: Annotated[Optional[StrictStr], Field(description="Only required if invoice[id] was provided. 'Invoice' should be used as value.")] = None,
        part_id: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Retrieve all invoices positions with this part. Must be provided with part[objectName]")] = None,
        part_object_name: Annotated[Optional[StrictStr], Field(description="Only required if part[id] was provided. 'Part' should be used as value.")] = None,
        ...
        :type id: float
        :param invoice_id: Retrieve all invoices positions with this invoice. Must be provided with invoice[objectName]
        :type invoice_id: float
        :param invoice_object_name: Only required if invoice[id] was provided. 'Invoice' should be used as value.
        :type invoice_object_name: str
        :param part_id: Retrieve all invoices positions with this part. Must be provided with part[objectName]
        :type part_id: float
        :param part_object_name: Only required if part[id] was provided. 'Part' should be used as value.
        :type part_object_name: str
        ...
        _param = self._get_invoice_pos_serialize(
            id=id,
    ...
    @validate_call
    def get_invoice_pos_with_http_info(
        self,
        id: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Retrieve all InvoicePos with this InvoicePos id")] = None,
        invoice_id: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Retrieve all invoices positions with this invoice. Must be provided with invoice[objectName]")] = None,
        invoice_object_name: Annotated[Optional[StrictStr], Field(description="Only required if invoice[id] was provided. 'Invoice' should be used as value.")] = None,
    ...
    @validate_call
    def get_invoice_pos_without_preload_content(
        self,
        id: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Retrieve all InvoicePos with this InvoicePos id")] = None,
        invoice_id: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Retrieve all invoices positions with this invoice. Must be provided with invoice[objectName]")] = None,
        invoice_object_name: Annotated[Optional[StrictStr], Field(description="Only required if invoice[id] was provided. 'Invoice' should be used as value.")] = None,
    ...
    def _get_invoice_pos_serialize(
        self,
        id,
        invoice_id,
        invoice_object_name,
        ...
        if part_id is not None:
            ...
            _query_params.append(('part[id]', part_id))
            
        if part_object_name is not None:
            
            _query_params.append(('part[objectName]', part_object_name))
