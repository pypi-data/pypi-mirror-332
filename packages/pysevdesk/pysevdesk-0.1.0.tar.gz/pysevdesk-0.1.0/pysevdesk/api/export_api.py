...
class ExportApi:
    ...
    def export_contact(
        ...
        :param sev_query: (required)
        :type sev_query: ExportContactSevQueryParameter
        :param download:
        :type download: bool
        ...
        _param = self._export_contact_serialize(
            sev_query=sev_query,
            download=download,
    ...
    @validate_call
    def export_contact_with_http_info(
        self,
        sev_query: ExportContactSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExportContact200Response]:
        """Export contact
    ...
    @validate_call
    def export_contact_without_preload_content(
        self,
        sev_query: ExportContactSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _export_contact_serialize(
        ...
        if sev_query is not None:
            
            _query_params.append(('sevQuery', sev_query))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Export/contactListCsv',
    ...
    def export_credit_note(
        ...
        :param sev_query: (required)
        :type sev_query: ExportCreditNoteSevQueryParameter
        :param download:
        :type download: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._export_credit_note_serialize(
            sev_query=sev_query,
            download=download,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExportCreditNote200Response",
            '400': None,
            '401': None,
            '409': None,
            '500': None,
    ...
    @validate_call
    def export_credit_note_with_http_info(
        self,
        sev_query: ExportCreditNoteSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExportCreditNote200Response]:
        """Export creditNote
    ...
    @validate_call
    def export_credit_note_without_preload_content(
        self,
        sev_query: ExportCreditNoteSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _export_credit_note_serialize(
        self,
        sev_query,
        download,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Export/creditNoteCsv',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def export_datev(
        self,
        start_date: Annotated[StrictInt, Field(description="the start date of the export as timestamp")],
        end_date: Annotated[StrictInt, Field(description="the end date of the export as timestamp")],
        scope: Annotated[StrictStr, Field(description="Define what you want to include in the datev export. This parameter takes a string of 5 letters. Each stands for a model that should be included. Possible letters are: ‘E’ (Earnings), ‘X’ (Expenditure), ‘T’ (Transactions), ‘C’ (Cashregister), ‘D’ (Assets). By providing one of those letter you specify that it should be included in the datev export. Some combinations are: ‘EXTCD’, ‘EXTD’ …")],
        download: Annotated[Optional[StrictBool], Field(description="Specifies if the document is downloaded")] = None,
        with_unpaid_documents: Annotated[Optional[StrictBool], Field(description="include unpaid documents")] = None,
        with_enshrined_documents: Annotated[Optional[StrictBool], Field(description="include enshrined documents")] = None,
        enshrine: Annotated[Optional[StrictBool], Field(description="Specify if you want to enshrine all models which were included in the export")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param start_date: the start date of the export as timestamp (required)
        :type start_date: int
        :param end_date: the end date of the export as timestamp (required)
        :type end_date: int
        ...
        :type download: bool
        :param with_unpaid_documents: include unpaid documents
        :type with_unpaid_documents: bool
        :param with_enshrined_documents: include enshrined documents
        :type with_enshrined_documents: bool
        ...
        _param = self._export_datev_serialize(
            start_date=start_date,
            end_date=end_date,
            scope=scope,
            download=download,
            with_unpaid_documents=with_unpaid_documents,
            with_enshrined_documents=with_enshrined_documents,
            enshrine=enshrine,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def export_datev_with_http_info(
        self,
        start_date: Annotated[StrictInt, Field(description="the start date of the export as timestamp")],
        end_date: Annotated[StrictInt, Field(description="the end date of the export as timestamp")],
        scope: Annotated[StrictStr, Field(description="Define what you want to include in the datev export. This parameter takes a string of 5 letters. Each stands for a model that should be included. Possible letters are: ‘E’ (Earnings), ‘X’ (Expenditure), ‘T’ (Transactions), ‘C’ (Cashregister), ‘D’ (Assets). By providing one of those letter you specify that it should be included in the datev export. Some combinations are: ‘EXTCD’, ‘EXTD’ …")],
    ...
    @validate_call
    def export_datev_without_preload_content(
        self,
        start_date: Annotated[StrictInt, Field(description="the start date of the export as timestamp")],
        end_date: Annotated[StrictInt, Field(description="the end date of the export as timestamp")],
        scope: Annotated[StrictStr, Field(description="Define what you want to include in the datev export. This parameter takes a string of 5 letters. Each stands for a model that should be included. Possible letters are: ‘E’ (Earnings), ‘X’ (Expenditure), ‘T’ (Transactions), ‘C’ (Cashregister), ‘D’ (Assets). By providing one of those letter you specify that it should be included in the datev export. Some combinations are: ‘EXTCD’, ‘EXTD’ …")],
    ...
    def _export_datev_serialize(
        ...
        if with_unpaid_documents is not None:
            
            _query_params.append(('withUnpaidDocuments', with_unpaid_documents))
            
        if with_enshrined_documents is not None:
            
            _query_params.append(('withEnshrinedDocuments', with_enshrined_documents))
            
        if enshrine is not None:
            
            _query_params.append(('enshrine', enshrine))
    ...
    def export_invoice(
        ...
        :param sev_query: (required)
        :type sev_query: ExportInvoiceSevQueryParameter
        :param download:
        :type download: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    def export_invoice_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExportInvoice200Response]:
        """Export invoice
    ...
    def _export_invoice_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Export/invoiceCsv',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def export_invoice_zip(
        self,
        sev_query: ExportInvoiceZipSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param sev_query: (required)
        :type sev_query: ExportInvoiceZipSevQueryParameter
        :param download:
        :type download: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._export_invoice_zip_serialize(
            sev_query=sev_query,
            download=download,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExportInvoiceZip200Response",
            '400': None,
            '401': None,
            '409': None,
            '500': None,
    ...
    @validate_call
    def export_invoice_zip_with_http_info(
        self,
        sev_query: ExportInvoiceZipSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExportInvoiceZip200Response]:
        """Export Invoice as zip
    ...
    @validate_call
    def export_invoice_zip_without_preload_content(
        self,
        sev_query: ExportInvoiceZipSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _export_invoice_zip_serialize(
        self,
        sev_query,
        download,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Export/invoiceZip',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def export_transactions(
        ...
        :param sev_query: (required)
        :type sev_query: ExportTransactionsSevQueryParameter
        :param download:
        :type download: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExportTransactions200Response",
            '400': None,
            '401': None,
            '409': None,
            '500': None,
    ...
    def export_transactions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExportTransactions200Response]:
        """Export transaction
    ...
    def _export_transactions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Export/transactionsCsv',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def export_voucher(
        ...
        :param sev_query: (required)
        :type sev_query: ExportVoucherSevQueryParameter
        :param download:
        :type download: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._export_voucher_serialize(
            sev_query=sev_query,
            download=download,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def export_voucher_with_http_info(
        self,
        sev_query: ExportVoucherSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExportVoucher200Response]:
        """Export voucher as zip
    ...
    @validate_call
    def export_voucher_without_preload_content(
        self,
        sev_query: ExportVoucherSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _export_voucher_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Export/voucherListCsv',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def export_voucher_zip(
        ...
        :param sev_query: (required)
        :type sev_query: ExportVoucherZipSevQueryParameter
        :param download:
        :type download: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._export_voucher_zip_serialize(
            sev_query=sev_query,
            download=download,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExportVoucherZip200Response",
            '400': None,
            '401': None,
            '409': None,
            '500': None,
    ...
    @validate_call
    def export_voucher_zip_with_http_info(
        self,
        sev_query: ExportVoucherZipSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExportVoucherZip200Response]:
        """Export voucher zip
    ...
    @validate_call
    def export_voucher_zip_without_preload_content(
        self,
        sev_query: ExportVoucherZipSevQueryParameter,
        download: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _export_voucher_zip_serialize(
        self,
        sev_query,
        download,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Export/voucherZip',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_export_config(
        self,
        sev_client_id: Annotated[Union[StrictFloat, StrictInt], Field(description="id of sevClient")],
        update_export_config_request: Annotated[Optional[UpdateExportConfigRequest], Field(description="Specify the update")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param sev_client_id: id of sevClient (required)
        :type sev_client_id: float
        :param update_export_config_request: Specify the update
        :type update_export_config_request: UpdateExportConfigRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_export_config_serialize(
            sev_client_id=sev_client_id,
            update_export_config_request=update_export_config_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_export_config_with_http_info(
        self,
        sev_client_id: Annotated[Union[StrictFloat, StrictInt], Field(description="id of sevClient")],
        update_export_config_request: Annotated[Optional[UpdateExportConfigRequest], Field(description="Specify the update")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_export_config_without_preload_content(
        self,
        sev_client_id: Annotated[Union[StrictFloat, StrictInt], Field(description="id of sevClient")],
        update_export_config_request: Annotated[Optional[UpdateExportConfigRequest], Field(description="Specify the update")] = None,
        _request_timeout: Union[
    ...
    def _update_export_config_serialize(
        self,
        sev_client_id,
        update_export_config_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the path parameters
        if sev_client_id is not None:
            _path_params['SevClientId'] = sev_client_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        if update_export_config_request is not None:
            _body_params = update_export_config_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/SevClient/{SevClientId}/updateExportConfig',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
