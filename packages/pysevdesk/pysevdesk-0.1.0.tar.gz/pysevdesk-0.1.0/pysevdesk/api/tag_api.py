...
class TagApi:
    ...
    def create_tag_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ModelTagCreateResponse]:
        """Create a new tag
    ...
    def _create_tag_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Tag/Factory/create',
    ...
    def delete_tag(
        self,
        tag_id: Annotated[StrictInt, Field(description="Id of tag to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tag_id: Id of tag to delete (required)
        :type tag_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_tag_by_id(
        self,
        tag_id: Annotated[StrictInt, Field(description="ID of tag to return")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tag_id: ID of tag to return (required)
        :type tag_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_tag_relations(
        ...
        _param = self._get_tag_relations_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetTagRelations200Response",
            '401': None,
            '500': None,
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_tag_relations_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTagRelations200Response]:
        """Retrieve tag relations
    ...
    @validate_call
    def get_tag_relations_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_tag_relations_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_tags(
        self,
        id: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="ID of the Tag")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Name of the Tag")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def update_tag(
        self,
        tag_id: Annotated[StrictInt, Field(description="ID of tag you want to update")],
        ...
        :param tag_id: ID of tag you want to update (required)
        :type tag_id: int
