...
class AccountingContactApi:
    ...
    def create_accounting_contact(
        self,
        model_accounting_contact: Annotated[Optional[ModelAccountingContact], Field(description="Creation data")] = None,
        ...
        :param model_accounting_contact: Creation data
        :type model_accounting_contact: ModelAccountingContact
        ...
        _param = self._create_accounting_contact_serialize(
            model_accounting_contact=model_accounting_contact,
    ...
    @validate_call
    def create_accounting_contact_with_http_info(
        self,
        model_accounting_contact: Annotated[Optional[ModelAccountingContact], Field(description="Creation data")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ModelAccountingContactResponse]:
        """Create a new accounting contact
    ...
    @validate_call
    def create_accounting_contact_without_preload_content(
        self,
        model_accounting_contact: Annotated[Optional[ModelAccountingContact], Field(description="Creation data")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_accounting_contact_serialize(
        self,
        model_accounting_contact,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if model_accounting_contact is not None:
            _body_params = model_accounting_contact
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/AccountingContact',
    ...
    @validate_call
    def delete_accounting_contact(
        self,
        accounting_contact_id: Annotated[StrictInt, Field(description="Id of accounting contact resource to delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param accounting_contact_id: Id of accounting contact resource to delete (required)
        :type accounting_contact_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_accounting_contact_serialize(
    ...
    @validate_call
    def delete_accounting_contact_with_http_info(
        self,
        accounting_contact_id: Annotated[StrictInt, Field(description="Id of accounting contact resource to delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_accounting_contact_without_preload_content(
        self,
        accounting_contact_id: Annotated[StrictInt, Field(description="Id of accounting contact resource to delete")],
        _request_timeout: Union[
            None,
    ...
    def _delete_accounting_contact_serialize(
        self,
        ...
        # process the path parameters
        if accounting_contact_id is not None:
            _path_params['accountingContactId'] = accounting_contact_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/AccountingContact/{accountingContactId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_accounting_contact(
        self,
        contact_id: Annotated[Optional[StrictStr], Field(description="ID of contact for which you want the accounting contact.")] = None,
        ...
        :param contact_id: ID of contact for which you want the accounting contact.
        :type contact_id: str
        ...
        _param = self._get_accounting_contact_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAccountingContact200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def get_accounting_contact_with_http_info(
        self,
        contact_id: Annotated[Optional[StrictStr], Field(description="ID of contact for which you want the accounting contact.")] = None,
        contact_object_name: Annotated[Optional[StrictStr], Field(description="Object name. Only needed if you also defined the ID of a contact.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAccountingContact200Response]:
        """Retrieve accounting contact
    ...
    @validate_call
    def get_accounting_contact_without_preload_content(
        self,
        contact_id: Annotated[Optional[StrictStr], Field(description="ID of contact for which you want the accounting contact.")] = None,
        contact_object_name: Annotated[Optional[StrictStr], Field(description="Object name. Only needed if you also defined the ID of a contact.")] = None,
        _request_timeout: Union[
    ...
    def _get_accounting_contact_serialize(
        self,
        contact_id,
        contact_object_name,
        _request_auth,
    ...
    @validate_call
    def get_accounting_contact_by_id(
        self,
        accounting_contact_id: Annotated[StrictInt, Field(description="ID of accounting contact to return")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param accounting_contact_id: ID of accounting contact to return (required)
        :type accounting_contact_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_accounting_contact_by_id_serialize(
            accounting_contact_id=accounting_contact_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_accounting_contact_by_id_with_http_info(
        self,
        accounting_contact_id: Annotated[StrictInt, Field(description="ID of accounting contact to return")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_accounting_contact_by_id_without_preload_content(
        self,
        accounting_contact_id: Annotated[StrictInt, Field(description="ID of accounting contact to return")],
        _request_timeout: Union[
            None,
    ...
    def _get_accounting_contact_by_id_serialize(
        self,
        accounting_contact_id,
        _request_auth,
        _content_type,
    ...
    def update_accounting_contact(
        self,
        accounting_contact_id: Annotated[StrictInt, Field(description="ID of accounting contact to update")],
        model_accounting_contact_update: Annotated[Optional[ModelAccountingContactUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param accounting_contact_id: ID of accounting contact to update (required)
        :type accounting_contact_id: int
        :param model_accounting_contact_update: Update data
        :type model_accounting_contact_update: ModelAccountingContactUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_accounting_contact_serialize(
            accounting_contact_id=accounting_contact_id,
            model_accounting_contact_update=model_accounting_contact_update,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_accounting_contact_with_http_info(
        self,
        accounting_contact_id: Annotated[StrictInt, Field(description="ID of accounting contact to update")],
        model_accounting_contact_update: Annotated[Optional[ModelAccountingContactUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_accounting_contact_without_preload_content(
        self,
        accounting_contact_id: Annotated[StrictInt, Field(description="ID of accounting contact to update")],
        model_accounting_contact_update: Annotated[Optional[ModelAccountingContactUpdate], Field(description="Update data")] = None,
        _request_timeout: Union[
    ...
    def _update_accounting_contact_serialize(
        self,
        accounting_contact_id,
        model_accounting_contact_update,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if model_accounting_contact_update is not None:
            _body_params = model_accounting_contact_update
