...
from pysevdesk.api_response import ApiResponse, T as ApiResponseT
import pysevdesk.models
from pysevdesk import rest
from pysevdesk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pysevdesk.models, klass)
