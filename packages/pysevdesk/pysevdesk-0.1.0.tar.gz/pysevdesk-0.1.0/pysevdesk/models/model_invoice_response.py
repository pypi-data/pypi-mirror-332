...
class ModelInvoiceResponse(BaseModel):
    """
    Invoice model
    """ # noqa: E501
    ...
    pay_date: Optional[datetime] = Field(default=None, description="Needs to be timestamp or dd.mm.yyyy", alias="payDate")
    ...
    account_intervall: Optional[StrictStr] = Field(default=None, description="The interval in which recurring invoices are due as ISO-8601 duration.<br>       Necessary attribute for all recurring invoices.", alias="accountIntervall")
    account_next_invoice: Optional[StrictStr] = Field(default=None, description="Timestamp when the next invoice will be generated by this recurring invoice.", alias="accountNextInvoice")
    ...
    enshrined: Optional[datetime] = Field(default=None, description="Enshrined invoices cannot be changed. Can only be set via [Invoice/{invoiceId}/enshrine](#tag/Invoice/operation/invoiceEnshrine). This operation cannot be undone.")
