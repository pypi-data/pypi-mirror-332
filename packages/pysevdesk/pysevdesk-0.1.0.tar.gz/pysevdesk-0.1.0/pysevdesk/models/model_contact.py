...
class ModelContact(BaseModel):
    ...
    parent: Optional[ModelContactParent] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelContact from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelContact from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "parent": ModelContactParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "surename": obj.get("surename"),
            "familyname": obj.get("familyname"),
            "titel": obj.get("titel"),
            "category": ModelContactCategory.from_dict(obj["category"]) if obj.get("category") is not None else None,
