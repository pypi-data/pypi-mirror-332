...
class ModelInvoice(BaseModel):
    ...
    Invoice model
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The invoice id. <span style='color:red'>Required</span> if you want to create or update an invoice position for an existing invoice")
    ...
    contact_person: ModelInvoiceContactPerson = Field(alias="contactPerson")
    ...
    sev_client: Optional[ModelInvoiceSevClient] = Field(default=None, alias="sevClient")
    invoice_date: StrictStr = Field(description="Needs to be provided as timestamp or dd.mm.yyyy  **Requirements:** * For final invoices (invoiceType = 'ER'), the invoiceDate must be later than or equal to the invoiceDate of related advance (invoiceType = 'AR') / partial (invoiceType = 'TR') invoices.</li>", alias="invoiceDate")
    ...
    time_to_pay: Optional[StrictInt] = Field(default=None, description="The time the customer has to pay the invoice in days", alias="timeToPay")
    discount: StrictInt = Field(description="If you want to give a discount, define the percentage here. Otherwise provide zero as value")
    ...
    address_country: ModelInvoiceAddressCountry = Field(alias="addressCountry")
    ...
    delivery_date_until: Optional[StrictInt] = Field(default=None, description="If the delivery date should be a time range, another timestamp can be provided in this attribute       * to define a range from timestamp used in deliveryDate attribute to the timestamp used here.", alias="deliveryDateUntil")
    status: StrictStr = Field(description="Please have a look in our       <a href='#tag/Invoice/Types-and-status-of-invoices'>Types and status of invoices</a>       to see what the different status codes mean")
    ...
    tax_rate: Union[StrictFloat, StrictInt] = Field(description="This is not used anymore. Use the taxRate of the individual positions instead.", alias="taxRate")
    tax_rule: ModelCreditNoteResponseTaxRule = Field(alias="taxRule")
    tax_text: StrictStr = Field(description="A common tax text would be 'Umsatzsteuer 19%'", alias="taxText")
    tax_type: StrictStr = Field(description="**Use this in sevdesk-Update 1.0 (instead of taxRule).**  Tax type of the invoice. There are four tax types: 1. default - Umsatzsteuer ausweisen 2. eu - Steuerfreie innergemeinschaftliche Lieferung (Europäische Union) 3. noteu - Steuerschuldnerschaft des Leistungsempfängers (außerhalb EU, z. B. Schweiz) 4. custom - Using custom tax set 5. ss - Not subject to VAT according to §19 1 UStG Tax rates are heavily connected to the tax type used.", alias="taxType")
    tax_set: Optional[ModelInvoiceTaxSet] = Field(default=None, alias="taxSet")
    dunning_level: Optional[StrictInt] = Field(default=None, description="Defines how many reminders have already been sent for the invoice.      Starts with 1 (Payment reminder) and should be incremented by one every time another reminder is sent.", alias="dunningLevel")
    payment_method: Optional[ModelInvoicePaymentMethod] = Field(default=None, alias="paymentMethod")
    send_date: Optional[datetime] = Field(default=None, description="The date the invoice was sent to the customer", alias="sendDate")
    invoice_type: StrictStr = Field(description="Type of the invoice. For more information on the different types, check       <a href='#tag/Invoice/Types-and-status-of-invoices'>this</a> section  ", alias="invoiceType")
    ...
    account_next_invoice: Optional[StrictInt] = Field(default=None, description="Timestamp when the next invoice will be generated by this recurring invoice.", alias="accountNextInvoice")
    currency: StrictStr = Field(description="Currency used in the invoice. Needs to be currency code according to ISO-4217")
    sum_net: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Net sum of the invoice", alias="sumNet")
    sum_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax sum of the invoice", alias="sumTax")
    sum_gross: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gross sum of the invoice", alias="sumGross")
    sum_discounts: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Sum of all discounts in the invoice", alias="sumDiscounts")
    sum_net_foreign_currency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Net sum of the invoice in the foreign currency", alias="sumNetForeignCurrency")
    sum_tax_foreign_currency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax sum of the invoice in the foreign currency", alias="sumTaxForeignCurrency")
    sum_gross_foreign_currency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gross sum of the invoice in the foreign currency", alias="sumGrossForeignCurrency")
    sum_discounts_foreign_currency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Discounts sum of the invoice in the foreign currency", alias="sumDiscountsForeignCurrency")
    sum_net_accounting: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Net accounting sum of the invoice. Is usually the same as sumNet", alias="sumNetAccounting")
    sum_tax_accounting: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax accounting sum of the invoice. Is usually the same as sumTax", alias="sumTaxAccounting")
    sum_gross_accounting: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gross accounting sum of the invoice. Is usually the same as sumGross", alias="sumGrossAccounting")
    ...
    send_type: Optional[StrictStr] = Field(default=None, description="Type which was used to send the invoice.", alias="sendType")
    origin: Optional[ModelInvoiceOrigin] = None
    ...
    property_is_e_invoice: Optional[StrictBool] = Field(default=None, description="If true, the invoice will be created as e-invoice.  To create a valid e-invoice some extra data are required - sevClient     - addressStreet     - addressZip     - addressCity     - bankIban     - bankBic     - contactEmail     - contactPhone     - taxNumber     - vatNumber - contact     - buyerReference     - email - invoice     - paymentMethod     - addressStreet     - addressZip     - addressCity     - addressCountry     - contact", alias="propertyIsEInvoice")
    map_all: StrictBool = Field(alias="mapAll")
    __properties: ClassVar[List[str]] = ["id", "objectName", "invoiceNumber", "contact", "contactPerson", "create", "update", "sevClient", "invoiceDate", "header", "headText", "footText", "timeToPay", "discount", "address", "addressCountry", "payDate", "createUser", "deliveryDate", "deliveryDateUntil", "status", "smallSettlement", "taxRate", "taxRule", "taxText", "taxType", "taxSet", "dunningLevel", "paymentMethod", "sendDate", "invoiceType", "accountIntervall", "accountNextInvoice", "currency", "sumNet", "sumTax", "sumGross", "sumDiscounts", "sumNetForeignCurrency", "sumTaxForeignCurrency", "sumGrossForeignCurrency", "sumDiscountsForeignCurrency", "sumNetAccounting", "sumTaxAccounting", "sumGrossAccounting", "paidAmount", "showNet", "enshrined", "sendType", "origin", "customerInternalNote", "propertyIsEInvoice", "mapAll"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if time_to_pay (nullable) is None
        # and model_fields_set contains the field
        if self.time_to_pay is None and "time_to_pay" in self.model_fields_set:
            _dict['timeToPay'] = None
        ...
        # set to None if delivery_date_until (nullable) is None
        # and model_fields_set contains the field
        if self.delivery_date_until is None and "delivery_date_until" in self.model_fields_set:
            _dict['deliveryDateUntil'] = None
        ...
        # set to None if dunning_level (nullable) is None
        # and model_fields_set contains the field
        if self.dunning_level is None and "dunning_level" in self.model_fields_set:
            _dict['dunningLevel'] = None
        ...
        # set to None if paid_amount (nullable) is None
        # and model_fields_set contains the field
        if self.paid_amount is None and "paid_amount" in self.model_fields_set:
            _dict['paidAmount'] = None
        ...
        # set to None if property_is_e_invoice (nullable) is None
        # and model_fields_set contains the field
        if self.property_is_e_invoice is None and "property_is_e_invoice" in self.model_fields_set:
            _dict['propertyIsEInvoice'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact": ModelInvoiceContact.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
            "contactPerson": ModelInvoiceContactPerson.from_dict(obj["contactPerson"]) if obj.get("contactPerson") is not None else None,
            "create": obj.get("create"),
            "update": obj.get("update"),
            "sevClient": ModelInvoiceSevClient.from_dict(obj["sevClient"]) if obj.get("sevClient") is not None else None,
            ...
            "addressCountry": ModelInvoiceAddressCountry.from_dict(obj["addressCountry"]) if obj.get("addressCountry") is not None else None,
            ...
            "taxSet": ModelInvoiceTaxSet.from_dict(obj["taxSet"]) if obj.get("taxSet") is not None else None,
            "dunningLevel": obj.get("dunningLevel"),
            "paymentMethod": ModelInvoicePaymentMethod.from_dict(obj["paymentMethod"]) if obj.get("paymentMethod") is not None else None,
            ...
            "origin": ModelInvoiceOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
            "customerInternalNote": obj.get("customerInternalNote"),
            "propertyIsEInvoice": obj.get("propertyIsEInvoice"),
            "mapAll": obj.get("mapAll")
        })
        return _obj
