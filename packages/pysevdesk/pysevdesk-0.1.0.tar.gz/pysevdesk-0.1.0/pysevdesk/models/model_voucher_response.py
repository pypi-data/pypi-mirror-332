...
class ModelVoucherResponse(BaseModel):
    """
    Voucher model
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The voucher id")
    object_name: Optional[StrictStr] = Field(default=None, description="The voucher object name", alias="objectName")
    map_all: Optional[StrictBool] = Field(default=None, alias="mapAll")
    create: Optional[datetime] = Field(default=None, description="Date of voucher creation")
    update: Optional[datetime] = Field(default=None, description="Date of last voucher update")
    sev_client: Optional[ModelVoucherResponseSevClient] = Field(default=None, alias="sevClient")
    create_user: Optional[ModelVoucherResponseCreateUser] = Field(default=None, alias="createUser")
    voucher_date: Optional[datetime] = Field(default=None, description="Needs to be provided as timestamp or dd.mm.yyyy", alias="voucherDate")
    supplier: Optional[ModelVoucherResponseSupplier] = None
    supplier_name: Optional[StrictStr] = Field(default=None, description="The supplier name.<br>       The value you provide here will determine what supplier name is shown for the voucher in case you did not provide a supplier.", alias="supplierName")
    description: Optional[StrictStr] = Field(default=None, description="The description of the voucher. Essentially the voucher number.")
    document: Optional[ModelVoucherResponseDocument] = None
    pay_date: Optional[datetime] = Field(default=None, description="Needs to be timestamp or dd.mm.yyyy", alias="payDate")
    status: Optional[StrictStr] = Field(default=None, description="Please have a look in       <a href='#tag/Voucher/Types-and-status-of-vouchers'>status of vouchers</a>      to see what the different status codes mean")
    sum_net: Optional[StrictStr] = Field(default=None, description="Net sum of the voucher", alias="sumNet")
    sum_tax: Optional[StrictStr] = Field(default=None, description="Tax sum of the voucher", alias="sumTax")
    sum_gross: Optional[StrictStr] = Field(default=None, description="Gross sum of the voucher", alias="sumGross")
    sum_net_accounting: Optional[StrictStr] = Field(default=None, description="Net accounting sum of the voucher. Is usually the same as sumNet", alias="sumNetAccounting")
    sum_tax_accounting: Optional[StrictStr] = Field(default=None, description="Tax accounting sum of the voucher. Is usually the same as sumTax", alias="sumTaxAccounting")
    sum_gross_accounting: Optional[StrictStr] = Field(default=None, description="Gross accounting sum of the voucher. Is usually the same as sumGross", alias="sumGrossAccounting")
    sum_discounts: Optional[StrictStr] = Field(default=None, description="Sum of all discounts in the voucher", alias="sumDiscounts")
    sum_discounts_foreign_currency: Optional[StrictStr] = Field(default=None, description="Discounts sum of the voucher in the foreign currency", alias="sumDiscountsForeignCurrency")
    paid_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount which has already been paid for this voucher by the customer", alias="paidAmount")
    tax_rule: Optional[ModelVoucherTaxRule] = Field(default=None, alias="taxRule")
    tax_type: Optional[StrictStr] = Field(default=None, description="**Use this in sevdesk-Update 1.0 (instead of taxRule).**  Tax type of the voucher. There are four tax types: 1. default - Umsatzsteuer ausweisen 2. eu - Steuerfreie innergemeinschaftliche Lieferung (Europäische Union) 3. noteu - Steuerschuldnerschaft des Leistungsempfängers (außerhalb EU, z. B. Schweiz) 4. custom - Using custom tax set 5. ss - Not subject to VAT according to §19 1 UStG Tax rates are heavily connected to the tax type used.", alias="taxType")
    credit_debit: Optional[StrictStr] = Field(default=None, description="Defines if your voucher is a credit (C) or debit (D)", alias="creditDebit")
    cost_centre: Optional[ModelVoucherResponseCostCentre] = Field(default=None, alias="costCentre")
    voucher_type: Optional[StrictStr] = Field(default=None, description="Type of the voucher. For more information on the different types, check       <a href='#tag/Voucher/Types-and-status-of-vouchers'>this</a>  ", alias="voucherType")
    currency: Optional[StrictStr] = Field(default=None, description="specifies which currency the voucher should have. Attention: If the currency differs from the default currency stored in the account, then either the \"propertyForeignCurrencyDeadline\" or \"propertyExchangeRate\" parameter must be specified. If both parameters are specified, then the \"propertyForeignCurrencyDeadline\" parameter is preferred")
    property_foreign_currency_deadline: Optional[datetime] = Field(default=None, description="Defines the exchange rate day and and then the exchange rate is set from sevdesk. Needs to be provided as timestamp or dd.mm.yyyy", alias="propertyForeignCurrencyDeadline")
    property_exchange_rate: Optional[StrictStr] = Field(default=None, description="Defines the exchange rate", alias="propertyExchangeRate")
    recurring_interval: Optional[StrictStr] = Field(default=None, description="The DateInterval in which recurring vouchers are generated.<br>       Necessary attribute for all recurring vouchers.", alias="recurringInterval")
    recurring_start_date: Optional[datetime] = Field(default=None, description="The date when the recurring vouchers start being generated.<br>       Necessary attribute for all recurring vouchers.", alias="recurringStartDate")
    recurring_next_voucher: Optional[datetime] = Field(default=None, description="The date when the next voucher should be generated.<br>       Necessary attribute for all recurring vouchers.", alias="recurringNextVoucher")
    recurring_last_voucher: Optional[datetime] = Field(default=None, description="The date when the last voucher was generated.", alias="recurringLastVoucher")
    recurring_end_date: Optional[datetime] = Field(default=None, description="The date when the recurring vouchers end being generated.<br>      Necessary attribute for all recurring vouchers.", alias="recurringEndDate")
    enshrined: Optional[datetime] = Field(default=None, description="Enshrined vouchers cannot be changed. Can only be set via [Voucher/{voucherId}/enshrine](#tag/Voucher/operation/voucherEnshrine). This operation cannot be undone.")
    tax_set: Optional[ModelVoucherResponseTaxSet] = Field(default=None, alias="taxSet")
    payment_deadline: Optional[datetime] = Field(default=None, description="Payment deadline of the voucher.", alias="paymentDeadline")
    delivery_date: Optional[datetime] = Field(default=None, description="Needs to be provided as timestamp or dd.mm.yyyy", alias="deliveryDate")
    delivery_date_until: Optional[datetime] = Field(default=None, description="Needs to be provided as timestamp or dd.mm.yyyy", alias="deliveryDateUntil")
    __properties: ClassVar[List[str]] = ["id", "objectName", "mapAll", "create", "update", "sevClient", "createUser", "voucherDate", "supplier", "supplierName", "description", "document", "payDate", "status", "sumNet", "sumTax", "sumGross", "sumNetAccounting", "sumTaxAccounting", "sumGrossAccounting", "sumDiscounts", "sumDiscountsForeignCurrency", "paidAmount", "taxRule", "taxType", "creditDebit", "costCentre", "voucherType", "currency", "propertyForeignCurrencyDeadline", "propertyExchangeRate", "recurringInterval", "recurringStartDate", "recurringNextVoucher", "recurringLastVoucher", "recurringEndDate", "enshrined", "taxSet", "paymentDeadline", "deliveryDate", "deliveryDateUntil"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['50', '100', '1000']):
            raise ValueError("must be one of enum values ('50', '100', '1000')")
        return value

    @field_validator('credit_debit')
    def credit_debit_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['C', 'D']):
    ...
    def voucher_type_validate_enum(cls, value):
        ...
        if value not in set(['VOU', 'RV']):
            raise ValueError("must be one of enum values ('VOU', 'RV')")
        return value

    @field_validator('recurring_interval')
    def recurring_interval_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['P0Y0M1W', 'P0Y0M2W', 'P0Y1M0W', 'P0Y3M0W', 'P0Y6M0W', 'P1Y0M0W', 'P2Y0M0W', 'P3Y0M0W', 'P4Y0M0W', 'P5Y0M0W']):
            raise ValueError("must be one of enum values ('P0Y0M1W', 'P0Y0M2W', 'P0Y1M0W', 'P0Y3M0W', 'P0Y6M0W', 'P1Y0M0W', 'P2Y0M0W', 'P3Y0M0W', 'P4Y0M0W', 'P5Y0M0W')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if voucher_date (nullable) is None
        # and model_fields_set contains the field
        if self.voucher_date is None and "voucher_date" in self.model_fields_set:
            _dict['voucherDate'] = None
        ...
        # set to None if credit_debit (nullable) is None
        # and model_fields_set contains the field
        if self.credit_debit is None and "credit_debit" in self.model_fields_set:
            _dict['creditDebit'] = None
        ...
        # set to None if property_foreign_currency_deadline (nullable) is None
        # and model_fields_set contains the field
        if self.property_foreign_currency_deadline is None and "property_foreign_currency_deadline" in self.model_fields_set:
            _dict['propertyForeignCurrencyDeadline'] = None

        # set to None if property_exchange_rate (nullable) is None
        # and model_fields_set contains the field
        if self.property_exchange_rate is None and "property_exchange_rate" in self.model_fields_set:
            _dict['propertyExchangeRate'] = None

        # set to None if recurring_interval (nullable) is None
        # and model_fields_set contains the field
        if self.recurring_interval is None and "recurring_interval" in self.model_fields_set:
            _dict['recurringInterval'] = None

        # set to None if recurring_start_date (nullable) is None
        # and model_fields_set contains the field
        if self.recurring_start_date is None and "recurring_start_date" in self.model_fields_set:
            _dict['recurringStartDate'] = None

        # set to None if recurring_next_voucher (nullable) is None
        # and model_fields_set contains the field
        if self.recurring_next_voucher is None and "recurring_next_voucher" in self.model_fields_set:
            _dict['recurringNextVoucher'] = None

        # set to None if recurring_last_voucher (nullable) is None
        # and model_fields_set contains the field
        if self.recurring_last_voucher is None and "recurring_last_voucher" in self.model_fields_set:
            _dict['recurringLastVoucher'] = None

        # set to None if recurring_end_date (nullable) is None
        # and model_fields_set contains the field
        if self.recurring_end_date is None and "recurring_end_date" in self.model_fields_set:
            _dict['recurringEndDate'] = None
        ...
        # set to None if payment_deadline (nullable) is None
        # and model_fields_set contains the field
        if self.payment_deadline is None and "payment_deadline" in self.model_fields_set:
            _dict['paymentDeadline'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sevClient": ModelVoucherResponseSevClient.from_dict(obj["sevClient"]) if obj.get("sevClient") is not None else None,
            "createUser": ModelVoucherResponseCreateUser.from_dict(obj["createUser"]) if obj.get("createUser") is not None else None,
            "voucherDate": obj.get("voucherDate"),
            "supplier": ModelVoucherResponseSupplier.from_dict(obj["supplier"]) if obj.get("supplier") is not None else None,
            "supplierName": obj.get("supplierName"),
            "description": obj.get("description"),
            "document": ModelVoucherResponseDocument.from_dict(obj["document"]) if obj.get("document") is not None else None,
            ...
            "taxRule": ModelVoucherTaxRule.from_dict(obj["taxRule"]) if obj.get("taxRule") is not None else None,
            "taxType": obj.get("taxType"),
            "creditDebit": obj.get("creditDebit"),
            "costCentre": ModelVoucherResponseCostCentre.from_dict(obj["costCentre"]) if obj.get("costCentre") is not None else None,
            "voucherType": obj.get("voucherType"),
            "currency": obj.get("currency"),
            "propertyForeignCurrencyDeadline": obj.get("propertyForeignCurrencyDeadline"),
            "propertyExchangeRate": obj.get("propertyExchangeRate"),
            "recurringInterval": obj.get("recurringInterval"),
            "recurringStartDate": obj.get("recurringStartDate"),
            "recurringNextVoucher": obj.get("recurringNextVoucher"),
            "recurringLastVoucher": obj.get("recurringLastVoucher"),
            "recurringEndDate": obj.get("recurringEndDate"),
            "enshrined": obj.get("enshrined"),
            "taxSet": ModelVoucherResponseTaxSet.from_dict(obj["taxSet"]) if obj.get("taxSet") is not None else None,
