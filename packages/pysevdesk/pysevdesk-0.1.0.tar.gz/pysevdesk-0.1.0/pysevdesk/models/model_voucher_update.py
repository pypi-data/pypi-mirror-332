...
class ModelVoucherUpdate(BaseModel):
    """
    Voucher model
    """ # noqa: E501
    ...
    supplier: Optional[ModelVoucherUpdateSupplier] = None
    ...
    status: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="<b>Not supported in sevdesk-Update 2.0.</b><br><br>    Please have a look in <a href='#tag/Voucher/Types-and-status-of-vouchers'>status of vouchers</a>    to see what the different status codes mean")
    ...
    tax_set: Optional[ModelVoucherUpdateTaxSet] = Field(default=None, alias="taxSet")
    ...
    __properties: ClassVar[List[str]] = ["voucherDate", "supplier", "supplierName", "description", "payDate", "status", "paidAmount", "taxRule", "taxType", "creditDebit", "voucherType", "currency", "propertyForeignCurrencyDeadline", "propertyExchangeRate", "taxSet", "paymentDeadline", "deliveryDate", "deliveryDateUntil", "document", "costCentre"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supplier": ModelVoucherUpdateSupplier.from_dict(obj["supplier"]) if obj.get("supplier") is not None else None,
            ...
            "taxSet": ModelVoucherUpdateTaxSet.from_dict(obj["taxSet"]) if obj.get("taxSet") is not None else None,
