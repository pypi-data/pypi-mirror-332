...
class ModelOrderUpdate(BaseModel):
    ...
    Order model
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The order id")
    object_name: Optional[StrictStr] = Field(default=None, description="The order object name", alias="objectName")
    create: Optional[datetime] = Field(default=None, description="Date of order creation")
    update: Optional[datetime] = Field(default=None, description="Date of last order update")
    order_number: Optional[StrictStr] = Field(default=None, description="The order number", alias="orderNumber")
    contact: Optional[ModelOrderUpdateContact] = None
    order_date: Optional[datetime] = Field(default=None, description="Needs to be provided as timestamp or dd.mm.yyyy", alias="orderDate")
    status: Optional[StrictInt] = Field(default=None, description="Please have a look in       <a href='#tag/Order/Types-and-status-of-orders'>status of orders</a>      to see what the different status codes mean")
    header: Optional[StrictStr] = Field(default=None, description="Normally consist of prefix plus the order number")
    ...
    address_country: Optional[ModelOrderUpdateAddressCountry] = Field(default=None, alias="addressCountry")
    create_user: Optional[ModelOrderUpdateCreateUser] = Field(default=None, alias="createUser")
    sev_client: Optional[ModelOrderUpdateSevClient] = Field(default=None, alias="sevClient")
    delivery_terms: Optional[StrictStr] = Field(default=None, description="Delivery terms of the order", alias="deliveryTerms")
    payment_terms: Optional[StrictStr] = Field(default=None, description="Payment terms of the order", alias="paymentTerms")
    origin: Optional[ModelOrderOrigin] = None
    version: Optional[StrictInt] = Field(default=None, description="Version of the order.<br>      Can be used if you have multiple drafts for the same order.<br>      Should start with 0")
    small_settlement: Optional[StrictBool] = Field(default=None, description="Defines if the client uses the small settlement scheme.      If yes, the order must not contain any vat", alias="smallSettlement")
    contact_person: Optional[ModelOrderUpdateContactPerson] = Field(default=None, alias="contactPerson")
    ...
    tax_set: Optional[ModelOrderUpdateTaxSet] = Field(default=None, alias="taxSet")
    tax_text: Optional[StrictStr] = Field(default=None, description="A common tax text would be 'Umsatzsteuer 19%'", alias="taxText")
    tax_type: Optional[StrictStr] = Field(default=None, description="**Use this in sevdesk-Update 1.0 (instead of taxRule).**  Tax type of the order. There are four tax types: 1. default - Umsatzsteuer ausweisen 2. eu - Steuerfreie innergemeinschaftliche Lieferung (Europäische Union) 3. noteu - Steuerschuldnerschaft des Leistungsempfängers (außerhalb EU, z. B. Schweiz) 4. custom - Using custom tax set 5. ss - Not subject to VAT according to §19 1 UStG Tax rates are heavily connected to the tax type used.", alias="taxType")
    order_type: Optional[StrictStr] = Field(default=None, description="Type of the order. For more information on the different types, check      <a href='#tag/Order/Types-and-status-of-orders'>this</a>  ", alias="orderType")
    send_date: Optional[datetime] = Field(default=None, description="The date the order was sent to the customer", alias="sendDate")
    ...
    currency: Optional[StrictStr] = Field(default=None, description="Currency used in the order. Needs to be currency code according to ISO-4217")
    sum_net: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Net sum of the order", alias="sumNet")
    sum_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax sum of the order", alias="sumTax")
    sum_gross: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gross sum of the order", alias="sumGross")
    sum_discounts: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Sum of all discounts in the order", alias="sumDiscounts")
    sum_net_foreign_currency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Net sum of the order in the foreign currency", alias="sumNetForeignCurrency")
    sum_tax_foreign_currency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax sum of the order in the foreign currency", alias="sumTaxForeignCurrency")
    sum_gross_foreign_currency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gross sum of the order in the foreign currency", alias="sumGrossForeignCurrency")
    sum_discounts_foreign_currency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Discounts sum of the order in the foreign currency", alias="sumDiscountsForeignCurrency")
    ...
    show_net: Optional[StrictBool] = Field(default=None, description="If true, the net amount of each position will be shown on the order. Otherwise gross amount", alias="showNet")
    send_type: Optional[StrictStr] = Field(default=None, description="Type which was used to send the order. IMPORTANT: Please refer to the order section of the       *     API-Overview to understand how this attribute can be used before using it!", alias="sendType")
    __properties: ClassVar[List[str]] = ["id", "objectName", "create", "update", "orderNumber", "contact", "orderDate", "status", "header", "headText", "footText", "addressCountry", "createUser", "sevClient", "deliveryTerms", "paymentTerms", "origin", "version", "smallSettlement", "contactPerson", "taxRate", "taxRule", "taxSet", "taxText", "taxType", "orderType", "sendDate", "address", "currency", "sumNet", "sumTax", "sumGross", "sumDiscounts", "sumNetForeignCurrency", "sumTaxForeignCurrency", "sumGrossForeignCurrency", "sumDiscountsForeignCurrency", "customerInternalNote", "showNet", "sendType"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set([100, 200, 300, 500, 750, 1000]):
            raise ValueError("must be one of enum values (100, 200, 300, 500, 750, 1000)")
        return value
    ...
    def order_type_validate_enum(cls, value):
        ...
        if value not in set(['AN', 'AB', 'LI']):
            raise ValueError("must be one of enum values ('AN', 'AB', 'LI')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if show_net (nullable) is None
        # and model_fields_set contains the field
        if self.show_net is None and "show_net" in self.model_fields_set:
            _dict['showNet'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact": ModelOrderUpdateContact.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
            "orderDate": obj.get("orderDate"),
            "status": obj.get("status"),
            "header": obj.get("header"),
            "headText": obj.get("headText"),
            "footText": obj.get("footText"),
            "addressCountry": ModelOrderUpdateAddressCountry.from_dict(obj["addressCountry"]) if obj.get("addressCountry") is not None else None,
            "createUser": ModelOrderUpdateCreateUser.from_dict(obj["createUser"]) if obj.get("createUser") is not None else None,
            "sevClient": ModelOrderUpdateSevClient.from_dict(obj["sevClient"]) if obj.get("sevClient") is not None else None,
            "deliveryTerms": obj.get("deliveryTerms"),
            "paymentTerms": obj.get("paymentTerms"),
            "origin": ModelOrderOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
            "version": obj.get("version"),
            "smallSettlement": obj.get("smallSettlement"),
            "contactPerson": ModelOrderUpdateContactPerson.from_dict(obj["contactPerson"]) if obj.get("contactPerson") is not None else None,
            ...
            "taxSet": ModelOrderUpdateTaxSet.from_dict(obj["taxSet"]) if obj.get("taxSet") is not None else None,
