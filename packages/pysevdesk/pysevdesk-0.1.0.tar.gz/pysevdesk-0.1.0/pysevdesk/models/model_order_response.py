...
class ModelOrderResponse(BaseModel):
    ...
    contact: Optional[ModelOrderResponseContact] = None
    ...
    status: Optional[StrictStr] = Field(default=None, description="Please have a look in       <a href='#tag/Order/Types-and-status-of-orders'>status of orders</a>      to see what the different status codes mean")
    ...
    address_country: Optional[ModelOrderResponseAddressCountry] = Field(default=None, alias="addressCountry")
    create_user: Optional[ModelOrderResponseCreateUser] = Field(default=None, alias="createUser")
    sev_client: Optional[ModelOrderResponseSevClient] = Field(default=None, alias="sevClient")
    ...
    origin: Optional[ModelOrderResponseOrigin] = None
    version: Optional[StrictStr] = Field(default=None, description="Version of the order.<br>      Can be used if you have multiple drafts for the same order.<br>      Should start with 0")
    ...
    contact_person: Optional[ModelOrderResponseContactPerson] = Field(default=None, alias="contactPerson")
    ...
    tax_set: Optional[ModelOrderResponseTaxSet] = Field(default=None, alias="taxSet")
    ...
    sum_net: Optional[StrictStr] = Field(default=None, description="Net sum of the order", alias="sumNet")
    sum_tax: Optional[StrictStr] = Field(default=None, description="Tax sum of the order", alias="sumTax")
    sum_gross: Optional[StrictStr] = Field(default=None, description="Gross sum of the order", alias="sumGross")
    sum_discounts: Optional[StrictStr] = Field(default=None, description="Sum of all discounts in the order", alias="sumDiscounts")
    sum_net_foreign_currency: Optional[StrictStr] = Field(default=None, description="Net sum of the order in the foreign currency", alias="sumNetForeignCurrency")
    sum_tax_foreign_currency: Optional[StrictStr] = Field(default=None, description="Tax sum of the order in the foreign currency", alias="sumTaxForeignCurrency")
    sum_gross_foreign_currency: Optional[StrictStr] = Field(default=None, description="Gross sum of the order in the foreign currency", alias="sumGrossForeignCurrency")
    sum_discounts_foreign_currency: Optional[StrictStr] = Field(default=None, description="Discounts sum of the order in the foreign currency", alias="sumDiscountsForeignCurrency")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact": ModelOrderResponseContact.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
            "orderDate": obj.get("orderDate"),
            "status": obj.get("status"),
            "header": obj.get("header"),
            "headText": obj.get("headText"),
            "footText": obj.get("footText"),
            "addressCountry": ModelOrderResponseAddressCountry.from_dict(obj["addressCountry"]) if obj.get("addressCountry") is not None else None,
            "createUser": ModelOrderResponseCreateUser.from_dict(obj["createUser"]) if obj.get("createUser") is not None else None,
            "sevClient": ModelOrderResponseSevClient.from_dict(obj["sevClient"]) if obj.get("sevClient") is not None else None,
            "deliveryTerms": obj.get("deliveryTerms"),
            "paymentTerms": obj.get("paymentTerms"),
            "origin": ModelOrderResponseOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
            "version": obj.get("version"),
            "smallSettlement": obj.get("smallSettlement"),
            "contactPerson": ModelOrderResponseContactPerson.from_dict(obj["contactPerson"]) if obj.get("contactPerson") is not None else None,
            ...
            "taxSet": ModelOrderResponseTaxSet.from_dict(obj["taxSet"]) if obj.get("taxSet") is not None else None,
