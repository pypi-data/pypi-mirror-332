...
class TestSaveInvoice(unittest.TestCase):
    """SaveInvoice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SaveInvoice:
        """Test SaveInvoice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveInvoice`
        """
        model = SaveInvoice()
        if include_optional:
            return SaveInvoice(
                invoice = pysevdesk.models.invoice_model.Invoice model(
                    id = 56, 
                    object_name = 'Invoice', 
                    invoice_number = 'RE-1000', 
                    contact = pysevdesk.models.model_invoice_contact.Model_Invoice_contact(
                        id = 56, 
                        object_name = 'Contact', ), 
                    contact_person = pysevdesk.models.model_invoice_contact_person.Model_Invoice_contactPerson(
                        id = 56, 
                        object_name = 'SevUser', ), 
                    create = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    sev_client = pysevdesk.models.model_invoice_sev_client.Model_Invoice_sevClient(
                        id = 56, 
...
street
postCode city', 
                    address_country = pysevdesk.models.model_invoice_address_country.Model_Invoice_addressCountry(
                        id = 1, 
                        object_name = 'StaticCountry', ), 
                    pay_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    create_user = pysevdesk.models.model_credit_note_create_user.Model_creditNote_createUser(
                        id = 56, 
                        object_name = 'SevUser', ), 
                    delivery_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    delivery_date_until = 56, 
                    status = '100', 
                    small_settlement = False, 
                    tax_rate = 0, 
                    tax_rule = pysevdesk.models.model_credit_note_response_tax_rule.Model_creditNoteResponse_taxRule(
                        id = '1', 
                        object_name = 'TaxRule', ), 
                    tax_text = 'Umsatzsteuer 19%', 
                    tax_type = 'default', 
                    tax_set = pysevdesk.models.model_invoice_tax_set.Model_Invoice_taxSet(
                        id = '1', 
                        object_name = 'TaxSet', ), 
                    dunning_level = 56, 
                    payment_method = pysevdesk.models.model_invoice_payment_method.Model_Invoice_paymentMethod(
                        id = 21919, 
                        object_name = 'PaymentMethod', ), 
                    send_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    invoice_type = 'RE', 
                    account_intervall = '', 
                    account_next_invoice = 56, 
                    currency = 'EUR', 
                    sum_net = 1.337, 
                    sum_tax = 1.337, 
                    sum_gross = 1.337, 
                    sum_discounts = 1.337, 
                    sum_net_foreign_currency = 1.337, 
                    sum_tax_foreign_currency = 1.337, 
                    sum_gross_foreign_currency = 1.337, 
                    sum_discounts_foreign_currency = 1.337, 
                    sum_net_accounting = 1.337, 
                    sum_tax_accounting = 1.337, 
                    sum_gross_accounting = 1.337, 
                    paid_amount = 1.337, 
                    show_net = False, 
                    enshrined = '2024-04-08T00:00+02:00', 
                    send_type = 'VPR', 
                    origin = pysevdesk.models.model_invoice_origin.Model_Invoice_origin(
                        id = '1', 
                        object_name = 'Order', ), 
                    ...
                    map_all = True, ),
                invoice_pos_save = [
                    pysevdesk.models.invoice_position_model.Invoice position model(
                        id = 56, 
                        object_name = 'InvoicePos', 
                        map_all = True, 
                        create = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        invoice = pysevdesk.models.model_invoice_pos_invoice.Model_InvoicePos_invoice(
                            id = 56, 
                            object_name = 'Invoice', ), 
                        part = pysevdesk.models.model_credit_note_pos_part.Model_creditNotePos_part(
                            id = 56, 
                            object_name = 'Part', ), 
                        quantity = 1, 
                        price = 100, 
                        name = 'Dragonglass', 
                        unity = pysevdesk.models.model_invoice_pos_unity.Model_InvoicePos_unity(
                            id = 1, 
                            object_name = 'Unity', ), 
                        sev_client = pysevdesk.models.model_invoice_pos_sev_client.Model_InvoicePos_sevClient(
                            id = 56, 
                            object_name = 'SevClient', ), 
                        position_number = 56, 
                        text = '', 
                ...
                invoice_pos_delete = pysevdesk.models.save_invoice_invoice_pos_delete.saveInvoice_invoicePosDelete(
                    id = 56, 
                    object_name = '', ),
                filename = bytes(b'blah'),
                discount_save = [
                    pysevdesk.models.save_invoice_discount_save_inner.saveInvoice_discountSave_inner(
                        discount = True, 
                        text = '', 
                        percentage = True, 
                        value = 1.337, 
                ...
                discount_delete = pysevdesk.models.save_invoice_discount_delete.saveInvoice_discountDelete(
                    id = 56, 
                    object_name = 'Discounts', )
            )
        else:
