...
def update_views(stdscr, instance, filter):
    ...
    instance.rens = slurm_list.view_list(
        instance, instance.jobs, filter, stylefn=styles.crsstyler, width=instance.left_width if hasattr(
            instance, 'left_width') else 72, jit=instance.job_id_type if hasattr(
            instance, 'job_id_type') else 'agg')
