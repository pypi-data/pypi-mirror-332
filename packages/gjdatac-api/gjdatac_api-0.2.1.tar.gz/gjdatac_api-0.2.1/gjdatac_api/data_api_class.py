...
class GJDataC:
    ...
    def get_basic_data_handle_data(data, asset_type):
        ...
        return new_df[['order_book_id', 'asset_type', 'data_date', 'value']]
    ...
    def get_history_bars(self, datetime_str=None, instrument_id=None, bar_count=None,
        ...
        if datetime_str and bar_count:
            ...
            # 执行查询并筛选数据
            result, bar_db_session = self._get_history_bar_execute_query(frequency, instrument_id, datetime_str,
                                                                         bar_count)
