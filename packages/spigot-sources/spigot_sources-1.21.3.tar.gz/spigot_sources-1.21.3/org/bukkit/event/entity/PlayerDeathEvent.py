...
class PlayerDeathEvent(EntityDeathEvent):
    ...
    def __init__(self, player: "Player", damageSource: "DamageSource", drops: list["ItemStack"], droppedExp: int, deathMessage: str):
        ...


    def __init__(self, player: "Player", damageSource: "DamageSource", drops: list["ItemStack"], droppedExp: int, newExp: int, deathMessage: str):
        ...


    def __init__(self, player: "Player", damageSource: "DamageSource", drops: list["ItemStack"], droppedExp: int, newExp: int, newTotalExp: int, newLevel: int, deathMessage: str):
        ...
