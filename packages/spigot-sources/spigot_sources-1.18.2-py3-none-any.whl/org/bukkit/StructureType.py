...
class StructureType(Keyed):
    ...
    chests.
    """
    OCEAN_RUIN = register(StructureType("ocean_ruin", MapCursor.Type.TEMPLE))
    """
    ...
    """
    OCEAN_MONUMENT = register(StructureType("monument", MapCursor.Type.TEMPLE))
    """
    ...
    naturally.
    """
    END_CITY = register(StructureType("endcity", MapCursor.Type.RED_X))
    """
