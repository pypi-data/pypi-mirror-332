...
class Verify:
    ...
    **Note:** In some cases the differences explained below can be subtle. When it's unclear
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: str) -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: int) -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: "Object") -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: str, p2: str) -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: int, p2: str) -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: "Object", p2: str) -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: str, p2: int) -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: int, p2: int) -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: "Object", p2: int) -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: str, p2: "Object") -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: int, p2: "Object") -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: "Object", p2: "Object") -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: "Object", p2: "Object", p3: "Object") -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
    ...
    @staticmethod
    def verify(expression: bool, errorMessageTemplate: str, p1: "Object", p2: "Object", p3: "Object", p4: "Object") -> None:
        """
        Ensures that `expression` is `True`, throwing a `VerifyException` with a
        custom message otherwise.
