...
class Files:
    ...
    def toString(file: "File", charset: "Charset") -> str:
        ...
        Deprecated
        - Prefer `asCharSource(file, charset).read()`. This method is scheduled to be
    ...
    def write(from: "CharSequence", to: "File", charset: "Charset") -> None:
        ...
        Deprecated
        - Prefer `asCharSink(to, charset).write(from)`. This method is scheduled to be
            removed in October 2019.
        """
        ...
    ...
    def copy(from: "File", charset: "Charset", to: "Appendable") -> None:
        ...
        Deprecated
        - Prefer `asCharSource(from, charset).copyTo(to)`. This method is scheduled to
    ...
    def readFirstLine(file: "File", charset: "Charset") -> str:
        ...
        Deprecated
        - Prefer `asCharSource(file, charset).readFirstLine()`. This method is
    ...
    def readLines(file: "File", charset: "Charset", callback: "LineProcessor"["T"]) -> "T":
        ...
        Deprecated
        - Prefer `asCharSource(file, charset).readLines(callback)`. This method is
            scheduled to be removed in October 2019.
        """
        ...
    ...
    def readBytes(file: "File", processor: "ByteProcessor"["T"]) -> "T":
        ...
        Deprecated
        - Prefer `asByteSource(file).read(processor)`. This method is scheduled to be
            removed in October 2019.
        """
        ...
    ...
    def hash(file: "File", hashFunction: "HashFunction") -> "HashCode":
        ...
        Deprecated
        - Prefer `asByteSource(file).hash(hashFunction)`. This method is scheduled to
            be removed in October 2019.
        """
        ...
