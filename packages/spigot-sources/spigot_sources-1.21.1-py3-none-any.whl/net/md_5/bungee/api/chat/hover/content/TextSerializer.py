"""
Python module generated from Java source file net.md_5.bungee.api.chat.hover.content.TextSerializer
...
class TextSerializer(JsonSerializer, JsonDeserializer):

    def deserialize(self, element: "JsonElement", type: "Type", context: "JsonDeserializationContext") -> "Text":
        ...


    def serialize(self, content: "Text", type: "Type", context: "JsonSerializationContext") -> "JsonElement":
        ...
