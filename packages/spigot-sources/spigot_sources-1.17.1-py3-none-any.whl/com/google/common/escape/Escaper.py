...
class Escaper:
    ...
    Character.isHighSurrogate surrogate Character.isLowSurrogate pairs, or
    by starting with short strings already known to be free of unpaired surrogates.
    
    The two primary implementations of this interface are CharEscaper and
    UnicodeEscaper. They are heavily optimized for performance and greatly simplify the task
    ...
    com.google.common.html.HtmlEscapers and com.google.common.xml.XmlEscapers. To
    create your own escapers, use CharEscaperBuilder, or extend `CharEscaper` or
    `UnicodeEscaper`.
    ...
    def escape(self, string: str) -> str:
        ...
        well formed characters. A `CharEscaper` should not be used in situations where input is
