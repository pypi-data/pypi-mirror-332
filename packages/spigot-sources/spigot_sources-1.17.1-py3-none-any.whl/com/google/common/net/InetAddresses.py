...
class InetAddresses:
    ...
    **Important note:** Unlike `InetAddress.getByName()`, the methods of this class never
    ...
    - <a target="_parent" href="http://en.wikipedia.org/wiki/Bogon_filtering">http://en.wikipedia.
    org/wiki/Bogon_filtering</a>
    - <a target="_parent" href="http://www.cymru.com/Bogons/ipv6.txt">http://www.cymru.com/Bogons/
    ipv6.txt</a>
    ...
    def forUriString(hostAddr: str) -> "InetAddress":
        ...
        This function is similar to InetAddresses.forString(String), however, it requires
        that IPv6 addresses are surrounded by square brackets.
        
        This function is the inverse of InetAddresses.toUriString(java.net.InetAddress).
    ...
    def getCoercedIPv4Address(ip: "InetAddress") -> "Inet4Address":
        ...
        This function does so by hashing the upper 64 bits into `224.0.0.0/3` (64 bits into 29
        bits).
