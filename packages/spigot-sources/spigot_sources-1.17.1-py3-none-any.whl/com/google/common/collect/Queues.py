...
class Queues:
    ...
    Also see this class's counterparts Lists, Sets, and Maps.
    ...
    def synchronizedQueue(queue: "Queue"["E"]) -> "Queue"["E"]:
        ...
        the queue's iterator: ```   `Queue<E> queue = Queues.synchronizedQueue(MinMaxPriorityQueue.<E>create());
          ...
    ...
    def synchronizedDeque(deque: "Deque"["E"]) -> "Deque"["E"]:
        ...
        guarantee serial access, it is critical that **all** access to the backing deque is
        accomplished through the returned deque.
        
        It is imperative that the user manually synchronize on the returned deque when accessing
        any of the deque's iterators: ```   `Deque<E> deque = Queues.synchronizedDeque(Queues.<E>newArrayDeque());
          ...
