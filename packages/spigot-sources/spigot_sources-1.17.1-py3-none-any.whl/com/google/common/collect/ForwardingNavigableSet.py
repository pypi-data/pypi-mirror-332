...
class ForwardingNavigableSet(ForwardingSortedSet, NavigableSet):
    ...
    **Warning:** The methods of `ForwardingNavigableSet` forward *indiscriminately*
    to the methods of the delegate. For example, overriding .add alone *will not*
    change the behavior of .addAll, which can lead to unexpected behavior. In this case, you
