...
class ImmutableSortedMultisetFauxverideShim(ImmutableMultiset):
    """
    "Overrides" the ImmutableMultiset static methods that lack
    ImmutableSortedMultiset equivalents with deprecated, exception-throwing versions. This
    ...
    def toImmutableMultiset() -> "Collector"["E", Any, "ImmutableMultiset"["E"]]:
        """
        Not supported. Use ImmutableSortedMultiset.toImmutableSortedMultiset instead.
        This method exists only to hide ImmutableMultiset.toImmutableMultiset from
    ...
    def of(element: "E") -> "ImmutableSortedMultiset"["E"]:
        ...
        Deprecated
        - **Pass a parameter of type `Comparable` to use
    ...
    def of(e1: "E", e2: "E") -> "ImmutableSortedMultiset"["E"]:
        ...
        Deprecated
        - **Pass the parameters of type `Comparable` to use
    ...
    def copyOf(elements: list["E"]) -> "ImmutableSortedMultiset"["E"]:
        ...
        Deprecated
        - **Pass parameters of type `Comparable` to use
