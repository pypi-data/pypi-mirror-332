...
class ContiguousSet(ImmutableSortedSet):
    ...
    **Warning:** Be extremely careful what you do with conceptually large instances (such as
    `ContiguousSet.create(Range.greaterThan(0), DiscreteDomain.integers()`). Certain
    operations on such a set can be performed efficiently, but others (such as Set.hashCode
    or Collections.frequency) can cause major performance problems.
    ...
    def intersection(self, other: "ContiguousSet"["C"]) -> "ContiguousSet"["C"]:
        ...
        Sets.intersection for ContiguousSet instances.
        """
        ...
