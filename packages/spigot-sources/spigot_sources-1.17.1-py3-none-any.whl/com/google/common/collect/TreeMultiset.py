...
class TreeMultiset(AbstractSortedMultiset, Serializable):
    ...
    or an explicit Comparator. In all cases, this implementation uses
    Comparable.compareTo or Comparator.compare instead of Object.equals to
    ...
    **Warning:** The comparison must be *consistent with equals* as explained by the
    ...
    java.util.Collection contract, which is specified in terms of Object.equals.
