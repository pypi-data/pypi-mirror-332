...
class LinearTransformation:
    ...
    def mapping(x1: float, y1: float) -> "LinearTransformationBuilder":
        ...
        finite. Call either LinearTransformationBuilder.and or
        LinearTransformationBuilder.withSlope on the returned object to finish building the
        instance.
        """
        ...
    ...
    def forNaN() -> "LinearTransformation":
        ...
        .transform methods all return Double.NaN. The .inverse method returns
        the same instance.
        """
        ...
    ...
    class LinearTransformationBuilder:
        ...
        LinearTransformation.mapping. You almost certainly don't want to keep instances around,
        but instead use method chaining. This represents a single point mapping, i.e. a mapping between
        one `x` and `y` value pair.
        """
