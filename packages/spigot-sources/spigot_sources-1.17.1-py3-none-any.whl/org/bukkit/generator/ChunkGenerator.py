...
class ChunkGenerator:
    ...
    **must** be completely thread safe and able to handle multiple concurrent
    ...
    - ChunkGenerator.shouldGenerateBedrock()
    ...
    def generateNoise(self, worldInfo: "WorldInfo", random: "Random", x: int, z: int, chunkData: "ChunkData") -> None:
        """
    ...
    def generateSurface(self, worldInfo: "WorldInfo", random: "Random", x: int, z: int, chunkData: "ChunkData") -> None:
        """
    ...
    def generateBedrock(self, worldInfo: "WorldInfo", random: "Random", x: int, z: int, chunkData: "ChunkData") -> None:
        """
        ...
        If .shouldGenerateBedrock() is set to True, the given
        ChunkData contains already the Vanilla bedrock generation.
    ...
    def generateCaves(self, worldInfo: "WorldInfo", random: "Random", x: int, z: int, chunkData: "ChunkData") -> None:
        """
