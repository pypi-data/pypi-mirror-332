...
class ScannerImpl(Scanner):
    ...
    See
    - <a href="http://www.yaml.org/spec/current.html.id2517668">4.1.6.
         Escape Sequences</a>
    """
    ...
    See
    - <a href="http://yaml.org/spec/1.1/current.html.id872840">5.6. Escape
         Sequences</a>
    """
    ...
    def setEmitComments(self, emitComments: bool) -> "ScannerImpl":
        """
        Set the scanner to ignore comments or emit them as a `CommentToken`.

        Arguments
        - emitComments: `True` to emit; `False` to ignore`
        """
        ...


    def isEmitComments(self) -> bool:
        ...
