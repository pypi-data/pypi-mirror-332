...
class Lists:
    ...
    def newArrayList() -> list["E"]:
        ...
        **Note for Java 7 and later:** this method is now unnecessary and should be treated as
        deprecated. Instead, use the `ArrayList` ArrayList.ArrayList() constructor
    ...
    def newArrayList(elements: Iterable["E"]) -> list["E"]:
        ...
        **Note for Java 7 and later:** if `elements` is a Collection, you don't
        need this method. Use the `ArrayList` ArrayList.ArrayList(Collection)
    ...
    def newArrayListWithCapacity(initialArraySize: int) -> list["E"]:
        ...
        **Note for Java 7 and later:** this method is now unnecessary and should be treated as
        deprecated. Instead, use `new`ArrayList.ArrayList(int) ArrayList`<>(int)`
        directly, taking advantage of the new <a href="http://goo.gl/iz2Wi">"diamond" syntax</a>.
    ...
    def newLinkedList() -> list["E"]:
        ...
        **Note for Java 7 and later:** this method is now unnecessary and should be treated as
        deprecated. Instead, use the `LinkedList` LinkedList.LinkedList()
        constructor directly, taking advantage of the new <a href="http://goo.gl/iz2Wi">"diamond"
        syntax</a>.
        """
        ...
    ...
    def newLinkedList(elements: Iterable["E"]) -> list["E"]:
        ...
        **Note for Java 7 and later:** if `elements` is a Collection, you don't
        need this method. Use the `LinkedList` LinkedList.LinkedList(Collection)
        constructor directly, taking advantage of the new <a href="http://goo.gl/iz2Wi">"diamond"
        syntax</a>.
        """
        ...
