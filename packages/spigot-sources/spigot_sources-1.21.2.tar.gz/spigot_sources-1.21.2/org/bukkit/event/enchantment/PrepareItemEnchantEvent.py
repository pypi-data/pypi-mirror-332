...
class PrepareItemEnchantEvent(InventoryEvent, Cancellable):
    ...
    def __init__(self, enchanter: "Player", view: "EnchantmentView", table: "Block", item: "ItemStack", offers: list["EnchantmentOffer"], bonus: int):
        ...
    ...
    def getView(self) -> "EnchantmentView":
        ...
