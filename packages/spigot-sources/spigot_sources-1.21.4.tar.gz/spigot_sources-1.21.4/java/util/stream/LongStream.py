"""
Python module generated from Java source file java.util.stream.LongStream
...
class LongStream(BaseStream):
    ...
    def filter(self, predicate: "LongPredicate") -> "LongStream":
        """
    ...
    def map(self, mapper: "LongUnaryOperator") -> "LongStream":
        """
    ...
    def mapToObj(self, mapper: "LongFunction"["U"]) -> "Stream"["U"]:
        """
    ...
    def mapToInt(self, mapper: "LongToIntFunction") -> "IntStream":
        """
    ...
    def mapToDouble(self, mapper: "LongToDoubleFunction") -> "DoubleStream":
        """
    ...
    def flatMap(self, mapper: "LongFunction"["LongStream"]) -> "LongStream":
        """
    ...
    def mapMulti(self, mapper: "LongMapMultiConsumer") -> "LongStream":
        """
        Returns a stream consisting of the results of replacing each element of
    ...
    def peek(self, action: "LongConsumer") -> "LongStream":
        """
    ...
    def limit(self, maxSize: int) -> "LongStream":
        """
    ...
    def skip(self, n: int) -> "LongStream":
        """
    ...
    def takeWhile(self, predicate: "LongPredicate") -> "LongStream":
        """
        ...
        .generate(LongSupplier)) or removing the ordering constraint with
        .unordered() may result in significant speedups of
    ...
    def dropWhile(self, predicate: "LongPredicate") -> "LongStream":
        """
    ...
    def forEach(self, action: "LongConsumer") -> None:
        """
    ...
    def forEachOrdered(self, action: "LongConsumer") -> None:
        """
    ...
    def reduce(self, identity: int, op: "LongBinaryOperator") -> int:
        """
    ...
    def reduce(self, op: "LongBinaryOperator") -> "OptionalLong":
        """
        Performs a <a href="package-summary.html#Reduction">reduction</a> on the
    ...
    def collect(self, supplier: "Supplier"["R"], accumulator: "ObjLongConsumer"["R"], combiner: "BiConsumer"["R", "R"]) -> "R":
        """
    ...
    def anyMatch(self, predicate: "LongPredicate") -> bool:
        """
    ...
    def allMatch(self, predicate: "LongPredicate") -> bool:
        """
    ...
    def noneMatch(self, predicate: "LongPredicate") -> bool:
        """
    ...
    @staticmethod
    def of(*values: Tuple[int, ...]) -> "LongStream":
        """
    ...
    @staticmethod
    def iterate(seed: int, f: "LongUnaryOperator") -> "LongStream":
        """
    ...
    @staticmethod
    def iterate(seed: int, hasNext: "LongPredicate", next: "LongUnaryOperator") -> "LongStream":
        """
    ...
    @staticmethod
    def range(startInclusive: int, endExclusive: int) -> "LongStream":
        """
    ...
    @staticmethod
    def rangeClosed(startInclusive: int, endInclusive: int) -> "LongStream":
        """
        Returns a sequential ordered `LongStream` from `startInclusive`
