...
class Server(PluginMessageRecipient):
    ...
    def getServerLinks(self) -> "ServerLinks":
        """
    ...
    def getEntityFactory(self) -> "EntityFactory":
        """
    ...
    def setPauseWhenEmptyTime(self, seconds: int) -> None:
        """
