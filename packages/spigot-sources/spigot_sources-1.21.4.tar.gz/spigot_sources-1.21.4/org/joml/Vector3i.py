"""
Python module generated from Java source file org.joml.Vector3i
...
class Vector3i(Externalizable, Cloneable, Vector3ic):
    """
    ...
    def __init__(self, d: int):
        """
        Create a new Vector3i and initialize all three components with
        the given value.
    ...
    def __init__(self, v: "Vector2ic", z: int):
        """
        Create a new Vector3i with the first two components from the
    ...
    def __init__(self, x: float, y: float, z: float, mode: int):
        """
        Create a new Vector3i with the given component values and
    ...
    def __init__(self, v: "Vector3fc", mode: int):
        """
        Create a new Vector3i and initialize its components to the rounded value of
        the given vector.
    ...
    def __init__(self, xyz: list[int]):
        """
        Create a new Vector3i and initialize its three components from the first
    ...
    def __init__(self, buffer: "ByteBuffer"):
        """
        Create a new Vector3i and read this vector from the supplied
    ...
    def xy(self, dest: "Vector2i") -> "Vector2i":
        """
        Copy the `(x, y)` components of `this` into the supplied `dest` vector
        and return it.
    ...
    def set(self, v: "Vector3ic") -> "Vector3i":
        """
    ...
    def set(self, v: "Vector3dc") -> "Vector3i":
        """
    ...
    def set(self, v: "Vector3dc", mode: int) -> "Vector3i":
        """
    ...
    def set(self, v: "Vector3fc", mode: int) -> "Vector3i":
        """
        Set this vector to the values of v using the given RoundingMode.
    ...
    def set(self, v: "Vector2ic", z: int) -> "Vector3i":
        """
    ...
    def set(self, xyz: list[int]) -> "Vector3i":
        """
    ...
    def set(self, buffer: "ByteBuffer") -> "Vector3i":
        """
    ...
    def set(self, index: int, buffer: "ByteBuffer") -> "Vector3i":
        """
    ...
    def set(self, buffer: "IntBuffer") -> "Vector3i":
        """
    ...
    def set(self, index: int, buffer: "IntBuffer") -> "Vector3i":
        """
    ...
    def setFromAddress(self, address: int) -> "Vector3i":
        """
    ...
    def setComponent(self, component: int, value: int) -> "Vector3i":
        """
    ...
    def sub(self, v: "Vector3ic") -> "Vector3i":
        """
    ...
    def sub(self, x: int, y: int, z: int) -> "Vector3i":
        """
    ...
    def add(self, v: "Vector3ic") -> "Vector3i":
        """
    ...
    def add(self, x: int, y: int, z: int) -> "Vector3i":
        """
    ...
    def mul(self, scalar: int) -> "Vector3i":
        """
    ...
    def mul(self, v: "Vector3ic") -> "Vector3i":
        """
    ...
    def mul(self, x: int, y: int, z: int) -> "Vector3i":
        """
    ...
    def div(self, scalar: float) -> "Vector3i":
        """
    ...
    def div(self, scalar: int) -> "Vector3i":
        """
        Divide all components of this vector by the given scalar value.
    ...
    def min(self, v: "Vector3ic") -> "Vector3i":
        """
    ...
    def max(self, v: "Vector3ic") -> "Vector3i":
        """
