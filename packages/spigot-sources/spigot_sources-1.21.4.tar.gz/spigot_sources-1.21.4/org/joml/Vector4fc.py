...
class Vector4fc:
    ...
    def mulGeneric(self, mat: "Matrix4fc", dest: "Vector4f") -> "Vector4f":
        """
        Multiply the given matrix `mat` with this vector and store the result in `dest`.
    ...
    def mulTranspose(self, mat: "Matrix4fc", dest: "Vector4f") -> "Vector4f":
        """
        Multiply the transpose of the given matrix `mat` with this vector and store the result in
        `dest`.
    ...
    def mulTranslation(self, mat: "Matrix4fc", dest: "Vector4f") -> "Vector4f":
        """
        Multiply the given matrix `mat`, which is assumed to only contain translation, with this vector
        and store the result in `dest`.
    ...
    def mulAffine(self, mat: "Matrix4fc", dest: "Vector4f") -> "Vector4f":
        """
        Multiply the given affine matrix `mat` with this vector and store the result in
        `dest`.
    ...
    def mulAffineTranspose(self, mat: "Matrix4fc", dest: "Vector4f") -> "Vector4f":
        """
        Multiply the transpose of the given affine matrix `mat` with this vector and store the result in
        `dest`.
    ...
    def mulGenericTranspose(self, mat: "Matrix4fc", dest: "Vector4f") -> "Vector4f":
        """
        Multiply the transpose of the given matrix `mat` with this vector and store the result in
        `dest`.
    ...
    def mulTranslation(self, mat: "Matrix4x3fc", dest: "Vector4f") -> "Vector4f":
        """
        Multiply the given matrix `mat`, which is assumed to only contain translation,
        with this vector and store the result in `dest`.
    ...
    def mulGeneric(self, mat: "Matrix4x3fc", dest: "Vector4f") -> "Vector4f":
        """
        Multiply the given matrix `mat` with this vector and store the result in `dest`.
    ...
    def mulProjectGeneric(self, mat: "Matrix4fc", dest: "Vector4f") -> "Vector4f":
        """
        Multiply the given matrix `mat` with this vector, perform perspective division
        and store the result in `dest`.
    ...
    def mulProjectTranslation(self, mat: "Matrix4fc", dest: "Vector3f") -> "Vector3f":
        """
        Multiply the given matrix `mat`, which is assumed to only contain translation, with this vector,
        perform perspective division and store the `(x, y, z)` result in `dest`.
    ...
    def mulProjectTranslation(self, mat: "Matrix4fc", dest: "Vector4f") -> "Vector4f":
        """
        Multiply the given matrix `mat`, which is assumed to only contain translation,
        with this vector, perform perspective division and store the result in `dest`.
    ...
    def mulProjectAffine(self, mat: "Matrix4fc", dest: "Vector4f") -> "Vector4f":
        """
        Multiply the given affine matrix `mat`, with this vector,
        perform perspective division and store the result in `dest`.
    ...
    def rotateAxis(self, angle: float, aX: float, aY: float, aZ: float, dest: "Vector4f") -> "Vector4f":
        ...
        then .rotateX(float, Vector4f) rotateX(), .rotateY(float, Vector4f) rotateY() or
        .rotateZ(float, Vector4f) rotateZ(), respectively, should be used instead.
