...
class Multiset(Collection):
    ...
    .entrySet is similar but contains Entry Multiset.Entry instances, each providing
    ...
    A multiset uses Object.equals to determine whether two instances should be considered
    "the same," *unless specified otherwise* by the implementation.
    
    **Warning:** as with normal Sets, it is almost always a bad idea to modify an
    ...
    def add(self, element: "E") -> bool:
        ...
        To both add the element and obtain the previous count of that element, use .add(Object, int) add`(element, 1)` instead.
    ...
    def remove(self, element: "Object") -> bool:
        ...
        To both remove the element and obtain the previous count of that element, use .remove(Object, int) remove`(element, 1)` instead.
    ...
    def setCount(self, element: "E", oldCount: int, newCount: int) -> bool:
        ...
        Arguments
        - element: the element to conditionally set the count of; may be null only if explicitly
            allowed by the implementation
    ...
    def removeAll(self, c: Iterable[Any]) -> bool:
        ...
        **Note:** This method ignores how often any element might appear in `c`, and only
        ...
        This method refines Collection.removeAll to further specify that it **may not**
        throw an exception in response to any of `elements` being null or of the wrong type.
        """
        ...
    ...
    def retainAll(self, c: Iterable[Any]) -> bool:
        ...
        **Note:** This method ignores how often any element might appear in `c`, and only
        ...
        This method refines Collection.retainAll to further specify that it **may not**
        throw an exception in response to any of `elements` being null or of the wrong type.
