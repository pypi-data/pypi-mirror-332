...
class CommentEventsCollector:
    ...
    def __init__(self, parser: "Parser", *expectedCommentTypes: Tuple["CommentType", ...]):
        ...
        - expectedCommentTypes: the comment types expected. Any comment types not included are not
               collected.
        """
        ...
    ...
    def collectEventsAndPoll(self, event: "Event") -> "Event":
        ...
        Returns
        - the event provided as an argument, if it is not collected; Otherwise, the first event
