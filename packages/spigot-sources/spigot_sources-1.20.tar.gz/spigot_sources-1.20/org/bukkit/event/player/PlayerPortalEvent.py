"""
Python module generated from Java source file org.bukkit.event.player.PlayerPortalEvent
...
class PlayerPortalEvent(PlayerTeleportEvent):
    ...
    def __init__(self, player: "Player", from: "Location", to: "Location", cause: "TeleportCause", getSearchRadius: int, canCreatePortal: bool, creationRadius: int):
        ...
