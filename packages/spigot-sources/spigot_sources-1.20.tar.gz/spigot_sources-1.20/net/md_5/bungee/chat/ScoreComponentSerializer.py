"""
Python module generated from Java source file net.md_5.bungee.chat.ScoreComponentSerializer
...
class ScoreComponentSerializer(BaseComponentSerializer, JsonSerializer, JsonDeserializer):

    def deserialize(self, element: "JsonElement", type: "Type", context: "JsonDeserializationContext") -> "ScoreComponent":
        ...


    def serialize(self, component: "ScoreComponent", type: "Type", context: "JsonSerializationContext") -> "JsonElement":
        ...
