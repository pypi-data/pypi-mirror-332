...
class UnicodeEscaper(Escaper):
    ...
    **Note:** This class is similar to CharEscaper but with one very
    ...
    implement the .escape(int) method.
    """
    ...
    def escape(self, out: "Appendable") -> "Appendable":
        ...
        Unlike .escape(String) it is permitted to append arbitrarily
        ...
        the escaping behavior is identical to that of .escape(String) and
