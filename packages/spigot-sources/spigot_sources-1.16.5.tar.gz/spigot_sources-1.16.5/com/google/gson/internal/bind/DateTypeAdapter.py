"""
Python module generated from Java source file com.google.gson.internal.bind.DateTypeAdapter
...
class DateTypeAdapter(TypeAdapter):
    ...
    FACTORY = TypeAdapterFactory() {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
            return typeToken.getRawType() == Date.class ? (TypeAdapter<T>) DateTypeAdapter() : null;
        }
    }


    def read(self, in: "JsonReader") -> "Date":
        ...
