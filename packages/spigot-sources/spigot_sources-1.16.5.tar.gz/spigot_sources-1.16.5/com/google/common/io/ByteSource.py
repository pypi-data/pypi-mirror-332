...
class ByteSource:
    ...
    def openBufferedStream(self) -> "InputStream":
        ...
        additional buffering (for example, a `ByteArrayInputStream`). This method should return a
    ...
    def isEmpty(self) -> bool:
        ...
        .sizeIfKnown returns zero, falling back to opening a stream and checking for EOF if the
        size is not known.
    ...
    def size(self) -> int:
        ...
        InputStream.skip(long) skip, if possible) to the end of the stream and return the total
