...
class ImmutableMultiset(ImmutableCollection, Multiset):
    """
    ...
    **Grouped iteration.** In all current implementations, duplicate elements always appear
    consecutively when iterating. Elements iterate in order by the *first* appearance of
    ...
    def toImmutableMultiset() -> "Collector"["E", Any, "ImmutableMultiset"["E"]]:
        ...
        `ImmutableMultiset`.  Elements iterate in order by the *first* appearance of that
    ...
    class Builder(Builder):
        ...
        def __init__(self):
            ...
            generated by ImmutableMultiset.builder.
            """
            ...
        ...
        def addCopies(self, element: "E", occurrences: int) -> "Builder"["E"]:
            ...
            Arguments
            - element: the element to add
            - occurrences: the number of occurrences of the element to add. May
            ...
            Raises
            - NullPointerException: if `element` is null
            - IllegalArgumentException: if `occurrences` is negative, or
