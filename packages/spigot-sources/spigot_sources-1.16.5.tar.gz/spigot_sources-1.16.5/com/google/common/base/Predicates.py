...
class Predicates:
    ...
    def and(components: Iterable["Predicate"["T"]]) -> "Predicate"["T"]:
        ...
        changes to it won't alter the behavior of this predicate. If `components` is empty, the returned predicate will always evaluate to `True`.
        """
        ...
    ...
    def or(components: Iterable["Predicate"["T"]]) -> "Predicate"["T"]:
        ...
        changes to it won't alter the behavior of this predicate. If `components` is empty, the returned predicate will always evaluate to `False`.
        """
        ...
    ...
    @staticmethod
    def instanceOf(clazz: type[Any]) -> "Predicate"["Object"]:
        """
    ...
    @staticmethod
    def assignableFrom(clazz: type[Any]) -> "Predicate"[type[Any]]:
        """
        Returns a predicate that evaluates to `True` if the class being tested is assignable
        **TO** `clazz`, that is, if it is a **subtype** of `clazz`. Yes, this method
        is named very incorrectly! Example: ```   `List<Class<?>> classes = Arrays.asList(
        ...
        Deprecated
        - Use the correctly-named method .subtypeOf instead.
        """
        ...
    ...
    def subtypeOf(clazz: type[Any]) -> "Predicate"[type[Any]]:
        """
        Returns a predicate that evaluates to `True` if the class being tested is assignable
        to (is a subtype of) `clazz`. Example: ```   `List<Class<?>> classes = Arrays.asList(
              Object.class, String.class, Number.class, Long.class);
