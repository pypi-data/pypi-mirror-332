...
class MemUtil:
    ...
    def copy(self, src: "Matrix4f", dest: "Matrix4f") -> None:
        ...


    def copy(self, src: "Matrix4x3f", dest: "Matrix4x3f") -> None:
        ...


    def copy(self, src: "Matrix4f", dest: "Matrix4x3f") -> None:
        ...


    def copy(self, src: "Matrix4x3f", dest: "Matrix4f") -> None:
        ...


    def copy(self, src: "Matrix3f", dest: "Matrix3f") -> None:
        ...


    def copy(self, src: "Matrix3f", dest: "Matrix4f") -> None:
        ...


    def copy(self, src: "Matrix4f", dest: "Matrix3f") -> None:
        ...


    def copy(self, src: "Matrix3f", dest: "Matrix4x3f") -> None:
        ...


    def copy(self, src: "Matrix3x2f", dest: "Matrix3x2f") -> None:
        ...


    def copy(self, src: "Matrix3x2d", dest: "Matrix3x2d") -> None:
        ...


    def copy(self, src: "Matrix2f", dest: "Matrix2f") -> None:
        ...


    def copy(self, src: "Matrix2d", dest: "Matrix2d") -> None:
        ...


    def copy(self, src: "Matrix2f", dest: "Matrix3f") -> None:
        ...


    def copy(self, src: "Matrix3f", dest: "Matrix2f") -> None:
        ...


    def copy(self, src: "Matrix2f", dest: "Matrix3x2f") -> None:
        ...


    def copy(self, src: "Matrix3x2f", dest: "Matrix2f") -> None:
        ...


    def copy(self, src: "Matrix2d", dest: "Matrix3d") -> None:
        ...


    def copy(self, src: "Matrix3d", dest: "Matrix2d") -> None:
        ...


    def copy(self, src: "Matrix2d", dest: "Matrix3x2d") -> None:
        ...


    def copy(self, src: "Matrix3x2d", dest: "Matrix2d") -> None:
        ...


    def copy3x3(self, src: "Matrix4f", dest: "Matrix4f") -> None:
        ...


    def copy3x3(self, src: "Matrix4x3f", dest: "Matrix4x3f") -> None:
        ...


    def copy3x3(self, src: "Matrix3f", dest: "Matrix4x3f") -> None:
        ...


    def copy3x3(self, src: "Matrix3f", dest: "Matrix4f") -> None:
        ...


    def copy4x3(self, src: "Matrix4f", dest: "Matrix4f") -> None:
        ...


    def copy4x3(self, src: "Matrix4x3f", dest: "Matrix4f") -> None:
        ...
    ...
    def copy(self, src: "Matrix4f", dest: list[float], off: int) -> None:
        ...


    def copy(self, src: "Matrix3f", dest: list[float], off: int) -> None:
        ...


    def copy(self, src: "Matrix4x3f", dest: list[float], off: int) -> None:
        ...


    def copy(self, src: "Matrix3x2f", dest: list[float], off: int) -> None:
        ...


    def copy(self, src: "Matrix3x2d", dest: list[float], off: int) -> None:
        ...


    def copy(self, src: "Matrix2f", dest: list[float], off: int) -> None:
        ...


    def copy(self, src: "Matrix2d", dest: list[float], off: int) -> None:
        ...


    def copy4x4(self, src: "Matrix4x3f", dest: list[float], off: int) -> None:
        ...


    def copy4x4(self, src: "Matrix4x3d", dest: list[float], off: int) -> None:
        ...
    ...
    def copy4x4(self, src: "Matrix3x2f", dest: list[float], off: int) -> None:
        ...


    def copy4x4(self, src: "Matrix3x2d", dest: list[float], off: int) -> None:
        ...


    def copy3x3(self, src: "Matrix3x2f", dest: list[float], off: int) -> None:
        ...


    def copy3x3(self, src: "Matrix3x2d", dest: list[float], off: int) -> None:
        ...
    ...
    class MemUtilUnsafe(MemUtilNIO):
        ...
        def putTransposed(self, m: "Matrix3x2f", offset: int, dest: "ByteBuffer") -> None:
            ...
