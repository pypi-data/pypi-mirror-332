"""
Python module generated from Java source file com.google.common.collect.ForwardingCollection
...
class ForwardingCollection(ForwardingObject, Collection):
    """
    ...
    **`default` method warning:** This class does *not* forward calls to `default` methods. Instead, it inherits their default implementations. When those implementations
    ...
    def removeAll(self, collection: Iterable[Any]) -> bool:
        ...
    ...
    def retainAll(self, collection: Iterable[Any]) -> bool:
        ...
