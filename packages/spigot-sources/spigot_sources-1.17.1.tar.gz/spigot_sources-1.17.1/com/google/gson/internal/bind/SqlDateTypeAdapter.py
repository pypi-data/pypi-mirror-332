"""
Python module generated from Java source file com.google.gson.internal.bind.SqlDateTypeAdapter
...
class SqlDateTypeAdapter(TypeAdapter):
    ...
    FACTORY = TypeAdapterFactory() {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
            return typeToken.getRawType() == java.sql.Date.class ? (TypeAdapter<T>) SqlDateTypeAdapter() : null;
        }
    }
