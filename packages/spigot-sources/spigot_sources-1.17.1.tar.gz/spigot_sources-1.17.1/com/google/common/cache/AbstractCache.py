...
class AbstractCache(Cache):
    ...
    implemented in terms of .getIfPresent; .putAll is implemented in terms of
    .put, .invalidateAll(Iterable) is implemented in terms of .invalidate.
    ...
    def getAllPresent(self, keys: Iterable[Any]) -> "ImmutableMap"["K", "V"]:
        """
    ...
    def invalidateAll(self, keys: Iterable[Any]) -> None:
        """
        Since
        - 11.0
        """
    ...
    class StatsCounter:
        """
        Accumulates statistics during the operation of a Cache for presentation by
        Cache.stats. This is solely intended for consumption by `Cache` implementors.
