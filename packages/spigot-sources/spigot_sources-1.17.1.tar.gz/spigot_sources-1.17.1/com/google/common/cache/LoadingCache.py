...
class LoadingCache(Cache, Function):
    ...
    def get(self, key: "K") -> "V":
        ...
        Raises
        - ExecutionException: if a checked exception was thrown while loading the value. (`ExecutionException` is thrown
    ...
    def getAll(self, keys: Iterable["K"]) -> "ImmutableMap"["K", "V"]:
        ...
        entries returned by CacheLoader.loadAll will be stored in the cache, over-writing any
    ...
    def apply(self, key: "K") -> "V":
        ...
        Deprecated
        - Provided to satisfy the `Function` interface; use .get or
