...
class Equivalence(BiPredicate):
    ...
    equivalences are the .identity() identity equivalence and .equals equals
    equivalence.
    ...
    def equivalent(self, a: "T", b: "T") -> bool:
        ...
        - It is *consistent*: for any references `x` and `y`, multiple invocations
    ...
    def test(self, t: "T", u: "T") -> bool:
        ...
        Deprecated
        - Provided only to satisfy the BiPredicate interface; use
            .equivalent instead.
        """
        ...
    ...
    def hash(self, t: "T") -> int:
        ...
        - It is *distributable across equivalence*: for any references `x` and `y`,
    ...
    def wrap(self, reference: "S") -> "Wrapper"["S"]:
        ...
        Object.equals() such that `wrap(a).equals(wrap(b))` if and only if
        `equivalent(a, b)`.
    ...
    def identity() -> "Equivalence"["Object"]:
        """
        Returns an equivalence that uses `==` to compare values and
        System.identityHashCode(Object) to compute the hash code.
        Equivalence.equivalent returns `True` if `a == b`, including in the case
