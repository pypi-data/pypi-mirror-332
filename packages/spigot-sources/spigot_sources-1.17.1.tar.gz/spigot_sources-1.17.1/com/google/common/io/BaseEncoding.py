...
class BaseEncoding:
    ...
    returns the string `"MZXW6==="`, and ```   `byte[] decoded = BaseEncoding.base32().decode("MZXW6===");````
    ...
    def decodingStream(self, reader: "Reader") -> "InputStream":
        ...
        `Reader`. The returned stream throws a DecodingException upon decoding-specific
        errors.
        """
        ...
    ...
    def base64() -> "BaseEncoding":
        ...
        in Encoded Data. Line feeds may be added using .withSeparator(String, int).
        """
        ...
