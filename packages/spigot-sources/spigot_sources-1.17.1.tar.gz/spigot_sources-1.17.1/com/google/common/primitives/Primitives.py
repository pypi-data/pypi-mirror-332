...
class Primitives:
    ...
    def allPrimitiveTypes() -> set[type[Any]]:
        """
        Returns an immutable set of all nine primitive types (including `void`). Note that a simpler way to test whether a `Class` instance is a member of this
        set is to call Class.isPrimitive.
