...
class ImmutableSortedSetFauxverideShim(ImmutableSet):
    """
    "Overrides" the ImmutableSet static methods that lack
    ImmutableSortedSet equivalents with deprecated, exception-throwing
    versions. This prevents accidents like the following: ```   `List<Object> objects = ...;
      // Sort them:
      Set<Object> sorted = ImmutableSortedSet.copyOf(objects);
      // BAD CODE! The returned set is actually an unsorted ImmutableSet!````
    
    While we could put the overrides in ImmutableSortedSet itself, it
    ...
    def toImmutableSet() -> "Collector"["E", Any, "ImmutableSet"["E"]]:
        """
        Not supported. Use ImmutableSortedSet.toImmutableSortedSet instead.
        This method exists only to hide ImmutableSet.toImmutableSet from
    ...
    def builder() -> "ImmutableSortedSet.Builder"["E"]:
        """
        Not supported. Use ImmutableSortedSet.naturalOrder, which offers
        ...
        Deprecated
        - Use ImmutableSortedSet.naturalOrder, which offers
            better type-safety.
        """
        ...
    ...
    def of(element: "E") -> "ImmutableSortedSet"["E"]:
        ...
        non-`Comparable` element.** Proper calls will resolve to the
        version in `ImmutableSortedSet`, not this dummy version.
    ...
    def of(e1: "E", e2: "E", e3: "E", e4: "E", e5: "E") -> "ImmutableSortedSet"["E"]:
        ...
        Deprecated
        - **Pass the parameters of type `Comparable` to use ImmutableSortedSet.of(
    ...
    def copyOf(elements: list["E"]) -> "ImmutableSortedSet"["E"]:
        ...
        non-`Comparable` elements.** Proper calls will resolve to the
        version in `ImmutableSortedSet`, not this dummy version.
