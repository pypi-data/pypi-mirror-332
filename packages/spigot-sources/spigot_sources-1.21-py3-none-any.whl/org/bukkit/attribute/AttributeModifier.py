...
from org.bukkit.inventory import EquipmentSlotGroup
...
class AttributeModifier(ConfigurationSerializable, Keyed):
    ...
    def __init__(self, uuid: "UUID", name: str, amount: float, operation: "Operation", slot: "EquipmentSlotGroup"):
        ...


    def __init__(self, key: "NamespacedKey", amount: float, operation: "Operation", slot: "EquipmentSlotGroup"):
        ...
    ...
    def getUniqueId(self) -> "UUID":
        ...
        Deprecated
        - attributes are now identified by keys
        """
        ...
    ...
    def getSlotGroup(self) -> "EquipmentSlotGroup":
        """
        Get the EquipmentSlot this AttributeModifier is active on,
        or null if this modifier is applicable for any slot.
