...
class EntityDeathEvent(EntityEvent):
    ...
    def __init__(self, entity: "LivingEntity", damageSource: "DamageSource", drops: list["ItemStack"]):
        ...


    def __init__(self, what: "LivingEntity", damageSource: "DamageSource", drops: list["ItemStack"], droppedExp: int):
        ...
