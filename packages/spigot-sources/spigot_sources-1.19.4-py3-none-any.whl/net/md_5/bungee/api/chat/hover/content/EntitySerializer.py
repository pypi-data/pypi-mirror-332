"""
Python module generated from Java source file net.md_5.bungee.api.chat.hover.content.EntitySerializer
...
class EntitySerializer(JsonSerializer, JsonDeserializer):

    def deserialize(self, element: "JsonElement", type: "Type", context: "JsonDeserializationContext") -> "Entity":
        ...


    def serialize(self, content: "Entity", type: "Type", context: "JsonSerializationContext") -> "JsonElement":
        ...
