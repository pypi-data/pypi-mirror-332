...
class JsonObject(JsonElement):
    ...
    def remove(self, property: str) -> "JsonElement":
        ...
        Returns
        - the JsonElement object that is being removed, or `null` if no
    ...
    def asMap(self) -> dict[str, "JsonElement"]:
        """
        Returns a mutable Map view of this `JsonObject`. Changes to the `Map`
        are visible in this `JsonObject` and the other way around.
    ...
    def equals(self, o: "Object") -> bool:
        ...
        the other object to be equal if it is an instance of `JsonObject` and has
