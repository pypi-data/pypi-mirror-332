...
class CollectionStartEvent(NodeEvent):
    ...
    def __init__(self, anchor: str, tag: str, implicit: bool, startMark: "Mark", endMark: "Mark", flowStyle: "Boolean"):
        """
        Existed in older versions but replaced with DumperOptions.FlowStyle-based constructor.
        Restored in v1.22 for backwards compatibility.

        Deprecated
        - Since restored in v1.22. Use
                    CollectionStartEvent.CollectionStartEvent(String, String, boolean, Mark, Mark, org.yaml.snakeyaml.DumperOptions.FlowStyle).
        """
        ...
