...
class CharSink:
    ...
    def openStream(self) -> "Writer":
        """
        Opens a new Writer for writing to this sink. This method should return a new,
    ...
    def writeFrom(self, readable: "Readable") -> int:
        ...
        Raises
        - IOException: if an I/O error occurs in the process of reading from `readable` or
