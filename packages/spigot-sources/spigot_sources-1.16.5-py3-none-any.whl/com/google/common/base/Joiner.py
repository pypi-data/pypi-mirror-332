...
class Joiner:
    ...
    them as a String. Example: ```   `Joiner joiner = Joiner.on("; ").skipNulls();
       . . .
    ...
    **Warning: joiner instances are always immutable**; a configuration method such as `useForNull` has no effect on the instance it is invoked on! You must store and use the new joiner
    instance returned by the method. This makes joiners thread-safe, and safe to store as `static final` constants. ```   `// Bad! Do not do this!
    ...
    def appendTo(self, appendable: "A", parts: Iterable[Any]) -> "A":
        """
    ...
    def appendTo(self, appendable: "A", parts: Iterator[Any]) -> "A":
        """
        Appends the string representation of each of `parts`, using the previously configured
        separator between each, to `appendable`.
    ...
    def appendTo(self, builder: "StringBuilder", parts: Iterable[Any]) -> "StringBuilder":
        """
        Appends the string representation of each of `parts`, using the previously configured
        separator between each, to `builder`. Identical to
        .appendTo(Appendable, Iterable), except that it does not throw IOException.
        """
        ...


    def appendTo(self, builder: "StringBuilder", parts: Iterator[Any]) -> "StringBuilder":
        """
        Appends the string representation of each of `parts`, using the previously configured
        separator between each, to `builder`. Identical to
        .appendTo(Appendable, Iterable), except that it does not throw IOException.
    ...
    def join(self, parts: Iterable[Any]) -> str:
        """
    ...
    def join(self, parts: Iterator[Any]) -> str:
        """
        Returns a string containing the string representation of each of `parts`, using the
        previously configured separator between each.
    ...
    class MapJoiner:
        ...
        - To output a single entry for each key, pass `multimap.asMap()` to a `MapJoiner`
        ...
        def appendTo(self, builder: "StringBuilder", map: dict[Any, Any]) -> "StringBuilder":
            """
            Appends the string representation of each entry of `map`, using the previously
            configured separator and key-value separator, to `builder`. Identical to
            .appendTo(Appendable, Map), except that it does not throw IOException.
            """
            ...
