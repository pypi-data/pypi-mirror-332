...
class Predicate(Predicate):
    """
    Legacy version of java.util.function.Predicate.  Determines a True or False value for a
    given input.
    ...
    <a href="https://github.com/google/guava/wiki/FunctionalExplained">the use of `Predicate`</a>.
