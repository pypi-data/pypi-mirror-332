...
class Function(Function):
    ...
    As this interface extends java.util.function.Function, an instance of this type
    can be used as a `java.util.function.Function` directly.  To use a
    `java.util.function.Function` in a context where a
    `com.google.common.base.Function` is needed, use `function::apply`.
    ...
    <a href="https://github.com/google/guava/wiki/FunctionalExplained">the use of `Function`</a>.
