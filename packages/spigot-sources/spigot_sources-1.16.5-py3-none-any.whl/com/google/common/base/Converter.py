...
class Converter(Function):
    ...
    *missing* information and the other is not. The .convert method handles this null
    ...
    - Convert between specific preset values using com.google.common.collect.Maps.asConverter Maps.asConverter. For example, use this to create
    ...
    - **Do not** call .doForward or .doBackward directly; these exist only to be
        overridden.
