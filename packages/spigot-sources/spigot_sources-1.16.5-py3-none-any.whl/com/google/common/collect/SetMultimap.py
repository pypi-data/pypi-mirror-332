...
class SetMultimap(Multimap):
    """
    A `Multimap` that cannot hold duplicate key-value pairs. Adding a
    ...
    a java.util.Comparator (or the natural order), see the
    ...
    def get(self, key: "K") -> set["V"]:
        ...
        method returns a Set, instead of the java.util.Collection
    ...
    def entries(self) -> set["Map.Entry"["K", "V"]]:
        """
