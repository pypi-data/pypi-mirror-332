...
class AbstractSortedSetMultimap(AbstractSetMultimap, SortedSetMultimap):
    """
    Basic implementation of the SortedSetMultimap interface. It's a
    wrapper around AbstractMapBasedMultimap that converts the returned
    collections into sorted sets. The .createCollection method
