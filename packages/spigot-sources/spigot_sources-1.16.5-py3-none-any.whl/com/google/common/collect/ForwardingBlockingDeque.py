"""
Python module generated from Java source file com.google.common.collect.ForwardingBlockingDeque
...
class ForwardingBlockingDeque(ForwardingDeque, BlockingDeque):
    ...
    **`default` method warning:** This class does *not* forward calls to `default` methods. Instead, it inherits their default implementations. When those implementations
    ...
    Deprecated
    - This class has moved to `com.google.common.util.concurrent`. Please use com.google.common.util.concurrent.ForwardingBlockingDeque instead. This class is scheduled
