...
class Hasher(PrimitiveSink):
    ...
    **Warning:** Chunks of data that are put into the Hasher are not delimited. The
    ...
    following three expressions all generate colliding hash codes: ```   `newHasher().putByte(b1).putByte(b2).putByte(b3).hash()
    ...
    def hashCode(self) -> int:
        """
        Deprecated
        - This returns Object.hashCode(); you almost certainly mean to call
            `hash().asInt()`.
        """
        ...
