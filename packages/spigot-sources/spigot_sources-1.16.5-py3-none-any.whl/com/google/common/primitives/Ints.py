...
class Ints:
    ...
    **Java 8 users:** use Integer.BYTES instead.
    ...
    def toByteArray(value: int) -> list[int]:
        ...
        use a shared java.nio.ByteBuffer instance, or use
    ...
    def stringConverter() -> "Converter"[str, "Integer"]:
        ...
        Integer.decode and Integer.toString(). The returned converter throws
    ...
    def tryParse(string: str, radix: int) -> "Integer":
        ...
        Raises
        - IllegalArgumentException: if `radix < Character.MIN_RADIX` or
