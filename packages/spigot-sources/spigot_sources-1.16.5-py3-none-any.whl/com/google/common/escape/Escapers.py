...
class Escapers:
    ...
    def computeReplacement(escaper: "CharEscaper", c: str) -> str:
        ...
        `null` if no replacement should be made. This method is intended for use in tests through
        the `EscaperAsserts` class; production users of CharEscaper should limit
    ...
    def computeReplacement(escaper: "UnicodeEscaper", cp: int) -> str:
        ...
        Returns a string that would replace the given character in the specified escaper, or
        `null` if no replacement should be made. This method is intended for use in tests through
        the `EscaperAsserts` class; production users of UnicodeEscaper should limit
        themselves to its public interface.
    ...
    class Builder:
        ...
        points. In these cases it is necessary to extend either ArrayBasedCharEscaper or
        ArrayBasedUnicodeEscaper to provide the desired behavior. However this builder is
