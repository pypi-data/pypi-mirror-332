"""
Python module generated from Java source file java.util.concurrent.atomic.AtomicLongFieldUpdater
...
class AtomicLongFieldUpdater:
    ...
    @staticmethod
    def newUpdater(tclass: type["U"], fieldName: str) -> "AtomicLongFieldUpdater"["U"]:
        """
    ...
    def getAndUpdate(self, obj: "T", updateFunction: "LongUnaryOperator") -> int:
        """
    ...
    def updateAndGet(self, obj: "T", updateFunction: "LongUnaryOperator") -> int:
        """
        Atomically updates (with memory effects as specified by VarHandle.compareAndSet) the field of the given object managed
        by this updater with the results of applying the given
    ...
    def getAndAccumulate(self, obj: "T", x: int, accumulatorFunction: "LongBinaryOperator") -> int:
        """
        Atomically updates (with memory effects as specified by VarHandle.compareAndSet) the field of the given object managed
    ...
    def accumulateAndGet(self, obj: "T", x: int, accumulatorFunction: "LongBinaryOperator") -> int:
        """
        Atomically updates (with memory effects as specified by VarHandle.compareAndSet) the field of the given object managed
        by this updater with the results of applying the given function
