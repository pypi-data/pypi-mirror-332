...
class EntityType(Enum):
    ...
    An ender eye signal.
    """
    POTION = ("potion", ThrownPotion, 16, False)
    """
    ...
    """
    FIREWORK_ROCKET = ("firework_rocket", Firework, 22, False)
    """
    ...
    """
    LIGHTNING_BOLT = ("lightning_bolt", LightningStrike, -1, False)
    """
    A bolt of lightning.
