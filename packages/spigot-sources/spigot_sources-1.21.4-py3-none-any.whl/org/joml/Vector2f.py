...
class Vector2f(Externalizable, Cloneable, Vector2fc):
    ...
    def __init__(self, v: "Vector3fc"):
        """
        Create a new Vector2f and initialize its components using the `x` and `y`
    ...
    def set(self, x: float, y: float) -> "Vector2f":
        ...
        Note that due to the `this` vector storing the components in float-precision,
        there is the possibility to lose precision.
    ...
    def set(self, v: "Vector3dc") -> "Vector2f":
        """
    ...
    def set(self, v: "Vector3fc") -> "Vector2f":
        """
        Set this vector to the `(x, y)` components of `v`.
    ...
    def set(self, v: "Vector3ic") -> "Vector2f":
        """
        Set this vector to the `(x, y)` components of `v`.
