"""
Python module generated from Java source file org.joml.Intersectionf
...
class Intersectionf:
    ...
    """
    Return value of
    .findClosestPointOnTriangle(float, float, float, float, float, float, float, float, float, float, float, float, Vector3f),
    ...
    AAR_SIDE_MINX = 0
    """
    Return value of .intersectRayAar(float, float, float, float, float, float, float, float, Vector2f) and
    ...
    OUTSIDE = -1
    """
    Return value of .intersectLineSegmentAab(float, float, float, float, float, float, float, float, float, float, float, float, Vector2f) and
    ...
    .intersectLineSegmentAar(Vector2fc, Vector2fc, Vector2fc, Vector2fc, Vector2f) to indicate that the line segment does not intersect the axis-aligned rectangle.
    """
    ONE_INTERSECTION = 1
    """
    Return value of .intersectLineSegmentAab(float, float, float, float, float, float, float, float, float, float, float, float, Vector2f) and
    ...
    or return value of .intersectLineSegmentAar(float, float, float, float, float, float, float, float, Vector2f) and
    .intersectLineSegmentAar(Vector2fc, Vector2fc, Vector2fc, Vector2fc, Vector2f) to indicate that one end point of the line segment lies inside of the axis-aligned rectangle.
    """
    TWO_INTERSECTION = 2
    """
    Return value of .intersectLineSegmentAab(float, float, float, float, float, float, float, float, float, float, float, float, Vector2f) and
    ...
    or return value of .intersectLineSegmentAar(float, float, float, float, float, float, float, float, Vector2f) and
    .intersectLineSegmentAar(Vector2fc, Vector2fc, Vector2fc, Vector2fc, Vector2f) to indicate that the line segment lies completely inside of the axis-aligned rectangle.
    """
    ...
    @staticmethod
    def intersectPlaneSphere(a: float, b: float, c: float, d: float, centerX: float, centerY: float, centerZ: float, radius: float, intersectionCenterAndRadius: "Vector4f") -> bool:
        """
        Test whether the plane with the general plane equation *a*x + b*y + c*z + d = 0* intersects the sphere with center
    ...
    @staticmethod
    def intersectPlaneSweptSphere(a: float, b: float, c: float, d: float, cX: float, cY: float, cZ: float, radius: float, vX: float, vY: float, vZ: float, pointAndTime: "Vector4f") -> bool:
        """
    ...
    @staticmethod
    def testAabPlane(min: "Vector3fc", max: "Vector3fc", a: float, b: float, c: float, d: float) -> bool:
        """
    ...
    @staticmethod
    def testAabAab(minA: "Vector3fc", maxA: "Vector3fc", minB: "Vector3fc", maxB: "Vector3fc") -> bool:
        """
    ...
    @staticmethod
    def testObOb(b0c: "Vector3f", b0uX: "Vector3f", b0uY: "Vector3f", b0uZ: "Vector3f", b0hs: "Vector3f", b1c: "Vector3f", b1uX: "Vector3f", b1uY: "Vector3f", b1uZ: "Vector3f", b1hs: "Vector3f") -> bool:
        """
    ...
    @staticmethod
    def intersectSphereSphere(aX: float, aY: float, aZ: float, radiusSquaredA: float, bX: float, bY: float, bZ: float, radiusSquaredB: float, centerAndRadiusOfIntersectionCircle: "Vector4f") -> bool:
        """
    ...
    @staticmethod
    def intersectSphereSphere(centerA: "Vector3fc", radiusSquaredA: float, centerB: "Vector3fc", radiusSquaredB: float, centerAndRadiusOfIntersectionCircle: "Vector4f") -> bool:
        """
    ...
    @staticmethod
    def intersectSphereTriangle(sX: float, sY: float, sZ: float, sR: float, v0X: float, v0Y: float, v0Z: float, v1X: float, v1Y: float, v1Z: float, v2X: float, v2Y: float, v2Z: float, result: "Vector3f") -> int:
        """
    ...
    @staticmethod
    def testSphereSphere(centerA: "Vector3fc", radiusSquaredA: float, centerB: "Vector3fc", radiusSquaredB: float) -> bool:
        """
        Test whether the one sphere with center `centerA` and square radius `radiusSquaredA` intersects the other
    ...
    @staticmethod
    def intersectRayPlane(origin: "Vector3fc", dir: "Vector3fc", point: "Vector3fc", normal: "Vector3fc", epsilon: float) -> float:
        """
    ...
    @staticmethod
    def testAabSphere(min: "Vector3fc", max: "Vector3fc", center: "Vector3fc", radiusSquared: float) -> bool:
        """
        Test whether the axis-aligned box with minimum corner `min` and maximum corner `max`
    ...
    @staticmethod
    def findClosestPointOnPlane(aX: float, aY: float, aZ: float, nX: float, nY: float, nZ: float, pX: float, pY: float, pZ: float, result: "Vector3f") -> "Vector3f":
        """
    ...
    @staticmethod
    def findClosestPointOnLineSegment(aX: float, aY: float, aZ: float, bX: float, bY: float, bZ: float, pX: float, pY: float, pZ: float, result: "Vector3f") -> "Vector3f":
        """
    ...
    @staticmethod
    def findClosestPointsLineSegments(a0X: float, a0Y: float, a0Z: float, a1X: float, a1Y: float, a1Z: float, b0X: float, b0Y: float, b0Z: float, b1X: float, b1Y: float, b1Z: float, resultA: "Vector3f", resultB: "Vector3f") -> float:
        """
    ...
    @staticmethod
    def findClosestPointsLineSegmentTriangle(aX: float, aY: float, aZ: float, bX: float, bY: float, bZ: float, v0X: float, v0Y: float, v0Z: float, v1X: float, v1Y: float, v1Z: float, v2X: float, v2Y: float, v2Z: float, lineSegmentResult: "Vector3f", triangleResult: "Vector3f") -> float:
        """
    ...
    @staticmethod
    def findClosestPointOnTriangle(v0X: float, v0Y: float, v0Z: float, v1X: float, v1Y: float, v1Z: float, v2X: float, v2Y: float, v2Z: float, pX: float, pY: float, pZ: float, result: "Vector3f") -> int:
        """
    ...
    @staticmethod
    def findClosestPointOnTriangle(v0: "Vector3fc", v1: "Vector3fc", v2: "Vector3fc", p: "Vector3fc", result: "Vector3f") -> int:
        """
    ...
    @staticmethod
    def findClosestPointOnRectangle(aX: float, aY: float, aZ: float, bX: float, bY: float, bZ: float, cX: float, cY: float, cZ: float, pX: float, pY: float, pZ: float, res: "Vector3f") -> "Vector3f":
        """
    ...
    @staticmethod
    def intersectSweptSphereTriangle(centerX: float, centerY: float, centerZ: float, radius: float, velX: float, velY: float, velZ: float, v0X: float, v0Y: float, v0Z: float, v1X: float, v1Y: float, v1Z: float, v2X: float, v2Y: float, v2Z: float, epsilon: float, maxT: float, pointAndTime: "Vector4f") -> int:
        """
    ...
    @staticmethod
    def intersectRaySphere(originX: float, originY: float, originZ: float, dirX: float, dirY: float, dirZ: float, centerX: float, centerY: float, centerZ: float, radiusSquared: float, result: "Vector2f") -> bool:
        """
    ...
    @staticmethod
    def intersectRaySphere(origin: "Vector3fc", dir: "Vector3fc", center: "Vector3fc", radiusSquared: float, result: "Vector2f") -> bool:
        """
    ...
    @staticmethod
    def testRaySphere(origin: "Vector3fc", dir: "Vector3fc", center: "Vector3fc", radiusSquared: float) -> bool:
        """
        Test whether the ray with the given `origin` and normalized direction `dir`
    ...
    @staticmethod
    def testLineSegmentSphere(p0: "Vector3fc", p1: "Vector3fc", center: "Vector3fc", radiusSquared: float) -> bool:
        """
    ...
    @staticmethod
    def intersectRayAab(originX: float, originY: float, originZ: float, dirX: float, dirY: float, dirZ: float, minX: float, minY: float, minZ: float, maxX: float, maxY: float, maxZ: float, result: "Vector2f") -> bool:
        """
    ...
    @staticmethod
    def intersectRayAab(origin: "Vector3fc", dir: "Vector3fc", min: "Vector3fc", max: "Vector3fc", result: "Vector2f") -> bool:
        """
    ...
    @staticmethod
    def intersectLineSegmentAab(p0X: float, p0Y: float, p0Z: float, p1X: float, p1Y: float, p1Z: float, minX: float, minY: float, minZ: float, maxX: float, maxY: float, maxZ: float, result: "Vector2f") -> int:
        """
        ...
        See
        - .intersectLineSegmentAab(Vector3fc, Vector3fc, Vector3fc, Vector3fc, Vector2f)
        """
        ...


    @staticmethod
    def intersectLineSegmentAab(p0: "Vector3fc", p1: "Vector3fc", min: "Vector3fc", max: "Vector3fc", result: "Vector2f") -> int:
        """
    ...
    @staticmethod
    def testRayAab(origin: "Vector3fc", dir: "Vector3fc", min: "Vector3fc", max: "Vector3fc") -> bool:
        """
        Test whether the ray with the given `origin` and direction `dir`
        intersects the axis-aligned box specified as its minimum corner `min` and maximum corner `max`.
    ...
    def testRayTriangleFront(originX: float, originY: float, originZ: float, dirX: float, dirY: float, dirZ: float, v0X: float, v0Y: float, v0Z: float, v1X: float, v1Y: float, v1Z: float, v2X: float, v2Y: float, v2Z: float, epsilon: float) -> bool:
        ...
        See
        - .testRayTriangleFront(Vector3fc, Vector3fc, Vector3fc, Vector3fc, Vector3fc, float)
        """
        ...


    @staticmethod
    def testRayTriangleFront(origin: "Vector3fc", dir: "Vector3fc", v0: "Vector3fc", v1: "Vector3fc", v2: "Vector3fc", epsilon: float) -> bool:
        """
        ...
        See
        - .testRayTriangleFront(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float)
        """
        ...
    ...
    def testRayTriangle(originX: float, originY: float, originZ: float, dirX: float, dirY: float, dirZ: float, v0X: float, v0Y: float, v0Z: float, v1X: float, v1Y: float, v1Z: float, v2X: float, v2Y: float, v2Z: float, epsilon: float) -> bool:
        ...
        See
        - .testRayTriangle(Vector3fc, Vector3fc, Vector3fc, Vector3fc, Vector3fc, float)
        """
        ...


    @staticmethod
    def testRayTriangle(origin: "Vector3fc", dir: "Vector3fc", v0: "Vector3fc", v1: "Vector3fc", v2: "Vector3fc", epsilon: float) -> bool:
        """
        Test whether the ray with the given `origin` and the given `dir` intersects the frontface of the triangle consisting of the three vertices
        `v0`, `v1` and `v2`.
        ...
        See
        - .testRayTriangle(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float)
        """
        ...
    ...
    @staticmethod
    def intersectRayTriangleFront(origin: "Vector3fc", dir: "Vector3fc", v0: "Vector3fc", v1: "Vector3fc", v2: "Vector3fc", epsilon: float) -> float:
        """
        ...
        See
        - .intersectRayTriangleFront(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float)
        """
        ...
    ...
    @staticmethod
    def intersectRayTriangle(origin: "Vector3fc", dir: "Vector3fc", v0: "Vector3fc", v1: "Vector3fc", v2: "Vector3fc", epsilon: float) -> float:
        """
        ...
        See
        - .intersectRayTriangle(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float)
        """
        ...
    ...
    def testLineSegmentTriangle(p0X: float, p0Y: float, p0Z: float, p1X: float, p1Y: float, p1Z: float, v0X: float, v0Y: float, v0Z: float, v1X: float, v1Y: float, v1Z: float, v2X: float, v2Y: float, v2Z: float, epsilon: float) -> bool:
        ...
        See
        - .testLineSegmentTriangle(Vector3fc, Vector3fc, Vector3fc, Vector3fc, Vector3fc, float)
        """
        ...


    @staticmethod
    def testLineSegmentTriangle(p0: "Vector3fc", p1: "Vector3fc", v0: "Vector3fc", v1: "Vector3fc", v2: "Vector3fc", epsilon: float) -> bool:
        """
        Test whether the line segment with the end points `p0` and `p1`
        intersects the triangle consisting of the three vertices `(v0X, v0Y, v0Z)`, `(v1X, v1Y, v1Z)` and `(v2X, v2Y, v2Z)`,
        regardless of the winding order of the triangle or the direction of the line segment between its two end points.
        ...
        See
        - .testLineSegmentTriangle(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float)
        """
        ...


    @staticmethod
    def intersectLineSegmentTriangle(p0X: float, p0Y: float, p0Z: float, p1X: float, p1Y: float, p1Z: float, v0X: float, v0Y: float, v0Z: float, v1X: float, v1Y: float, v1Z: float, v2X: float, v2Y: float, v2Z: float, epsilon: float, intersectionPoint: "Vector3f") -> bool:
        """
        ...
        See
        - .intersectLineSegmentTriangle(Vector3fc, Vector3fc, Vector3fc, Vector3fc, Vector3fc, float, Vector3f)
        """
        ...


    @staticmethod
    def intersectLineSegmentTriangle(p0: "Vector3fc", p1: "Vector3fc", v0: "Vector3fc", v1: "Vector3fc", v2: "Vector3fc", epsilon: float, intersectionPoint: "Vector3f") -> bool:
        """
        ...
        See
        - .intersectLineSegmentTriangle(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, Vector3f)
        """
        ...


    @staticmethod
    def intersectLineSegmentPlane(p0X: float, p0Y: float, p0Z: float, p1X: float, p1Y: float, p1Z: float, a: float, b: float, c: float, d: float, intersectionPoint: "Vector3f") -> bool:
        """
        Determine whether the line segment with the end points `(p0X, p0Y, p0Z)` and `(p1X, p1Y, p1Z)`
    ...
    @staticmethod
    def intersectLineCircle(a: float, b: float, c: float, centerX: float, centerY: float, radius: float, intersectionCenterAndHL: "Vector3f") -> bool:
        """
        Test whether the line with the general line equation *a*x + b*y + c = 0* intersects the circle with center
    ...
    @staticmethod
    def intersectLineCircle(x0: float, y0: float, x1: float, y1: float, centerX: float, centerY: float, radius: float, intersectionCenterAndHL: "Vector3f") -> bool:
        """
    ...
    @staticmethod
    def testAarLine(min: "Vector2fc", max: "Vector2fc", a: float, b: float, c: float) -> bool:
        """
    ...
    @staticmethod
    def testAarAar(minA: "Vector2fc", maxA: "Vector2fc", minB: "Vector2fc", maxB: "Vector2fc") -> bool:
        """
    ...
    @staticmethod
    def testMovingCircleCircle(centerA: "Vector2f", moveA: "Vector2f", aR: float, centerB: "Vector2f", bR: float) -> bool:
        """
    ...
    @staticmethod
    def intersectCircleCircle(aX: float, aY: float, radiusSquaredA: float, bX: float, bY: float, radiusSquaredB: float, intersectionCenterAndHL: "Vector3f") -> bool:
        """
    ...
    @staticmethod
    def intersectCircleCircle(centerA: "Vector2fc", radiusSquaredA: float, centerB: "Vector2fc", radiusSquaredB: float, intersectionCenterAndHL: "Vector3f") -> bool:
        """
    ...
    @staticmethod
    def testCircleCircle(centerA: "Vector2fc", radiusSquaredA: float, centerB: "Vector2fc", radiusSquaredB: float) -> bool:
        """
        Test whether the one circle with center `centerA` and square radius `radiusSquaredA` intersects the other
    ...
    @staticmethod
    def intersectRayLine(origin: "Vector2fc", dir: "Vector2fc", point: "Vector2fc", normal: "Vector2fc", epsilon: float) -> float:
        """
    ...
    def intersectRayLineSegment(originX: float, originY: float, dirX: float, dirY: float, aX: float, aY: float, bX: float, bY: float) -> float:
        ...
        *p(t) = origin + t * dir* of the intersection point, if any.
        ...
        See
        - .intersectRayLineSegment(Vector2fc, Vector2fc, Vector2fc, Vector2fc)
        """
        ...


    @staticmethod
    def intersectRayLineSegment(origin: "Vector2fc", dir: "Vector2fc", a: "Vector2fc", b: "Vector2fc") -> float:
        """
        ...
        *p(t) = origin + t * dir* of the intersection point, if any.
        ...
        See
        - .intersectRayLineSegment(float, float, float, float, float, float, float, float)
        """
        ...
    ...
    @staticmethod
    def testAarCircle(min: "Vector2fc", max: "Vector2fc", center: "Vector2fc", radiusSquared: float) -> bool:
        """
        Test whether the axis-aligned rectangle with minimum corner `min` and maximum corner `max`
    ...
    @staticmethod
    def findClosestPointOnTriangle(v0X: float, v0Y: float, v1X: float, v1Y: float, v2X: float, v2Y: float, pX: float, pY: float, result: "Vector2f") -> int:
        """
    ...
    @staticmethod
    def findClosestPointOnTriangle(v0: "Vector2fc", v1: "Vector2fc", v2: "Vector2fc", p: "Vector2fc", result: "Vector2f") -> int:
        """
        Determine the closest point on the triangle with the vertices `v0`, `v1`, `v2`
        between that triangle and the given point `p` and store that point into the given `result`.
    ...
    @staticmethod
    def intersectRayCircle(originX: float, originY: float, dirX: float, dirY: float, centerX: float, centerY: float, radiusSquared: float, result: "Vector2f") -> bool:
        """
    ...
    @staticmethod
    def intersectRayCircle(origin: "Vector2fc", dir: "Vector2fc", center: "Vector2fc", radiusSquared: float, result: "Vector2f") -> bool:
        """
        Test whether the ray with the given `origin` and direction `dir`
        intersects the circle with the given `center` and square radius `radiusSquared`,
        and store the values of the parameter *t* in the ray equation *p(t) = origin + t * dir* for both points (near
    ...
    @staticmethod
    def testRayCircle(origin: "Vector2fc", dir: "Vector2fc", center: "Vector2fc", radiusSquared: float) -> bool:
        """
        Test whether the ray with the given `origin` and direction `dir`
    ...
    @staticmethod
    def intersectRayAar(originX: float, originY: float, dirX: float, dirY: float, minX: float, minY: float, maxX: float, maxY: float, result: "Vector2f") -> int:
        """
    ...
    @staticmethod
    def intersectRayAar(origin: "Vector2fc", dir: "Vector2fc", min: "Vector2fc", max: "Vector2fc", result: "Vector2f") -> int:
        """
        ...
        See
        - .intersectRayAar(float, float, float, float, float, float, float, float, Vector2f)
        """
        ...


    @staticmethod
    def intersectLineSegmentAar(p0X: float, p0Y: float, p1X: float, p1Y: float, minX: float, minY: float, maxX: float, maxY: float, result: "Vector2f") -> int:
        """
    ...
    @staticmethod
    def intersectLineSegmentAar(p0: "Vector2fc", p1: "Vector2fc", min: "Vector2fc", max: "Vector2fc", result: "Vector2f") -> int:
        """
        Determine whether the undirected line segment with the end points `p0` and `p1`
        intersects the axis-aligned rectangle given as its minimum corner `min` and maximum corner `max`,
        and store the values of the parameter *t* in the ray equation *p(t) = p0 + t * (p1 - p0)* of the near and far point of intersection
        ...
        #see .intersectLineSegmentAar(float, float, float, float, float, float, float, float, Vector2f)
    ...
    def testRayAar(originX: float, originY: float, dirX: float, dirY: float, minX: float, minY: float, maxX: float, maxY: float) -> bool:
        ...
        See
        - .testRayAar(Vector2fc, Vector2fc, Vector2fc, Vector2fc)
        """
        ...


    @staticmethod
    def testRayAar(origin: "Vector2fc", dir: "Vector2fc", min: "Vector2fc", max: "Vector2fc") -> bool:
        """
        Test whether the ray with the given `origin` and direction `dir`
        ...
        See
        - .testRayAar(float, float, float, float, float, float, float, float)
        """
        ...
    ...
    @staticmethod
    def testPointTriangle(point: "Vector2fc", v0: "Vector2fc", v1: "Vector2fc", v2: "Vector2fc") -> bool:
        """
    ...
    @staticmethod
    def testCircleTriangle(center: "Vector2fc", radiusSquared: float, v0: "Vector2fc", v1: "Vector2fc", v2: "Vector2fc") -> bool:
        """
    ...
    @staticmethod
    def intersectPolygonRay(verticesXY: list[float], originX: float, originY: float, dirX: float, dirY: float, p: "Vector2f") -> int:
        """
    ...
    @staticmethod
    def intersectPolygonRay(vertices: list["Vector2fc"], originX: float, originY: float, dirX: float, dirY: float, p: "Vector2f") -> int:
        """
    ...
    @staticmethod
    def intersectLineLine(ps1x: float, ps1y: float, pe1x: float, pe1y: float, ps2x: float, ps2y: float, pe2x: float, pe2y: float, p: "Vector2f") -> bool:
        """
    ...
    @staticmethod
    def testPolygonPolygon(v1s: list["Vector2f"], v2s: list["Vector2f"]) -> bool:
        """
