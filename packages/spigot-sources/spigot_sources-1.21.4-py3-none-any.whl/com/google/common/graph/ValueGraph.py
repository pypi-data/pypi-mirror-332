...
class ValueGraph(BaseGraph):
    ...
    def predecessors(self, node: "N") -> set["N"]:
        ...
        If `node` is removed from the graph after this method is called, the `Set` returned by
    ...
    def equals(self, object: "Object") -> bool:
        ...
        Thus, two value graphs A and B are equal if **all** of the following are True:
          ...
          - The .edgeValue(N, N) value of a given edge is the same in both A and B.
    ...
    def hashCode(self) -> int:
        ...
        map from each of its .edges() edges to the associated .edgeValue(N, N) edge
        value.
