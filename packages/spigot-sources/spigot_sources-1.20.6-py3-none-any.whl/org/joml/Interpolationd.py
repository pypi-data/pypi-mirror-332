"""
Python module generated from Java source file org.joml.Interpolationd
...
class Interpolationd:
    ...
    @staticmethod
    def interpolateTriangle(v0X: float, v0Y: float, f0X: float, f0Y: float, v1X: float, v1Y: float, f1X: float, f1Y: float, v2X: float, v2Y: float, f2X: float, f2Y: float, x: float, y: float, dest: "Vector2d") -> "Vector2d":
        """
    ...
    @staticmethod
    def dFdxLinear(v0X: float, v0Y: float, f0X: float, f0Y: float, v1X: float, v1Y: float, f1X: float, f1Y: float, v2X: float, v2Y: float, f2X: float, f2Y: float, dest: "Vector2d") -> "Vector2d":
        """
    ...
    @staticmethod
    def dFdyLinear(v0X: float, v0Y: float, f0X: float, f0Y: float, v1X: float, v1Y: float, f1X: float, f1Y: float, v2X: float, v2Y: float, f2X: float, f2Y: float, dest: "Vector2d") -> "Vector2d":
        """
    ...
    @staticmethod
    def interpolateTriangle(v0X: float, v0Y: float, f0X: float, f0Y: float, f0Z: float, v1X: float, v1Y: float, f1X: float, f1Y: float, f1Z: float, v2X: float, v2Y: float, f2X: float, f2Y: float, f2Z: float, x: float, y: float, dest: "Vector3d") -> "Vector3d":
        """
    ...
    @staticmethod
    def interpolationFactorsTriangle(v0X: float, v0Y: float, v1X: float, v1Y: float, v2X: float, v2Y: float, x: float, y: float, dest: "Vector3d") -> "Vector3d":
        """
