"""
Python module generated from Java source file java.util.OptionalInt
...
class OptionalInt:
    ...
    value are provided, such as .orElse(int) orElse()
    (returns a default value if no value is present) and
    .ifPresent(IntConsumer) ifPresent() (performs an
    ...
    def ifPresent(self, action: "IntConsumer") -> None:
        """
    ...
    def ifPresentOrElse(self, action: "IntConsumer", emptyAction: "Runnable") -> None:
        """
        If a value is present, performs the given action with the value,
    ...
    def orElseGet(self, supplier: "IntSupplier") -> int:
        """
