"""
Python module generated from Java source file net.md_5.bungee.chat.KeybindComponentSerializer
...
class KeybindComponentSerializer(BaseComponentSerializer, JsonSerializer, JsonDeserializer):

    def deserialize(self, json: "JsonElement", typeOfT: "Type", context: "JsonDeserializationContext") -> "KeybindComponent":
        ...


    def serialize(self, src: "KeybindComponent", typeOfSrc: "Type", context: "JsonSerializationContext") -> "JsonElement":
        ...
