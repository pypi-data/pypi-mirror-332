...
def get_mock_search_result():
    ...
    try:
        ...
        data_folder_path = str(files('ai_agent_directory.data'))
    ...
    def api(self, access_key, name, item_info, **kwargs):
        ...
        try:
            ...
            if access_key == MOCK_ACCESS_KEY:
                print ("DEBUG: input access key is mocked setting to mock result, please visit http://www.deepnlp.org/workspace/my_ai_services to register your key")
