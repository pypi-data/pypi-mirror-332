...
from .model import AIxBlockMLBase


class AIxBlockMLBaseHelper(AIxBlockMLBase):
...
class AIxBlockMLChoices(AIxBlockMLBaseHelper):

    def __init__(self, **kwargs):
        super(AIxBlockMLChoices, self).__init__(**kwargs)
