...
class CeleryErrorRoute(DefaultErrorRoute):
    ...
    def add_default_exceptions_handler(
        fs_app,
        debug=False,
        excs_to_status_codes={**DefaultErrorRoute.DEFAULT_STATUS_CODE_MAPPINGS, **DEFAULT_STATUS_CODE_MAPPINGS}
    ):
        super().add_default_exceptions_handler(fs_app, debug, excs_to_status_codes)