...
from hakisto.click import hakisto_inline_location, hakisto_severity, hakisto_short_trace, hakisto_process_all, hakisto_use_color
...
@click.option('-k', '--keyfile', type=click.Path(exists=True, dir_okay=False, readable=True, allow_dash=False, path_type=pathlib.Path), help="Keyfile")
@click.argument("filename", type=click.Path(exists=True, dir_okay=False, readable=True, allow_dash=False, path_type=pathlib.Path))
@click.pass_context
...
@server.command()
@click.option('-s', '--secret', type=click.Path(exists=True, dir_okay=False, readable=True, allow_dash=False, path_type=pathlib.Path), help="File with encrypted secret")
@click.option('-k', '--keyfile', type=click.Path(exists=True, dir_okay=False, readable=True, allow_dash=False, path_type=pathlib.Path), help="Keyfile")
@click.argument("filename", type=click.Path(exists=True, dir_okay=False, readable=True, allow_dash=False, path_type=pathlib.Path))
@click.pass_context
