...
async def _(bot_id: str | None = None) -> Result[list[BaseInfo]]:
    ...
    try:
        ...
        logger.error(f"WebUi {router.prefix}/get_base_info 调用错误 {type(e)}:{e}")
...
async def _(bot_id: str | None = None) -> Result[QueryCount]:
    try:
        ...
        logger.error(f"WebUi {router.prefix}/get_all_chat_count 调用错误 {type(e)}:{e}")
        return Result.fail(f"发生了一点错误捏 {type(e)}: {e}")
...
async def _(bot_id: str | None = None) -> Result[QueryCount]:
    try:
        ...
        logger.error(f"WebUi {router.prefix}/get_all_call_count 调用错误 {type(e)}:{e}")
        return Result.fail(f"发生了一点错误捏 {type(e)}: {e}")
...
async def _(bot_id: str) -> Result[dict[str, int]]:
    try:
        ...
        logger.error(f"WebUi {router.prefix}/get_fg_count 调用错误 {type(e)}:{e}")
        return Result.fail(f"发生了一点错误捏 {type(e)}: {e}")
...
async def _(
    ...
    try:
        ...
        logger.error(f"WebUi {router.prefix}/get_active_group 调用错误 {type(e)}:{e}")
        return Result.fail(f"发生了一点错误捏 {type(e)}: {e}")
...
async def _(
    ...
    try:
        ...
        logger.error(f"WebUi {router.prefix}/get_hot_plugin 调用错误 {type(e)}:{e}")
        return Result.fail(f"发生了一点错误捏 {type(e)}: {e}")
...
async def _(bot_id: str) -> Result[BotBlockModule]:
    try:
        ...
        logger.error(
            f"WebUi {router.prefix}/get_bot_block_module 调用错误 {type(e)}:{e}"
        )
        return Result.fail(f"发生了一点错误捏 {type(e)}: {e}")
...
async def _(param: BotManageUpdateParam):
    try:
        ...
        logger.error(f"WebUi {router.prefix}/update_bot_manage 调用错误 {type(e)}:{e}")
        return Result.fail(f"发生了一点错误捏 {type(e)}: {e}")
