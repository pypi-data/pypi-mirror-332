...
def gofee_cluster_symmetry(tmp_path_factory) -> Database:
...
def test_has_candidates(gofee_cluster_symmetry: Database) -> None:
    assert len(gofee_cluster_symmetry.get_all_candidates()) != 0
