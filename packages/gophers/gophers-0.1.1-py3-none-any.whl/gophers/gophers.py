...
class DataFrame:
    ...
    def FillNA(self, value):
        ...
        return self
    def RenameWrapper(self, old_name, new_name):
...
def main():
    ...
    # report = df.CreateReport("My Report")
    # report.AddPage("Page1")
    # report.AddText("Page1", "This is some text on Page 1")
    # report.AddHeading("Page1", "Text on Page 1",4)
    # report.AddPage("Page2")
    
    # chart = df.ColumnChart("barchart","subtext","col1", Agg(Sum("col2")))
    # DisplayChart(chart)
    # report.AddChart("Page1", chart)
