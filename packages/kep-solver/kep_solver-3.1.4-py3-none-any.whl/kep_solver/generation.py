...
class DynamicGenerator:
    ...
    def __init__(
        ...
        :param recipient_arrival_rate: The expected number of recipient
            arrivals per period.
        ...
        :param ndd_arrival_rate: The expected number of non-directed donors
            arrivals per period.
        ...
        :param recipient_temporary_departure_function: A function that takes a non-directed
            donor and returns the chance of this donor being ill in any period
        """
        self._recipient_arrival_rate = recipient_arrival_rate
        ...
        self._ndd_arrival_rate = ndd_arrival_rate
    ...
    def _gen_participants(
        ...
        arrival_counts: npt.NDArray[np.int_],
        ...
        def _get_temporary_departure_departure(
            ...
            for r_period in range(period + 1, periods):
            ...
            for _ in range(count):
                ...
                temporary_departures[participant.id], departures[participant.id] = (
                    _get_temporary_departure_departure(
                        participant, temporary_departure_function, attrition_function
                    )
                )
        return arrivals, departures, temporary_departures
    ...
    def generate(
        ...
        :param instance: The (regular) Instance in question
        ...
        recip_arrival_counts = np.random.poisson(self._recipient_arrival_rate, periods)
        ndd_arrival_counts = np.random.poisson(self._ndd_arrival_rate, periods)
