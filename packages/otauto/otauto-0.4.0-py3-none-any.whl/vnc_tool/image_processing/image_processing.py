from communication.fastapi.clent_ppocr import OCRClient #高精度ocr模型
from communication.fd.docker_fdv1 import *
from communication.ini_file_operationv2 import INIFileHandler # ini文件操作
from vnc_tool.image_processing.imagefinder_v4 import ImageFinder # 图片识别
from vnc_tool.image_processing.image_matcher import ImageMatcher # 图片匹配
from vnc_tool.image_processing.multipoint_colors_v4 import multipoint_colors
import json
import numpy as np
import cv2
...
class ImageProcessor:
    ...
    def data_treating_bytes_area(self, treating_dict: dict,res_numpy):
        """
