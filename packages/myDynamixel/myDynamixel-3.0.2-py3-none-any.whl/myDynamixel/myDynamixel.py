...
class Dxlfunc:
    ...
    def multi_read(self, MotorIDs, INPUT_Address):
        ...
        for i, now_id in enumerate(MotorIDs):
            ...
            addparam_result = ctypes.c_ubyte(self._read_group.addParam(i, now_address[self.MotorSeries[i]], data_length)).value
    ...
    def multi_write(self, MotorIDs, INPUT_Address, values):
        ...
        for i, now_id in enumerate(MotorIDs):
            ...
            addparam_result = ctypes.c_ubyte(self._write_group.addParam(i, now_address[self.MotorSeries[i]], data_length, now_value)).value
            if addparam_result != 1:
                print('Add param failure')
