...
class ScriptManager:
    ...
    def reloadScript(self, name: str) -> bool:
        """
        Reload a currently loaded script.

        Arguments
        - name: The name of the script to reload. Name should contain the script file extension (.py)

        Returns
        - True if the script was successfully reloaded, False if otherwise
    ...
    def getAllScripts(self) -> "SortedSet"[str]:
        """
