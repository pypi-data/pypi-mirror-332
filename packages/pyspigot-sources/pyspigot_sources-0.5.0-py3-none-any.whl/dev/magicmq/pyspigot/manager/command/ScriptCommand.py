...
class ScriptCommand(TabExecutor):
    ...
    def __init__(self, script: "Script", commandFunction: Callable, tabFunction: Callable, name: str, description: str, prefix: str, usage: str, aliases: list[str], permission: str, permissionMessage: str):
        """
        Arguments
