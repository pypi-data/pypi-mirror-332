...
class BaseTasksOptions:
    def __init__(
        ...
        *,
        ...
        release_opts: typing.Optional[typing.Union["ReleaseTasksOptions", typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        if isinstance(release_opts, dict):
            release_opts = ReleaseTasksOptions(**release_opts)
        if __debug__:
    ...
    @builtins.property
    def release_opts(self) -> typing.Optional["ReleaseTasksOptions"]:
        '''Release task options.'''
        result = self._values.get("release_opts")
        return typing.cast(typing.Optional["ReleaseTasksOptions"], result)
...
class PythonBasicProject(
    ...
    def __init__(
        ...
        *,
        ...
        release: typing.Optional[typing.Union["ReleaseTasksOptions", typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        :param lint: Linting configurations such as rules selected etc.
        :param release: Release options for the "release" task.
        :param sample: Create sample code and test (if dir doesn't exist yet). Default: true
        :param test: Test configurations.
...
class ReleaseTasks(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param project: -
        :param action: Action to be taken after calculating the next tag/notes Options: - console: Print calculated tag/notes to console - tag: Calculate tag/notes, commit and tag (git) resources - push: Calculate tag/notes, commit, tag (git) and push resources to remote git. Default: 'console'
...
@jsii.data_type(
    jsii_type="projen-practical-constructs.ReleaseTasksOptions",
...
class ReleaseTasksOptions(NextTagOptions):
    def __init__(
        self,
        *,
        bump_action: typing.Optional[builtins.str] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__27a8133ff297afed81531be2cb6822e6568a25fdcf4a3f7068e9a35318da0d76)
            check_type(argname="argument bump_action", value=bump_action, expected_type=type_hints["bump_action"])
            check_type(argname="argument bump_files", value=bump_files, expected_type=type_hints["bump_files"])
            check_type(argname="argument changelog_file", value=changelog_file, expected_type=type_hints["changelog_file"])
            check_type(argname="argument from_ref", value=from_ref, expected_type=type_hints["from_ref"])
    ...
    def action(self) -> typing.Optional[builtins.str]:
        '''Action to be taken after calculating the next tag/notes Options:  - console: Print calculated tag/notes to console  - tag: Calculate tag/notes, commit and tag (git) resources  - push: Calculate tag/notes, commit, tag (git) and push resources to remote git.
    ...
    def __repr__(self) -> str:
        return "ReleaseTasksOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class PythonBasicOptions(
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(release, dict):
            release = ReleaseTasksOptions(**release)
    ...
    @builtins.property
    def release(self) -> typing.Optional[ReleaseTasksOptions]:
...
def _typecheckingstub__27a8133ff297afed81531be2cb6822e6568a25fdcf4a3f7068e9a35318da0d76(
    *,
    bump_action: typing.Optional[builtins.str] = None,
    bump_files: typing.Optional[typing.Sequence[builtins.str]] = None,
    changelog_file: typing.Optional[builtins.str] = None,
