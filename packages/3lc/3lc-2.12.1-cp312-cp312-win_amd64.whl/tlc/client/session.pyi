...
class Session:
    ...
    @staticmethod
    def initialize_run(project_name: str, run_name: str, run_url: Url | None = None, description: str | None = None, parameters: dict[str, Any] | None = None, if_exists_option: IfExistsOption = ...) -> str:
...
def init(project_name: str | None = None, run_name: str | None = None, description: str | None = None, parameters: dict[str, Any] | None = None, if_exists: Literal['reuse', 'overwrite', 'rename', 'raise'] = 'rename', *, run_url: Url | str | None = None) -> Run:
    ...
    :param run_url: Url to the run. If provided, project_name and run_name are ignored and the run will be created at
        the provided url. If the url already exists, the if_exists argument is used to determine how to proceed.
