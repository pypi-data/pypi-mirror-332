...
class SIDPClient:
    ...
    class TestInfo(object):
        ...
        def get_provisioning_job_status(self, uuid: str, branch: str) -> dict:
            ...
            if not pipeline_id:
                return self.format_json_error(False, "pipeline not found or pipeline too old.")
            ...
            if not job_id:
                return self.format_json_error(False, f"job provisioning not found in pipeline {pipeline_id}")
        ...
        def wait_pipeline(self, pipeline_id: str) -> tuple[bool, str]:
            ...
            """
            timeout = int(os.environ.get("SIDP_PROVISIONING_TIMEOUT", 3600))  # Fetch from env var or 1h
            while timeout > 0:
                timeout = timeout - 5
