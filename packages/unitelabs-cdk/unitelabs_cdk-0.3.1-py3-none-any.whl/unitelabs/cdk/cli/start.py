...
@utils.coroutine
async def start(app, tls, cert, key, verbose: int, log_config: typing.Optional[str]):
    ...
    if tls:
        ...
        os.environ["SILA_SERVER__CERT"] = cert.read_text()
        os.environ["SILA_SERVER__KEY"] = key.read_text()
