...
def create_bible_index(old_testament_path: str | None, new_testament_path: str | None, nlp_tokenizer: NLPTokenizer,
                       bible_chapter_expansion: dict[int, list[str]] | None = None) -> BibleChapterIndex:
    '''
    Creates the Bible index.

    old_testament_path: File path to Old Testament Bible chapters.
    new_testament_path: File path to New Testament Bible chapters.
    nlp_tokenizer: NLP tokenizer to tokenize Bible chapters.
    bible_chapter_expansion: Dictionary of generated queries to expand Bible chapters. Defaults to None.

    Returns the Bible index.
    '''
    ...
    if old_testament_path: # Index Old Testament Bible chapters.
        ...
        with open(old_testament_path, 'rb') as old_testament_file:
            for bible_chapter_line in tqdm(old_testament_file):
                ...
                bible_chapter_text = ' '.join(bible_chapter['verses'].values())
    ...
    return bible_chapter_index
        ...
        #bible_chapter_index = create_bible_index('bible_data/old_testament.jsonl', 'bible_data/new_testament.jsonl', NLPTokenizer())
