"""
    ...
    The version of the OpenAPI document: 2025.03.06
    ...
    def __init__(self, api_client=None):
        ...
        def __create_support_user(
            ...
            **kwargs
            ...
            >>> thread = api.create_support_user(support_user, async_req=True)
            >>> result = thread.get()
        ...
        if self.create_support_user is None:
            self.create_support_user = _Endpoint(
                settings={
                    ...
                    'operation_id': 'create_support_user',
                    'http_method': 'POST',
                    'servers': None,
                },
                params_map={
                ...
                api_client=api_client,
                callable=__create_support_user
            )
        ...
        def __delete_support_user(
            ...
            **kwargs
            ...
            >>> thread = api.delete_support_user(support_user_id, async_req=True)
            >>> result = thread.get()

            Args:
                support_user_id (str): support_user_id path
        ...
        if self.delete_support_user is None:
            self.delete_support_user = _Endpoint(
                settings={
                    ...
                    'endpoint_path': '/v1/support_users/{support_user_id}',
        ...
        def __get_support_user(
            ...
            **kwargs
            ...
            >>> thread = api.get_support_user(support_user_id, async_req=True)
            >>> result = thread.get()
        ...
        def __update_support_user(
            ...
            **kwargs
            ...
            >>> thread = api.update_support_user(support_user_id, async_req=True)
            >>> result = thread.get()
