...
def hakisto_short_trace(
    ...
    """
    attrs['default'] = default or os.getenv("HAKISTO_SHORT_TRACE", "False").upper() in ("TRUE", "ON", "1", "YES")
    attrs['show_default'] = show_default
    attrs['help'] = attrs.get('help', "Use shortened trace?")

    return make_decorator(cls=cls or click.Option,
                          param_decls=param_decls or ('--log-short-trace/--no-log-short-trace',),
                          **attrs)
...
def hakisto_process_short_trace(log_short_trace: bool, **kwargs) -> None:
    ...
    """
    Logger.global_short_trace = log_short_trace
