...
class FletEasyX:
    ...
    async def __add_on_events(self) -> None:
    ...
    async def __add_on_events_custom(self) -> None:
    ...
    def _add_configuration_start(self, page: Page):
        ...
        # add events
        self.__check_async(self.__add_on_events)
        self.__check_async(self.__add_on_events_custom)

        # add configuration in datasy
