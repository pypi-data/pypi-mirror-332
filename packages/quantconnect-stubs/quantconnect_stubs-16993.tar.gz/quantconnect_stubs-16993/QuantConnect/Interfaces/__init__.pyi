...
class IApi(System.IDisposable, metaclass=abc.ABCMeta):
    ...
    def broadcast_live_command(self, source_project_id: int, command: typing.Any) -> QuantConnect.Api.RestResponse:
        """
        Broadcast a live command
        
        :param source_project_id: Project for the live instance we want to source the command from
