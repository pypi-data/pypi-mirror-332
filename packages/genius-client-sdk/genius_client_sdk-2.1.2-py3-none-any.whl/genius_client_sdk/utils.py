...
def send_http_request(
    ...
    response = _send_raw_http_request(
        agent_url, http_request_method, call, json_data, data, headers
    )
...
def _send_raw_http_request(
    ...
    # set resource control, if not set
    if (
    ...
    if http_request_method.lower() == "get":
        ...
        return requests.put(url, headers=headers, data=data, json=json_data)
