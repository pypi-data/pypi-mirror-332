...
class ConceptChecker(BaseChecker):
    """
    ConceptChecker class checks if a class is a concpet by looking for a specific decorator. It also
    checks if the concept has the required documentation block, and the necessary serializatio methods.
    """
