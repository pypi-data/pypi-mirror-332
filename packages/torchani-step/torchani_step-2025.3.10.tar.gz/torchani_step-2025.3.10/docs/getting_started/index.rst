...
Installation
============
The TorchANI step is probably already installed in your SEAMM
...
check for `torchani-step`. If it is not installed, or
...
The non-graphical installer is also straightforward::
  ...
  seamm-installer install --update torchani-step
