...
class TorchANIStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the TorchANI step. It must be
    ...
    my_description = {
        "description": "An interface for TorchANI",
        "group": "Simulations",
        "name": "TorchANI",
    }
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return torchani_step.TorchANI(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return torchani_step.TkTorchANI(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return TorchANIStep.my_description
