...
class DataLoader:
    ...
    @skip_if_empty
    def write_company(self, name: str, dataset_type: str, description: str, dates: Dates) -> Company:
        ...
        """
        company = Company(name, dataset_type, description, dates, self.db)
    ...
    def write_time_region_features(
        ...
        for feature_name, description in feature_description_map.items():
            ...
            feature_description = TimeRegionFeatureDescription(
                feature_name, description, company, self.db
            )
