...
from mem0llama.configs.base import MemoryConfig, MemoryItem
from mem0llama.configs.prompts import get_update_memory_messages
from mem0llama.memory.base import MemoryBase
from mem0llama.memory.setup import setup_config
from mem0llama.memory.storage import SQLiteManager
from mem0llama.memory.utils import (
    get_fact_retrieval_messages,
    parse_messages,
    parse_vision_messages,
    remove_code_blocks,
)
from mem0llama.utils.factory import EmbedderFactory, LlmFactory, VectorStoreFactory
...
class Memory(MemoryBase):
    def __init__(self, config: MemoryConfig = MemoryConfig()):
        ...
        if self.config.graph_store.config:
            from mem0llama.memory.graph_memory import MemoryGraph
