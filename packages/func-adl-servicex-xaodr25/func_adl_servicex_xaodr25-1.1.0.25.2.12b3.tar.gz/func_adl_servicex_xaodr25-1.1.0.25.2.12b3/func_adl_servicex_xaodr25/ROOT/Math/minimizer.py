...
class Minimizer:
    ...
    def SetVariable(self, ivar: int, name: func_adl_servicex_xaodr25.str.str, val: float, step: float) -> bool:
        "A method"
        ...

    def SetLowerLimitedVariable(self, ivar: int, name: func_adl_servicex_xaodr25.str.str, val: float, step: float, lower: float) -> bool:
        "A method"
        ...

    def SetUpperLimitedVariable(self, ivar: int, name: func_adl_servicex_xaodr25.str.str, val: float, step: float, upper: float) -> bool:
        "A method"
        ...

    def SetLimitedVariable(self, ivar: int, name: func_adl_servicex_xaodr25.str.str, val: float, step: float, lower: float, upper: float) -> bool:
        "A method"
        ...

    def SetFixedVariable(self, ivar: int, name: func_adl_servicex_xaodr25.str.str, val: float) -> bool:
        "A method"
        ...
    ...
    def VariableName(self, ivar: int) -> func_adl_servicex_xaodr25.str.str:
        "A method"
        ...

    def VariableIndex(self, name: func_adl_servicex_xaodr25.str.str) -> int:
        "A method"
        ...
