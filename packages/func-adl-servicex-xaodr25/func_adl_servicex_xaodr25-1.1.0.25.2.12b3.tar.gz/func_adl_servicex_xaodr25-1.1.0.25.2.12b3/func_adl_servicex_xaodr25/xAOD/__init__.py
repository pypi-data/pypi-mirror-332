...
if not TYPE_CHECKING:
    ...
    klfitterresult = _load_me("func_adl_servicex_xaodr25.xAOD.klfitterresult")
    klfitterresultauxcontainer = _load_me("func_adl_servicex_xaodr25.xAOD.klfitterresultauxcontainer")
    ...
    pseudotopresult = _load_me("func_adl_servicex_xaodr25.xAOD.pseudotopresult")
    ...
    systematicevent = _load_me("func_adl_servicex_xaodr25.xAOD.systematicevent")
    systematiceventauxcontainer = _load_me("func_adl_servicex_xaodr25.xAOD.systematiceventauxcontainer")
