...
class Event:
    ...
    def SystematicEvents(self, name: str) -> func_adl_servicex_xaodr25.FADLStream[func_adl_servicex_xaodr25.xAOD.systematicevent.SystematicEvent]:
        ...

    def PseudoTopResults(self, name: str) -> func_adl_servicex_xaodr25.FADLStream[func_adl_servicex_xaodr25.xAOD.pseudotopresult.PseudoTopResult]:
        ...

    def KLFitterResults(self, name: str) -> func_adl_servicex_xaodr25.FADLStream[func_adl_servicex_xaodr25.xAOD.klfitterresult.KLFitterResult]:
        ...
