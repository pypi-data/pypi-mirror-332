...
class CaloSampling:
    ...
    def getSamplingName(self, theSample: CaloSampling.CaloSample) -> func_adl_servicex_xaodr25.str.str:
        "A method"
        ...

    def getSampling(self, name: func_adl_servicex_xaodr25.str.str) -> func_adl_servicex_xaodr25.calosampling.CaloSampling.CaloSample:
        "A method"
        ...
