...
if not TYPE_CHECKING:
    ...
    elementlink_datavector_xaod_tracksurface_v1__ = _load_me("func_adl_servicex_xaodr25.elementlink_datavector_xaod_tracksurface_v1__")
    ...
    elementlink_datavector_xaod_uncalibratedmeasurement_v1__ = _load_me("func_adl_servicex_xaodr25.elementlink_datavector_xaod_uncalibratedmeasurement_v1__")
    ...
    str = _load_me("func_adl_servicex_xaodr25.str")
    ...
    vector_char_ = _load_me("func_adl_servicex_xaodr25.vector_char_")
    ...
    vector_unsigned char_ = _load_me("func_adl_servicex_xaodr25.vector_unsigned char_")
    vector_int_ = _load_me("func_adl_servicex_xaodr25.vector_int_")
    vector_int_ = _load_me("func_adl_servicex_xaodr25.vector_int_")
    vector_int_ = _load_me("func_adl_servicex_xaodr25.vector_int_")
    ...
    from . import elementlink_datavector_xaod_tracksurface_v1__
    ...
    from . import vector_unsigned char_
    from . import vector_int_
    from . import vector_int_
    from . import vector_int_
