Got it! Here's the updated README with the package name changed to `ai_terminal`:
...
Once you upload the `ai_terminal` package to PyPI, users will be able to install and use it globally using `pip install ai_terminal`.