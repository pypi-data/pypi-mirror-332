...
class FoundEntitlementAssociation(BaseModel):
    ...
    """ # noqa: E501
    account_id: StrictStr = Field(description="The ID of the account that has been granted the entitlement.")
    integration_specific_entitlement_id: StrictStr = Field(description="The ID of the entitlement that has been granted.")
    integration_specific_resource_id: StrictStr = Field(description="The ID of the resource to which the entitlement applies.")
    __properties: ClassVar[List[str]] = ["account_id", "integration_specific_entitlement_id", "integration_specific_resource_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "integration_specific_entitlement_id": obj.get("integration_specific_entitlement_id"),
