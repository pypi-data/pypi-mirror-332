...
class FoundAccountData(BaseModel):
    ...
    """ # noqa: E501
    integration_specific_id: StrictStr = Field(description="Integration specific identifier that uniquely identifies an account.")
    email: Optional[StrictStr] = Field(default=None, description="The email address associated with the account.")
    given_name: Optional[StrictStr] = Field(default=None, description="The given name (first name) of the account holder.")
    family_name: Optional[StrictStr] = Field(default=None, description="The family name (last name) of the account holder.")
    username: Optional[StrictStr] = Field(default=None, description="The username associated with the account.")
    user_status: Optional[AccountStatus] = Field(default=None, description="The current status of the account.")
    extra_data: Optional[Dict[str, Any]] = Field(default=None, description="Additional data specific to the connector that doesn't fit into the standard fields.")
    custom_attributes: Optional[Dict[str, StrictStr]] = Field(default=None, description="Custom attributes associated with the account. See the list_custom_attributes_schema capability.")
    account_type: Optional[AccountType] = Field(default=None, description="The type of the account (e.g., service account or user account).")
    __properties: ClassVar[List[str]] = ["integration_specific_id", "email", "given_name", "family_name", "username", "user_status", "extra_data", "custom_attributes", "account_type"]
