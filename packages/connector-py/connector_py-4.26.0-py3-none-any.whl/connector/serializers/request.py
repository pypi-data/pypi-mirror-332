...
def AnnotatedField(
    ...
    **kwargs,
    ...
    :param semantic_type: The semantic type of the field. Currently only "account-id" is supported. Sets `x-semantic-type`.
    ...
    if semantic_type:
        json_schema_extra["x-semantic-type"] = semantic_type
    if hidden:
