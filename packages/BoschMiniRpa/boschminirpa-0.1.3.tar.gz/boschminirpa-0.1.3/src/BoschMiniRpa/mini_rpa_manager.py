    ...
    def start_bot(self):
        ...
        if self.delivery_data:
            ...
            if delivery_type == 'send_email':
                ...
                attachment_name = self.prepare_file_name(email_values['file_name'])
                self.send_email(email_account, email_password, email_address, email_body, email_header, email_subject, email_to, email_cc, attachment_name)
                ...
                hrs_send_anniversary_email(card_type, email_to_manager_column, manager_name_column, anniversary_year_column, email_to_column, user_name_column, email_cc,
