...
def lazy_import():
    from sifflet_sdk.client.model.join_rule_params_join_condition import (
        JoinRuleParamsJoinCondition,
    )

    globals()["JoinRuleParamsJoinCondition"] = JoinRuleParamsJoinCondition


class JoinRuleParams(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "join_condition": (JoinRuleParamsJoinCondition,),  # noqa: E501
    ...
    def _from_openapi_data(cls, dataset_id, *args, **kwargs):  # noqa: E501
        """JoinRuleParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            join_condition (JoinRuleParamsJoinCondition): [optional]  # noqa: E501
