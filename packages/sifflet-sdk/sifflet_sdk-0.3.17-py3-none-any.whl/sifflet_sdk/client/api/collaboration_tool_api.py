...
class CollaborationToolApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.connect_collaboration_tool_endpoint = _Endpoint(
            settings={
                "response_type": (GetCollaborationToolConfigResponseDto,),
                "auth": ["JWT"],
        ...
        self.patch_collaboration_tool_config_by_type_endpoint = _Endpoint(
            ...
            params_map={
                "all": [
                    "patch_collaboration_tool_config_dto",
                ],
                "required": [
                    "patch_collaboration_tool_config_dto",
                ],
            ...
            root_map={
                ...
                "allowed_values": {},
                "openapi_types": {
                    "patch_collaboration_tool_config_dto": (PatchCollaborationToolConfigDto,),
                },
                "attribute_map": {},
                "location_map": {
                    "patch_collaboration_tool_config_dto": "body",
                },
                "collection_format_map": {},
            },
            headers_map={
    ...
    def patch_collaboration_tool_config_by_type(self, patch_collaboration_tool_config_dto, **kwargs):
        """Patch Collaboration Tool config by type  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_collaboration_tool_config_by_type(patch_collaboration_tool_config_dto, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        kwargs["patch_collaboration_tool_config_dto"] = patch_collaboration_tool_config_dto
