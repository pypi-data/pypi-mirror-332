...
class RuleApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.patch_rule_run_endpoint = _Endpoint(
            settings={
                "response_type": None,
                "auth": ["JWT"],
                "endpoint_path": "/internal/v1/rules/{id}/rule-run/{runId}",
                "operation_id": "patch_rule_run",
                "http_method": "PATCH",
                "servers": None,
            },
            params_map={
    ...
    def patch_rule_run(self, id, run_id, rule_run_patch_dto, **kwargs):
        """Patch a rule run  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_rule_run(id, run_id, rule_run_patch_dto, async_req=True)
        >>> result = thread.get()
        ...
        return self.patch_rule_run_endpoint.call_with_http_info(**kwargs)
