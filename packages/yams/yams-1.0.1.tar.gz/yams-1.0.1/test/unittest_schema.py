...
class EntitySchemaTC(BaseSchemaTC):
    ...
    def test_deepcopy(self):
        ...
        self.assertCountEqual(
            list(eperson.subject_relations.values()), schema["Person"].subject_relations.values()
        )
        self.assertCountEqual(
            list(eperson.object_relations.values()), schema["Person"].object_relations.values()
        )
...
class SchemaTC(BaseSchemaTC):
    ...
    def test_pickle(self):
        ...
        self.assertEqual(
            list(eperson.object_relations.values()),
            list(pschema["Person"].object_relations.values()),
        )
