        ...
        while True:
            ...
            user_agent = random.choice([
                fake.chrome(
                    ...
                    version_to=random.randrange(version_from, 1500) + 1,
                    build_from=build_from,
                    build_to=random.randrange(build_from, 4500) + 1
                ),
                fake.firefox(),
            ...
            # 检查关键词：列表为空或存在任一关键词则返回
            if not keywords or any(kw in user_agent for kw in keywords):
                break
        return user_agent
