...
def RibLoss() -> kf.KCell:
    ...
    for i, d in enumerate(
        [
            dict(width=0.3, length=0),
            dict(width=0.3, length=25_000),
            dict(width=0.3, length=5_000),
            dict(width=0.3, length=20_000),
            dict(width=0.3, length=10_000),
            dict(width=0.3, length=15_000),
            dict(width=0.5, length=0),
            dict(width=0.5, length=25_000),
            dict(width=0.5, length=5_000),
            dict(width=0.5, length=20_000),
            dict(width=0.5, length=10_000),
            dict(width=0.5, length=15_000),
            dict(width=0.8, length=0),
            dict(width=0.8, length=25_000),
            dict(width=0.8, length=5_000),
            dict(width=0.8, length=20_000),
            dict(width=0.8, length=10_000),
            dict(width=0.8, length=15_000),
        ]
    ):
