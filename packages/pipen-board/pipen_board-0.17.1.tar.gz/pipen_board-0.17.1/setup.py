...
install_requires = \
['pipen-args>=0.17,<0.18',
 'pipen-log2file>=0.10,<0.11',
 'psutil>=5.9,<6.0',
...
extras_require = \
{'all': ['pipen-report>=0.23,<0.24',
         'pipen-diagram>=0.13,<0.14',
         'pipen-filters>=0.15,<0.16'],
 'diagram': ['pipen-diagram>=0.13,<0.14'],
 'filters': ['pipen-filters>=0.15,<0.16'],
 'report': ['pipen-report>=0.23,<0.24']}
