...
async def generate_google_search_queries(
    ...
    few_shot_example_queries_lines = [
        'Examples:',
        f'- site:linkedin.com/in "{org_name}" "technology_used check Eg Neo4j" intitle:"{org_name}" -intitle:technology_used',
...
"""
    ...
    if status == "SUCCESS" and response:
        ...
        return (
            ...
            f'AND ("{company_name}") AND ("{response.location_to_filter_by}")'
        ).strip()
    else:
        return ""
...
"""
    ...
    if status == "SUCCESS" and response:
        ...
        return (
            ...
            f'AND ("{response.location_to_filter_by}")'
        ).strip()
    else:
        return ""
