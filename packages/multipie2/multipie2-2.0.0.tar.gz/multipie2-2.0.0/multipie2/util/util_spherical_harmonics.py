...
from multipie2 import TOL
from multipie2.util.util import get_variable
from multipie2.data.data_definition import max_s_rank
...
def Olm(l, m, s=0, k=0, rv=None, factor=False):
    ...
    if get_variable(molm, False) or rv is None or rv.dtype == object:
        if factor:
