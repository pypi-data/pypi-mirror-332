...
from audiozen.console import console
...
def init_logging_logger(output_dir):
    ...
    Note:
        We have three ways to log messages:
        - build-in `print` function.
        - `console.print` function from `rich` library. It provides colorful and formatted output.
        - `console.log` function from `rich` module. It further provides timestamp and code location.
    ...
    console_formatter = logging.Formatter("%(message)s")  # rich will add more info about the log
