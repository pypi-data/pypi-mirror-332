...
def asymmetric_stft(y, analysis_win, win_length=None, hop_length=None):
    """Forward STFT using PyTorch.

    Args:
        y: The input signal with a shape of (batch_size, signal_length).
