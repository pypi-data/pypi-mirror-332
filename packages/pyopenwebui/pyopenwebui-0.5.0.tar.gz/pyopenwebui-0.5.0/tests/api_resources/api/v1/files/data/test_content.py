...
class TestContent:
    ...
    def test_method_update(self, client: Pyopenwebui) -> None:
        content = client.api.v1.files.data.content.update(
            id="id",
            content="content",
        )
    ...
    def test_raw_response_update(self, client: Pyopenwebui) -> None:
        response = client.api.v1.files.data.content.with_raw_response.update(
            id="id",
            content="content",
        )
    ...
    def test_streaming_response_update(self, client: Pyopenwebui) -> None:
        with client.api.v1.files.data.content.with_streaming_response.update(
            id="id",
            content="content",
        ) as response:
    ...
    def test_path_params_update(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.files.data.content.with_raw_response.update(
                id="",
                content="content",
            )
    ...
    def test_method_get(self, client: Pyopenwebui) -> None:
        content = client.api.v1.files.data.content.get(
            "id",
        )
        assert_matches_type(object, content, path=["response"])
    ...
    def test_raw_response_get(self, client: Pyopenwebui) -> None:
        response = client.api.v1.files.data.content.with_raw_response.get(
            "id",
        )
    ...
    def test_streaming_response_get(self, client: Pyopenwebui) -> None:
        with client.api.v1.files.data.content.with_streaming_response.get(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.files.data.content.with_raw_response.get(
                "",
            )
...
class TestAsyncContent:
    ...
    async def test_method_update(self, async_client: AsyncPyopenwebui) -> None:
        content = await async_client.api.v1.files.data.content.update(
            id="id",
            content="content",
        )
        assert_matches_type(object, content, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.files.data.content.with_raw_response.update(
            id="id",
            content="content",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.files.data.content.with_streaming_response.update(
            id="id",
            content="content",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.files.data.content.with_raw_response.update(
                id="",
                content="content",
            )
    ...
    async def test_method_get(self, async_client: AsyncPyopenwebui) -> None:
        content = await async_client.api.v1.files.data.content.get(
            "id",
        )
        assert_matches_type(object, content, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.files.data.content.with_raw_response.get(
            "id",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.files.data.content.with_streaming_response.get(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.files.data.content.with_raw_response.get(
                "",
            )
