...
class TestConfig:
    ...
    def test_method_update(self, client: Pyopenwebui) -> None:
        config = client.api.v1.images.image.config.update(
    ...
    def test_raw_response_update(self, client: Pyopenwebui) -> None:
        response = client.api.v1.images.image.config.with_raw_response.update(
            image_size="IMAGE_SIZE",
            image_steps=0,
            model="MODEL",
        )
    ...
    def test_streaming_response_update(self, client: Pyopenwebui) -> None:
        with client.api.v1.images.image.config.with_streaming_response.update(
            image_size="IMAGE_SIZE",
            image_steps=0,
            model="MODEL",
        ) as response:
    ...
    def test_method_get(self, client: Pyopenwebui) -> None:
        config = client.api.v1.images.image.config.get()
        assert_matches_type(object, config, path=["response"])

    @parametrize
    def test_raw_response_get(self, client: Pyopenwebui) -> None:
        response = client.api.v1.images.image.config.with_raw_response.get()
    ...
    def test_streaming_response_get(self, client: Pyopenwebui) -> None:
        with client.api.v1.images.image.config.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncConfig:
    ...
    async def test_method_update(self, async_client: AsyncPyopenwebui) -> None:
        config = await async_client.api.v1.images.image.config.update(
            image_size="IMAGE_SIZE",
            image_steps=0,
            model="MODEL",
        )
    ...
    async def test_raw_response_update(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.images.image.config.with_raw_response.update(
            image_size="IMAGE_SIZE",
            image_steps=0,
            model="MODEL",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.images.image.config.with_streaming_response.update(
            image_size="IMAGE_SIZE",
            image_steps=0,
            model="MODEL",
        ) as response:
    ...
    async def test_method_get(self, async_client: AsyncPyopenwebui) -> None:
        config = await async_client.api.v1.images.image.config.get()
        assert_matches_type(object, config, path=["response"])

    @parametrize
    async def test_raw_response_get(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.images.image.config.with_raw_response.get()
    ...
    async def test_streaming_response_get(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.images.image.config.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
