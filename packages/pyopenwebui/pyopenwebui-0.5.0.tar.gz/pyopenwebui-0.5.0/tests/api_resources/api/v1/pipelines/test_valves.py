...
class TestValves:
    ...
    def test_method_update(self, client: Pyopenwebui) -> None:
        valve = client.api.v1.pipelines.valves.update(
    ...
    def test_raw_response_update(self, client: Pyopenwebui) -> None:
        response = client.api.v1.pipelines.valves.with_raw_response.update(
            pipeline_id="pipeline_id",
            url_idx=0,
            body={},
        )
    ...
    def test_streaming_response_update(self, client: Pyopenwebui) -> None:
        with client.api.v1.pipelines.valves.with_streaming_response.update(
            pipeline_id="pipeline_id",
            url_idx=0,
            body={},
        ) as response:
    ...
    def test_path_params_update(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `pipeline_id` but received ''"):
            client.api.v1.pipelines.valves.with_raw_response.update(
                pipeline_id="",
                url_idx=0,
                body={},
            )
    ...
    def test_method_get(self, client: Pyopenwebui) -> None:
        valve = client.api.v1.pipelines.valves.get(
            pipeline_id="pipeline_id",
            url_idx=0,
        )
        assert_matches_type(object, valve, path=["response"])
    ...
    def test_raw_response_get(self, client: Pyopenwebui) -> None:
        response = client.api.v1.pipelines.valves.with_raw_response.get(
            pipeline_id="pipeline_id",
            url_idx=0,
        )
    ...
    def test_streaming_response_get(self, client: Pyopenwebui) -> None:
        with client.api.v1.pipelines.valves.with_streaming_response.get(
            pipeline_id="pipeline_id",
            url_idx=0,
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `pipeline_id` but received ''"):
            client.api.v1.pipelines.valves.with_raw_response.get(
                pipeline_id="",
                url_idx=0,
            )
    ...
    def test_method_get_spec(self, client: Pyopenwebui) -> None:
        valve = client.api.v1.pipelines.valves.get_spec(
            pipeline_id="pipeline_id",
            url_idx=0,
        )
        assert_matches_type(object, valve, path=["response"])
    ...
    def test_raw_response_get_spec(self, client: Pyopenwebui) -> None:
        response = client.api.v1.pipelines.valves.with_raw_response.get_spec(
            pipeline_id="pipeline_id",
            url_idx=0,
        )
    ...
    def test_streaming_response_get_spec(self, client: Pyopenwebui) -> None:
        with client.api.v1.pipelines.valves.with_streaming_response.get_spec(
            pipeline_id="pipeline_id",
            url_idx=0,
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get_spec(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `pipeline_id` but received ''"):
            client.api.v1.pipelines.valves.with_raw_response.get_spec(
                pipeline_id="",
                url_idx=0,
            )
...
class TestAsyncValves:
    ...
    async def test_method_update(self, async_client: AsyncPyopenwebui) -> None:
        valve = await async_client.api.v1.pipelines.valves.update(
            pipeline_id="pipeline_id",
            url_idx=0,
            body={},
        )
    ...
    async def test_raw_response_update(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.pipelines.valves.with_raw_response.update(
            pipeline_id="pipeline_id",
            url_idx=0,
            body={},
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.pipelines.valves.with_streaming_response.update(
            pipeline_id="pipeline_id",
            url_idx=0,
            body={},
        ) as response:
    ...
    async def test_path_params_update(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `pipeline_id` but received ''"):
            await async_client.api.v1.pipelines.valves.with_raw_response.update(
                pipeline_id="",
                url_idx=0,
                body={},
            )
    ...
    async def test_method_get(self, async_client: AsyncPyopenwebui) -> None:
        valve = await async_client.api.v1.pipelines.valves.get(
            pipeline_id="pipeline_id",
            url_idx=0,
        )
        assert_matches_type(object, valve, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.pipelines.valves.with_raw_response.get(
            pipeline_id="pipeline_id",
            url_idx=0,
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.pipelines.valves.with_streaming_response.get(
            pipeline_id="pipeline_id",
            url_idx=0,
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `pipeline_id` but received ''"):
            await async_client.api.v1.pipelines.valves.with_raw_response.get(
                pipeline_id="",
                url_idx=0,
            )
    ...
    async def test_method_get_spec(self, async_client: AsyncPyopenwebui) -> None:
        valve = await async_client.api.v1.pipelines.valves.get_spec(
            pipeline_id="pipeline_id",
            url_idx=0,
        )
        assert_matches_type(object, valve, path=["response"])
    ...
    async def test_raw_response_get_spec(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.pipelines.valves.with_raw_response.get_spec(
            pipeline_id="pipeline_id",
            url_idx=0,
        )
    ...
    async def test_streaming_response_get_spec(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.pipelines.valves.with_streaming_response.get_spec(
            pipeline_id="pipeline_id",
            url_idx=0,
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_spec(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `pipeline_id` but received ''"):
            await async_client.api.v1.pipelines.valves.with_raw_response.get_spec(
                pipeline_id="",
                url_idx=0,
            )
