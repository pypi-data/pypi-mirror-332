...
class TestBanners:
    ...
    def test_method_get(self, client: Pyopenwebui) -> None:
        banner = client.api.v1.configs.banners.get()
        assert_matches_type(BannerGetResponse, banner, path=["response"])

    @parametrize
    def test_raw_response_get(self, client: Pyopenwebui) -> None:
        response = client.api.v1.configs.banners.with_raw_response.get()
    ...
    def test_streaming_response_get(self, client: Pyopenwebui) -> None:
        with client.api.v1.configs.banners.with_streaming_response.get() as response:
    ...
    def test_method_set(self, client: Pyopenwebui) -> None:
        banner = client.api.v1.configs.banners.set(
            banners=[
                {
                    "id": "id",
                    "content": "content",
        ...
        assert_matches_type(BannerSetResponse, banner, path=["response"])

    @parametrize
    def test_raw_response_set(self, client: Pyopenwebui) -> None:
        response = client.api.v1.configs.banners.with_raw_response.set(
            banners=[
                {
                    "id": "id",
                    "content": "content",
    ...
    def test_streaming_response_set(self, client: Pyopenwebui) -> None:
        with client.api.v1.configs.banners.with_streaming_response.set(
            banners=[
                {
                    "id": "id",
                    "content": "content",
...
class TestAsyncBanners:
    ...
    async def test_method_get(self, async_client: AsyncPyopenwebui) -> None:
        banner = await async_client.api.v1.configs.banners.get()
        assert_matches_type(BannerGetResponse, banner, path=["response"])

    @parametrize
    async def test_raw_response_get(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.configs.banners.with_raw_response.get()
    ...
    async def test_streaming_response_get(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.configs.banners.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_set(self, async_client: AsyncPyopenwebui) -> None:
        banner = await async_client.api.v1.configs.banners.set(
            banners=[
                {
                    "id": "id",
                    "content": "content",
    ...
    async def test_raw_response_set(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.configs.banners.with_raw_response.set(
            banners=[
                {
                    "id": "id",
                    "content": "content",
    ...
    async def test_streaming_response_set(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.configs.banners.with_streaming_response.set(
            banners=[
                {
                    "id": "id",
                    "content": "content",
