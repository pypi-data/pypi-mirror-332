...
class TestInfo:
    ...
    def test_method_update(self, client: Pyopenwebui) -> None:
        info = client.api.v1.users.user.info.update(
            body={},
        )
    ...
    def test_raw_response_update(self, client: Pyopenwebui) -> None:
        response = client.api.v1.users.user.info.with_raw_response.update(
            body={},
        )
    ...
    def test_streaming_response_update(self, client: Pyopenwebui) -> None:
        with client.api.v1.users.user.info.with_streaming_response.update(
            body={},
        ) as response:
    ...
    def test_method_get(self, client: Pyopenwebui) -> None:
        info = client.api.v1.users.user.info.get()
        assert_matches_type(object, info, path=["response"])

    @parametrize
    def test_raw_response_get(self, client: Pyopenwebui) -> None:
        response = client.api.v1.users.user.info.with_raw_response.get()
    ...
    def test_streaming_response_get(self, client: Pyopenwebui) -> None:
        with client.api.v1.users.user.info.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncInfo:
    ...
    async def test_method_update(self, async_client: AsyncPyopenwebui) -> None:
        info = await async_client.api.v1.users.user.info.update(
            body={},
        )
        assert_matches_type(object, info, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.users.user.info.with_raw_response.update(
            body={},
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.users.user.info.with_streaming_response.update(
            body={},
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get(self, async_client: AsyncPyopenwebui) -> None:
        info = await async_client.api.v1.users.user.info.get()
        assert_matches_type(object, info, path=["response"])

    @parametrize
    async def test_raw_response_get(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.users.user.info.with_raw_response.get()
    ...
    async def test_streaming_response_get(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.users.user.info.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
