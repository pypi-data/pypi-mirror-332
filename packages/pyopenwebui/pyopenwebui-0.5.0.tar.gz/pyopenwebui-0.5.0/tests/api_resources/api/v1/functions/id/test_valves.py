...
class TestValves:
    ...
    def test_method_update(self, client: Pyopenwebui) -> None:
        valve = client.api.v1.functions.id.valves.update(
            id="id",
            body={},
        )
    ...
    def test_raw_response_update(self, client: Pyopenwebui) -> None:
        response = client.api.v1.functions.id.valves.with_raw_response.update(
            id="id",
            body={},
        )
    ...
    def test_streaming_response_update(self, client: Pyopenwebui) -> None:
        with client.api.v1.functions.id.valves.with_streaming_response.update(
            id="id",
            body={},
        ) as response:
    ...
    def test_path_params_update(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.functions.id.valves.with_raw_response.update(
                id="",
                body={},
            )
    ...
    def test_method_get(self, client: Pyopenwebui) -> None:
        valve = client.api.v1.functions.id.valves.get(
            "id",
        )
        assert_matches_type(object, valve, path=["response"])
    ...
    def test_raw_response_get(self, client: Pyopenwebui) -> None:
        response = client.api.v1.functions.id.valves.with_raw_response.get(
            "id",
        )
    ...
    def test_streaming_response_get(self, client: Pyopenwebui) -> None:
        with client.api.v1.functions.id.valves.with_streaming_response.get(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.functions.id.valves.with_raw_response.get(
                "",
            )

    @parametrize
    def test_method_get_spec(self, client: Pyopenwebui) -> None:
        valve = client.api.v1.functions.id.valves.get_spec(
            "id",
        )
        assert_matches_type(object, valve, path=["response"])
    ...
    def test_raw_response_get_spec(self, client: Pyopenwebui) -> None:
        response = client.api.v1.functions.id.valves.with_raw_response.get_spec(
            "id",
        )
    ...
    def test_streaming_response_get_spec(self, client: Pyopenwebui) -> None:
        with client.api.v1.functions.id.valves.with_streaming_response.get_spec(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get_spec(self, client: Pyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.functions.id.valves.with_raw_response.get_spec(
                "",
            )
...
class TestAsyncValves:
    ...
    async def test_method_update(self, async_client: AsyncPyopenwebui) -> None:
        valve = await async_client.api.v1.functions.id.valves.update(
            id="id",
            body={},
        )
        assert_matches_type(object, valve, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.functions.id.valves.with_raw_response.update(
            id="id",
            body={},
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.functions.id.valves.with_streaming_response.update(
            id="id",
            body={},
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.functions.id.valves.with_raw_response.update(
                id="",
                body={},
            )
    ...
    async def test_method_get(self, async_client: AsyncPyopenwebui) -> None:
        valve = await async_client.api.v1.functions.id.valves.get(
            "id",
        )
        assert_matches_type(object, valve, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.functions.id.valves.with_raw_response.get(
            "id",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.functions.id.valves.with_streaming_response.get(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.functions.id.valves.with_raw_response.get(
                "",
            )

    @parametrize
    async def test_method_get_spec(self, async_client: AsyncPyopenwebui) -> None:
        valve = await async_client.api.v1.functions.id.valves.get_spec(
            "id",
        )
        assert_matches_type(object, valve, path=["response"])
    ...
    async def test_raw_response_get_spec(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.functions.id.valves.with_raw_response.get_spec(
            "id",
        )
    ...
    async def test_streaming_response_get_spec(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.functions.id.valves.with_streaming_response.get_spec(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get_spec(self, async_client: AsyncPyopenwebui) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.functions.id.valves.with_raw_response.get_spec(
                "",
            )
