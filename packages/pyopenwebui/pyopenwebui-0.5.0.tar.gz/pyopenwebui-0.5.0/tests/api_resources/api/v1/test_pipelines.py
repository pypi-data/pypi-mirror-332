...
class TestPipelines:
    ...
    def test_streaming_response_list(self, client: Pyopenwebui) -> None:
        with client.api.v1.pipelines.with_streaming_response.list() as response:
    ...
    def test_method_delete(self, client: Pyopenwebui) -> None:
        pipeline = client.api.v1.pipelines.delete(
            id="id",
            url_idx=0,
        )
        assert_matches_type(object, pipeline, path=["response"])
    ...
    def test_raw_response_delete(self, client: Pyopenwebui) -> None:
        response = client.api.v1.pipelines.with_raw_response.delete(
            id="id",
            url_idx=0,
        )
    ...
    def test_streaming_response_delete(self, client: Pyopenwebui) -> None:
        with client.api.v1.pipelines.with_streaming_response.delete(
            id="id",
            url_idx=0,
        ) as response:
            assert not response.is_closed
    ...
    def test_method_add(self, client: Pyopenwebui) -> None:
        pipeline = client.api.v1.pipelines.add(
            url="url",
            url_idx=0,
        )
        assert_matches_type(object, pipeline, path=["response"])
    ...
    def test_raw_response_add(self, client: Pyopenwebui) -> None:
        response = client.api.v1.pipelines.with_raw_response.add(
            url="url",
            url_idx=0,
        )
    ...
    def test_streaming_response_add(self, client: Pyopenwebui) -> None:
        with client.api.v1.pipelines.with_streaming_response.add(
            url="url",
            url_idx=0,
        ) as response:
            assert not response.is_closed
    ...
    def test_method_get(self, client: Pyopenwebui) -> None:
        pipeline = client.api.v1.pipelines.get()
        assert_matches_type(object, pipeline, path=["response"])
    ...
    def test_raw_response_get(self, client: Pyopenwebui) -> None:
        response = client.api.v1.pipelines.with_raw_response.get()
    ...
    def test_streaming_response_get(self, client: Pyopenwebui) -> None:
        with client.api.v1.pipelines.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_upload(self, client: Pyopenwebui) -> None:
        pipeline = client.api.v1.pipelines.upload(
    ...
    def test_raw_response_upload(self, client: Pyopenwebui) -> None:
        response = client.api.v1.pipelines.with_raw_response.upload(
            file=b"raw file contents",
            url_idx=0,
        )
    ...
    def test_streaming_response_upload(self, client: Pyopenwebui) -> None:
        with client.api.v1.pipelines.with_streaming_response.upload(
            file=b"raw file contents",
            url_idx=0,
        ) as response:
            assert not response.is_closed
...
class TestAsyncPipelines:
    ...
    async def test_method_list(self, async_client: AsyncPyopenwebui) -> None:
        pipeline = await async_client.api.v1.pipelines.list()
        assert_matches_type(object, pipeline, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.pipelines.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.pipelines.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncPyopenwebui) -> None:
        pipeline = await async_client.api.v1.pipelines.delete(
            id="id",
            url_idx=0,
        )
        assert_matches_type(object, pipeline, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.pipelines.with_raw_response.delete(
            id="id",
            url_idx=0,
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.pipelines.with_streaming_response.delete(
            id="id",
            url_idx=0,
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_add(self, async_client: AsyncPyopenwebui) -> None:
        pipeline = await async_client.api.v1.pipelines.add(
            url="url",
            url_idx=0,
        )
        assert_matches_type(object, pipeline, path=["response"])
    ...
    async def test_raw_response_add(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.pipelines.with_raw_response.add(
            url="url",
            url_idx=0,
        )
    ...
    async def test_streaming_response_add(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.pipelines.with_streaming_response.add(
            url="url",
            url_idx=0,
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_get(self, async_client: AsyncPyopenwebui) -> None:
        pipeline = await async_client.api.v1.pipelines.get()
        assert_matches_type(object, pipeline, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.pipelines.with_raw_response.get()
    ...
    async def test_streaming_response_get(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.pipelines.with_streaming_response.get() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_upload(self, async_client: AsyncPyopenwebui) -> None:
        pipeline = await async_client.api.v1.pipelines.upload(
            file=b"raw file contents",
            url_idx=0,
        )
        assert_matches_type(object, pipeline, path=["response"])
    ...
    async def test_raw_response_upload(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.api.v1.pipelines.with_raw_response.upload(
            file=b"raw file contents",
            url_idx=0,
        )
    ...
    async def test_streaming_response_upload(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.api.v1.pipelines.with_streaming_response.upload(
            file=b"raw file contents",
            url_idx=0,
        ) as response:
            assert not response.is_closed
