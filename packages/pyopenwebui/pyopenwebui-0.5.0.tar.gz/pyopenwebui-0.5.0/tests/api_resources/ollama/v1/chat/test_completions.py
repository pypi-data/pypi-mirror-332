...
class TestCompletions:
    ...
    def test_method_generate_by_index(self, client: Pyopenwebui) -> None:
        completion = client.ollama.v1.chat.completions.generate_by_index(
            url_idx=0,
            body={},
        )
        assert_matches_type(object, completion, path=["response"])
    ...
    def test_raw_response_generate_by_index(self, client: Pyopenwebui) -> None:
        response = client.ollama.v1.chat.completions.with_raw_response.generate_by_index(
            url_idx=0,
            body={},
        )
    ...
    def test_streaming_response_generate_by_index(self, client: Pyopenwebui) -> None:
        with client.ollama.v1.chat.completions.with_streaming_response.generate_by_index(
            url_idx=0,
            body={},
        ) as response:
            assert not response.is_closed
...
class TestAsyncCompletions:
    ...
    async def test_method_generate_by_index(self, async_client: AsyncPyopenwebui) -> None:
        completion = await async_client.ollama.v1.chat.completions.generate_by_index(
            url_idx=0,
            body={},
        )
        assert_matches_type(object, completion, path=["response"])
    ...
    async def test_raw_response_generate_by_index(self, async_client: AsyncPyopenwebui) -> None:
        response = await async_client.ollama.v1.chat.completions.with_raw_response.generate_by_index(
            url_idx=0,
            body={},
        )
    ...
    async def test_streaming_response_generate_by_index(self, async_client: AsyncPyopenwebui) -> None:
        async with async_client.ollama.v1.chat.completions.with_streaming_response.generate_by_index(
            url_idx=0,
            body={},
        ) as response:
            assert not response.is_closed
