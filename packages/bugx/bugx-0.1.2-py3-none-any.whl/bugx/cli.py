...
def version_callback(value: bool) -> None:
    """Version callback"""
    if value:
        typer.echo(message=f"{CliApplication.APP_NAME} version {CliApplication.VERSION}")
        raise typer.Exit()


@app.callback(short_help="Prints the Version and Changelog.")
def cli_version(
    display_version: Annotated[
        bool, typer.Option("--version", "-v", help="Prints the Version and Changelog.")
    ] = False,
) -> None:
    if display_version:
