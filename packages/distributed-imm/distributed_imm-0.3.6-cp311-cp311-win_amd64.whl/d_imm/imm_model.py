...
class DistributedIMM:
    ...
    def predict(self, x_data: DataFrame):
        ...
        predict_udf = udf(lambda features: self._predict_subtree(self.tree, features), IntegerType())
        return x_data.withColumn("prediction", predict_udf(col("features_array")))
