...
class DatabaseInstance:
    ...
    def get_db_read(self):
        return self.get_db(force="read")

    def get_db_write(self):
        return self.get_db(force="write")
    ...
    def get_clean_db_read(self):
        return self.get_clean_db(force="read")

    def get_clean_db_write(self):
        return self.get_clean_db(force="write")
    ...
    async def async_get_db_read(self):
        return self.async_get_db(force="read")

    async def async_get_db_write(self):
        return self.async_get_db(force="write")
    ...
    async def async_get_clean_db_read(self):
        return self.async_get_clean_db(force="read")

    async def async_get_clean_db_write(self):
        return self.async_get_clean_db(force="write")
