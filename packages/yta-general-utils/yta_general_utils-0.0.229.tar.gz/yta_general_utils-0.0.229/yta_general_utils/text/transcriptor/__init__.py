...
class WebRealTimeAudioTranscriptor:
    ...
    def transcribe(
        ...
        while (
            ...
            tmp_number_of_events = self._get_number_of_results()
            """
            ...
            """
            if (
                tmp_number_of_events > number_of_events or
            ...
            if tmp_number_of_events > number_of_events:
                number_of_events = tmp_number_of_events
