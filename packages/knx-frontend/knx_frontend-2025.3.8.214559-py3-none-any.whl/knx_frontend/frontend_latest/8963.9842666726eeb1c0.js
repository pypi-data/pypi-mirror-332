      ...
      ${this.uploading?l.dy`<div class="container">
            ...
            >${this.value?"string"==typeof this.value?l.dy`<div class="row">
                    ...
                    <ha-icon-button
                      ...
                      .path=${u}
                    ></ha-icon-button>
                  </div>`:(this.value instanceof FileList?Array.from(this.value):(0,c.r)(this.value)).map((e=>l.dy`<div class="row">
                        <div class="value" @click=${this._openFilePicker}>
                          <ha-svg-icon
                            .path=${this.icon||h}
                          ></ha-svg-icon>
