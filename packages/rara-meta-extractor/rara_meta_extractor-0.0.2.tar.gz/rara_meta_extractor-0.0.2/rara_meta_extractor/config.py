...
SIMPLE_FIELDS_FILE_PATH = os.path.join("rara_meta_extractor", "data", "simple_fields.txt")
RESTRICTED_FIELDS_FILE_PATH = os.path.join("rara_meta_extractor", "data", "fields.json")
