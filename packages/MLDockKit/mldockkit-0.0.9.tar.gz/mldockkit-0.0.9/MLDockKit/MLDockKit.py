...
def visualize_dock_results(presentation='cartoon', show_iAA=True, color='grey70'):
...
def MLDockKit(smiles, output_file="MLDockKit_output.txt", presentation='cartoon', show_iAA=True, color='grey70'):
    """
    ...
    show_iAA (bool): Option to show interacting amino acids only (default: True).
    color (str): Color for the receptor and interacting residues (default: 'blue').
