...
en_stopwords = pickle.load(open(str(importlib.resources.files('megautils').joinpath('resources/en_stopwords.pkl')), "rb"))
pt_stopwords = pickle.load(open(str(importlib.resources.files('megautils').joinpath('resources/pt_stopwords.pkl')), "rb"))
...
def find_needle_in_haystack(needle: str, haystack: List[str], best_of: int = 1):
    ...
    return deduplicate_results(merged_results, top_k=best_of)
