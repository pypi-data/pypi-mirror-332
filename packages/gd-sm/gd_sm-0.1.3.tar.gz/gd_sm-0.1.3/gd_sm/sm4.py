...
def encrypt(key, plain_data, mode='ecb', iv='00' * 16):  # key/plain_data/iv可以传入16进制字符串或者bytes
...
def decrypt(key, cipher_data, mode='ecb', iv='00' * 16):  # key/cipher_data/iv可以传入16进制字符串或者bytes
