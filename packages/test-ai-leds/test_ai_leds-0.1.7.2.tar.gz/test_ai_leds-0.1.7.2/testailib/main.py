...
arguments = (
    ...
    ("--relative-path", dict(type=str, help="Caminho para arquivo a ser gerado o teste unitario"))
)
    ...
    match args.generate:
        ...
        case 'unit':
            if not args.relative_path:
                parser.error("--relative-path é obrigatório quando generate é unit")
            else:
                handle_unit(args.relative_path, args.output_path)
