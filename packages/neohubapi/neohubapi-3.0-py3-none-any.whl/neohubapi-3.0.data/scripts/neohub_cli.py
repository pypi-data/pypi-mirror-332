...
from neohubapi.neohub import NeoHub, NeoHubUsageError
...
class NeoHubCLI:
    ...
    async def callable(self):
        ...
        # See if we have the right number of command line arguments.
