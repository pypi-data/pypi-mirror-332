...
class TestAssetsExtract:
    ...
    @parametrize
    def test_method_update_status_with_all_params(self, client: Trellis) -> None:
        assets_extract = client.assets_extract.update_status(
            body={},
            api_version="2025-03",
        )
...
class TestAsyncAssetsExtract:
    ...
    @parametrize
    async def test_method_update_status_with_all_params(self, async_client: AsyncTrellis) -> None:
        assets_extract = await async_client.assets_extract.update_status(
            body={},
            api_version="2025-03",
        )
