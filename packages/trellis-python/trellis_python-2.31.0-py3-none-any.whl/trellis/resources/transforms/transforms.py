...
class TransformsResource(SyncAPIResource):
    ...
    def duplicate(
        ...
        *,
        ...
        Args:
          copy_assets: Copy the assets over from the old transformation.
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform(
                    {"copy_assets": copy_assets}, transform_duplicate_params.TransformDuplicateParams
                ),
            ),
    ...
    def wake_up(
        ...
        *,
        ...
        """This call is of fire and forget type.

        It will add the task in the background.
