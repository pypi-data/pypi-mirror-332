...
setup(
    ...
    version='0.1.1',  # Versão da sua biblioteca
    ...
    install_requires=[  # Dependências do projeto
        'numpy>=1.21.0,<2.0.0',  # Versão mínima do numpy
        'torch>=1.10.0,<2.0.0',  # Versão mínima do PyTorch
        'pandas>=1.3.0,<2.0.0',  # Versão mínima do pandas
        'scikit-learn>=1.0.0,<2.0.0',  # Versão mínima do scikit-learn
        'xgboost>=1.5.0,<2.0.0',  # Versão mínima do XGBoost
        'scikit-optimize>=0.9.0,<1.0.0',  # Versão mínima do scikit-optimize
    ],
