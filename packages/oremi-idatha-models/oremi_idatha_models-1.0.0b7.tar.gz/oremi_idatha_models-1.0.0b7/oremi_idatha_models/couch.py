...
class DocumentViewRow(Generic[DocumentViewKey, DocumentViewValue, DocumentViewDoc], BaseModel):
  id: str
  key: DocumentViewKey
...
class DocumentViewRowError(Generic[DocumentViewKey], BaseModel):
  key: DocumentViewKey
  error: str


class DocumentViewResponse(Generic[DocumentViewKey, DocumentViewValue, DocumentViewDoc], BaseModel):
  """
  View response.
