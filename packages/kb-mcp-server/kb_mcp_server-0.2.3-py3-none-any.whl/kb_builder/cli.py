...
def build_main():
    ...
    This function creates a dedicated parser for the build command,
    bypassing the subcommand structure of the main CLI.
    """
    import sys
    import argparse
...
def retrieve_main():
    ...
    This function creates a dedicated parser for the retrieve command,
    bypassing the subcommand structure of the main CLI.
    """
    import sys
    import argparse
