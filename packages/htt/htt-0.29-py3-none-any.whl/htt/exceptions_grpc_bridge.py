...
def grpc_to_status_code(grpc_code: grpc.StatusCode) -> int:
...
def status_to_grpc_code(http_code: int) -> grpc.StatusCode:
    return _status_to_grpc_mapping.get(http_code, grpc.StatusCode.UNKNOWN)
