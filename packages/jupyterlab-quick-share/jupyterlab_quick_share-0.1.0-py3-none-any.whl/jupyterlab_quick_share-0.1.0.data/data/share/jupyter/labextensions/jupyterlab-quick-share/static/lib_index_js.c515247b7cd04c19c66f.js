...
function fixJupytextIssue1344(app) {
    app.shell.layoutModified.connect(() => {
        ...
        const jupytextSectionTitle = Array.from(document.querySelectorAll('.jp-Launcher-sectionTitle'))
            .find(el => el.textContent === "Jupytext");
        // If found, find the parent section and remove it
        if (jupytextSectionTitle) {
            const jupytextSection = jupytextSectionTitle.closest('.jp-Launcher-section');
            jupytextSection === null || jupytextSection === void 0 ? void 0 : jupytextSection.remove();
        }
        (_a = document.querySelector('.jp-Launcher-section')) === null || _a === void 0 ? void 0 : _a.remove();
    });
}
...
//# sourceMappingURL=lib_index_js.c515247b7cd04c19c66f.js.map