    ...
    activate: async (app, fileBrowser, settingRegistry) => {
        ...
        app.commands.addCommand('jupyterlab-quick-share:share', {
            ...
            execute: async () => {
                ...
                try {
                    const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_3__.requestAPI)(`share?path=${encodeURIComponent(selectedFile.path)}`);
...
//# sourceMappingURL=lib_index_js.36577e5bcb5ba50fc1f5.js.map