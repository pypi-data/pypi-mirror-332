...
function findLauncherSectionWithTitle(title, els) {
    var _a;
    return (_a = Array.from(els).find(el => { var _a; return ((_a = el.textContent) === null || _a === void 0 ? void 0 : _a.trim()) === title; })) === null || _a === void 0 ? void 0 : _a.closest('.jp-Launcher-section');
}
...
//# sourceMappingURL=lib_index_js.8b6fc95d889b40707c2e.js.map