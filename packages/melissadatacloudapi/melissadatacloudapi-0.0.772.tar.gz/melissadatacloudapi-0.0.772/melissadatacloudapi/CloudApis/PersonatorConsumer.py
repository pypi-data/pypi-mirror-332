...
class PersonatorConsumer(CloudApiBase):
    ...
    def set_address_line1(self, value):
        self._set_parameter("address_line1", value)
    
    def set_address_line2(self, value):
        self._set_parameter("address_line2", value)
    ...
    def add_record(self, request):
        """
        Adds a record request to the records list.

        Args:
        - request (GlobalEmailRecordRequest): Record request to add.
        """
