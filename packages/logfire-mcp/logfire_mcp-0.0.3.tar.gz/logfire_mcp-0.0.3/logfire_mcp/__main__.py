...
def main():
    ...
    parser.add_argument("--logfire-read-token", type=str, required=True)
    parser.add_argument("--logfire-base-url", type=str, default="https://logfire-api.pydantic.dev")
    args = parser.parse_args()

    app = app_factory(args.logfire_read_token, args.logfire_base_url)
