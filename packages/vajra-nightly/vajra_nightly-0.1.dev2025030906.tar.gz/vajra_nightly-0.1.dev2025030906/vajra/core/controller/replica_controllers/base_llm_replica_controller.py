...
from vajra.utils.logging_utils import pretty_print_resource_mapping
...
class BaseLLMReplicaController(BaseReplicaController):
    ...
    def _init_workers_ray(self, **ray_remote_kwargs):
        ...
        # Create a resource mapping dictionary for pretty printing
        resource_mapping = {self.replica_id: replica_resources}
        logger.info(
            f"Starting workers on Replica {self.replica_id} with resource mapping:"
        )
