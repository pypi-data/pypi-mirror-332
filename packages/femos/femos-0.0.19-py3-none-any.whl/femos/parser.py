...
def get_evolution_summary(arguments, input_nodes, output_nodes, memory_consumption_probe=100):
    output = [str.format('# Basic summary'),
              ...
              str.format('Output nodes: {}', output_nodes),
    ...
    if isinstance(arguments.auto_stop, int):
        output.append(str.format('Auto-stop: {}', arguments.auto_stop))
...
def get_core_argument_parser():
    ...
    parser.add_argument('--genotype', metavar='G', type=str,
                        choices=[simple_genotype_choice, uncorrelated_one_step_size_genotype_choice,
                                 uncorrelated_n_step_size_genotype_choice], default='simple_genotype',
    ...
    parser.add_argument('--auto_stop', type=int)
    ...
    parser.add_argument('--population_backup_interval', type=int, default=None)
...
def handle_evolution_run(input_nodes, output_nodes, train_evaluation_strategy, test_evaluation_strategy):
    ...
    if not arguments.dry_run:
        ...
        return get_evolved_population(initial_population, phenotype_strategy, train_evaluation_strategy,
                                      ...
                                      epoch_summary_strategy, arguments.auto_stop)
