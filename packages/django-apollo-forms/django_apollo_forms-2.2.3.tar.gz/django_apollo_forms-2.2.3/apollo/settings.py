...
DEFAULTS = {
    ...
    'RECAPTCHA_SITE_KEY': None, # the site key for recaptcha v3 (only required if you want to include recaptcha in forms)
    'RECAPTCHA_SECRET_KEY': None, # the recaptcha v3 secret key (only required if you want to include recaptcha in forms)
    'DEFAULT_FORM_SUBMISSION_SERIALIZER': 'apollo.api.v1.serializers.FormSubmissionSerializer', # dotted path to the default form submission serializer
}
