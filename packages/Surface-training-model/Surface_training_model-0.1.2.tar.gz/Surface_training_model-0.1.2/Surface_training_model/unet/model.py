...
class AttU_Net(nn.Module):
    ...
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        # self.adaptive_pool = nn.AdaptiveAvgPool2d((None,3600))#添加自适应池化层
    ...
    def forward(self, x):
        ...
        # e5 = self.adaptive_pool(e5) #添加自适应池化层
        ...
        # 确保x4和d5的尺寸匹配
        if x4.size() != d5.size():
            d5 = F.interpolate(d5, size=x4.size()[2:], mode='bilinear', align_corners=True)
...
class R2AttU_Net(nn.Module):
    ...
    """
    # def __init__(self, in_ch=1, out_ch=2, t=2):
