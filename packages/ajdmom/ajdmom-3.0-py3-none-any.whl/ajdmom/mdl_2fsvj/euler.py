"""
Module for generating a trajectory of samples from mdl_2fsvj by Euler approximation
...
def r2FSVJ(v0, par, N, n_segment=10, h=1):
    """Generate a trajectory of samples from mdl_2fsvj by Euler approximation

    :param float v0: values of the initial variances :math:`(v_1(0),v_2(0)) > (0,0)`.
