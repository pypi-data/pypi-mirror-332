...
from FireBased.client.proto import CheckInResponseMessage, CheckInRequestMessage
...
class RegisterGcmRequestBody(BaseModel):
    ...
    def from_models(
            ...
            install_request_body: RegisterInstallRequestBody,
            install_request_response: FirebaseInstallationRequestResponse,
            check_in_request_body: CheckInRequestMessage,
            check_in_request_response: CheckInResponseMessage
    ):
        return cls(
            ...
            user_agent=f"Android-GCM/1.5 ({check_in_request_body.checkin.build.model})"
        )
