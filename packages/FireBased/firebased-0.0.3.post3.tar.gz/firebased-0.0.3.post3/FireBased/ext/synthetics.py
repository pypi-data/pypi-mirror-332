...
class Device(BaseModel):
    ...
    device_software_build: str
    dalvik_user_agent: str

    @classmethod
    def get_random(cls) -> 'Device':
        """Get a random device from the device list"""
        return cls(**random.choice(DEVICES))

    def generate_build_pydict(self) -> dict:
        """
        e.g.
        ...
        return {
            "fingerprint": self.generate_fake_fingerprint(),
            "hardware": random.choice(CODENAMES),
            "brand": self.device_manufacturer,
            "radio": random.choice(RADIOS),
            "client_id": f"android-{self.device_manufacturer.lower()}"
        }

    def generate_fake_fingerprint(self) -> str:
        """Create a fake fingerprint"""

        return f"{self.device_manufacturer}/{self.device_name}/{self.device_name}:${self.android_version}/{self.device_software_build}/${random.randint(123456, 654321)}:user/release-keys"
...
CODENAMES: list[str] = [
    ...
    "jellybean", "kitkat", "lollipop", "marshmallow", "nougat", "oreo", "pie", "quincetart",
    "redvelvetcake", "snowcone", "tiramisu", "upsidedowncake", "vanilla",
    "snapdragon888", "snapdragon865", "snapdragon870", "snapdragon855", "snapdragon845",
    "snapdragon778g", "snapdragon750g", "snapdragon690", "snapdragon680", "snapdragon665",
    "exynos2200", "exynos2100", "exynos990", "exynos9820", "exynos9810", "exynos8895",
    "exynos8890", "exynos7420", "exynos7885", "exynos9611", "mediatekd1200", "mediatekd1100",
    "mediatekdimensity9000", "mediatekdimensity8100", "mediatekdimensity8000",
    "mediatekdimensity920", "mediatekdimensity820", "mediatekdimensity800",
    "mediatekheliox90", "mediatekheliox70", "mediatekheliox30",
    "kirin9000", "kirin990", "kirin980", "kirin970", "kirin960", "kirin950", "kirin820",
    "kirin810", "kirin710", "kirin659", "googletensor", "googletensor2", "googletensor3",
    "qualcommqcs605", "qualcommqcm6490", "qualcommqcs410", "qualcommqcs610", "qualcommqcs405",
    "unisocsc9863a", "unisocsc9832e", "unisoctigertr610", "unisoctigertr510",
    "unisocspreadtrumsc7731e", "unisocspreadtrumsc9863a", "rockchiprk3399",
    "rockchiprk3288", "rockchiprk3326", "rockchiprk3588", "amlogics905x4",
    "amlogics922x", "amlogics905d3", "amlogics805x", "mediatekp60", "mediatekp90",
    "mediatekg90t", "mediatekg95", "mediatekp22", "mediatekp35", "mediatekp60t",
    "mediatekp70", "mediatekp100", "mediatekp200", "qualcommmsm8996",
    "qualcommmsm8953", "qualcommmsm8937", "qualcommmsm8917", "qualcommmsm8909"
]
