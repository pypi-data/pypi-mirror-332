...
class SDG_classifier_using_model:
    ...
    def __init__(self, model_name):
        ...
        if model_name == 'RoBERTa':
            ...
            self.model.load_state_dict(torch.load('./models/roberta_model', map_location=torch.device(device)),strict=False)
            ...
            self.model.load_state_dict(torch.load('./models/xlnet_model', map_location=torch.device(device)))
