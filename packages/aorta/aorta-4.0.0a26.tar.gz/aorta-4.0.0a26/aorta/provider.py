...
class Provider:
    ...
    __handlers__: dict[tuple[str, str], set[type[MessageHandler[Any]]]] = collections.defaultdict(set)
    ...
    @classmethod
    def get(cls, envelope: Envelope[Any] | MessageHeader, sewers: bool = True) -> set[type[MessageHandler[Any]]]:
