...
class ChalkClient:
    ...
    def prompt_evaluation(
        ...
        See https://docs.chalk.ai/docs/prompt-evaluations for more information.
        ...
        evaluators
            ...
            See https://docs.chalk.ai/docs/prompt-evaluations#evaluators for more information.
        meta
            Arbitrary `key:value` pairs to associate with a query.
        input
            The features for which there are known values.
    ...
    def load_features(self, branch: BranchIdParam = ...):
        ...
        --------
        >>> from chalk.client import ChalkClient
        >>> client = ChalkClient(branch='notebook)
