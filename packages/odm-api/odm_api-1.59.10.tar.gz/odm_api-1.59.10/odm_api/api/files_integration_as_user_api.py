...
class FilesIntegrationAsUserApi:
    ...
    @validate_call
    def get_files_by_study_as_user(
        self,
        ...
        _param = self._get_files_by_study_as_user_serialize(
            id=id,
    ...
    @validate_call
    def get_files_by_study_as_user_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_files_by_study_as_user_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    def _get_files_by_study_as_user_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-user/integration/link/files/by/study/{id}',
