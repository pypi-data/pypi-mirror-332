...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_url", "no_content_change_since", "pulp_last_updated", "pulp_labels", "name", "hidden", "pulp_href", "pulp_created", "content_guard", "prn", "base_path"]
