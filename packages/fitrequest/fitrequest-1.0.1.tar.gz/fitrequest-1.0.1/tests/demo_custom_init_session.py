...
class ClassFromJson(FitClass.from_json(Path(__file__).parent / 'demo.json')):
    def __init__(self, username: str | None = None, password: str | None = None):
        self.session.update(
            auth={
                'username': {'env_name': 'API_USERNAME', 'init_value': username},
...
class ClassFromYaml(FitClass.from_yaml(Path(__file__).parent / 'demo.yaml')):
    def __init__(self, username: str | None = None, password: str | None = None):
        self.session.update(
            auth={
                'username': {'env_name': 'API_USERNAME', 'init_value': username},
...
client_with_specific_args_custom_init_session = ClassWithSpecificArgs(**init_custom_auth)
