...
class Xsession:
    ...
    def execute_query(self, query, data_frame=True):
        ...
        try:
            ...
            # Always assign a unique request name
            unique_request_name = f"query_{uuid.uuid4().hex[:8]}"
            query["requestName"] = unique_request_name
            print(f"Assigned unique query name: {unique_request_name}")
            ...
            return self.get_result(unique_request_name, data_frame)
