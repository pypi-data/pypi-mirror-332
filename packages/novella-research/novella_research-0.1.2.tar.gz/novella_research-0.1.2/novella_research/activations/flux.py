    ...
    def call(self, inputs):
        if self.activation:
            if self.activation2:
                ...
                return (self.w * keras.activations.get(self.activation)(inputs)) + self.b
        elif self.activation2:
            return keras.activations.get(self.activation2)((self.w * inputs) + self.b)
        else:
