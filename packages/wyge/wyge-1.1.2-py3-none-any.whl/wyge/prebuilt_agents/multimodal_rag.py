...
class MultiModalRAG:
    def __init__(self, openai_api_key: str, vector_db_path: str = "./vector_db2"):
        ...
        self.collection = self.chroma_client.create_collection("pdf_data2")
    ...
    def extract_pdf_content(self, pdf_path: str, page_range: Tuple[int, int] = (1, 10)) -> Tuple[List, List, List]:
        ...
        return extractor.extract_text(), extractor.extract_tables(table_flavor='pdfplumber'), extractor.extract_images()
...
if __name__ == "__main__":
    ...
    # # Process a PDF
    rag.process_pdf("C:/Users/prudh/Downloads/integrated-report-consolidated.pdf", page_range=(150, 175))
