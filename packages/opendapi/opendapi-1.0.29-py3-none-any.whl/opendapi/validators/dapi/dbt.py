...
class DbtDapiValidator(DapiValidator, DBTCloudMixin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # also do not run for push events
        # HACK: envvar set at run skip condition
        always_skip = os.environ.get("ALWAYS_SKIP_DBT_SYNC") == "true"
        self._skip = (self._dbt_commit_sha != head_sha) or always_skip
        ...
        if self._skip:
            logger.info(
                ...
                extra={
                    ...
                    "always_skip_envvar": os.environ.get("ALWAYS_SKIP_DBT_SYNC")
                    == "true",
                },
            )
