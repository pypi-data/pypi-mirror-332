...
def death_by_powerpoint():
    ...
    game.game_elements.append(background)
    game.game_elements.append(fps)
    game.game_elements.append(keypresstimer)
    game.game_elements.append(frame_based_timer)
    game.game_elements.append(k1)
    game.game_elements.append(k2)
