...
def generate_preset():
    ...
    preset = {"files_to_generate": files_to_generate, "folders_to_generate": folders_to_generate}
...
def load_preset():
    ...
    with open(path, "r") as file:
        ...
        folders_to_generate = preset["folders_to_generate"]
