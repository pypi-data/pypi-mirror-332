...
def generate_pack():
    ...
    if "pack.mcmeta" in files_to_generate:
        pack_mcmeta["description"] = input("Enter the description for your pack.mcmeta file: ")
        pack_mcmeta["pack_format"] = int(input("Enter the current datapack format/version: "))
