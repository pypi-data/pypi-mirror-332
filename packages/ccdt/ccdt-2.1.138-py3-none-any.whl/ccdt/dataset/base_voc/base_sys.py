            ...
            if key == "single_object_dict":
                for rectangular_key, rectangular_value in value.items():
                    for objectRectangle_key, objectRectangle in rectangular_value.items():
                        ltx = objectRectangle[0].get("objectRectangle").get("ltX")
                        lty = objectRectangle[0].get("objectRectangle").get("ltY")
                        rbx = objectRectangle[0].get("objectRectangle").get("rbX")
                        rby = objectRectangle[0].get("objectRectangle").get("rbY")
