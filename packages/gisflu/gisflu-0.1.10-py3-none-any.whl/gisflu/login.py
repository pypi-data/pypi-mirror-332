...
def login(username: str | None = None, password: str | None = None) -> credentials:
    ...
    assert "Prove that you are not a robot" not in downloadPageText, (
        "Captcha detected, use your account in webpage normally for a while, and then try gisflu again"
    )
