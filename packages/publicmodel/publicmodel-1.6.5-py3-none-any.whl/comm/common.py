...
from comm.abnormal.error_class import FormatError, MaxAttemptsExceededError, OptionError, LoadError
...
def animation_progress_bar(text, characters, switch_interval, task_func, *args, **kwargs):
...
if __name__ == "__main__":
    weather_info = animation_progress_bar("Fetching weather data...", None, 0.25, weather)
