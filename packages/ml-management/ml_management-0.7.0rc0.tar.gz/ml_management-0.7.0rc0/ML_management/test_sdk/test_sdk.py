...
class TestSDK(unittest.TestCase):
    ...
    def test_rebuild_model_version_image(self):
        ...
        self.assertIsInstance(ML_management.sdk.model.rebuild_model_version_image(name=NAME, version=VERSION), str)
    ...
    def test_metric_history(self):
        """Test sdk.available_metrics method returns correct answer."""
        response = ML_management.sdk.job.metric_history("job_name", "metric")
    ...
    def test_get_required_classes_by_executor(self):
        ...
        required_classes = ML_management.sdk.executor.get_required_classes_by_executor(name=NAME, version=VERSION)
