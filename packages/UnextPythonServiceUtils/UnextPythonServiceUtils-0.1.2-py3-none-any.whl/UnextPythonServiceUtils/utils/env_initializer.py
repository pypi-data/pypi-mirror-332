...
class EnvStore(metaclass=SingletonMeta):
    def __init__(self) -> None:
        ...
        self._service_x_api_key_1: Optional[str] = None
        self._service_x_api_key_2: Optional[str] = None
        self._mongo_uri: Optional[str] = None
    ...
    @property
    def service_x_api_key_1(self) -> str:
        return cast(str, self._service_x_api_key_1)

    @service_x_api_key_1.setter
    def service_x_api_key_1(self, value: str) -> None:
        self._service_x_api_key_1 = value

    @property
    def service_x_api_key_2(self) -> str:
        return cast(str, self._service_x_api_key_2)

    @service_x_api_key_2.setter
    def service_x_api_key_2(self, value: str) -> None:
        self._service_x_api_key_2 = value
