...
#     def __init__(self, pretrained_path, num_classes, max_length: int = None, **kwargs):
...
class TextClassifier(TokenClassifier):
    ...
    def __init__(self, pretrained_path, backbone, classifier, max_length: int, padding=True, truncation=True, 
...
class AutoCNNTextClassifier(TextClassifier):
    ...
    def __init__(self, pretrained_path, num_classes, max_length: int = None, padding=True, truncation=True, 
