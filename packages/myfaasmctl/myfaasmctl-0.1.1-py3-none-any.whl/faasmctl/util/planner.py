...
def prepare_planner_msg(msg_type, msg_body=None):
    ...
    elif msg_type == "INITIALIZE_STATE":
        http_message.type = HttpMessage.Type.INITIALIZE_STATE
    else:
...
def initialize_state():
    ...
    planner_msg = prepare_planner_msg("INITIALIZE_STATE", MessageToJson(req, indent=None))
    response = post(url, data=planner_msg, timeout=None)
