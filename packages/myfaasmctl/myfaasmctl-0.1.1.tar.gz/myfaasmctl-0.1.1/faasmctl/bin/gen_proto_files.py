...
def gen_proto_files(clean=False):
    ...
    """
    docker cp faasm-115803-faasm-cli-1:/usr/local/code/faasm/faabric/src/planner/planner_pb2.py /pvol/runtime/faasmctl/faasmctl/util/gen_proto/planner_pb2.py
    docker cp faasm-115803-faasm-cli-1:/usr/local/code/faasm/faabric/src/proto/faabric_pb2.py /pvol/runtime/faasmctl/faasmctl/util/gen_proto/faabric_pb2.py
    """
    # Delete container
