...
def download_libtorch():
    # URL e arquivo zip
    libtorch_cpu_zip = "libtorch-cxx11-abi-shared-with-deps-2.6.0+cpu.zip"
    libtorch_cpu_url = (
        "https://download.pytorch.org/libtorch/cpu/"
        "libtorch-cxx11-abi-shared-with-deps-2.6.0%2Bcpu.zip"
    )
    ...
    if all_files_present:
        print("Todos os arquivos requeridos já estão presentes em:", lib_path)
        return
    else:
...
from .RagPUREAI_embed import *
from .RagPUREAI_libs import *

from . import RagPUREAI_chunks_clean
from . import RagPUREAI_meta
from . import RagPUREAI_extract
from . import RagPUREAI_embed
from . import RagPUREAI_libs