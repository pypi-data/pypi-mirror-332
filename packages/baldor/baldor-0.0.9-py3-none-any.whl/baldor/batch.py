...
def main():
    ...
    helper = argparse.ArgumentParser(prog="batch_solve", description="Estimating the Minimum Dominating Set with a 8-approximation ratio for all undirected graphs encoded in DIMACS format and stored in a directory.")
