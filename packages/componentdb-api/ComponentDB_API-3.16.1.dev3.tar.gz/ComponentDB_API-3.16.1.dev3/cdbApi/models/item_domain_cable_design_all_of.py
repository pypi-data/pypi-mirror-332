...
class ItemDomainCableDesignAllOf(object):
    ...
    def __init__(self, connection_list=None, assigned_item=None, catalog_item=None, technical_system_list=None, inventory_item=None, is_housed=None, alternate_name=None, local_vars_configuration=None):  # noqa: E501
