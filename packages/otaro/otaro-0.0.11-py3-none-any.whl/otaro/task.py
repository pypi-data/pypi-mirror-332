...
class Task(BaseModel):
    """
    `Task`, the basic building block in Otaro.
    ...
    def __init__(
        ...
        model: Annotated[
            str,
            Doc("LLM provider following litellm-supported identifiers"),
        ],
        inputs: Annotated[
            list[Field | str],
            Doc("List of input fields for the task"),
        ],
        outputs: Annotated[
            list[Field | str],
            Doc("List of output fields for the task"),
        ],
        desc: Annotated[
            str,
            Doc("Optional task description for more details"),
        ] = "",
        demos: Annotated[
            list[dict] | None,
            Doc(
                "Optional list of demo examples where each example is "
                "a dict with keys corresponding to union of fields in "
                "inputs and outputs"
            ),
        ] = None,
        rules: Annotated[
            list[str] | None,
            Doc("Optional list of strings representing rules"),
        ] = None,
        config_file: str | None = None,
        **kwargs,
    ):
