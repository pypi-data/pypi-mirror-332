...
import { d as defineComponent, u as useExecutionStore, c as computed, a as useSettingStore, b as useWorkflowStore, e as useTitle, o as openBlock, f as createElementBlock, g as useWorkspaceStore, w as watchEffect, h as app, r as resolveDirective, i as withDirectives, v as vShow, j as unref, k as createVNode, s as showNativeSystemMenu, l as script, m as createBaseVNode, n as normalizeStyle, _ as _export_sfc, p as onMounted, q as onBeforeUnmount, t as useSidebarTabStore, x as useBottomPanelStore, y as createBlock, z as withCtx, A as renderSlot, B as createCommentVNode, C as resolveDynamicComponent, F as Fragment, D as renderList, E as toDisplayString, G as script$5, H as markRaw, I as useI18n, J as useCommandStore, K as useCanvasStore, L as LiteGraph, M as useColorPaletteStore, N as watch, O as useNodeDefStore, P as BadgePosition, Q as LGraphBadge, R as _, S as NodeBadgeMode, T as ref, U as useEventListener, V as nextTick, W as st, X as normalizeI18nKey, Y as useChainCallback, Z as normalizeClass, $ as createBounds, a0 as LGraphCanvas, a1 as getItemsColorOption, a2 as script$7, a3 as adjustColor, a4 as isColorable, a5 as isLGraphNode, a6 as useExtensionService, a7 as isLGraphGroup, a8 as script$8, a9 as useTitleEditorStore, aa as LGraphGroup, ab as LGraphNode, ac as EditableText, ad as defineStore, ae as useNodeFrequencyStore, af as useNodeBookmarkStore, ag as highlightQuery, ah as script$a, ai as formatNumberWithSuffix, aj as NodeSourceType, ak as createTextVNode, al as script$b, am as NodePreview, an as NodeSearchFilter, ao as script$c, ap as SearchFilterChip, aq as useLitegraphService, ar as storeToRefs, as as isRef, at as toRaw, au as useUserStore, av as useDialogStore, aw as SettingDialogHeader, ax as SettingDialogContent, ay as useKeybindingStore, az as Teleport, aA as usePragmaticDraggable, aB as usePragmaticDroppable, aC as withModifiers, aD as mergeProps, aE as useWorkflowService, aF as useWorkflowBookmarkStore, aG as script$e, aH as script$f, aI as useModelToNodeStore, aJ as ComfyNodeDefImpl, aK as ComfyModelDef, aL as ComfyWorkflow, aM as te, aN as LGraph, aO as LLink, aP as DragAndScale, aQ as ContextMenu, aR as CanvasPointer, aS as isImageNode, aT as isVideoNode, aU as isAudioNode, aV as api, aW as getStorageValue, aX as useModelStore, aY as setStorageValue, aZ as LinkMarkerShape, a_ as IS_CONTROL_WIDGET, a$ as updateControlWidgetLabel, b0 as useColorPaletteService, b1 as ChangeTracker, b2 as i18n, b3 as useToast, b4 as useToastStore, b5 as useQueueSettingsStore, b6 as script$h, b7 as useQueuePendingTaskCountStore, b8 as useLocalStorage, b9 as useDraggable, ba as watchDebounced, bb as inject, bc as useElementBounding, bd as lodashExports, be as useEventBus, bf as useMenuItemStore, bg as provide, bh as isElectron, bi as electronAPI, bj as isNativeWindow, bk as useDialogService, bl as LGraphEventMode, bm as useQueueStore, bn as DEFAULT_DARK_COLOR_PALETTE, bo as DEFAULT_LIGHT_COLOR_PALETTE, bp as t, bq as useErrorHandling } from "./index-BkHJAJ1x.js";
import { s as script$1, a as script$2, b as script$3, c as script$4, d as script$6, e as script$9, f as script$d, g as script$i, h as script$j } from "./index-kodtIHFM.js";
import { s as script$g } from "./index-DZZCkK_-.js";
import { u as useKeybindingService } from "./keybindingService-DN1axCwQ.js";
import { u as useServerConfigStore } from "./serverConfigStore-C9TyKLue.js";
import "./index-BubRfZO0.js";
...
const NodeTooltip = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-f03142eb"]]);
...
const SelectionToolbox = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-7303479a"]]);
...
const usePaste = /* @__PURE__ */ __name(() => {
  const workspaceStore = useWorkspaceStore();
  const canvasStore = useCanvasStore();
  const pasteItemOnNode = /* @__PURE__ */ __name((items, node) => {
    if (!node) return;
...
//# sourceMappingURL=GraphView-A0HUOGEX.js.map
