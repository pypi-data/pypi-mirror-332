...
const _hoisted_1$n = { class: "window-actions-spacer" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", {
        ...
        withDirectives(createBaseVNode("div", _hoisted_1$n, null, 512), [
...
const _hoisted_1$m = { class: "flex flex-col h-full" };
...
const DomWidget = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["__scopeId", "data-v-f6b94b7c"]]);
  ...
  setup(__props) {
    ...
    const updateWidgets = /* @__PURE__ */ __name(() => {
      ...
      for (const widget of domWidgetStore.widgetInstances.values()) {
        ...
        widgetState.visible = lgCanvas.isNodeVisible(node) && !(widget.options.hideOnZoom && lowQuality) && widget.isVisible();
...
//# sourceMappingURL=GraphView-DcddkNu5.js.map
