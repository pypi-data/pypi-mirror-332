...
from Pairs_Package.data import fetch_data
...
print("API Secret:", ALPACA_API_SECRET)
...
def send_daily_pair_trade(stock1_ticker="MMM", stock2_ticker="HWM", allocation_multiplier=1.0):
    """
