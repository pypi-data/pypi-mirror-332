...
def prepare_wrap(strat: "StrategyTutorialUniswapSwap") -> Optional[ActionBundle]:
    """
...
def validate_wrap(strat: "StrategyTutorialUniswapSwap") -> bool:
    ...
    if wrap_executed.amount != int(strat.amount_in):
        raise ValueError(
            f"Validation failed: Expected amount {strat.amount_in}, Received: {wrap_executed.amount}"
        )
