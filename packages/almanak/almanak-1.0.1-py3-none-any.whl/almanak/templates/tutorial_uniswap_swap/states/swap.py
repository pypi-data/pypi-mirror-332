...
from src.almanak_library.constants import ETH_ADDRESS
...
def prepare_swap(strat: "StrategyTutorialUniswapSwap") -> Optional[ActionBundle]:
    """
...
def sadflow_partial_retry(strat: "StrategyTutorialUniswapSwap") -> ActionBundle:
    ...
    if strat.persistent_state.sadflow_actions and len(strat.persistent_state.sadflow_actions) > 0:
        raise ValueError(
            "Partial Retry (Swap): Sadflow Partial Retry already attempted. Halting strategy for human intervention."
        )
