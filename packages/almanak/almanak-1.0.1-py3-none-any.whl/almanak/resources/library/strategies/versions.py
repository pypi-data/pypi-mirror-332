...
class Versions(SyncAPIResource):
    def list(
        self, strategy_name: str, *, limit: int = 100, offset: int = 0, **kwargs
    ...
    def retrieve(self, strategy_name: str, version: str, **kwargs) -> ArtifactVersion:
        return self._get(
            f"/library/strategies/{strategy_name}/versions/{version}",
            options=make_request_options(**kwargs),
    ...
    def download(
        self, strategy_name: str, version: str, **kwargs
    ) -> ArtifactDownloadUrl:
        return self._get(
            f"/library/strategies/{strategy_name}/versions/{version}/url",
            options=make_request_options(**kwargs),
    ...
    def get_uris(
        ...
        return self._get(
            f"/library/strategies/{strategy_name}/versions/{version}/uri",
            options=make_request_options(**kwargs),
    ...
    def upload(
        self, strategy_name: str, version: str, files: List[str], **kwargs
    ) -> ArtifactUploadUrl:
        all_files = []
                ...
                for root, _, filenames in os.walk(file):
                    for filename in filenames:
                        ...
                        relative_path = os.path.relpath(
                            os.path.join(root, filename), file
                        )
        ...
        response = self._post(
            f"/library/strategies/{strategy_name}/versions/{version}/upload",
            body={"files": files},
            options=make_request_options(**kwargs),
            cast_to=ArtifactUploadUrl,
            unpack_by_keys=["data", "generateStrategyUploadUrls"],
        )
    ...
    def delete(self, strategy_name: str, version: str, **kwargs) -> ArtifactDeleted:
        return self._delete(
            f"/library/strategies/{strategy_name}/versions/{version}",
            options=make_request_options(**kwargs),
