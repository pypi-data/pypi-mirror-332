...
class SimpleCan:
    ...
    def sendAllMessagesFromDBCrd(self,  period_minimum = 10, period_maximum = 1000, duration=30):
        canTxMessageList = self.dbcReader.getcanTxMessageList()
        for canMessage in canTxMessageList:
    ...
    def sendCanMessage(self, messageName, duration=30, **kwargs):
