...
from libarf.controllers.airflow_controller import AirflowController
from libarf.routes.airflow_routes import setup_airflow_routes
from libarf.utils.jwt import CustomJWT
from libarf.services.api_services import CustomAPI
from libarf.routes.react_routes import setup_react_routes
from libarf.public import get_frontend_assets_path, get_offline_assets_path
from libarf.airflow.manager.stop import stop_airflow
from libarf.airflow.manager.start import start_airflow
...
def main():
    ...
    config = uvicorn.Config("libarf.main:app", host=fastapi_host, port=fastapi_port, reload=True, log_level="warning")
