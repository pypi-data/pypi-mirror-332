...
class Himawari(Preparation):
    def __init__(self,work_path=None,plotting_lat_range=[-10,50],plotting_lon_range=[90,180],time_period=['20150707'],data_path='/data/data/cloud2025/temporary_data'):
...
###
    ...
    def band7Refl(self,band07_file_list,band07_list,band13_list,sun_zenith_angle_list):
        ...
        for i in range(0,len(band07_list)):
            ...
            sun_zth_2km = self.fitting_resolution(sun_zenith_angle,'4km_sun_zth',2)
