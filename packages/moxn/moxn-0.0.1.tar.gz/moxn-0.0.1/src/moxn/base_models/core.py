...
from moxn.base_models.content import Author, PromptRole
...
class _Request(BaseModel):
    ...
    prompt_order: list[UUID] = Field(default_factory=list, alias="promptOrder")
...
class _Task(BaseModel):
    ...
    description: str
    created_at: datetime = Field(..., alias="createdAt")
    requests: Sequence[_Request] = Field(default_factory=list)
