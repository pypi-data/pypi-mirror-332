...
setup (name = 'altamus_pymavlink',
       version = __version__,
       description = 'Altamus Python MAVLink code',
       long_description = long_description,
       long_description_content_type = "text/markdown",
       url = 'https://github.com/altamusinc/altamus_pymavlink',
       ...
       license='LGPLv3',
       package_dir = { 'altamus_pymavlink' : '.' },
       package_data = { 'altamus_pymavlink.dialects.v10' : ['*.xml'],
                        'altamus_pymavlink.dialects.v20' : ['*.xml'],
                        'altamus_pymavlink.generator'    : [ '*.xsd',
                                                     'java/lib/*.*',
                                                     'java/lib/Messages/*.*',
                                                     'C/include_v1.0/*.h',
                                                     'C/include_v1.0/*.hpp',
                                                     ...
                                                     'CS/*.*',
                                                     'swift/*.swift',],
                        'altamus_pymavlink'              : ['message_definitions/v*/*.xml']
                        },
       packages = ['altamus_pymavlink',
                   'altamus_pymavlink.generator',
                   'altamus_pymavlink.dialects',
                   'altamus_pymavlink.dialects.v10',
                   'altamus_pymavlink.dialects.v10.python2',
                   'altamus_pymavlink.dialects.v20',
                   'altamus_pymavlink.dialects.v20.python2'],
