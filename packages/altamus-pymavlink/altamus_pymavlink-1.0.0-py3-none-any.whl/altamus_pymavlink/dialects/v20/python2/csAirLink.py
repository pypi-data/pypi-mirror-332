...
class MAVLink_airlink_auth_response_message(MAVLink_message):
    ...
    fieldtypes = ["uint8_t"]
    fielddisplays_by_name = {}
    fieldenums_by_name = {"resp_type": "AIRLINK_AUTH_RESPONSE_TYPE"}
    fieldunits_by_name = {}
...
class MAVLink_airlink_eye_gs_hole_push_request_message(MAVLink_message):
    ...
    fieldtypes = ["uint8_t"]
    fielddisplays_by_name = {}
    fieldenums_by_name = {"resp_type": "AIRLINK_EYE_GS_HOLE_PUSH_RESP_TYPE"}
    fieldunits_by_name = {}
    native_format = bytearray(b"<B")
    orders = [0]
    lengths = [1]
...
class MAVLink_airlink_eye_gs_hole_push_response_message(MAVLink_message):
    ...
    fielddisplays_by_name = {}
    fieldenums_by_name = {"resp_type": "AIRLINK_EYE_GS_HOLE_PUSH_RESP_TYPE", "ip_version": "AIRLINK_EYE_IP_VERSION"}
    fieldunits_by_name = {}
    ...
    def __init__(self, resp_type, ip_version, ip_address_4, ip_address_6, ip_port):
...
class MAVLink_airlink_eye_hp_message(MAVLink_message):
    ...
    fieldtypes = ["uint8_t"]
    fielddisplays_by_name = {}
    fieldenums_by_name = {"resp_type": "AIRLINK_EYE_HOLE_PUSH_TYPE"}
    fieldunits_by_name = {}
    native_format = bytearray(b"<B")
    orders = [0]
    lengths = [1]
...
class MAVLink_airlink_eye_turn_init_message(MAVLink_message):
    ...
    fieldtypes = ["uint8_t"]
    fielddisplays_by_name = {}
    fieldenums_by_name = {"resp_type": "AIRLINK_EYE_TURN_INIT_TYPE"}
    fieldunits_by_name = {}
    native_format = bytearray(b"<B")
    orders = [0]
    lengths = [1]
...
class MAVLink(object):
    ...
    def airlink_auth_encode(self, login, password):
        """
        Authorization package
    ...
    def airlink_auth_send(self, login, password, force_mavlink1=False):
        """
        Authorization package
    ...
    def airlink_auth_response_encode(self, resp_type):
        """
        Response to the authorization request
    ...
    def airlink_auth_response_send(self, resp_type, force_mavlink1=False):
        """
        Response to the authorization request
    ...
    def airlink_eye_gs_hole_push_request_encode(self, resp_type):
        """
        Request to hole punching
    ...
    def airlink_eye_gs_hole_push_request_send(self, resp_type, force_mavlink1=False):
        """
        Request to hole punching
    ...
    def airlink_eye_gs_hole_push_response_encode(self, resp_type, ip_version, ip_address_4, ip_address_6, ip_port):
        """
        Response information about the connected device
    ...
    def airlink_eye_gs_hole_push_response_send(self, resp_type, ip_version, ip_address_4, ip_address_6, ip_port, force_mavlink1=False):
        """
        Response information about the connected device
    ...
    def airlink_eye_hp_encode(self, resp_type):
        """
    ...
    def airlink_eye_hp_send(self, resp_type, force_mavlink1=False):
        """
        A package with information about the hole punching status. It is used
        for constant sending to avoid NAT closing timeout.
    ...
    def airlink_eye_turn_init_encode(self, resp_type):
        """
        Initializing the TURN protocol
    ...
    def airlink_eye_turn_init_send(self, resp_type, force_mavlink1=False):
        """
        Initializing the TURN protocol
