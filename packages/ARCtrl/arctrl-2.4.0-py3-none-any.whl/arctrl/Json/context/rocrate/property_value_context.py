...
def _arrow1419(__unit: None=None) -> IEncodable:
    ...
    class ObjectExpr1414(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1406()), ("additionalType", ObjectExpr1407()), ("alternateName", ObjectExpr1408()), ("measurementMethod", ObjectExpr1409()), ("description", ObjectExpr1410()), ("category", ObjectExpr1411()), ("categoryCode", ObjectExpr1412()), ("value", ObjectExpr1413()), ("valueCode", ObjectExpr1414()), ("unit", ObjectExpr1415()), ("unitCode", ObjectExpr1416()), ("comments", ObjectExpr1417())])
    ...
    return ObjectExpr1418()


context_jsonvalue: IEncodable = _arrow1419()
