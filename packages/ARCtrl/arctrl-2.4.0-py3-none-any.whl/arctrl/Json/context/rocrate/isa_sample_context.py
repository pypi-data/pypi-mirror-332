...
IContext_reflection = _expr1638

def _arrow1645(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1639()), ("bio", ObjectExpr1640()), ("Sample", ObjectExpr1641()), ("name", ObjectExpr1642()), ("additionalProperties", ObjectExpr1643())])
    ...
    return ObjectExpr1644()


context_jsonvalue: IEncodable = _arrow1645()
