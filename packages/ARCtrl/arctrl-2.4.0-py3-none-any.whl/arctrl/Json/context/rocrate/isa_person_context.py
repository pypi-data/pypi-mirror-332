...
IContext_reflection = _expr1557

def _arrow1572(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1558()), ("Person", ObjectExpr1559()), ("orcid", ObjectExpr1560()), ("firstName", ObjectExpr1561()), ("lastName", ObjectExpr1562()), ("midInitials", ObjectExpr1563()), ("email", ObjectExpr1564()), ("address", ObjectExpr1565()), ("phone", ObjectExpr1566()), ("fax", ObjectExpr1567()), ("comments", ObjectExpr1568()), ("roles", ObjectExpr1569()), ("affiliation", ObjectExpr1570())])
    ...
    return ObjectExpr1571()


context_jsonvalue: IEncodable = _arrow1572()

def _arrow1577(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1573()), ("Person", ObjectExpr1574()), ("name", ObjectExpr1575())])
    ...
    return ObjectExpr1576()


context_minimal_json_value: IEncodable = _arrow1577()
