...
IContext_reflection = _expr1627

def _arrow1637(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1628()), ("Publication", ObjectExpr1629()), ("pubMedID", ObjectExpr1630()), ("doi", ObjectExpr1631()), ("title", ObjectExpr1632()), ("status", ObjectExpr1633()), ("authorList", ObjectExpr1634()), ("comments", ObjectExpr1635())])
    ...
    return ObjectExpr1636()


context_jsonvalue: IEncodable = _arrow1637()
