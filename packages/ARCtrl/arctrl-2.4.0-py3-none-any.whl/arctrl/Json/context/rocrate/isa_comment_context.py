...
IContext_reflection = _expr1433

def _arrow1441(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1436()), ("Comment", ObjectExpr1437()), ("name", ObjectExpr1438()), ("value", ObjectExpr1439())])
    ...
    return ObjectExpr1440()


context_jsonvalue: IEncodable = _arrow1441()
