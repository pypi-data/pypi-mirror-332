...
IContext_reflection = _expr1473

def _arrow1485(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1474()), ("FactorValue", ObjectExpr1475()), ("additionalType", ObjectExpr1476()), ("category", ObjectExpr1477()), ("categoryName", ObjectExpr1478()), ("categoryCode", ObjectExpr1479()), ("value", ObjectExpr1480()), ("valueCode", ObjectExpr1481()), ("unit", ObjectExpr1482()), ("unitCode", ObjectExpr1483())])
    ...
    return ObjectExpr1484()


context_jsonvalue: IEncodable = _arrow1485()
