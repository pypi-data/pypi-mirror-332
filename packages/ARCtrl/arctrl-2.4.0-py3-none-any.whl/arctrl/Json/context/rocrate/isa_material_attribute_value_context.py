...
def _arrow1522(__unit: None=None) -> IEncodable:
    ...
    class ObjectExpr1518(IEncodable):
        def Encode(self, helpers_6: IEncoderHelpers_1[Any]) -> Any:
            return helpers_6.encode_string("sdo:valueReference")

    class ObjectExpr1519(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1512()), ("MaterialAttributeValue", ObjectExpr1513()), ("additionalType", ObjectExpr1514()), ("category", ObjectExpr1515()), ("categoryCode", ObjectExpr1516()), ("value", ObjectExpr1517()), ("valueCode", ObjectExpr1518()), ("unit", ObjectExpr1519()), ("unitCode", ObjectExpr1520())])
    ...
    return ObjectExpr1521()


context_jsonvalue: IEncodable = _arrow1522()
