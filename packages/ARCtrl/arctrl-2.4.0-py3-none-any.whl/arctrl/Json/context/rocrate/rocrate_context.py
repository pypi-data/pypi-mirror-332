...
def _arrow1677(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("@id", ObjectExpr1674())])
...
conforms_to_jsonvalue: IEncodable = _arrow1677()
...
def _arrow1684(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1678()), ("arc", ObjectExpr1679()), ("CreativeWork", ObjectExpr1680()), ("about", ObjectExpr1681()), ("conformsTo", ObjectExpr1682())])
