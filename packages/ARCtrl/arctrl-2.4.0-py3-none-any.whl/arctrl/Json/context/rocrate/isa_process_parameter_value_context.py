...
IContext_reflection = _expr1592

def _arrow1603(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1593()), ("additionalType", ObjectExpr1594()), ("ProcessParameterValue", ObjectExpr1595()), ("category", ObjectExpr1596()), ("categoryCode", ObjectExpr1597()), ("value", ObjectExpr1598()), ("valueCode", ObjectExpr1599()), ("unit", ObjectExpr1600()), ("unitCode", ObjectExpr1601())])
...
context_jsonvalue: IEncodable = _arrow1603()
