...
def ROCrate_encoder(oa: Material) -> IEncodable:
    ...
    def _arrow2281(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2285(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2286(value_5: MaterialType, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_5)

    def _arrow2287(oa_1: Material, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2281()), ("@type", list_1_1(singleton(ObjectExpr2282()))), ("additionalType", ObjectExpr2283()), try_include("name", _arrow2285, oa.Name), try_include("type", _arrow2286, oa.MaterialType), try_include_list_opt("characteristics", ROCrate_encoder_2, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2287, oa.DerivesFrom), ("@context", context_jsonvalue)]))
...
def _arrow2295(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2294(get: IGetters) -> Material:
            ...
            def _arrow2289(__unit: None=None) -> str | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("@id", Decode_uri)

            def _arrow2290(__unit: None=None) -> str | None:
                object_arg_3: IOptionalGetter = get.Optional
                return object_arg_3.Field("name", string)

            def _arrow2291(__unit: None=None) -> MaterialType | None:
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("type", ROCrate_decoder_1)

            def _arrow2292(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2293(__unit: None=None) -> FSharpList[Material] | None:
                arg_13: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_6: IOptionalGetter = get.Optional
                return object_arg_6.Field("derivesFrom", arg_13)

            return Material(_arrow2289(), _arrow2290(), _arrow2291(), _arrow2292(), _arrow2293())

        return object(_arrow2294)

    return decode(None)


ROCrate_decoder: Decoder_1[Material] = _arrow2295()
...
def ISAJson_encoder(id_map: Any | None, c: Material) -> IEncodable:
    def f(oa: Material, id_map: Any=id_map, c: Any=c) -> IEncodable:
        ...
        def _arrow2299(value: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2301(value_2: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2302(oa_1: MaterialAttributeValue, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_1)

        def _arrow2303(c_1: Material, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder(id_map, c_1)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2299, ROCrate_genID(oa)), try_include("name", _arrow2301, oa.Name), try_include("type", ISAJson_encoder_1, oa.MaterialType), try_include_list_opt("characteristics", _arrow2302, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2303, oa.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2305(m_1: Material, id_map: Any=id_map, c: Any=c) -> str:
            return ROCrate_genID(m_1)

        return encode(_arrow2305, f, c, id_map)
...
def _arrow2312(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2311(get: IGetters) -> Material:
            def _arrow2306(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
            ...
            def _arrow2308(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", ISAJson_decoder_1)

            def _arrow2309(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2310(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow2306(), _arrow2307(), _arrow2308(), _arrow2309(), _arrow2310())

        return Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2311)

    return decode(None)


ISAJson_decoder: Decoder_1[Material] = _arrow2312()
