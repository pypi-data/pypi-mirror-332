...
def _arrow2350(Item: Sample) -> ProcessInput:
    return ProcessInput(1, Item)


def _arrow2351(Item_1: Source) -> ProcessInput:
    return ProcessInput(0, Item_1)


def _arrow2352(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2353(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2350, ROCrate_decoder_1), map(_arrow2351, ROCrate_decoder_2), map(_arrow2352, ROCrate_decoder_3), map(_arrow2353, ROCrate_decoder_4)]))
...
def _arrow2355(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2356(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2357(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2358(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2355, ISAJson_decoder_1), map(_arrow2356, ISAJson_decoder_2), map(_arrow2357, ISAJson_decoder_3), map(_arrow2358, ISAJson_decoder_4)]))
