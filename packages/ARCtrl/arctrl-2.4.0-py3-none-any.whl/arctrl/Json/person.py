...
def encoder(person: Person) -> IEncodable:
    ...
    def _arrow2046(value: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2048(value_2: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2050(value_4: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2052(value_6: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2056(value_8: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2060(value_10: str, person: Any=person) -> IEncodable:
        class ObjectExpr2059(IEncodable):
            def Encode(self, helpers_5: IEncoderHelpers_1[Any]) -> Any:
                return helpers_5.encode_string(value_10)

        return ObjectExpr2059()

    def _arrow2065(value_12: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2067(value_14: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2070(value_16: str, person: Any=person) -> IEncodable:
    ...
    def _arrow2072(oa: OntologyAnnotation, person: Any=person) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2073(comment: Comment, person: Any=person) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("firstName", _arrow2046, person.FirstName), try_include("lastName", _arrow2048, person.LastName), try_include("midInitials", _arrow2050, person.MidInitials), try_include("orcid", _arrow2052, person.ORCID), try_include("email", _arrow2056, person.EMail), try_include("phone", _arrow2060, person.Phone), try_include("fax", _arrow2065, person.Fax), try_include("address", _arrow2067, person.Address), try_include("affiliation", _arrow2070, person.Affiliation), try_include_seq("roles", _arrow2072, person.Roles), try_include_seq("comments", _arrow2073, person.Comments)]))
...
def _arrow2091(get: IGetters) -> Person:
    ...
    def _arrow2083(__unit: None=None) -> str | None:
    ...
    def _arrow2089(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2090(__unit: None=None) -> Array[Comment] | None:
        arg_21: Decoder_1[Array[Comment]] = resize_array(decoder_1)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_21)

    return Person(_arrow2080(), _arrow2081(), _arrow2082(), _arrow2083(), _arrow2084(), _arrow2085(), _arrow2086(), _arrow2087(), _arrow2088(), _arrow2089(), _arrow2090())


decoder: Decoder_1[Person] = object(_arrow2091)
...
def ROCrate_Affiliation_encoder(affiliation: str) -> IEncodable:
    ...
    def _arrow2095(__unit: None=None, affiliation: Any=affiliation) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = of_array([("@type", ObjectExpr2093()), ("@id", _arrow2095()), ("name", ObjectExpr2096()), ("@context", context_jsonvalue)])
...
def _arrow2098(get: IGetters) -> str:
    object_arg: IRequiredGetter = get.Required
    return object_arg.Field("name", string)


ROCrate_Affiliation_decoder: Decoder_1[str] = object(_arrow2098)
...
def ROCrate_encoder(oa: Person) -> IEncodable:
    ...
    def _arrow2102(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2105(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2107(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2109(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2111(value_8: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2115(value_10: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2122(value_14: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2125(value_16: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2126(affiliation: str, oa: Any=oa) -> IEncodable:
        return ROCrate_Affiliation_encoder(affiliation)

    def _arrow2127(oa_1: OntologyAnnotation, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2128(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2102()), ("@type", ObjectExpr2103()), try_include("orcid", _arrow2105, oa.ORCID), try_include("firstName", _arrow2107, oa.FirstName), try_include("lastName", _arrow2109, oa.LastName), try_include("midInitials", _arrow2111, oa.MidInitials), try_include("email", _arrow2115, oa.EMail), try_include("phone", _arrow2119, oa.Phone), try_include("fax", _arrow2122, oa.Fax), try_include("address", _arrow2125, oa.Address), try_include("affiliation", _arrow2126, oa.Affiliation), try_include_seq("roles", _arrow2127, oa.Roles), try_include_seq("comments", _arrow2128, oa.Comments), ("@context", context_jsonvalue_1)]))
...
def _arrow2144(get: IGetters) -> Person:
    ...
    def _arrow2142(__unit: None=None) -> Array[OntologyAnnotation] | None:
        arg_19: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_ROCrate_decoderDefinedTerm)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("roles", arg_19)

    def _arrow2143(__unit: None=None) -> Array[Comment] | None:
        arg_21: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoderDisambiguatingDescription)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_21)

    return Person(_arrow2133(), _arrow2134(), _arrow2135(), _arrow2136(), _arrow2137(), _arrow2138(), _arrow2139(), _arrow2140(), _arrow2141(), _arrow2142(), _arrow2143())


ROCrate_decoder: Decoder_1[Person] = object(_arrow2144)
...
def ROCrate_encodeAuthorListString(author_list: str) -> IEncodable:
    def encode_single(name: str, author_list: Any=author_list) -> IEncodable:
        ...
        def _arrow2148(value_1: str, name: Any=name) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@type", ObjectExpr2146()), try_include("name", _arrow2148, name), ("@context", context_minimal_json_value)]))
...
def _arrow2154(get: IGetters) -> str:
    def _arrow2152(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("name", string)

    return default_arg(_arrow2152(), "")


ROCrate_decodeAuthorListString: Decoder_1[str] = map_3(ctor, array_3(object(_arrow2154)))
...
def ISAJson_encoder(id_map: Any | None, person: Person) -> IEncodable:
    def f(person_1: Person, id_map: Any=id_map, person: Any=person) -> IEncodable:
        ...
        def _arrow2159(value: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2161(value_2: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2163(value_4: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2165(value_6: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2167(value_8: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2169(value_10: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2171(value_12: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2173(value_14: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2175(value_16: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2176(oa: OntologyAnnotation, person_1: Any=person_1) -> IEncodable:
            return OntologyAnnotation_encoder(oa)

        def _arrow2177(comment: Comment, person_1: Any=person_1) -> IEncodable:
            return encoder_1(comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2159, ROCrate_genID(person_2)), try_include("firstName", _arrow2161, person_2.FirstName), try_include("lastName", _arrow2163, person_2.LastName), try_include("midInitials", _arrow2165, person_2.MidInitials), try_include("email", _arrow2167, person_2.EMail), try_include("phone", _arrow2169, person_2.Phone), try_include("fax", _arrow2171, person_2.Fax), try_include("address", _arrow2173, person_2.Address), try_include("affiliation", _arrow2175, person_2.Affiliation), try_include_seq("roles", _arrow2176, person_2.Roles), try_include_seq("comments", _arrow2177, person_2.Comments)]))
    ...
    if id_map is not None:
        def _arrow2179(p_1: Person, id_map: Any=id_map, person: Any=person) -> str:
            return ROCrate_genID(p_1)

        return encode(_arrow2179, f, person, id_map)
...
def _arrow2190(get: IGetters) -> Person:
    ...
    def _arrow2188(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return Person_setOrcidFromComments(Person(None, _arrow2180(), _arrow2181(), _arrow2182(), _arrow2183(), _arrow2184(), _arrow2185(), _arrow2186(), _arrow2187(), _arrow2188(), _arrow2189()))
