...
def _arrow305(builder: IGetters) -> FsWorkbook:
...
decode_rows: Decoder_1[FsWorkbook] = object(_arrow305)
...
def _arrow307(builder: IGetters) -> FsWorkbook:
    wb: FsWorkbook = FsWorkbook()
    ws: IEnumerable_1[FsWorksheet]
...
decode_columns: Decoder_1[FsWorkbook] = object(_arrow307)
