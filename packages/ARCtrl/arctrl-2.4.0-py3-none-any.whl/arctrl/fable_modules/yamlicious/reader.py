...
def collect_sequence_elements(eles: FSharpList[PreprocessorElement]) -> FSharpList[FSharpList[PreprocessorElement]]:
    ...
    if pattern_matching_result == 0:
        def _arrow357(__unit: None=None, eles: Any=eles) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
            def _arrow356(__unit: None=None) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
                return collect_sequence_elements(rest)

            return append(singleton(cons(PreprocessorElement(2, value_2(v["Value"])), yaml_ast_list)) if (v["Value"] is not None) else singleton(yaml_ast_list), delay(_arrow356))

        return to_list(delay(_arrow357))
        ...
        if is_empty(eles):
            ...
            if active_pattern_result_1 is not None:
                ...
                def _arrow359(__unit: None=None, eles: Any=eles) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
                    def _arrow358(__unit: None=None) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
                        return collect_sequence_elements(tail(eles))

                    return append(singleton(singleton_1(PreprocessorElement(2, value_2(v_1["Value"])))), delay(_arrow358))

                return to_list(delay(_arrow359))

            elif _007CYamlComment_007C__007C(head(eles)) is not None:
                def _arrow361(__unit: None=None, eles: Any=eles) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
                    def _arrow360(__unit: None=None) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
                        return collect_sequence_elements(tail(eles))

                    return append(singleton(singleton_1(head(eles))), delay(_arrow360))

                return to_list(delay(_arrow361))
...
def tokenize(yaml_list: FSharpList[PreprocessorElement], string_dict: Any, comment_dict: Any) -> YAMLElement:
    def loop_read(restlist_mut: FSharpList[PreprocessorElement], acc_mut: FSharpList[YAMLElement], yaml_list: Any=yaml_list, string_dict: Any=string_dict, comment_dict: Any=comment_dict) -> YAMLElement:
        while True:
            ...
            if pattern_matching_result == 0:
                def _arrow362(e: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                    return is_sequence_element(e)

                sequence_elements: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow362, rest0)))
                def _arrow363(e_1: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                    return is_sequence_element(e_1)

                restlist_mut = to_list(skip_while(_arrow363, rest0))
                def _arrow369(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                    def _arrow368(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                        def _arrow367(i: FSharpList[PreprocessorElement]) -> YAMLElement:
                            return loop_read(i, empty())

                        return map_1(_arrow367, sequence_elements)

                    return append(singleton(loop_read(cons(PreprocessorElement(2, v["Key"]), yaml_ast_list), empty())), delay(_arrow368))

                acc_mut = cons(YAMLElement(2, to_list(delay(_arrow369))), acc)
                continue
                ...
                if pattern_matching_result_1 == 0:
                    def _arrow370(e_2: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                        return is_sequence_element(e_2)

                    sequence_elements_1: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow370, rest0_1)))
                    def _arrow371(e_3: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                        return is_sequence_element(e_3)

                    restlist_mut = to_list(skip_while(_arrow371, rest0_1))
                    def _arrow377(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                        def _arrow376(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                            def _arrow375(i_1: FSharpList[PreprocessorElement]) -> YAMLElement:
                                return loop_read(i_1, empty())

                            return map_1(_arrow375, sequence_elements_1)

                        return append(singleton(loop_read(singleton_1(PreprocessorElement(2, v_1["Key"])), empty())), delay(_arrow376))

                    acc_mut = cons(YAMLElement(2, to_list(delay(_arrow377))), acc)
                    continue
                    ...
                    def _arrow378(e_4: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                        return is_sequence_element(e_4)

                    sequence_elements_2: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow378, rest0_2)))
                    def _arrow379(e_5: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                        return is_sequence_element(e_5)

                    restlist_mut = to_list(skip_while(_arrow379, rest0_2))
                    def _arrow385(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                        def _arrow384(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                            def _arrow383(i_2: FSharpList[PreprocessorElement]) -> YAMLElement:
                                return loop_read(i_2, empty())

                            return map_1(_arrow383, sequence_elements_2)

                        return append(singleton(loop_read(object_list_1, empty())), delay(_arrow384))

                    acc_mut = cons(YAMLElement(2, to_list(delay(_arrow385))), acc)
                    continue
                    ...
                    if pattern_matching_result_2 == 0:
                        def _arrow386(e_6: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                            return is_sequence_element(e_6)

                        sequence_elements_3: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow386, rest0_3)))
                        def _arrow387(e_7: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                            return is_sequence_element(e_7)

                        restlist_mut = to_list(skip_while(_arrow387, rest0_3))
                        def _arrow393(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                            def _arrow392(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                                def _arrow391(i_3: FSharpList[PreprocessorElement]) -> YAMLElement:
                                    return loop_read(i_3, empty())

                                return map_1(_arrow391, sequence_elements_3)

                            return append(singleton(loop_read(singleton_1(PreprocessorElement(2, value_2(v_3["Value"]))), empty())), delay(_arrow392))
                        ...
                        def _arrow395(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                            def _arrow394(value: str) -> YAMLElement:
                                return loop_read(singleton_1(PreprocessorElement(2, value.strip())), empty())

                            return map_1(_arrow394, split)

                        current_4: YAMLElement = YAMLElement(2, to_list(delay(_arrow395)))
                        restlist_mut = rest_4
                        ...
                        def _arrow397(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                            def _arrow396(i_4: PreprocessorElement) -> IEnumerable_1[YAMLElement]:
                            ...
                            return collect(_arrow396, i_list)

                        current_5: YAMLElement = YAMLElement(2, to_list(delay(_arrow397)))
                        restlist_mut = rest_5
                        def _arrow398(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> FSharpList[YAMLElement]:
                            c2_2: str = c2
                            return of_array_with_tail([YAMLElement(4, c2_2), current_5], acc)

                        def _arrow399(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> FSharpList[YAMLElement]:
                            c1_2: str = c1
                            return of_array_with_tail([current_5, YAMLElement(4, c1_2)], acc)

                        def _arrow400(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> FSharpList[YAMLElement]:
                            c1_1: str = c1
                            c2_1: str = c2
                            return of_array_with_tail([YAMLElement(4, c2_1), current_5, YAMLElement(4, c1_1)], acc)

                        acc_mut = (cons(current_5, acc) if (c2 is None) else _arrow398()) if (c1 is None) else (_arrow399() if (c2 is None) else _arrow400())
                        continue
                        ...
                        if pattern_matching_result_3 == 0:
                            ...
                            def _arrow402(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                                def _arrow401(value_1: str) -> IEnumerable_1[YAMLElement]:
                                ...
                                return collect(_arrow401, split_1)

                            current_6: FSharpList[YAMLElement] = reverse(to_list(delay(_arrow402)))
                            restlist_mut = rest_6
                            ...
                            def _arrow404(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                                def _arrow403(i_5: PreprocessorElement) -> IEnumerable_1[YAMLElement]:
                                ...
                                return collect(_arrow403, i_list_1)

                            current_7: YAMLElement = YAMLElement(0, YAMLContent_create_27AED5E3(opener_1["Key"], c1_3), YAMLElement(3, to_list(delay(_arrow404))))
                            restlist_mut = rest_7
                            ...
                            if pattern_matching_result_4 == 0:
                                ...
                                if pattern_matching_result_5 == 0:
                                    ...
                                    def _arrow405(e_8: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                                        return is_sequence_element(e_8)

                                    sequence_elements_4: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow405, rest0_4)))
                                    def _arrow406(e_9: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                                        return is_sequence_element(e_9)

                                    rest_9: FSharpList[PreprocessorElement] = to_list(skip_while(_arrow406, rest0_4))
                                    def _arrow409(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                                        def _arrow408(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                                            def _arrow407(i_6: FSharpList[PreprocessorElement]) -> YAMLElement:
                                                return loop_read(i_6, empty())

                                            return map_1(_arrow407, sequence_elements_4)

                                        return append(singleton(loop_read(object_list_2, empty())), delay(_arrow408))

                                    seq: YAMLElement = YAMLElement(2, to_list(delay(_arrow409)))
                                    restlist_mut = rest_9
                                    ...
                                    if pattern_matching_result_6 == 0:
                                        ...
                                        def _arrow410(e_10: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                                            return is_sequence_element(e_10)

                                        sequence_elements_5: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow410, rest0_5)))
                                        def _arrow411(e_11: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                                            return is_sequence_element(e_11)

                                        rest_10: FSharpList[PreprocessorElement] = to_list(skip_while(_arrow411, rest0_5))
                                        def _arrow414(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                                            def _arrow413(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                                                def _arrow412(i_7: FSharpList[PreprocessorElement]) -> YAMLElement:
                                                    return loop_read(i_7, empty())

                                                return map_1(_arrow412, sequence_elements_5)

                                            return append(singleton(loop_read(singleton_1(PreprocessorElement(2, value_2(w_1["Value"]))), empty())), delay(_arrow413))

                                        seq_1: YAMLElement = YAMLElement(2, to_list(delay(_arrow414)))
