...
class FactorValue(Record):
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow648(__unit: None=None) -> str:
            value_2: str = value
            return value_2

        def _arrow649(__unit: None=None) -> str:
            category_2: str = category
            return (category_2 + ":") + "No Value"

        def _arrow650(__unit: None=None) -> str:
            category_1: str = category
            value_1: str = value
            return (category_1 + ":") + value_1

        return ("" if (value is None) else _arrow648()) if (category is None) else (_arrow649() if (value is None) else _arrow650())
...
FactorValue_reflection = _expr651
...
def FactorValue__SetCategory_ZDED3A0F(this: FactorValue, c: OntologyAnnotation) -> FactorValue:
    def _arrow652(__unit: None=None, this: Any=this, c: Any=c) -> Factor | None:
    ...
    return FactorValue(this.ID, _arrow652(), this.Value, this.Unit)
