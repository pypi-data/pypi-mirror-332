...
class ProcessParameterValue(Record):
    ...
    def SetCategory(self, c: OntologyAnnotation) -> ProcessParameterValue:
        this: ProcessParameterValue = self
        def _arrow671(__unit: None=None) -> ProtocolParameter | None:
        ...
        return ProcessParameterValue(_arrow671(), this.Value, this.Unit)
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow674(__unit: None=None) -> str:
            category_1: str = category
            value_1: str = value
            return (category_1 + ":") + value_1

        return ("" if (value is None) else _arrow672()) if (category is None) else (_arrow673() if (value is None) else _arrow674())
...
ProcessParameterValue_reflection = _expr675
