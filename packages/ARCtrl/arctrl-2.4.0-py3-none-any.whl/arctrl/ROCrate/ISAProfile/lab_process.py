...
def _expr1391() -> TypeInfo:
    return class_type("ARCtrl.ROCrate.LabProcess", None, LabProcess, LDObject_reflection())


class LabProcess(LDObject):
    ...
    def get_name() -> Callable[[LabProcess], str]:
        def _arrow1387(lp: LabProcess) -> str:
            return lp.GetName()
    ...
    def get_agent() -> Callable[[LabProcess], str]:
        def _arrow1388(lp: LabProcess) -> str:
            return lp.GetAgent()
    ...
    def get_object() -> Callable[[LabProcess], str]:
        def _arrow1389(lp: LabProcess) -> str:
            return lp.GetObject()
    ...
    def get_result() -> Callable[[LabProcess], str]:
        def _arrow1390(lp: LabProcess) -> str:
            return lp.GetResult()

        return _arrow1390


LabProcess_reflection = _expr1391
