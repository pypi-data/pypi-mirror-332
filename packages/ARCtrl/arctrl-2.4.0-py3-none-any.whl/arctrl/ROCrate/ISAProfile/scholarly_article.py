...
def _expr1404() -> TypeInfo:
    return class_type("ARCtrl.ROCrate.ScholarlyArticle", None, ScholarlyArticle, LDObject_reflection())


class ScholarlyArticle(LDObject):
    ...
    def get_headline() -> Callable[[ScholarlyArticle], str]:
        def _arrow1402(s: ScholarlyArticle) -> str:
    ...
    def get_identifier() -> Callable[[ScholarlyArticle], str]:
        def _arrow1403(s: ScholarlyArticle) -> str:
            return s.GetIdentifier()

        return _arrow1403


ScholarlyArticle_reflection = _expr1404
