...
def encode(encoder: Callable[[Any, Any, Any, _A], IEncodable], obj: Any) -> IEncodable:
    ...
    oa_table: Any = Dictionary([], ObjectExpr3172())
    class ObjectExpr3173:
        @property
    ...
    cell_table: Any = Dictionary([], ObjectExpr3173())
    ...
    class ObjectExpr3174(IEncodable):
...
def decode(decoder: Callable[[Array[str], Array[OntologyAnnotation], Array[CompositeCell]], __A]) -> Decoder_1[Any]:
    def _arrow3176(get: IGetters, decoder: Any=decoder) -> __B:
        ...
        def _arrow3175(__unit: None=None) -> Array[CompositeCell]:
