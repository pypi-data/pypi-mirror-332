...
def int_1(value: YAMLElement) -> int:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: int = 0
        def _arrow418(__unit: None=None, value: Any=value) -> int:
            return out_arg

        def _arrow419(v_1: int, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1 or 0

        match_value = (try_parse(v.Value, 511, False, 32, FSharpRef(_arrow418, _arrow419)), out_arg)
        if match_value[0]:
...
def float_1(value: YAMLElement) -> float:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: float = 0.0
        def _arrow420(__unit: None=None, value: Any=value) -> float:
            return out_arg

        def _arrow421(v_1: float, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_1(v.Value, FSharpRef(_arrow420, _arrow421)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def bool_1(value: YAMLElement) -> bool:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: bool = False
        def _arrow422(__unit: None=None, value: Any=value) -> bool:
            return out_arg

        def _arrow423(v_1: bool, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_2(v.Value, FSharpRef(_arrow422, _arrow423)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def map(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return of_list(map_1(mapping, value.fields[0]), ObjectExpr424())
...
def dict_1(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return Dictionary(of_seq(map_1(mapping, value.fields[0]), ObjectExpr425()), ObjectExpr426())
...
def datetime(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow427(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow428(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_3(v.Value, FSharpRef(_arrow427, _arrow428)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def datetime_offset(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow430(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow431(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_4(v.Value, FSharpRef(_arrow430, _arrow431)), out_arg)
        if match_value[0]:
            return match_value[1]
...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow461(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr460(IRequiredGetter):
        ...
        self.required: IRequiredGetter = _arrow461()
        def _arrow463(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr462(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow463()
        def _arrow465(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr464(IMultipleOptionalGetter):
        ...
        self.multiple_optional: IMultipleOptionalGetter = _arrow465()
        def _arrow467(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr466(IOverflowGetter):
            ...
            return ObjectExpr466()

        self.overflow: IOverflowGetter = _arrow467()
