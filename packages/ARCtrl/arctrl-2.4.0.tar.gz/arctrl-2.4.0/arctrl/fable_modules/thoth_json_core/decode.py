...
string: Decoder_1[str] = ObjectExpr56()
...
char: Decoder_1[str] = ObjectExpr58()

class ObjectExpr61(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, str]
            out_arg: str = "00000000-0000-0000-0000-000000000000"
            def _arrow59(__unit: None=None) -> str:
                return out_arg

            def _arrow60(v: str) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_1(helpers.as_string(value_1), FSharpRef(_arrow59, _arrow60)), out_arg)
...
guid: Decoder_1[str] = ObjectExpr61()

class ObjectExpr62(Decoder_1[None]):
...
unit: Decoder_1[None] = ObjectExpr62()

class ObjectExpr65(Decoder_1[int8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow63(__unit: None=None) -> int8:
                return out_arg

            def _arrow64(v: int8) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 8, FSharpRef(_arrow63, _arrow64)), out_arg)
...
sbyte: Decoder_1[int8] = ObjectExpr65()

class ObjectExpr68(Decoder_1[uint8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow66(__unit: None=None) -> uint8:
                return out_arg

            def _arrow67(v: uint8) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 8, FSharpRef(_arrow66, _arrow67)), out_arg)
...
byte: Decoder_1[uint8] = ObjectExpr68()

class ObjectExpr71(Decoder_1[int16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow69(__unit: None=None) -> int16_1:
                return out_arg

            def _arrow70(v: int16_1) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 16, FSharpRef(_arrow69, _arrow70)), out_arg)
...
int16: Decoder_1[int16_1] = ObjectExpr71()

class ObjectExpr74(Decoder_1[uint16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow72(__unit: None=None) -> uint16_1:
                return out_arg

            def _arrow73(v: uint16_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 16, FSharpRef(_arrow72, _arrow73)), out_arg)
...
uint16: Decoder_1[uint16_1] = ObjectExpr74()

class ObjectExpr77(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            out_arg: int = 0
            def _arrow75(__unit: None=None) -> int:
                return out_arg

            def _arrow76(v: int) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 32, FSharpRef(_arrow75, _arrow76)), out_arg)
...
int_1: Decoder_1[int] = ObjectExpr77()

class ObjectExpr80(Decoder_1[uint32_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint32_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow78(__unit: None=None) -> uint32_1:
                return out_arg

            def _arrow79(v: uint32_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 32, FSharpRef(_arrow78, _arrow79)), out_arg)
...
uint32: Decoder_1[uint32_1] = ObjectExpr80()

class ObjectExpr83(Decoder_1[int64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow81(__unit: None=None) -> int64_1:
                return out_arg

            def _arrow82(v: int64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, False, 64, FSharpRef(_arrow81, _arrow82)), out_arg)
...
int64: Decoder_1[int64_1] = ObjectExpr83()

class ObjectExpr86(Decoder_1[uint64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow84(__unit: None=None) -> uint64_1:
                return out_arg

            def _arrow85(v: uint64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, True, 64, FSharpRef(_arrow84, _arrow85)), out_arg)
...
uint64: Decoder_1[uint64_1] = ObjectExpr86()

class ObjectExpr89(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            def _arrow87(__unit: None=None) -> int:
                return out_arg

            def _arrow88(v: int) -> None:
                nonlocal out_arg
                out_arg = v

            parse_result = (try_parse_4(helpers.as_string(value_1), FSharpRef(_arrow87, _arrow88)), out_arg)
...
bigint: Decoder_1[int] = ObjectExpr89()

class ObjectExpr90(Decoder_1[bool]):
...
bool_1: Decoder_1[bool] = ObjectExpr90()

class ObjectExpr91(Decoder_1[float]):
...
float_1: Decoder_1[float] = ObjectExpr91()

class ObjectExpr92(Decoder_1[float32_1]):
...
float32: Decoder_1[float32_1] = ObjectExpr92()

class ObjectExpr95(Decoder_1[Decimal]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Decimal, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            def _arrow93(__unit: None=None) -> Decimal:
                return out_arg

            def _arrow94(v: Decimal) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_5(helpers.as_string(value_1), FSharpRef(_arrow93, _arrow94)), out_arg)
...
decimal: Decoder_1[Decimal] = ObjectExpr95()

class ObjectExpr98(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            ...
            def _arrow96(__unit: None=None) -> Any:
                return out_arg

            def _arrow97(v: Any) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_6(helpers.as_string(value_1), FSharpRef(_arrow96, _arrow97)), out_arg)
...
datetime_local: Decoder_1[Any] = ObjectExpr98()

class ObjectExpr101(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, Any]
            out_arg: Any = create(0)
            def _arrow99(__unit: None=None) -> Any:
                return out_arg

            def _arrow100(v: Any) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_7(helpers.as_string(value_1), FSharpRef(_arrow99, _arrow100)), out_arg)
...
timespan: Decoder_1[Any] = ObjectExpr101()
...
def decode_maybe_null(helpers: IDecoderHelpers_1[Any], path: str, decoder: Decoder_1[Any], value_1: Any) -> FSharpResult_2[Any | None, tuple[str, ErrorReason_1[_JSONVALUE]]]:
    if helpers.is_null_value(value_1):
        ...
        if match_value.tag == 1:
            def _arrow102(__unit: None=None, helpers: Any=helpers, path: Any=path, decoder: Any=decoder, value_1: Any=value_1) -> tuple[str, ErrorReason_1[_JSONVALUE]]:
            ...
            return FSharpResult_2(1, _arrow102())
...
def optional_at(field_names: FSharpList[str], decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr105(Decoder_1[_VALUE_ | None]):
...
def at(field_names: FSharpList[str], decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr107(Decoder_1[_VALUE_]):
...
def index(requested_index: int, decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr108(Decoder_1[_VALUE_]):
...
def option(decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr109(Decoder_1[_VALUE_ | None]):
...
def list_1(decoder: Decoder_1[Any]) -> Decoder_1[FSharpList[Any]]:
    class ObjectExpr111(Decoder_1[FSharpList[_VALUE_]]):
            ...
            if helpers.is_array(value_1):
                ...
                while (error is None) if (i < len(tokens)) else False:
                    ...
                    if match_value.tag == 1:
                        ...
                        x: tuple[str, ErrorReason_1[__A_]] | None = _arrow110()
                        error = x
...
def resize_array(decoder: Decoder_1[Any]) -> Decoder_1[Array[Any]]:
    class ObjectExpr113(Decoder_1[Array[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                ...
                while (error is None) if (i < len(tokens)) else False:
                    ...
                    match_value: FSharpResult_2[_VALUE_, tuple[str, ErrorReason_1[__A_]]] = decoder.Decode(helpers, value_2)
                    if match_value.tag == 1:
                        def _arrow112(__unit: None=None) -> tuple[str, ErrorReason_1[__A_]]:
                            tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                            return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])
...
def seq(decoder: Decoder_1[Any]) -> Decoder_1[IEnumerable_1[Any]]:
    class ObjectExpr115(Decoder_1[IEnumerable_1[_VALUE_]]):
...
def array(decoder: Decoder_1[Any]) -> Decoder_1[Array[Any]]:
    class ObjectExpr117(Decoder_1[Array[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                i: int = -1
                tokens: Array[__A_] = helpers.as_array(value_1)
                def folder(acc: FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow116(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                                return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])

                            return FSharpResult_2(1, _arrow116())
...
class ObjectExpr118(Decoder_1[FSharpList[str]]):
...
keys: Decoder_1[FSharpList[str]] = ObjectExpr118()

def key_value_pairs(decoder: Decoder_1[Any]) -> Decoder_1[FSharpList[tuple[str, _VALUE]]]:
    class ObjectExpr119(Decoder_1[FSharpList[tuple[str, _VALUE_]]]):
...
def one_of(decoders: FSharpList[Decoder_1[Any]]) -> Decoder_1[Any]:
    class ObjectExpr120(Decoder_1[_VALUE_]):
...
def succeed(output: Any | None=None) -> Decoder_1[Any]:
    class ObjectExpr122(Decoder_1[_A_]):
...
def fail(msg: str) -> Decoder_1[Any]:
    class ObjectExpr123(Decoder_1[_A_]):
...
def and_then(cb: Callable[[_A], Decoder_1[_B]], decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr124(Decoder_1[_B_]):
...
def all(decoders: FSharpList[Decoder_1[Any]]) -> Decoder_1[FSharpList[Any]]:
    class ObjectExpr125(Decoder_1[FSharpList[_A_]]):
...
def map7(ctor: Callable[[_A, _B, _C, _D, _E, _F, _G], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any], d7: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr131(Decoder_1[_OUTPUT_]):
...
def map8(ctor: Callable[[_A, _B, _C, _D, _E, _F, _G, _H], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any], d7: Decoder_1[Any], d8: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr132(Decoder_1[_OUTPUT_]):
...
def and_map(__unit: None=None) -> Callable[[Decoder_1[_A], Decoder_1[Callable[[_A], _B]]], Decoder_1[_B]]:
    def _arrow134(d: Decoder_1[_A]) -> Callable[[Decoder_1[Callable[[_A], _B]]], Decoder_1[_B]]:
        def _arrow133(d_1: Decoder_1[Callable[[_A], _B]]) -> Decoder_1[_B]:
...
def _expr139(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
class Getters_2(Generic[_JSONVALUE, _T]):
    def __init__(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> None:
        ...
        def _arrow136(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr135(IRequiredGetter):
        ...
        self.required: IRequiredGetter = _arrow136()
        def _arrow138(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr137(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow138()
...
def object(builder: Callable[[IGetters], _VALUE]) -> Decoder_1[Any]:
    class ObjectExpr140(Decoder_1[_VALUE_]):
...
def dict_1(decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    def _arrow142(elements: FSharpList[tuple[str, _VALUE]], decoder: Any=decoder) -> Any:
        class ObjectExpr141:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        return of_list(elements, ObjectExpr141())

    return map(_arrow142, key_value_pairs(decoder))


def map_0027(key_decoder: Decoder_1[Any], value_decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    def _arrow144(elements: Array[tuple[_KEY, _VALUE]], key_decoder: Any=key_decoder, value_decoder: Any=value_decoder) -> Any:
        class ObjectExpr143:
            @property
            def Compare(self) -> Callable[[_KEY_, _KEY_], int]:
                return compare

        return of_seq_1(elements, ObjectExpr143())

    return map(_arrow144, array(tuple2(key_decoder, value_decoder)))
