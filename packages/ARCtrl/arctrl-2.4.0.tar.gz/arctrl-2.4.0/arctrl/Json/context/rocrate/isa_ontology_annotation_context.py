...
IContext_reflection = _expr1532

def _arrow1540(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1533()), ("OntologyAnnotation", ObjectExpr1534()), ("annotationValue", ObjectExpr1535()), ("termSource", ObjectExpr1536()), ("termAccession", ObjectExpr1537()), ("comments", ObjectExpr1538())])
    ...
    return ObjectExpr1539()


context_jsonvalue: IEncodable = _arrow1540()
