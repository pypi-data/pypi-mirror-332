...
IContext_reflection = _expr1523

def _arrow1531(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1524()), ("bio", ObjectExpr1525()), ("Material", ObjectExpr1526()), ("type", ObjectExpr1527()), ("name", ObjectExpr1528()), ("characteristics", ObjectExpr1529())])
    ...
    return ObjectExpr1530()


context_jsonvalue: IEncodable = _arrow1531()
