...
IContext_reflection = _expr1541

def _arrow1550(__unit: None=None) -> IEncodable:
    ...
    class ObjectExpr1548(IEncodable):
        def Encode(self, helpers_6: IEncoderHelpers_1[Any]) -> Any:
            return helpers_6.encode_string("sdo:disambiguatingDescription")

    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1542()), ("OntologySourceReference", ObjectExpr1543()), ("description", ObjectExpr1544()), ("name", ObjectExpr1545()), ("file", ObjectExpr1546()), ("version", ObjectExpr1547()), ("comments", ObjectExpr1548())])
    ...
    return ObjectExpr1549()


context_jsonvalue: IEncodable = _arrow1550()
