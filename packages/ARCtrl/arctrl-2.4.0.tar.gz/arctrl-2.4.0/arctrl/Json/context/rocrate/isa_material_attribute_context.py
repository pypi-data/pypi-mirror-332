...
def _arrow1510(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1504()), ("arc", ObjectExpr1505()), ("MaterialAttribute", ObjectExpr1506()), ("ArcMaterialAttribute", ObjectExpr1507()), ("characteristicType", ObjectExpr1508())])
