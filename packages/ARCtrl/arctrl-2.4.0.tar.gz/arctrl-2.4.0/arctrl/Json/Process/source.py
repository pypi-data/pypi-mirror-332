...
def ROCrate_encoder(oa: Source) -> IEncodable:
    ...
    def _arrow2316(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2320(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2316()), ("@type", list_1_1(singleton(ObjectExpr2317()))), ("additionalType", ObjectExpr2318()), try_include("name", _arrow2320, oa.Name), try_include_list_opt("characteristics", ROCrate_encoder_1, oa.Characteristics), ("@context", context_jsonvalue)]))
...
def _arrow2325(get: IGetters) -> Source:
    ...
    def _arrow2324(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2322(), _arrow2323(), _arrow2324())


ROCrate_decoder: Decoder_1[Source] = object(_arrow2325)
...
def ISAJson_encoder(id_map: Any | None, oa: Source) -> IEncodable:
    def f(oa_1: Source, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2329(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2331(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2332(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2329, ROCrate_genID(oa_1)), try_include("name", _arrow2331, oa_1.Name), try_include_list_opt("characteristics", _arrow2332, oa_1.Characteristics)]))
    ...
    if id_map is not None:
        def _arrow2334(s_1: Source, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2334, f, oa, id_map)
...
def _arrow2338(get: IGetters) -> Source:
    ...
    def _arrow2337(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2335(), _arrow2336(), _arrow2337())


ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2338)
