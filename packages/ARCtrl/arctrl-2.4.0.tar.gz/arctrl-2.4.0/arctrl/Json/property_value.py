...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr1810(), None)
            ...
            pattern_input_1 = (ObjectExpr1811(), None)

        elif v.tag == 0:
            oa_1: OntologyAnnotation = v.fields[0]
            def _arrow1813(value_3: str, pv: Any=pv) -> IEncodable:
            ...
            def _arrow1816(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow1813, oa_1.Name), map(_arrow1816, oa_1.TermAccessionNumber))
            ...
            pattern_input_1 = (ObjectExpr1818(), None)
    ...
    def _arrow1827(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1829(value_11: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1831(value_13: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1833(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1835(value_17: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1837(value_19: str, pv: Any=pv) -> IEncodable:
        ...
        return ObjectExpr1836()

    def _arrow1838(x: IEncodable, pv: Any=pv) -> IEncodable:
        return x

    def _arrow1839(x_1: IEncodable, pv: Any=pv) -> IEncodable:
        return x_1

    def _arrow1841(value_21: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1843(value_23: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1823()), ("@type", ObjectExpr1825()), ("additionalType", _arrow1827()), try_include("alternateName", _arrow1829, pv.AlternateName()), try_include("measurementMethod", _arrow1831, pv.MeasurementMethod()), try_include("description", _arrow1833, pv.Description()), try_include("category", _arrow1835, pattern_input[0]), try_include("categoryCode", _arrow1837, pattern_input[1]), try_include("value", _arrow1838, pattern_input_1[0]), try_include("valueCode", _arrow1839, pattern_input_1[1]), try_include("unit", _arrow1841, pattern_input_2[0]), try_include("unitCode", _arrow1843, pattern_input_2[1]), ("@context", context_jsonvalue)]))
...
def decoder(create: Callable[[str | None, str | None, str | None, OntologyAnnotation | None, Value_4 | None, OntologyAnnotation | None], _T]) -> Decoder_1[Any]:
    def _arrow1846(get: IGetters, create: Any=create) -> _T:
        ...
        def _arrow1845(__unit: None=None) -> Value_4 | None:
            value: str | None
        ...
        return create(alternate_name, measurement_method, description, category, _arrow1845(), unit)
