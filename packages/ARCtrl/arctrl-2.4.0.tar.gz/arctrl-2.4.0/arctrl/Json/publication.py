...
def encoder(oa: Publication) -> IEncodable:
    ...
    def _arrow1977(value: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1979(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1981(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1983(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1984(oa_1: OntologyAnnotation, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow1985(comment: Comment, oa: Any=oa) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("pubMedID", _arrow1977, oa.PubMedID), try_include("doi", _arrow1979, oa.DOI), try_include("authorList", _arrow1981, oa.Authors), try_include("title", _arrow1983, oa.Title), try_include("status", _arrow1984, oa.Status), try_include_seq("comments", _arrow1985, oa.Comments)]))
...
def _arrow1993(get: IGetters) -> Publication:
    ...
    def _arrow1991(__unit: None=None) -> OntologyAnnotation | None:
    ...
    return Publication(_arrow1987(), _arrow1988(), _arrow1989(), _arrow1990(), _arrow1991(), _arrow1992())


decoder: Decoder_1[Publication] = object(_arrow1993)
...
def ROCrate_encoder(oa: Publication) -> IEncodable:
    ...
    def _arrow2003(author_list: str, oa: Any=oa) -> IEncodable:
        return ROCrate_encodeAuthorListString(author_list)

    def _arrow2007(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2008(oa_1: OntologyAnnotation, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2011(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1997()), ("@type", ObjectExpr1998()), try_include("pubMedID", _arrow2000, oa.PubMedID), try_include("doi", _arrow2002, oa.DOI), try_include("authorList", _arrow2003, oa.Authors), try_include("title", _arrow2007, oa.Title), try_include("status", _arrow2008, oa.Status), try_include_seq("comments", _arrow2011, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2027(get: IGetters) -> Publication:
    ...
    def _arrow2025(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("status", OntologyAnnotation_ROCrate_decoderDefinedTerm)

    def _arrow2026(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoderDisambiguatingDescription)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Publication(_arrow2019(), _arrow2020(), _arrow2021(), _arrow2023(), _arrow2025(), _arrow2026())


ROCrate_decoder: Decoder_1[Publication] = object(_arrow2027)
...
def ISAJson_encoder(id_map: Any | None, oa: Publication) -> IEncodable:
    ...
    def _arrow2033(value: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2035(value_2: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2037(value_4: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2039(value_6: str, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2040(oa_1: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2041(comment: Comment, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        return ISAJson_encoder_1(id_map, comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("pubMedID", _arrow2033, oa.PubMedID), try_include("doi", _arrow2035, oa.DOI), try_include("authorList", _arrow2037, oa.Authors), try_include("title", _arrow2039, oa.Title), try_include("status", _arrow2040, oa.Status), try_include_seq("comments", _arrow2041, oa.Comments)]))
