...
def encoder(osr: OntologySourceReference) -> IEncodable:
    ...
    def _arrow1850(value: str, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1852(value_2: str, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1854(value_4: str, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1856(value_6: str, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1857(comment: Comment, osr: Any=osr) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("description", _arrow1850, osr.Description), try_include("file", _arrow1852, osr.File), try_include("name", _arrow1854, osr.Name), try_include("version", _arrow1856, osr.Version), try_include_seq("comments", _arrow1857, osr.Comments)]))
...
def _arrow1864(get: IGetters) -> OntologySourceReference:
    ...
    def _arrow1863(__unit: None=None) -> Array[Comment] | None:
        arg_9: Decoder_1[Array[Comment]] = Decode_resizeArray(decoder_1)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("comments", arg_9)

    return OntologySourceReference(_arrow1859(), _arrow1860(), _arrow1861(), _arrow1862(), _arrow1863())


decoder: Decoder_1[OntologySourceReference] = object(_arrow1864)
...
def ROCrate_encoder(osr: OntologySourceReference) -> IEncodable:
    ...
    def _arrow1868(__unit: None=None, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1871(value_2: str, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1873(value_4: str, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1875(value_6: str, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1877(value_8: str, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1878(comment: Comment, osr: Any=osr) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1868()), ("@type", ObjectExpr1869()), try_include("description", _arrow1871, osr.Description), try_include("file", _arrow1873, osr.File), try_include("name", _arrow1875, osr.Name), try_include("version", _arrow1877, osr.Version), try_include_seq("comments", _arrow1878, osr.Comments), ("@context", context_jsonvalue)]))
...
def _arrow1885(get: IGetters) -> OntologySourceReference:
    ...
    def _arrow1883(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("version", string)

    def _arrow1884(__unit: None=None) -> Array[Comment] | None:
        arg_9: Decoder_1[Array[Comment]] = Decode_resizeArray(decoder_1)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("comments", arg_9)

    return OntologySourceReference(_arrow1880(), _arrow1881(), _arrow1882(), _arrow1883(), _arrow1884())


ROCrate_decoder: Decoder_1[OntologySourceReference] = object(_arrow1885)
...
def ISAJson_encoder(id_map: Any | None, osr: OntologySourceReference) -> IEncodable:
    ...
    def _arrow1889(value: str, id_map: Any=id_map, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1891(value_2: str, id_map: Any=id_map, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1893(value_4: str, id_map: Any=id_map, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1895(value_6: str, id_map: Any=id_map, osr: Any=osr) -> IEncodable:
    ...
    def _arrow1896(comment: Comment, id_map: Any=id_map, osr: Any=osr) -> IEncodable:
        return ISAJson_encoder_1(id_map, comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("description", _arrow1889, osr.Description), try_include("file", _arrow1891, osr.File), try_include("name", _arrow1893, osr.Name), try_include("version", _arrow1895, osr.Version), try_include_seq("comments", _arrow1896, osr.Comments)]))
