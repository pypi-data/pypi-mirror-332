...
def _expr1394() -> TypeInfo:
    return class_type("ARCtrl.ROCrate.Sample", None, Sample, LDObject_reflection())


class Sample(LDObject):
    ...
    def get_name() -> Callable[[Sample], str]:
        def _arrow1393(s: Sample) -> str:
            return s.GetName()

        return _arrow1393


Sample_reflection = _expr1394
