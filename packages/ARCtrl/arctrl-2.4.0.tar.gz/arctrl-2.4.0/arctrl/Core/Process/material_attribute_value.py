...
class MaterialAttributeValue(Record):
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow655(__unit: None=None) -> str:
            value_2: str = value
            return value_2
        ...
        return ("" if (value is None) else _arrow655()) if (category is None) else (_arrow656() if (value is None) else _arrow657())
...
MaterialAttributeValue_reflection = _expr658
...
def MaterialAttributeValue__SetCategory_ZDED3A0F(this: MaterialAttributeValue, c: OntologyAnnotation) -> MaterialAttributeValue:
    def _arrow659(__unit: None=None, this: Any=this, c: Any=c) -> MaterialAttribute | None:
    ...
    return MaterialAttributeValue(this.ID, _arrow659(), this.Value, this.Unit)
