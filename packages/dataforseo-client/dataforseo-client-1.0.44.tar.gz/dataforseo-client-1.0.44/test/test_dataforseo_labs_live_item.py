...
class TestDataforseoLabsLiveItem(unittest.TestCase):
    """DataforseoLabsLiveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsLiveItem:
        """Test DataforseoLabsLiveItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsLiveItem`
        """
        model = DataforseoLabsLiveItem()
        if include_optional:
            return DataforseoLabsLiveItem(
                se_type = '',
    ...
    def testDataforseoLabsLiveItem(self):
        """Test DataforseoLabsLiveItem"""
