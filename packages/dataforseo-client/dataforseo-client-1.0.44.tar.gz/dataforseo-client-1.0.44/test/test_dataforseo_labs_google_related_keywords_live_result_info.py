    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleRelatedKeywordsLiveResultInfo:
        ...
        if include_optional:
            return DataforseoLabsGoogleRelatedKeywordsLiveResultInfo(
                se_type = '',
                seed_keyword = '',
                seed_keyword_data = dataforseo_client.models.keyword_data_info.KeywordDataInfo(
                    se_type = '', 
                    keyword = '', 
                    location_code = 56, 
                    language_code = '', 
                ...
                items_count = 56,
                items = [
                    dataforseo_client.models.dataforseo_labs_related_keywords_live_item.DataforseoLabsRelatedKeywordsLiveItem(
                        se_type = '', 
