...
class TestDataforseoLabsRelatedKeywordsLiveItem(unittest.TestCase):
    """DataforseoLabsRelatedKeywordsLiveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsRelatedKeywordsLiveItem:
        """Test DataforseoLabsRelatedKeywordsLiveItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsRelatedKeywordsLiveItem`
        """
        model = DataforseoLabsRelatedKeywordsLiveItem()
        if include_optional:
            return DataforseoLabsRelatedKeywordsLiveItem(
                se_type = '',
    ...
    def testDataforseoLabsRelatedKeywordsLiveItem(self):
        """Test DataforseoLabsRelatedKeywordsLiveItem"""
