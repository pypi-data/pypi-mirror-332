...
import ctypes
from tubiu.Other.__setting__ import windll
user32 = windll.user32
try:
    from tubiu.__TUBIU__ import notify
    from tubiu.__TUBIU__ import print
    import codinghou
...
if __name__ == "__main__":
    notify("Title","Message","app_name",timeout=5,icon=None)
