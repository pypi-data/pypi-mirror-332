...
import ctypes
from Other.__setting__ import user32
try:
    from __TUBIU__ import notify
    from __TUBIU__ import Print,output
    import codinghou
    notify = None
except ImportError:
    pass
...
class __Message__:
    ...
    def __init__(self):
        ...
        self.user32.MessageBoxA.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_uint]
        self.user32.MessageBoxA.restype = ctypes.c_int
    ...
    def show_message_box(self, message, title, style=MB_OK | MB_ICONINFORMATION):
        ...
        try:
            ...
            result = self.user32.MessageBoxA(0, encoded_message, encoded_title, style)
            return result
