...
dati = {'bollettino_medico':'Bollettino medico di sabato 8 marzo 2025: Il pontefice rimane in prognosi riservata. Le sue condizioni sono stabili, ma gravi'}
risposta = gpt.invocaGPT(1,domanda=domanda,assistente=assistente, esempio=esempio, dati=dati)
payload.setProposta(bind='proposte',id='prima', value=risposta)
payload.setContesto(key='bollettino_medico', value=dati)
