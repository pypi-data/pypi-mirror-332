...
gpt = SirioAi(config)
risposta = gpt.invocaGPT(1,"Come sta il pontefice",'', '', {'bollettino_medico':'Bollettino medico di sabato 8 marzo 2025: Il pontefice rimane in prognosi riservata. Le sue condizioni sono stabili, ma gravi'})
