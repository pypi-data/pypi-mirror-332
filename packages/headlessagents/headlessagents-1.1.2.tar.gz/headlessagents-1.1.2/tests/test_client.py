...
from headlessagents import HeadlessAgents, AsyncHeadlessAgents, APIResponseValidationError
from headlessagents._types import Omit
from headlessagents._models import BaseModel, FinalRequestOptions
from headlessagents._constants import RAW_RESPONSE_HEADER
from headlessagents._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from headlessagents._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: HeadlessAgents | AsyncHeadlessAgents) -> int:
...
class TestHeadlessAgents:
    client = HeadlessAgents(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "headlessagents/_legacy_response.py",
                        "headlessagents/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "headlessagents/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"HEADLESS_AGENTS_API_KEY": Omit()}):
            client2 = HeadlessAgents(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, client: HeadlessAgents) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(HEADLESS_AGENTS_BASE_URL="http://localhost:5000/from/env"):
            client = HeadlessAgents(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: HeadlessAgents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: HeadlessAgents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: HeadlessAgents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = HeadlessAgents(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = HeadlessAgents(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("headlessagents._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_omit_retry_count_header(
        self, client: HeadlessAgents, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.with_raw_response.check_health(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.with_raw_response.check_health(extra_headers={"x-stainless-retry-count": "42"})

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncHeadlessAgents:
    client = AsyncHeadlessAgents(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"HEADLESS_AGENTS_API_KEY": Omit()}):
            client2 = AsyncHeadlessAgents(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncHeadlessAgents) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(HEADLESS_AGENTS_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncHeadlessAgents(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncHeadlessAgents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncHeadlessAgents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncHeadlessAgents) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncHeadlessAgents(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncHeadlessAgents(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncHeadlessAgents,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.with_raw_response.check_health()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncHeadlessAgents, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.with_raw_response.check_health(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.with_raw_response.check_health(extra_headers={"x-stainless-retry-count": "42"})
    ...
    def test_get_platform(self) -> None:
        ...
        from headlessagents._utils import asyncify
        from headlessagents._base_client import get_platform 
