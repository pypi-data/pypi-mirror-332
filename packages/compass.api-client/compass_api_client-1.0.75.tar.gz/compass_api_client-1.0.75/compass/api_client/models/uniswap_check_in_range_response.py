...
class UniswapCheckInRangeResponse(BaseModel):
    ...
    """ # noqa: E501
    in_range: StrictBool = Field(description="Whether the position is in active tick range or not. If not in range, the position is not earning trading fees.")
    __properties: ClassVar[List[str]] = ["in_range"]
