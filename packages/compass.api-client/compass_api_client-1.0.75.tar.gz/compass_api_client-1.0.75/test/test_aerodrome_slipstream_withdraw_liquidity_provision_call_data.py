...
class TestAerodromeSlipstreamWithdrawLiquidityProvisionCallData(unittest.TestCase):
    """AerodromeSlipstreamWithdrawLiquidityProvisionCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromeSlipstreamWithdrawLiquidityProvisionCallData:
        """Test AerodromeSlipstreamWithdrawLiquidityProvisionCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromeSlipstreamWithdrawLiquidityProvisionCallData`
        """
        model = AerodromeSlipstreamWithdrawLiquidityProvisionCallData()
        if include_optional:
            return AerodromeSlipstreamWithdrawLiquidityProvisionCallData(
                token_id = 56,
    ...
    def testAerodromeSlipstreamWithdrawLiquidityProvisionCallData(self):
        """Test AerodromeSlipstreamWithdrawLiquidityProvisionCallData"""
