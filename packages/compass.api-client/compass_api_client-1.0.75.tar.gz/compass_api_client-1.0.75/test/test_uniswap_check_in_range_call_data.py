...
class TestUniswapCheckInRangeCallData(unittest.TestCase):
    """UniswapCheckInRangeCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapCheckInRangeCallData:
        """Test UniswapCheckInRangeCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapCheckInRangeCallData`
        """
        model = UniswapCheckInRangeCallData()
        if include_optional:
    ...
    def testUniswapCheckInRangeCallData(self):
        """Test UniswapCheckInRangeCallData"""
