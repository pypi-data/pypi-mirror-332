...
class TestAmountADesired(unittest.TestCase):
    """AmountADesired unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountADesired:
        """Test AmountADesired
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountADesired`
        """
        model = AmountADesired()
        if include_optional:
