...
class TestAaveGetAssetPrice(unittest.TestCase):
    """AaveGetAssetPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveGetAssetPrice:
        """Test AaveGetAssetPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveGetAssetPrice`
        """
        model = AaveGetAssetPrice()
        if include_optional:
            return AaveGetAssetPrice(
    ...
    def testAaveGetAssetPrice(self):
        """Test AaveGetAssetPrice"""
