...
class TestAmountOutMin(unittest.TestCase):
    """AmountOutMin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountOutMin:
        """Test AmountOutMin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountOutMin`
        """
        model = AmountOutMin()
        if include_optional:
            return AmountOutMin(
