...
class TestAmountInMaximum(unittest.TestCase):
    """AmountInMaximum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountInMaximum:
        """Test AmountInMaximum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountInMaximum`
        """
        model = AmountInMaximum()
        if include_optional:
