...
class TestAmount0Desired(unittest.TestCase):
    """Amount0Desired unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Amount0Desired:
        """Test Amount0Desired
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Amount0Desired`
        """
        model = Amount0Desired()
        if include_optional:
