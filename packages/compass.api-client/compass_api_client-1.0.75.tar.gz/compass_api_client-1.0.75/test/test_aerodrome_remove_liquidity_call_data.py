...
class TestAerodromeRemoveLiquidityCallData(unittest.TestCase):
    """AerodromeRemoveLiquidityCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromeRemoveLiquidityCallData:
        """Test AerodromeRemoveLiquidityCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromeRemoveLiquidityCallData`
        """
        model = AerodromeRemoveLiquidityCallData()
        if include_optional:
    ...
    def testAerodromeRemoveLiquidityCallData(self):
        """Test AerodromeRemoveLiquidityCallData"""
