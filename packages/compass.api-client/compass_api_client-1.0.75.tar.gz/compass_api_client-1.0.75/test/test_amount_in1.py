...
class TestAmountIn1(unittest.TestCase):
    """AmountIn1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountIn1:
        """Test AmountIn1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountIn1`
        """
        model = AmountIn1()
        if include_optional:
            return AmountIn1(
