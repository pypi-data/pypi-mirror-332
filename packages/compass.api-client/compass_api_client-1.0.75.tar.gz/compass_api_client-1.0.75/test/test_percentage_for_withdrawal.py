...
class TestPercentageForWithdrawal(unittest.TestCase):
    """PercentageForWithdrawal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PercentageForWithdrawal:
        """Test PercentageForWithdrawal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PercentageForWithdrawal`
        """
        model = PercentageForWithdrawal()
        if include_optional:
            return PercentageForWithdrawal(
            )
        else:
            return PercentageForWithdrawal(
        )
    ...
    def testPercentageForWithdrawal(self):
        """Test PercentageForWithdrawal"""
