...
class TestRequestUserAddress(unittest.TestCase):
    """RequestUserAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestUserAddress:
        """Test RequestUserAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestUserAddress`
        """
        model = RequestUserAddress()
        if include_optional:
    ...
    def testRequestUserAddress(self):
        """Test RequestUserAddress"""
