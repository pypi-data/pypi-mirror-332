...
class TestAaveGetUserPositionSummary(unittest.TestCase):
    """AaveGetUserPositionSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveGetUserPositionSummary:
        """Test AaveGetUserPositionSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveGetUserPositionSummary`
        """
        model = AaveGetUserPositionSummary()
        if include_optional:
            return AaveGetUserPositionSummary(
    ...
    def testAaveGetUserPositionSummary(self):
        """Test AaveGetUserPositionSummary"""
