...
class TestAaveRepayCallData(unittest.TestCase):
    """AaveRepayCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveRepayCallData:
        """Test AaveRepayCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveRepayCallData`
        """
        model = AaveRepayCallData()
        if include_optional:
            return AaveRepayCallData(
                asset = '1INCH',
                amount = None,
    ...
    def testAaveRepayCallData(self):
        """Test AaveRepayCallData"""
