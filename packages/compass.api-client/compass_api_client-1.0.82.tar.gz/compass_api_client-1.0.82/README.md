...
<div class=\"mt-6 flex justify-center\">
    <a href=\"/auth/get_bearer_token\" 
       class=\"inline-flex justify-center py-2 px-6 border border-transparent rounded-md shadow-sm bg-blue-600 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors\">
        Get Bearer Token
    </a>
</div>
