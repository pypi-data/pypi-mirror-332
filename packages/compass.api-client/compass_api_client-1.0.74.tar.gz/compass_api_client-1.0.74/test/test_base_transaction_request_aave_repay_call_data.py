...
class TestBaseTransactionRequestAaveRepayCallData(unittest.TestCase):
    """BaseTransactionRequestAaveRepayCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseTransactionRequestAaveRepayCallData:
        """Test BaseTransactionRequestAaveRepayCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseTransactionRequestAaveRepayCallData`
        """
        model = BaseTransactionRequestAaveRepayCallData()
        if include_optional:
            return BaseTransactionRequestAaveRepayCallData(
                chain = 'ethereum:mainnet',
                sender = '',
                call_data = compass.api_client.models.aave_repay_call_data.AaveRepayCallData(
                    asset = '1INCH', 
                    amount = null, 
    ...
    def testBaseTransactionRequestAaveRepayCallData(self):
        """Test BaseTransactionRequestAaveRepayCallData"""
