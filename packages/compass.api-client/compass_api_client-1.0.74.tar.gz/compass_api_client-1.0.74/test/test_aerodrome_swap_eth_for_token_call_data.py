...
class TestAerodromeSwapEthForTokenCallData(unittest.TestCase):
    """AerodromeSwapEthForTokenCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromeSwapEthForTokenCallData:
        """Test AerodromeSwapEthForTokenCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromeSwapEthForTokenCallData`
        """
        model = AerodromeSwapEthForTokenCallData()
        if include_optional:
            return AerodromeSwapEthForTokenCallData(
                token_out = '1INCH',
                amount_in = None,
                amount_out_min = None,
                stable = True,
    ...
    def testAerodromeSwapEthForTokenCallData(self):
        """Test AerodromeSwapEthForTokenCallData"""
