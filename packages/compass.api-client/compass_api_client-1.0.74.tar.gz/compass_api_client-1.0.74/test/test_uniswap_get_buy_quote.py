...
class TestUniswapGetBuyQuote(unittest.TestCase):
    """UniswapGetBuyQuote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapGetBuyQuote:
        """Test UniswapGetBuyQuote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapGetBuyQuote`
        """
        model = UniswapGetBuyQuote()
        if include_optional:
            return UniswapGetBuyQuote(
    ...
    def testUniswapGetBuyQuote(self):
        """Test UniswapGetBuyQuote"""
