...
class TestAmountTokenMin(unittest.TestCase):
    """AmountTokenMin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountTokenMin:
        """Test AmountTokenMin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountTokenMin`
        """
        model = AmountTokenMin()
        if include_optional:
