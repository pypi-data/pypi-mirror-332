...
class TestAmountBMin(unittest.TestCase):
    """AmountBMin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountBMin:
        """Test AmountBMin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountBMin`
        """
        model = AmountBMin()
        if include_optional:
            return AmountBMin(
