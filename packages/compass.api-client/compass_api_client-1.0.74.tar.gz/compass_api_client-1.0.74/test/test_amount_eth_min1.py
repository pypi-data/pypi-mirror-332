...
class TestAmountEthMin1(unittest.TestCase):
    """AmountEthMin1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountEthMin1:
        """Test AmountEthMin1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountEthMin1`
        """
        model = AmountEthMin1()
        if include_optional:
            return AmountEthMin1(
            )
        else:
            return AmountEthMin1(
        )
