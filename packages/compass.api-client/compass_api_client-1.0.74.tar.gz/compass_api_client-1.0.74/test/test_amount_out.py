...
class TestAmountOut(unittest.TestCase):
    """AmountOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountOut:
        """Test AmountOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountOut`
        """
        model = AmountOut()
        if include_optional:
            return AmountOut(
