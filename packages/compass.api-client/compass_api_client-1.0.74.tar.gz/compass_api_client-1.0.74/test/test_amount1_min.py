...
class TestAmount1Min(unittest.TestCase):
    """Amount1Min unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Amount1Min:
        """Test Amount1Min
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Amount1Min`
        """
        model = Amount1Min()
        if include_optional:
            return Amount1Min(
