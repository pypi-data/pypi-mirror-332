...
class TestUniswapGetSellQuote(unittest.TestCase):
    """UniswapGetSellQuote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapGetSellQuote:
        """Test UniswapGetSellQuote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapGetSellQuote`
        """
        model = UniswapGetSellQuote()
        if include_optional:
            return UniswapGetSellQuote(
    ...
    def testUniswapGetSellQuote(self):
        """Test UniswapGetSellQuote"""
