...
class TestAerodromeSlipstreamPoolPrice(unittest.TestCase):
    """AerodromeSlipstreamPoolPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromeSlipstreamPoolPrice:
        """Test AerodromeSlipstreamPoolPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromeSlipstreamPoolPrice`
        """
        model = AerodromeSlipstreamPoolPrice()
        if include_optional:
            return AerodromeSlipstreamPoolPrice(
                token_in = '1INCH',
                token_out = '1INCH',
                price = '',
                tick = 56
    ...
    def testAerodromeSlipstreamPoolPrice(self):
        """Test AerodromeSlipstreamPoolPrice"""
