...
class TestUniswapSellQuoteInfo(unittest.TestCase):
    """UniswapSellQuoteInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapSellQuoteInfo:
        """Test UniswapSellQuoteInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapSellQuoteInfo`
        """
        model = UniswapSellQuoteInfo()
        if include_optional:
            return UniswapSellQuoteInfo(
                amount_out = '',
                price_after = ''
            )
        else:
    ...
    def testUniswapSellQuoteInfo(self):
        """Test UniswapSellQuoteInfo"""
