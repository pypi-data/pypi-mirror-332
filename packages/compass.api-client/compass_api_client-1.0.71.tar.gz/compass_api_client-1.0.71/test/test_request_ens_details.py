...
class TestRequestEnsDetails(unittest.TestCase):
    """RequestEnsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestEnsDetails:
        """Test RequestEnsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestEnsDetails`
        """
        model = RequestEnsDetails()
        if include_optional:
            return RequestEnsDetails(
    ...
    def testRequestEnsDetails(self):
        """Test RequestEnsDetails"""
