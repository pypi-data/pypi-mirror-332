...
class TestGetSupportedTokens(unittest.TestCase):
    """GetSupportedTokens unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSupportedTokens:
        """Test GetSupportedTokens
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSupportedTokens`
        """
        model = GetSupportedTokens()
        if include_optional:
    ...
    def testGetSupportedTokens(self):
        """Test GetSupportedTokens"""
