...
class TestBaseTransactionRequestUniswapIncreaseLiquidityProvisionCallData(unittest.TestCase):
    """BaseTransactionRequestUniswapIncreaseLiquidityProvisionCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseTransactionRequestUniswapIncreaseLiquidityProvisionCallData:
        """Test BaseTransactionRequestUniswapIncreaseLiquidityProvisionCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseTransactionRequestUniswapIncreaseLiquidityProvisionCallData`
        """
        model = BaseTransactionRequestUniswapIncreaseLiquidityProvisionCallData()
        if include_optional:
            return BaseTransactionRequestUniswapIncreaseLiquidityProvisionCallData(
    ...
    def testBaseTransactionRequestUniswapIncreaseLiquidityProvisionCallData(self):
        """Test BaseTransactionRequestUniswapIncreaseLiquidityProvisionCallData"""
