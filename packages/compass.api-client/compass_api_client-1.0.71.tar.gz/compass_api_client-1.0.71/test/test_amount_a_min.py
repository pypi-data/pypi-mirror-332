...
class TestAmountAMin(unittest.TestCase):
    """AmountAMin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountAMin:
        """Test AmountAMin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountAMin`
        """
        model = AmountAMin()
        if include_optional:
            return AmountAMin(
