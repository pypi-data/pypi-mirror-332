...
class TestAmountBDesired(unittest.TestCase):
    """AmountBDesired unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountBDesired:
        """Test AmountBDesired
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountBDesired`
        """
        model = AmountBDesired()
        if include_optional:
