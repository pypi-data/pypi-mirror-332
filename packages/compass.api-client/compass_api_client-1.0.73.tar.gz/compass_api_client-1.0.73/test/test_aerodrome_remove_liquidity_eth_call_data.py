...
class TestAerodromeRemoveLiquidityEthCallData(unittest.TestCase):
    """AerodromeRemoveLiquidityEthCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromeRemoveLiquidityEthCallData:
        """Test AerodromeRemoveLiquidityEthCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromeRemoveLiquidityEthCallData`
        """
        model = AerodromeRemoveLiquidityEthCallData()
        if include_optional:
            return AerodromeRemoveLiquidityEthCallData(
                token = '1INCH',
                stable = True,
                liquidity = None,
    ...
    def testAerodromeRemoveLiquidityEthCallData(self):
        """Test AerodromeRemoveLiquidityEthCallData"""
