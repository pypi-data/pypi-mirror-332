...
class TestUnwrapWethRequestCallData(unittest.TestCase):
    """UnwrapWethRequestCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnwrapWethRequestCallData:
        """Test UnwrapWethRequestCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnwrapWethRequestCallData`
        """
        model = UnwrapWethRequestCallData()
        if include_optional:
            return UnwrapWethRequestCallData(
                amount = None
            )
        else:
            return UnwrapWethRequestCallData(
    ...
    def testUnwrapWethRequestCallData(self):
        """Test UnwrapWethRequestCallData"""
