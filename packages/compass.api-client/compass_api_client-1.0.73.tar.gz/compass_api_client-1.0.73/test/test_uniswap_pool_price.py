...
class TestUniswapPoolPrice(unittest.TestCase):
    """UniswapPoolPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapPoolPrice:
        """Test UniswapPoolPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapPoolPrice`
        """
        model = UniswapPoolPrice()
        if include_optional:
            return UniswapPoolPrice(
                token_in = '1INCH',
                token_out = '1INCH',
                price = '',
                tick = 56
