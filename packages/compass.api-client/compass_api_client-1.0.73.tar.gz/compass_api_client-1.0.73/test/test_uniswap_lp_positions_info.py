...
class TestUniswapLPPositionsInfo(unittest.TestCase):
    """UniswapLPPositionsInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapLPPositionsInfo:
        """Test UniswapLPPositionsInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapLPPositionsInfo`
        """
        model = UniswapLPPositionsInfo()
        if include_optional:
            return UniswapLPPositionsInfo(
                positions = {
    ...
    def testUniswapLPPositionsInfo(self):
        """Test UniswapLPPositionsInfo"""
