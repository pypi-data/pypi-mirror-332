...
class TestAmountOutMin1(unittest.TestCase):
    """AmountOutMin1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountOutMin1:
        """Test AmountOutMin1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountOutMin1`
        """
        model = AmountOutMin1()
        if include_optional:
            return AmountOutMin1(
            )
        else:
            return AmountOutMin1(
        )
