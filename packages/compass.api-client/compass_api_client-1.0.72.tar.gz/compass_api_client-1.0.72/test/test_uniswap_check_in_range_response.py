...
class TestUniswapCheckInRangeResponse(unittest.TestCase):
    """UniswapCheckInRangeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapCheckInRangeResponse:
        """Test UniswapCheckInRangeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapCheckInRangeResponse`
        """
        model = UniswapCheckInRangeResponse()
        if include_optional:
            return UniswapCheckInRangeResponse(
                in_range = True
            )
        else:
            return UniswapCheckInRangeResponse(
    ...
    def testUniswapCheckInRangeResponse(self):
        """Test UniswapCheckInRangeResponse"""
