...
class TestAmountIn(unittest.TestCase):
    """AmountIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountIn:
        """Test AmountIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountIn`
        """
        model = AmountIn()
        if include_optional:
            return AmountIn(
