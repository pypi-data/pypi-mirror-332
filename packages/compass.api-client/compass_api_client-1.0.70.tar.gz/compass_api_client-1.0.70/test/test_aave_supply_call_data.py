...
class TestAaveSupplyCallData(unittest.TestCase):
    """AaveSupplyCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveSupplyCallData:
        """Test AaveSupplyCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveSupplyCallData`
        """
        model = AaveSupplyCallData()
        if include_optional:
            return AaveSupplyCallData(
                asset = '1INCH',
                amount = None,
                on_behalf_of = ''
            )
    ...
    def testAaveSupplyCallData(self):
        """Test AaveSupplyCallData"""
