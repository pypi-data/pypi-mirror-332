...
class TestAmountTokenMin1(unittest.TestCase):
    """AmountTokenMin1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountTokenMin1:
        """Test AmountTokenMin1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountTokenMin1`
        """
        model = AmountTokenMin1()
        if include_optional:
            return AmountTokenMin1(
            )
        else:
            return AmountTokenMin1(
        )
