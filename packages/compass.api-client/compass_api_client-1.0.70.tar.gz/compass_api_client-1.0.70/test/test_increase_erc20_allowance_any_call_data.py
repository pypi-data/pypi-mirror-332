...
class TestIncreaseErc20AllowanceAnyCallData(unittest.TestCase):
    """IncreaseErc20AllowanceAnyCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncreaseErc20AllowanceAnyCallData:
        """Test IncreaseErc20AllowanceAnyCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncreaseErc20AllowanceAnyCallData`
        """
        model = IncreaseErc20AllowanceAnyCallData()
        if include_optional:
            return IncreaseErc20AllowanceAnyCallData(
    ...
    def testIncreaseErc20AllowanceAnyCallData(self):
        """Test IncreaseErc20AllowanceAnyCallData"""
