...
class TestAmountEthMin(unittest.TestCase):
    """AmountEthMin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountEthMin:
        """Test AmountEthMin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountEthMin`
        """
        model = AmountEthMin()
        if include_optional:
            return AmountEthMin(
