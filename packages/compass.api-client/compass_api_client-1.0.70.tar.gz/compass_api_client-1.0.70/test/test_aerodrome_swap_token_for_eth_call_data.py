...
class TestAerodromeSwapTokenForEthCallData(unittest.TestCase):
    """AerodromeSwapTokenForEthCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromeSwapTokenForEthCallData:
        """Test AerodromeSwapTokenForEthCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromeSwapTokenForEthCallData`
        """
        model = AerodromeSwapTokenForEthCallData()
        if include_optional:
            return AerodromeSwapTokenForEthCallData(
                token_in = '1INCH',
                amount_in = None,
                amount_out_min = None,
                stable = True,
    ...
    def testAerodromeSwapTokenForEthCallData(self):
        """Test AerodromeSwapTokenForEthCallData"""
