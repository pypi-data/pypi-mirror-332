# dingo_walk.walk : a python library for metabolic networks sampling and analysis
# dingo_walk.walk is part of GeomScale project
...
import warnings
import math
from dingo_walk.walk.MetabolicNetwork import MetabolicNetwork
from dingo_walk.walk.fva import slow_fva
from dingo_walk.walk.utils import (
...
try:
    import gurobipy
    from dingo_walk.walk.gurobi_based_implementations import (
        fast_fba,
        fast_fva,
        fast_inner_ball,
...
class PolytopeSampler:
    ...
    def facet_redundancy_removal(self, value):
        ...
        if (not self._parameters["fast_computations"]) and value:
            warnings.warn(
                "Since you are in slow mode the redundancy removal step is skipped (dingo_walk.walk does not currently support this functionality in slow mode)"
            )
