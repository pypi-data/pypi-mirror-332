...
import cobra
from ding_walk.walk.loading_models import read_json_file, read_mat_file, read_sbml_file, parse_cobra_model
from ding_walk.walk.fva import slow_fva
from ding_walk.walk.fba import slow_fba

try:
    import gurobipy
    from ding_walk.walk.gurobi_based_implementations import fast_fba, fast_fva, fast_inner_ball
