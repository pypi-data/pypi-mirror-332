...
from dingo_walk.fba import slow_fba
from dingo_walk.loading_models import read_json_file
from dingo_walk.inner_ball import slow_inner_ball
...
try:
    import gurobipy
    from dingo_walk.gurobi_based_implementations import fast_fba, fast_fva, fast_inner_ball
