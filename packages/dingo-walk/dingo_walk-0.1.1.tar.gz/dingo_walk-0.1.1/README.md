...
To exploit the fast implementations of dingo_walk, you have to install the [Gurobi solver](https://www.gurobi.com/). Run
...
If you have installed successfully the `gurobi` library, dingo_walk turns to the *fast mode* by default. To set a certain mode you could use the following member functions,
