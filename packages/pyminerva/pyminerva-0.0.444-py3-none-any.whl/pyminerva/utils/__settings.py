...
# 보유종목들
# MY_TICKERS = {
#     'US':[{'bond':['TLT','EDV','HYG','LQD','TMF','IEF','SHV','SHY']}, {'stock':['SPY','QQQ','BAC','ENB','O','SCHD','SOXL','VNQ']}, \
#           {'commodity':['GLD']}, {'currency':['UUP']}, ],
#     'KR':[{'bond':['148070.KS','302190.KS','385560.KS','451530.KS','451670.KS','453850.KS']}, \
#           {'stock':['^KS200', '008770.KS','530107.KS','252670.KS']}, {'commodity':['']}, {'currency':['']}, ],    
#     'EU':[{'bond':['']}, {'stock':['']}, {'commodity':['']}, {'currency':['']}, ],
#     'JP':[{'bond':['1482.T','1487.T','2620.T','2621.T']}, {'stock':['^N225', '1325.T','1545.T','1547.T','1571.T','1573.T','1678.T','2034.T','2563.T']}, 
#           {'commodity':['']}, {'currency':['']}, ],
#     'CN':[{'bond':['']}, {'stock':['510330.SS','002304.SZ','002594.SZ']}, {'commodity':['']}, {'currency':['']}, ],
#     'DE':[{'bond':['DBXG.DE','IBB1.DE','IS04.DE','IUSU.DE','VGEB.DE','VUTY.AS']}, {'stock':['^STOXX50E', 'BAS.DE','BNP.PA','CS.PA','GLE.PA']}, 
#           {'commodity':['']}, {'currency':['']}, ],    
#     'IN':[{'bond':['']}, {'stock':['^BSESN','']}, {'commodity':['']}, {'currency':['']}, ],
#     'SG':[{'bond':['A35.SI']}, {'stock':['^STI', 'AJBU.SI','C6L.SI','CLR.SI','D05.SI','M44U.SI','ME8U.SI','Y92.SI','Z74.SI']}, 
#           {'commodity':['']}, {'currency':['']}, ],
# }
...
WATCH_TICKERS2 = {
    'US':[{'bond':['TLT','EDV','HYG',]}, {'stock':['SPY','QQQ',]}, \
          {'commodity':['GLD']}, {'currency':['UUP']}, ],
    'KR':[{'bond':['148070.KS',]}, \
          {'stock':['^KS200', '008770.KS',]}, {'commodity':['']}, {'currency':['']}, ],
}
