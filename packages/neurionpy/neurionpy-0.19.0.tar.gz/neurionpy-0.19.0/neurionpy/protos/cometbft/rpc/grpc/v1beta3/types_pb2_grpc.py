...
from cometbft.rpc.grpc.v1beta3 import types_pb2 as cometbft_dot_rpc_dot_grpc_dot_v1beta3_dot_types__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in cometbft/rpc/grpc/v1beta3/types_pb2_grpc.py depends on'
...
class BroadcastAPIStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BroadcastTx = channel.unary_unary(
                ...
                response_deserializer=cometbft_dot_rpc_dot_grpc_dot_v1beta3_dot_types__pb2.ResponseBroadcastTx.FromString,
                _registered_method=True)
...
def add_BroadcastAPIServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BroadcastTx': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=cometbft_dot_rpc_dot_grpc_dot_v1beta3_dot_types__pb2.ResponseBroadcastTx.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'cometbft.rpc.grpc.v1beta3.BroadcastAPI', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cometbft.rpc.grpc.v1beta3.BroadcastAPI', rpc_method_handlers)
...
class BroadcastAPI(object):
    ...
    def BroadcastTx(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            cometbft_dot_rpc_dot_grpc_dot_v1beta3_dot_types__pb2.ResponseBroadcastTx.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
