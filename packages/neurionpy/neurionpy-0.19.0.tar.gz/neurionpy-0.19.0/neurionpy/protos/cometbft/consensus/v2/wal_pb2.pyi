from cometbft.consensus.v2 import types_pb2 as _types_pb2
from cometbft.types.v2 import events_pb2 as _events_pb2
...
class MsgInfo(_message.Message):
    __slots__ = ("msg", "peer_id", "receive_time")
    ...
    def __init__(self, msg: _Optional[_Union[_types_pb2.Message, _Mapping]] = ..., peer_id: _Optional[str] = ..., receive_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
