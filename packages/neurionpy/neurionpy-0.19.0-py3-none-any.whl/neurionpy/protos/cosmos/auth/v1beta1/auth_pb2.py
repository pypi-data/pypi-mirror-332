...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_BASEACCOUNT'].fields_by_name['pub_key']._serialized_options = b'\352\336\037\024public_key,omitempty\362\336\037\021yaml:\"public_key\"'
  _globals['_BASEACCOUNT'].fields_by_name['account_number']._loaded_options = None
  _globals['_BASEACCOUNT'].fields_by_name['account_number']._serialized_options = b'\362\336\037\025yaml:\"account_number\"'
  _globals['_BASEACCOUNT']._loaded_options = None
  _globals['_BASEACCOUNT']._serialized_options = b'\210\240\037\000\230\240\037\000\350\240\037\000\312\264-\010AccountI'
  _globals['_MODULEACCOUNT'].fields_by_name['base_account']._loaded_options = None
  _globals['_MODULEACCOUNT'].fields_by_name['base_account']._serialized_options = b'\320\336\037\001\362\336\037\023yaml:\"base_account\"'
  _globals['_MODULEACCOUNT']._loaded_options = None
  _globals['_MODULEACCOUNT']._serialized_options = b'\210\240\037\000\230\240\037\000\312\264-\016ModuleAccountI'
  _globals['_PARAMS'].fields_by_name['max_memo_characters']._loaded_options = None
  _globals['_PARAMS'].fields_by_name['max_memo_characters']._serialized_options = b'\362\336\037\032yaml:\"max_memo_characters\"'
  _globals['_PARAMS'].fields_by_name['tx_sig_limit']._loaded_options = None
  _globals['_PARAMS'].fields_by_name['tx_sig_limit']._serialized_options = b'\362\336\037\023yaml:\"tx_sig_limit\"'
  _globals['_PARAMS'].fields_by_name['tx_size_cost_per_byte']._loaded_options = None
  _globals['_PARAMS'].fields_by_name['tx_size_cost_per_byte']._serialized_options = b'\362\336\037\034yaml:\"tx_size_cost_per_byte\"'
  _globals['_PARAMS'].fields_by_name['sig_verify_cost_ed25519']._loaded_options = None
  _globals['_PARAMS'].fields_by_name['sig_verify_cost_ed25519']._serialized_options = b'\342\336\037\024SigVerifyCostED25519\362\336\037\036yaml:\"sig_verify_cost_ed25519\"'
  _globals['_PARAMS'].fields_by_name['sig_verify_cost_secp256k1']._loaded_options = None
  _globals['_PARAMS'].fields_by_name['sig_verify_cost_secp256k1']._serialized_options = b'\342\336\037\026SigVerifyCostSecp256k1\362\336\037 yaml:\"sig_verify_cost_secp256k1\"'
