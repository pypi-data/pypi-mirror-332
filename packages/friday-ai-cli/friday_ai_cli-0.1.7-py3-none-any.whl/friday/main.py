...
from .core.engine import sampling_loop, MODEL_3_7
...
async def start_chat_session(api_key: Optional[str] = None):
    ...
    # Initialize FridayTerminal for better UI
    terminal = FridayTerminal()
    ...
    try:
        while True:
            ...
            # Start loader immediately after user input
            # loader = FridayLoader()
            # loader.start()
