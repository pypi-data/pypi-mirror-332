...
class LocationFix(_message.Message):
    __slots__ = ("timestamp_source", "timestamp", "frame_id", "latitude", "longitude", "altitude", "position_covariance", "position_covariance_type")
...
class PositionFix(_message.Message):
    __slots__ = ("timestamp", "latitude_degree", "longitude_degree", "altitude_meters", "horizontal_accuracy_meters", "vertical_accuracy_meters", "geodetic_datum", "source")
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., latitude_degree: _Optional[float] = ..., longitude_degree: _Optional[float] = ..., altitude_meters: _Optional[float] = ..., horizontal_accuracy_meters: _Optional[float] = ..., vertical_accuracy_meters: _Optional[float] = ..., geodetic_datum: _Optional[str] = ..., source: _Optional[_Union[PositionSource, _Mapping]] = ...) -> None: ...
