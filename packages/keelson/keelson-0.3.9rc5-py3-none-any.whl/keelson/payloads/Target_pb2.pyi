...
class Target(_message.Message):
    __slots__ = ("timestamp", "data_source", "description", "position", "speed_through_water", "speed_over_ground", "rate_of_turn", "heading", "collision_monitoring", "navigation_status", "json_str")
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
