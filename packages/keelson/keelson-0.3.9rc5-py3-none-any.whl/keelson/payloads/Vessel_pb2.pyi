...
class Vessel(_message.Message):
    __slots__ = ("timestamp", "information", "position", "speed_through_water", "speed_over_ground", "rate_of_turn", "heading", "navigation_status", "common_reference_point", "data_source", "voyage", "statics")
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
