...
from typing import Any, Dict, List, Optional, Set, Type, Union, get_type_hints, Literal
...
class LLMAgentConfigModel(AgentConfigModel):
    ...
    agent_type: Literal["llm"] = Field("llm", description="Type must be 'llm'")
...
class ToolAgentConfigModel(AgentConfigModel):
    ...
    agent_type: Literal["tool"] = Field("tool", description="Type must be 'tool'")
...
class WorkflowAgentConfigModel(AgentConfigModel):
    ...
    agent_type: Literal["workflow"] = Field("workflow", description="Type must be 'workflow'")
