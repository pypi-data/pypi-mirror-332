...
> **Note**: The capability decorator requires the `agent_name` parameter to be specified as a keyword argument. This clearly associates the capability with a specific agent.
