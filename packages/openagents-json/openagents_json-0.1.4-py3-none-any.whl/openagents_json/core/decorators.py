...
def create_capability_decorator(registry):
    ...
    def capability(*, agent_name: str, name: str = None, description: str = "", **metadata) -> Callable[[CapabilityFunc], CapabilityFunc]:
        """
        Enhanced decorator to register an agent capability.

        Args:
            agent_name: Name of the agent this capability belongs to (keyword-only)
            name: Name of the capability (defaults to function name if None)
        ...
        Returns:
            Decorated function that registers the capability
        ...
        # Store the agent name in metadata
        ...
        def decorator(func: CapabilityFunc) -> CapabilityFunc:
            ...
            # Set final capability name (defaulting to function name if None)
            capability_name = name if name is not None else func.__name__
