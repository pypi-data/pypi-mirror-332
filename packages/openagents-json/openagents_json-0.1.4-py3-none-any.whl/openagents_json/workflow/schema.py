...
WORKFLOW_SCHEMA = {
    ...
    "properties": {
        ...
        "state_dependencies": {
            "type": "object",
            "description": "State dependencies between steps",
            "properties": {
                "isolation": {
                    "type": "string",
                    "enum": ["none", "step", "agent", "workflow"],
                    "description": "Level of state isolation between steps",
                    "default": "none"
                },
                "persistence": {
                    "type": "string",
                    "enum": ["none", "memory", "disk", "database"],
                    "description": "Level of state persistence required",
                    "default": "memory"
                },
                "sharing": {
                    "type": "array",
                    "description": "Steps that share state",
                    "items": {
                        "type": "object",
                        "properties": {
                            "source": {"type": "string"},
            ...
            "properties": {
                ...
                "state": {
                    ...
                    "properties": {
                        "isolation": {
                            "type": "boolean",
                            "description": "Whether to isolate state changes in this step",
                            "default": False
                        },
                        "persist": {
                            "type": "boolean",
                            "description": "Whether to persist state after this step",
                            "default": True
                        },
                        "import_from": {
                            "type": "array",
                            "description": "Step IDs to import state from",
                            "items": {"type": "string"}
                        },
                        "export_to": {
                            "type": "array",
                            "description": "Step IDs to export state to",
                            "items": {"type": "string"}
                        },
                        "keys": {
                            "type": "array",
                            "description": "Specific state keys to import/export (if empty, all keys are used)",
                            "items": {"type": "string"}
                        }
                    }
                },
