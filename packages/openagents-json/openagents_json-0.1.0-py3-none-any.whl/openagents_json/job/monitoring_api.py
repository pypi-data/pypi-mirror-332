...
async def get_job_summary():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, 
            detail=f"Error getting job summary: {str(e)}"
        )
...
async def get_job_tag_metrics():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error getting job tag metrics: {str(e)}"
        )
...
async def get_job_priority_metrics():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error getting job priority metrics: {str(e)}"
        )
...
async def get_all_workers():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error getting all workers: {str(e)}"
        )
...
async def get_event_counts():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error getting event counts: {str(e)}"
        )
...
async def enable_monitoring():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error enabling monitoring: {str(e)}"
        )
...
async def disable_monitoring():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error disabling monitoring: {str(e)}"
        )
