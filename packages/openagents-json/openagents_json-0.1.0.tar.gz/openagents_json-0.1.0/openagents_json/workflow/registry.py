...
from openagents_json.workflow.schema import WorkflowValidator, WorkflowMetadata, WorkflowVersion
...
class WorkflowRegistry:
    ...
    def get(self, workflow_id: str, version: Optional[str] = None) -> Optional[Dict[str, Any]]:
        """
        ...
        if version:
            ...
            # Get latest version
            versions = sorted(self.workflows[workflow_id].keys(), 
