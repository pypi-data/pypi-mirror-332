...
from openagents_json.job.retry import RetryPolicy, FixedDelayRetryPolicy
...
class Job:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "retry_policy": self.retry_policy.to_dict() if hasattr(self, 'retry_policy') and self.retry_policy else None,
