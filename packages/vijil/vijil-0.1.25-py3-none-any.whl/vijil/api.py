...
detector_ids_with_params = [
    ...
    "autoredteam.detectors.llm.ContextualPrecisionAPI",
    ...
    "autoredteam.detectors.toolcalling.TaskCompletionAPI",
]
DEFAULT_DETECTOR_PARAMS = {}
for id in detector_ids_with_params:
    DEFAULT_DETECTOR_PARAMS[id] = {"hub": "openai", "model": "gpt-4o"}
    
DETECTOR_LIST = json.load(open(os.path.join(os.path.dirname(__file__), "data", "detector_list.json"), "r"))
