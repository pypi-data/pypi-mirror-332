...
class TransformerModel(nn.Module):
    ...
    def fwd(
        ...
        with open("plot_token_charts.txt", "r") as file:
            plot_token_charts = bool(str(file.read()).strip())
        ...
        with open("store_attentions.txt", "r") as file:
            store_attentions = bool(str(file.read()).strip())
    ...
    def plot_tokens(self):
        ...
        with open("imp_params.txt", "r") as file:
            be_suspicious = bool(str(file.read()).strip())
        ...
        elif len(data[0][1]) == 1 and be_suspicious:
