...
function useCoreCommands() {
  ...
  return [
    ...
    {
      id: "Comfy.Help.OpenGGUFGitHub",
      icon: "pi pi-github",
      label: "Open GGUF GitHub",
      menubarLabel: "GGUF",
      versionAdded: "1.5.5",
      function: /* @__PURE__ */ __name(() => {
        window.open(
    ...
    {
      id: "Comfy.Help.OpenGGUFDiscord",
      icon: "pi pi-discord",
      label: "Open GGUF Discord",
      menubarLabel: "Discord",
      versionAdded: "1.5.5",
      function: /* @__PURE__ */ __name(() => {
        window.open("https://discord.gg/Rs2ftd4bhW", "_blank");
      }, "function")
    },
    {
      id: "Comfy.Help.AboutGGUF",
      icon: "pi pi-info-circle",
      label: "Open About GGUF",
      menubarLabel: "About GGUF",
      versionAdded: "1.6.4",
      function: /* @__PURE__ */ __name(() => {
