...
class XpanderClient(metaclass=jsii.JSIIMeta, jsii_type="xpander-sdk.XpanderClient"):
    ...
    def __init__(
        ...
        jsii.create(self.__class__, self, [api_key, base_url, with_metrics_report, organization_id, should_reset_cache])
...
class Agent(Base, metaclass=jsii.JSIIMeta, jsii_type="xpander-sdk.Agent"):
    ...
    def events(self) -> typing.Any:
        return typing.cast(typing.Any, jsii.invoke(self, "events", []))
