...
## Patches
We gladly welcome patches to fix such vulnerabilities! See [CONTRIBUTING.md](https://github.com/davidbrownell/uvRepoTemplate/blob/main/CONTRIBUTING.md). for information about contributions.
