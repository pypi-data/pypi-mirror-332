...
setup(
  ...
  version = '0.9.6.1',      # Start with a small number and increase it with every change you make
  ...
  author_email = 'jparkastro@khu.ac.kr',      # Type in your E-Mail
  url = 'https://github.com/jhparkastro/gpcal',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/jhparkastro/gpcal/archive/v0.9.6.0.tar.gz',    # I explain this later on
