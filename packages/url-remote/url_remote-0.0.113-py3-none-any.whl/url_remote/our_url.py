...
class OurUrl:
    ...
    def endpoint_url(
        ...
        port: int = SERVERLESS_OFFLINE_DEFAULT_PORT,
    ) -> str:
        """
        ...
        """
        environment_name = OurUrl.get_actual_environment(component_name, environment_name)
    ...
    def _base_url_builder(
        *,
        ...
        if environment_name != EnvironmentName.LOCAL.value:
            ...
            direct_url = f"http://{direct_domain}:{SERVERLESS_OFFLINE_DEFAULT_PORT}/dev/api/v{version}/{entity_name}/{action_name}"  # noqa: E501
        return direct_url
    ...
    def get_actual_environment(component_name, environment_name):
        path = 'component.json'
