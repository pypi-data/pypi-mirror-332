...
class ModelGenerator:
    ...
    def __init__(self, config_path: Path, output_dir: Path, models_format: ModelsFormat) -> None:
    ...
    @classmethod
    def glue_schema_to_object_schema(cls, glue_schema: Any) -> tuple[Any, list[str]]:
        import amsdal_glue as glue
        ...
        for prop in glue_schema.properties:
            ...
            property_data = {
                'type': cls.glue_type_to_object_schema_type(prop.type),
                'title': prop.name,
            }
        ...
        if glue_schema.constraints:
            for constraint in glue_schema.constraints:
                if isinstance(constraint, glue.ForeignKeyConstraint):
                    ...
                    pk_fields = cls.replace_list_subset(
                        pk_fields,
                        constraint.fields,
                        [_field_name],
                    )
