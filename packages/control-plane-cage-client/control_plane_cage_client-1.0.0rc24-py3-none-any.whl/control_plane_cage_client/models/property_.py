...
class Property:
    ...
    Attributes:
        id (str):
        name (Union[Unset, str]): Name of the element.
        ...
        logical_type (Union[Unset, AbstractPropertyLogicalType]): The logical element data type.
        logical_type_options (Union[Unset, AbstractPropertyLogicalTypeOptions]): Additional optional metadata to
            describe the logical type.
