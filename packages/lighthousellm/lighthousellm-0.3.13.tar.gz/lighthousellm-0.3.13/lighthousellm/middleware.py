...
class TracingMiddleware:
    """Middleware for propagating distributed tracing context using LightHousellm.

    This middleware checks for the 'lighthousellm-trace' header and propagates the
    ...
    def __init__(self, app):
        ...
        from lighthousellm.run_helpers import tracing_context  # type: ignore
    ...
    async def __call__(self, scope: dict, receive, send):
        ...
        If the request is HTTP and contains the 'lighthousellm-trace' header,
        ...
        if scope["type"] == "http" and "headers" in scope:
            ...
            if b"lighthousellm-trace" in headers:
