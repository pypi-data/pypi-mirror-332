...
from lighthousellm.utils import get_docker_compose_command
from lighthousellm.env._git import exec_git
...
def get_runtime_environment() -> dict:
    ...
    from lighthousellm import __version__

    shas = get_release_shas()
    return {
        "sdk": "lighthousellm-py",
        "sdk_version": __version__,
        "library": "lighthousellm",
...
def get_langchain_env_var_metadata() -> dict:
    ...
    excluded = {
        ...
        "LANGCHAIN_PROJECT",
        "LANGCHAIN_SESSION",
        "LIGHTHOUSELLM_RUNS_ENDPOINTS",
    }
    langchain_metadata = {
        k: v
        for k, v in os.environ.items()
        if (k.startswith("LANGCHAIN_") or k.startswith("LIGHTHOUSELLM_"))
