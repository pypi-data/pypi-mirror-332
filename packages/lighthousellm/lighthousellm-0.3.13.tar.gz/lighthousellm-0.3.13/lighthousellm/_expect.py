...
"expectation" feedback to LightHousellm.
...
Example usage:
    .. code-block:: python
        ...
        def test_output_semantically_close():
            ...
            # Apply an assertion and log 'expectation' feedback to LightHousellm
...
if TYPE_CHECKING:
    from lighthousellm._internal._edit_distance import EditDistanceConfig
    from lighthousellm._internal._embedding_distance import EmbeddingConfig
...
class _Expect:
    ...
    def embedding_distance(
        ...
        *,
        ...
        This logs the embedding distance to LightHousellm and returns a `_Matcher` instance
        ...
        Examples:
            ...
            ... ).to_be_less_than(1.0)
        """  # noqa: E501
        from lighthousellm._internal._embedding_distance import EmbeddingDistance
    ...
    def edit_distance(
        ...
        *,
        ...
        This logs the string distance (Damerau-Levenshtein) to LightHousellm and returns
        ...
        """
        from lighthousellm._internal._edit_distance import EditDistance
    ...
    def score(
        ...
        *,
        ...
        """Log a numeric score to LightHousellm.
        ...
        Examples:
            ...
            <lighthousellm._expect._Matcher object at ...>
