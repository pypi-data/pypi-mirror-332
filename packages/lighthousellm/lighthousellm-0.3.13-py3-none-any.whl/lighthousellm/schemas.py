...
class Attachment(NamedTuple):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from lighthousellm.schemas import Attachment
...
class LightHousellmInfo(BaseModel):
    """Information about the LightHousellm server."""

    version: str = ""
    """The version of the LightHousellm server."""
...
class LightHousellmSettings(BaseModel):
    """Settings for the LightHousellm tenant."""
