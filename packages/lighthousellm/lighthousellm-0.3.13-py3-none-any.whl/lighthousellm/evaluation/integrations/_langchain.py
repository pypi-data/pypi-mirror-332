...
from lighthousellm.evaluation.evaluator import DynamicRunEvaluator
...
class LangChainStringEvaluator:
    ...
    Examples:
        ...
        >>> from lighthousellm.evaluation import LangChainStringEvaluator, evaluate
    ...
    def as_run_evaluator(
        ...
        This is the object used in the LightHousellm `evaluate` API.
