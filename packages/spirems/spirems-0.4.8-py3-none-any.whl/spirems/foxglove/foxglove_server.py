...
from spirems.foxglove.middleware import SpireMSMiddlewareThread, MiddlewareChannelId
import argparse


logger = get_logger('FoxgloveServer')
...
async def main():
    ...
    middleware = SpireMSMiddlewareThread(ip=args.ip, port=args.port)
