...
class LoggierFlask(Loggier):
    ...
    def __init__(
        ...
        self.app = app
        if app is not None:
            api_key = api_key or app.config.get("PYLOGHUB_API_KEY")
            environment = environment or app.config.get("PYLOGHUB_ENVIRONMENT", environment)
            tags = tags or app.config.get("PYLOGHUB_TAGS", [])
            context = context or app.config.get("PYLOGHUB_CONTEXT", {})
    ...
    def init_app(self, app: Flask) -> None:
        ...
        app.config.setdefault("PYLOGHUB_API_KEY", self.api_key)
        app.config.setdefault("PYLOGHUB_ENVIRONMENT", self.environment)
