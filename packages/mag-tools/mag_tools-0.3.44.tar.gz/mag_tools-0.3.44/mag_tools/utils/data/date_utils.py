...
class DateUtils:
    ...
    @staticmethod
    def pick_datetime(text: str) -> List[Union[datetime, date, time]]:
        """
        从字符串中提取日期、时间和日期时间。
