...
catalyst = RagaAICatalyst(
    access_key=os.getenv("RAGAAI_CATALYST_PROD_ACCESS_KEY"),
    secret_key=os.getenv("RAGAAI_CATALYST_PROD_SECRET_KEY"),
    base_url=os.getenv("RAGAAI_CATALYST_PROD_BASE_URL"),
)

# Initialize tracer
tracer = Tracer(
    project_name="langgraph_testing_100525",
