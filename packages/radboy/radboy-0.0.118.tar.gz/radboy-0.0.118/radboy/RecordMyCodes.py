        ...
        try:
            ...
            if not bypass_clear_time_clear_protection:
                ...
                if clred != tdt:
                    ...
                    graveyard=Prompt.__init2__(None,func=lambda text,data,passThru=[],PassThru=True:FormBuilderMkText(text,data,passThru=[],PassThru=PassThru),ptext="Are working overnight?/skip backup==True.",helpText="type a boolean yes or no",data="boolean")
