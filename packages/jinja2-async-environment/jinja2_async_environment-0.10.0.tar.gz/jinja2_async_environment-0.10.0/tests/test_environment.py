...
class TestAsyncEnvironment:
    ...
    @pytest.fixture
    def environment(self, mock_loader: AsyncBaseLoader, mock_bytecode_cache: AsyncBytecodeCache) -> AsyncEnvironment:
        """Create an environment with mock loader and bytecode cache."""
        env = AsyncEnvironment(
            loader=mock_loader,
            bytecode_cache=mock_bytecode_cache
        )
        # Set is_async to True explicitly, as it might not be set automatically in tests
        env.is_async = True
        return env

    def test_init(self, mock_loader: AsyncBaseLoader, mock_bytecode_cache: AsyncBytecodeCache) -> None:
    ...
    def test_select_template_not_implemented(self, environment: AsyncEnvironment) -> None:
        """Test that select_template raises NotImplementedError."""
        with pytest.raises(NotImplementedError):
            environment.select_template(["template.html"])

    def test_get_or_select_template_not_implemented(self, environment: AsyncEnvironment) -> None:
        """Test that get_or_select_template raises NotImplementedError."""
        with pytest.raises(NotImplementedError):
            environment.get_or_select_template("template.html")

    @pytest.mark.asyncio
    async def test_get_template_async_with_template_object(self, environment: AsyncEnvironment) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_template_async_with_parent(self, environment: AsyncEnvironment) -> None:
        ...
        environment._load_template_async.assert_called_once_with("child_from_parent.html", None)

    @pytest.mark.asyncio
    async def test_get_template_async_with_globals(self, environment: AsyncEnvironment) -> None:
        ...
        environment._load_template_async.assert_called_once_with("template.html", globals_dict)

    @pytest.mark.asyncio
    async def test_select_template_async_with_empty_list(self, environment: AsyncEnvironment) -> None:
    ...
    @pytest.mark.asyncio
    async def test_select_template_async_with_undefined(self, environment: AsyncEnvironment) -> None:
        """Test select_template_async with Undefined object."""
        undefined = MagicMock(spec=Undefined)
        undefined._fail_with_undefined_error = MagicMock(side_effect=TemplateNotFound("undefined"))
    ...
    @pytest.mark.asyncio
    async def test_select_template_async_with_template_object(self, environment: AsyncEnvironment) -> None:
    ...
    @pytest.mark.asyncio
    async def test_select_template_async_with_parent(self, environment: AsyncEnvironment) -> None:
        ...
        result = await environment.select_template_async(["template.html"], parent="parent.html")
    ...
    @pytest.mark.asyncio
    async def test_select_template_async_not_found(self, environment: AsyncEnvironment) -> None:
        """Test select_template_async when no templates are found."""
        # Mock _load_template_async to fail
        environment._load_template_async = AsyncMock(side_effect=TemplateNotFound("not found"))
        
        with pytest.raises(TemplatesNotFound) as exc_info:
            await environment.select_template_async(["template1.html", "template2.html"])
        
        assert "template1.html" in str(exc_info.value)
        assert "template2.html" in str(exc_info.value)

    @pytest.mark.asyncio
    async def test_get_or_select_template_async_with_string(self, environment: AsyncEnvironment) -> None:
        ...
        environment.get_template_async.assert_called_once_with("template.html", None, None)
        assert result is template

    @pytest.mark.asyncio
    async def test_get_or_select_template_async_with_template_object(self, environment: AsyncEnvironment) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_or_select_template_async_with_list(self, environment: AsyncEnvironment) -> None:
        ...
        result = await environment.get_or_select_template_async(templates, parent="parent.html", globals={"var": "value"})
        
        environment.select_template_async.assert_called_once_with(templates, "parent.html", {"var": "value"})
        assert result is template

    @pytest.mark.asyncio
    async def test_load_template_async_with_template_object(self, environment: AsyncEnvironment) -> None:
    ...
    @pytest.mark.asyncio
    async def test_load_template_async_with_string(self, environment: AsyncEnvironment) -> None:
        """Test _load_template_async with string."""
        # Mock _get_template
        template = MagicMock(spec=Template)
        environment._get_template = AsyncMock(return_value=template)
        
        result = await environment._load_template_async("template.html", {"var": "value"})
        
        environment._get_template.assert_called_once_with("template.html", {"var": "value"})
        assert result is template

    @pytest.mark.asyncio
    async def test_load_template_async_with_iterable(self, environment: AsyncEnvironment) -> None:
        """Test _load_template_async with iterable of template names."""
        # Mock _get_template to fail on first template, succeed on second
        template = MagicMock(spec=Template)
        environment._get_template = AsyncMock(side_effect=[
            TemplateNotFound("template1.html"),
            template
        ])
        
        result = await environment._load_template_async(["template1.html", "template2.html"], None)
        
        assert environment._get_template.call_count == 2
        assert result is template

    @pytest.mark.asyncio
    async def test_load_template_async_with_iterable_all_not_found(self, environment: AsyncEnvironment) -> None:
        ...
        with pytest.raises(TemplatesNotFound) as exc_info:
            await environment._load_template_async(["template1.html", "template2.html"], None)
    ...
    @pytest.mark.asyncio
    async def test_get_template_with_cache_hit(self, environment: AsyncEnvironment) -> None:
        ...
        with patch("jinja2_async_environment.environment.ref", return_value=cache_key[0]):
    ...
    @pytest.mark.asyncio
    async def test_get_template_with_cache_hit_and_globals(self, environment: AsyncEnvironment) -> None:
    ...
    async def test_get_template_with_cache_miss(
        ...
        # Assertions
        assert result is template
        mock_loader.load.assert_called_once_with(environment, "template.html", globals_dict)
