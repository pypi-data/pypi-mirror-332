...
class TestAsyncCodeGenerator:
    ...
    @pytest.fixture
    def code_generator(self, environment: MagicMock, stream: MagicMock) -> AsyncCodeGenerator:
        """Create an AsyncCodeGenerator for testing."""
        return AsyncCodeGenerator(
            environment, "test_name", "test_filename", stream
        )
    ...
    def test_visit_extends_multiple_times(
        ...
        code_generator.writeline.assert_any_call('raise TemplateRuntimeError("extended multiple times")')
