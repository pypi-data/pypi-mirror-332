...
class UsageTracker:
    def __init__(self, db_username, db_password, db_host, create_table=False):
        """
        ...
        Optionally, create the table if needed.
        
        For users that only have read and insert permission, set create_table=False.
        """
...
class AsyncUsageTracker:
    ...
    """
    def __init__(self, db_username, db_password, db_host, create_table=False):
        # Pass create_table flag to control whether the table is created
        self.tracker = UsageTracker(db_username, db_password, db_host, create_table=create_table)
