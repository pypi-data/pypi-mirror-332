# neuroairAPI/controllers/device_controller.py
import logging
...
from utils.events import Event, EventHandler
...
class DeviceController:
    ...
    def __init__(self, communication: CommunicationInterface, config: DeviceConfig, event_handler: EventHandler):
        """
    ...
    async def set_channel_parameters(self, channel: int, on_tick: int, off_tick: int, **kwargs) -> Optional[List[str]]:
        """
        ...
        # Теперь можно использовать "сырую" команду:
