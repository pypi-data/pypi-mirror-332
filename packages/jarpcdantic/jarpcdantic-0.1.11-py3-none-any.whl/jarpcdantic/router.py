        ...
        async def wrapped(*args: Any, **kwargs: Any) -> Any:
            ...
            if instance._client is not None:
                ...
                for service_key in {"ts", "ttl", "request_id", "rsvp", "durable"}:
                    ...
                    if underscored_key in method_signature.parameters and underscored_key not in service_kwargs:
                        param = method_signature.parameters[underscored_key]
                        if param.default is not param.empty:  # Проверяем, есть ли дефолтное значение
                    ...
                    if underscored_key in service_kwargs:
                        service_kwargs[service_key] = service_kwargs.pop(underscored_key)
                ...
                response = await instance._client(
                    ...
                    generic_response_type=method_signature.return_annotation,
                    **service_kwargs,
                )
