...
class bstack111l11l1l1_opy_:
    ...
    bstack111l111lll_opy_: Union[None, Callable]
    def __init__(self, timeout=1, bstack111l11l1ll_opy_=1, bstack111l111ll1_opy_=None, bstack111l111lll_opy_=None):
    ...
    def enqueue(self, job: Callable):
        if not callable(job):
            raise ValueError(bstack11ll1l_opy_ (u"ࠧ࡯࡮ࡷࡣ࡯࡭ࡩࠦࡪࡰࡤ࠽ࠤࠧ࿌") + type(job))
        self.queue.put(job)
    def start(self):
        if self.threads:
            return
    ...
    def stop(self):
        ...
        self.threads.clear()
    def worker(self):
        while not self.bstack111l11l111_opy_.is_set():
            try:
                ...
                try:
                    ...
                    if callable(self.bstack111l111ll1_opy_):
                        self.bstack111l111ll1_opy_(e, job)
                finally:
                    self.queue.task_done()
            except queue.Empty:
                pass
            except Exception as e:
                if callable(self.bstack111l111lll_opy_):
                    self.bstack111l111lll_opy_(e)