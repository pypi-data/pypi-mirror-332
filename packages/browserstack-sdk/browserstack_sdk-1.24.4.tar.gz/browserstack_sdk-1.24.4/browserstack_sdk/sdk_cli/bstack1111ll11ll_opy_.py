...
class bstack1111l11lll_opy_:
    bstack1l11l1l111l_opy_ = bstack11ll1l_opy_ (u"ࠢࡣࡧࡱࡧ࡭ࡳࡡࡳ࡭ࠥᒂ")
    context: bstack111l11111l_opy_
    data: Dict[str, Any]
    platform_index: int
    def __init__(self, context: bstack111l11111l_opy_):
        self.context = context
        self.data = dict({bstack1111l11lll_opy_.bstack1l11l1l111l_opy_: defaultdict(lambda: timedelta(microseconds=0))})
        self.platform_index = int(os.environ.get(bstack11ll1l_opy_ (u"ࠨࡄࡕࡓ࡜࡙ࡅࡓࡕࡗࡅࡈࡑ࡟ࡑࡎࡄࡘࡋࡕࡒࡎࡡࡌࡒࡉࡋࡘࠨᒃ"), bstack11ll1l_opy_ (u"ࠩ࠳ࠫᒄ")))
    def ref(self) -> str:
        return str(self.context.id)
    def bstack11111lllll_opy_(self, target: object):
        return bstack1111l11lll_opy_.create_context(target) == self.context
    def bstack1ll1l111l1l_opy_(self, context: bstack111l11111l_opy_):
        return context and context.thread_id == self.context.thread_id and context.process_id == self.context.process_id
    def bstack1111l1111_opy_(self, key: str, value: timedelta):
        self.data[bstack1111l11lll_opy_.bstack1l11l1l111l_opy_][key] += value
    def bstack1lll1l11ll1_opy_(self) -> dict:
        return self.data[bstack1111l11lll_opy_.bstack1l11l1l111l_opy_]
    @staticmethod
    def create_context(
        target: object,
