# pymmseqs/config/cluster_config.py
...
class ClusterConfig(BaseConfig):
    def __init__(
        ...
        self.cluster_db = Path(cluster_db)
    ...
    def run(self) -> None:
        ...
        args = self._get_command_args("cluster")
        mmseqs_output = run_mmseqs_command(args)

        self._handle_command_output(
            mmseqs_output=mmseqs_output,
            output_identifier="Cluster",
            output_path=str(self.cluster_db)
        )
