...
def viperpreprocessrtms(vipertoken,host,port,topic,producerid,offset,maxrows=0,enabletls=0,delay=100,brokerhost='',brokerport=-999,microserviceid='',
                              ...
                              preprocesstopic='',array=0,saveasarray=0,rawdataoutput=0,
                              rtmsthreshold='',rtmsthresholdtopic='',attackthreshold='',
                              attackthresholdtopic='',patternthreshold='',patternthresholdtopic=''):
    global connectionerror
    ...
    value=("preprocessrtms?vipertoken="+vipertoken + "&topicname="+topic + "&delay=" + str(delay) + "&maxrows=" +str(maxrows) +
           ...
           + "&identifier=" + identifier + "&preprocesstopic=" + preprocesstopic + "&patternscorethreshold=" + str(patternscorethreshold)
           + "&array=" + str(array)+ "&saveasarray=" + str(saveasarray) + "&rawdataoutput=" + str(rawdataoutput)
           + "&rtmsthreshold=" + rtmsthreshold+ "&rtmsthresholdtopic=" + rtmsthresholdtopic + "&attackthreshold=" + attackthreshold
           + "&attackthresholdtopic=" + attackthresholdtopic + "&patternthreshold=" + patternthreshold + "&patternthresholdtopic=" + patternthresholdtopic)
