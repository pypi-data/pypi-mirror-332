...
*rtmsthreshold*: string, optional

- Threshold number for RTMS score between 0-1

*rtmsthresholdtopic*: string, optional

- Name of a kafka topic that will contain messages greater

  than rtmsthreshold

*attackthreshold*: string, optional

- Threshold number between 0-1
                              
*attackthresholdtopic*: string, optional

- Name of a kafka topic that will contain messages greater

  than attackthreshold

*patternthreshold*: string, optional

- Threshold number between 0-1

*patternthresholdtopic*: string, optional
