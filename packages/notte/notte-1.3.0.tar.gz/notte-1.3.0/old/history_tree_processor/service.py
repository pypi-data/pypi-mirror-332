...
from notte.pipe.preprocessing.dom.history_tree_processor.views import DOMHistoryElement, HashedDomElement
from notte.pipe.preprocessing.dom.types import DOMElementNode
...
class HistoryTreeProcessor:
	...
	def _hash_dom_element(dom_element: DOMElementNode) -> HashedDomElement:
		...
		# text_hash = DomNodeProcessor._text_hash(dom_element)
