    ...
    def _create_model_from_hf(
        ...
        *,
        ...
        :param retry: This can be used to force a new artifact to be created with the same name and an incremented
            version,
        :param requests: Specify compute resource requests for your task.
        :param limits: Compute limits. Specify compute resource limits for your task.
        ...
        model_cache_wf, source_path = create_hf_model_cache_workflow(
            image, hf_token_key, union_api_key, requests=requests, limits=limits
        )
