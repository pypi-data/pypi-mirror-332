...
class BlueskyList:
    ...
    def get_list_feed(self, handle: str, list_id: str, limit: int = 100) -> Dict[str, List[Dict[str, Any]]]:
        """
        Get posts directly from a Bluesky list feed/timeline.
        ...
        try:
            ...
            # Use the app.bsky.feed.getList endpoint to get the list feed directly
            try:
                # Set up parameters for pagination if needed
                params = {"list": list_uri, "limit": min(100, limit)}
                all_posts = []
                cursor = None
                ...
                while len(all_posts) < limit:
                    ...
                    response = self.client.app.bsky.feed.get_list(params)
                ...
                print(f"❌ Error fetching list feed: {str(e)}")
                return {}
