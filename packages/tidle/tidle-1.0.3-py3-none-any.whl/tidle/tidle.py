...
class Game:
    def __init__(self):
        ...
        self.upgrades = [
            ...
            {"name": "Cycle Booster", "description": "Generates cycles over time.", "base_cost": 5,
             "currency": "cycles",
             "effect": self.increase_auto_cycles},
            {"name": "Process Enhancer", "description": "Generates processes over time.", "base_cost": 2,
             "currency": "processes",
             "effect": self.increase_auto_processes},
            {"name": "Loop Accelerator", "description": "Speeds up loop generation.", "base_cost": 1,
             "currency": "loops",
