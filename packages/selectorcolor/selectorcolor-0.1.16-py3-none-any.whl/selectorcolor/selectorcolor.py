        ...
        self.controles = ft.Container(
            content = ft.Column(
                [
                    ...
                    ft.ResponsiveRow([ft.Text("Vermelho", selectable=True, color="#BEBCE7", col = 3),self.slides[f'r'],], spacing=0),
                    ft.ResponsiveRow([ft.Text("Verde", selectable=True,  col = 3, color="#BEBCE7"),self.slides[f'g'],], spacing=0),
                    ft.ResponsiveRow([ft.Text("Azul", selectable=True, col = 3, color="#BEBCE7"),self.slides[f'b'],], spacing=0),
                ],
                width=380,
                spacing=0,
                run_spacing=0,
