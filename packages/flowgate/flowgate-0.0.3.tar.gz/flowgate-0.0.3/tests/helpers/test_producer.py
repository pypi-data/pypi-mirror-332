...
from flowgate.helpers import producer
...
def confluent_avro_producer():
    ...
    with ExitStack() as stack:
        stack.enter_context(
            patch("flowgate.helpers.producer.ConfluentAvroProducer.__init__", MagicMock)
        )
        stack.enter_context(
            patch("flowgate.helpers.producer.ConfluentAvroProducer.produce", producer)
        )
        yield producer


@pytest.fixture
@patch("flowgate.helpers.producer.AvroProducer._close", MagicMock())
