...
class KISDomesticStock:
    ...
    def order_cash(
        ...
        if side == "sell":
            tr_id = "VTTC0801U" if self.auth.paper_trading else "TTTC0011U"
        else:
            tr_id = "VTTC0802U" if self.auth.paper_trading else "TTTC0012U"
    ...
    def order_rvsecncl(
        ...
        tr_id = "VTTC0803U" if self.auth.paper_trading else "TTTC0013U"
        req_body = {
            "CANO": cano,
            "ACNT_PRDT_CD": acnt_prdt_cd,
            "KRX_FWDG_ORD_ORGNO": "",
