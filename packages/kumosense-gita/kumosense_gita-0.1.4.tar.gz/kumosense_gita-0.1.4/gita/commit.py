...
def generate_commit_message(changes: str, use_sticker: bool = False) -> str:
    ...
    system_prompt = "Sen git uchun O'zbekcha commit message yozadigan AI botisan. Commitlar text ko'rinishda yozi markdownda emas."
    if use_sticker:
        system_prompt += (
            " Emoji yoki sticker bilan commitni yanada aniqroq va chiroyliroq yoz."
        )
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": f"Mana koddagi o‘zgarishlar:\n{changes}\nYaxshi commit yoz.",
            },
        ],
        web_search=False,
    )
