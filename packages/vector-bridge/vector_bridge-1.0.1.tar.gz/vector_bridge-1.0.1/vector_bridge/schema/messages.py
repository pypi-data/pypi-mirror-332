...
class MessageCreateCustomer(BaseModel):
    content: str
    data: Optional[Dict] = Field(default_factory=dict)


class MessageCreateCustomerWithJson(MessageCreateCustomer):
    response_structure_definition: Union[BaseModel, List[BaseModel]]


class MessageCreateAgent(BaseModel):
    content: str
