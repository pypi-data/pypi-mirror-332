...
def parse_dependencies(dep_file):
    ...
    if raw_content.strip().startswith('{') and raw_content.strip().endswith('}'):
        try:
            ...
            dependencies = json.loads(raw_content)
            print(f"Successfully parsed dependencies as JSON: {json.dumps(dependencies, indent=2)}")
            return dependencies
    ...
    for line in lines:
        ...
        if ":" in line and not line.startswith(" "):
            ...
            # Initialize as simple version string
