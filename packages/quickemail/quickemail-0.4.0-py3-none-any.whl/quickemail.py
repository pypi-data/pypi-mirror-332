...
class QuickEmail:
    ...
    def creatmsg(self):
        ...
        if self._is_html:
            ...
            html_plain = 'plain'
            msg = MIMEText(self.mail_content, 'plain', _charset='utf-8')
        ...
        msg_plain_content = MIMEText(self.mail_content, 'plain', _charset='utf-8')
...
if __name__ == '__main__':
    ...
    quicksend = QuickEmail('smtp.test.com', 587)
    ...
    quicksend.mail_date = int(time.time())
    quicksend.mail_subject = 'mY subject还有中文!'
    quicksend.mail_content = '<font color=red>red content一段中文</font>'
    quicksend.mail_attach = ['C:\\Users\\Administrator\\Pictures\\1.png']
    quicksend.is_html = True
