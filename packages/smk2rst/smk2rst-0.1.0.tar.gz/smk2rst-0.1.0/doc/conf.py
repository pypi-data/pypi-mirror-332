...
try:
    ...
    version = get_version("smk2rst")
except ImportError:
    from pkg_resources import get_distribution

    version = get_distribution("smk2rst").version

# -- Project information -----------------------------------------------------
short_version = ".".join(version.split(".")[:2])
project = "smk2rst {}".format(short_version)
...
html_title = "smk2rst {}".format(version)
