...
class Property(CloudApiBase):
    ...
    # Properties with setters using _set_parameter
    @property
...
# Class Methods
    ...
    async def get_lookup_property_async(self, response_type):
        """
        This asynchronous function sends the CloudAPI request using the /v4/WEB/LookupProperty endpoint
        """
        self.set_endpoint("/v4/WEB/LookupProperty")
        return await self.get_async(response_type)
    ...
    async def post_lookup_property_async(self, response_type):
        """
    ...
    async def get_lookup_deeds_async(self, response_type):
        """
    ...
    async def post_lookup_deeds_async(self, response_type):
        """
    ...
    async def get_lookup_homes_by_owner_async(self, response_type):
        """
        This asynchronous function sends the CloudAPI request using the /v4/WEB/LookupHomesByOwner endpoint
        """
        self.set_endpoint("/v4/WEB/LookupHomesByOwner")
        return await self.get_async(response_type)
    ...
    async def post_lookup_homes_by_owner_async(self, response_type):
        """
