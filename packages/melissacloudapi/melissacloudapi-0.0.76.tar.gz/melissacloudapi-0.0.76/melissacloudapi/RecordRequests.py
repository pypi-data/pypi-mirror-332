...
class GlobalAddressVerificationRecordRequest:
    def __init__(self, record_id=None, organization=None, address_line1=None, address_line2=None, 
                 address_line3=None, address_line4=None, address_line5=None, address_line6=None, 
                 address_line7=None, address_line8=None, double_dependent_locality=None, 
    ...
    def to_dict(self):
        return {
            ...
            "AddressLine5": self.address_line5,
            "AddressLine6": self.address_line6,
            "AddressLine7": self.address_line7,
            "AddressLine8": self.address_line8,
...
class PeopleBusinessSearchRecordRequest:
    def __init__(self, customer_id=None, match_level=None, max_records=None, transmission_reference=None,
                 address_line1=None, administrative_area=None, country=None, locality=None, phone_number=None,
...
class PersonatorConsumerRecordRequest:
    def __init__(self, record_id=None, address_line1=None, address_line2=None, birth_day=None, birth_month=None,
...
class PersonatorIdentityRecordRequest():
    def __init__(
        ...
        email="", date_of_birth="", account_number="", address_line1="", address_line2="", address_line3="", address_line4="", 
        address_line5="", address_line6="", address_line7="", address_line8="", locality="", administrative_area="", 
...
class PropertyRecordRequest:
    def __init__(
        ...
        record_id="", account="", address_key="", address_line1="", 
        address_line2="", apn="", city="", country="", fips="", 
