...
class GlobalAddressVerificationRecord(ResponseBase):
    def __init__( self, record_id="", results="", formatted_address="", organization="", address_line1="", address_line2="", address_line3="", 
                 address_line4="", address_line5="", address_line6="", address_line7="", address_line8="", sub_premises="", double_dependent_locality="", 
    ...
    def from_dict(cls, data: dict):
        ...
        return cls(
            ...
            address_line5 = data.get("AddressLine5", ""),
            address_line6 = data.get("AddressLine6", ""),
            address_line7 = data.get("AddressLine7", ""),
            address_line8 = data.get("AddressLine8", ""),
    ...
    def get_address_line3(self):
        return self.address_line3 or ""

    def get_address_line4(self):
        return self.address_line4 or ""

    def get_address_line5(self):
        return self.address_line5 or ""

    def get_address_line6(self):
        return self.address_line6 or ""

    def get_address_line7(self):
        return self.address_line7 or ""

    def get_address_line8(self):
        return self.address_line8 or ""
