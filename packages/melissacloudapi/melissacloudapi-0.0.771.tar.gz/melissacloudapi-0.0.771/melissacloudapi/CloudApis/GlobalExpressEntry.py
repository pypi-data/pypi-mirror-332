...
class GlobalExpressEntry(CloudApiBase):
    ...
    def address_line1(self, value):
        self._set_parameter("address_line1", value)
    ...
    def set_address_line1(self, address_line1):
        if self.endpoint.lower() == "web/globalexpressaddress":
            self._set_parameter("address_line1", self.parameters.get("line1", "")) 
        else:
            self._set_parameter("address_line1", address_line1)
    ...
    # Asynchronous function sends the CloudAPI request using the /web/ExpressAddress endpoint
    async def get_express_address_async(self, type):
        self.set_endpoint("/web/ExpressAddress")
        return await self.get_async(type)
    ...
    # Asynchronous function sends the CloudAPI request using the /web/ExpressCityState endpoint
    async def get_express_city_state_async(self, type):
        self.set_endpoint("/web/ExpressCityState")
        return await self.get_async(type)
    ...
    # Asynchronous function sends the CloudAPI request using the /web/ExpressPostalCode endpoint
    async def get_express_postal_code_async(self, type):
        self.set_endpoint("/web/ExpressPostalCode")
        return await self.get_async(type)
    ...
    # Asynchronous function sends the CloudAPI request using the /web/ExpressStreet endpoint
    async def get_express_street_async(self, type):
        self.set_endpoint("/web/ExpressStreet")
        return await self.get_async(type)
    ...
    # Asynchronous function sends the CloudAPI request using the /web/ExpressFreeForm endpoint
    async def get_express_free_form_async(self, type):
        self.set_endpoint("/web/ExpressFreeForm")
        return await self.get_async(type)
    ...
    # Asynchronous function sends the CloudAPI request using the /web/GlobalExpressAddress endpoint
    async def get_global_express_address_async(self, type):
        self.set_endpoint("/web/GlobalExpressAddress")
        return await self.get_async(type)
    ...
    # Asynchronous function sends the CloudAPI request using the /web/GlobalExpressLocalityAdministrativeArea endpoint
    async def get_global_express_locality_administrative_area_async(self, type):
        self.set_endpoint("/web/GlobalExpressLocalityAdministrativeArea")
        return await self.get_async(type)
    ...
    # Asynchronous function sends the CloudAPI request using the /web/GlobalExpressCountry endpoint
    async def get_global_express_country_async(self, type):
        self.set_endpoint("/web/GlobalExpressCountry")
        return await self.get_async(type)
    ...
    # Asynchronous function sends the CloudAPI request using the /web/GlobalExpressFreeForm endpoint
    async def get_global_express_free_form_async(self, type):
        self.set_endpoint("/web/GlobalExpressFreeForm")
        return await self.get_async(type)
    ...
    # Asynchronous function sends the CloudAPI request using the /web/GlobalExpressPostalCode endpoint
    async def get_global_express_postal_code_async(self, type):
        self.set_endpoint("/web/GlobalExpressPostalCode")
        return await self.get_async(type)
    ...
    # Asynchronous function sends the CloudAPI request using the /web/GlobalExpressThoroughfare endpoint
    async def get_global_express_thoroughfare_async(self, type):
        self.set_endpoint("/web/GlobalExpressThoroughfare")
        return await self.get_async(type)
