...
class InterFusionInference:
    ...
    def predict(self, user_texts, item_texts, user_features_list=None, item_features_list=None, batch_size=32):
        ...
        # Access feature sizes properly considering DataParallel
        if isinstance(self.model, nn.DataParallel):
            user_feature_size = self.model.module.user_feature_size
            item_feature_size = self.model.module.item_feature_size
        else:
            user_feature_size = self.model.user_feature_size
            item_feature_size = self.model.item_feature_size
