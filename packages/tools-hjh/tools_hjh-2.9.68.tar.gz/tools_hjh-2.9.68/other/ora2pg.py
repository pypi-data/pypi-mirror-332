...
def main():
    if run_mode == 'copy_data':
        ...
        if src_db_type == 'oracle' and dst_db_type == 'pgsql':
            copy_table_o2p(run_mode)
        elif src_db_type == 'oracle' and dst_db_type == 'oracle':
            copy_table_o2o(run_mode)
            ...
            for table_from_sql in tables_from_sql:
                if '-->' in table_mess:
                    ...
                    if dst_db_type == 'pgsql':
                        ...
                        table_map = (src_schema, table_from_sql[0], src_schema, table_from_sql[0], src_where)
                if table_map not in table_map_list and table_map[0] + '.' + table_map[1] not in exclude_tables:
                    table_map_list.append(table_map)
    ...
    def ready():
        try:
            ...
            for col in cols_for_copy:
                ...
                elif 'CLOB' in str(col[1]) and is_optimize_clob == 'true' and dst_db_type == 'pgsql':
                    is_exists_clob = True
                ...
                elif 'RAW' in str(col[1]) and col[2] == 16 and is_use_rawtohex == 'true' and dst_db_type == 'pgsql':
                    once_num = once_num_lob
                    merge_col[idx] = [idx2]
                    idx2 = idx2 + 1
