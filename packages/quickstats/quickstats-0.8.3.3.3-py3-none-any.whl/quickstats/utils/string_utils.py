...
class PartialFormatter:
    ...
    Example usage:
        ...
        # Double braces are preserved
        template_with_braces = "Value: {value}, Literal: {{not_a_field}}"
        result = formatter.format(template_with_braces, value=42)
        # Result: "Value: 42, Literal: {not_a_field}"
    """
    ...
    def format(self, format_string, **kwargs):
        ...
        # This ensures we don't try to format escaped braces
        tmp_open = "\uE000"  # Use a Unicode private use character as a temporary marker
        tmp_close = "\uE001"
    ...
    def is_fully_formatted(self, string: str):
        """
        ...
        """
        # First replace escaped braces to avoid counting them
