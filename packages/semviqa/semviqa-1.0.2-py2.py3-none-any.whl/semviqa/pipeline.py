...
from .ser.eval import *
from .ser.qatc_model import QATCForQuestionAnswering
from .tvc.eval import *
from .tvc.model import ClaimVerificationModel
import argparse
...
def main(args):
    ...
    model_3_class = ClaimVerificationModel.from_pretrained(args.model_3_class).to(device)
    model_2_class = ClaimVerificationModel.from_pretrained(args.model_2_class).to(device)
    print('Start predict')
