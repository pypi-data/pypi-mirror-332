...
class DataplaneRequest(BaseModel):
    ...
    def request_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['result-set', 'streaming']):
            raise ValueError("must be one of enum values ('result-set', 'streaming')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataplaneRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataplaneRequest from a dict"""
        if obj is None:
            return None
