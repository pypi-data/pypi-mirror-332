...
class AgentInfoProto(google___protobuf___message___Message):
    ...
    done_reason = ... # type: builtin___int
    ...
    def __init__(self,
        *,
        ...
        done_reason : typing___Optional[builtin___int] = None,
        ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"action_mask",u"done",u"done_reason",u"group_id",u"group_reward",u"id",u"max_step_reached",u"observations",u"reward"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"action_mask",b"action_mask",u"done",b"done",u"done_reason",b"done_reason",u"group_id",b"group_id",u"group_reward",b"group_reward",u"id",b"id",u"max_step_reached",b"max_step_reached",u"observations",b"observations",u"reward",b"reward"]) -> None: ...
