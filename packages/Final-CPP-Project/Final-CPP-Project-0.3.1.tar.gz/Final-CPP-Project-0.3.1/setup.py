...
setup(
    ...
    version="0.3.1", #업로드할꺼면 여기서 수정 후 라이브러리 업로드 가능 > 버전 규칙 0.1.0 → 0.1.1 (작은 버그 수정) /0.1.0 → 0.2.0 (새로운 기능 추가) /0.1.0 → 1.0.0 (대규모 변경)
    ...
    install_requires=[
        ...
        'configobj==5.0.6',
        'cryptography==36.0.1',
        'dbus-python==1.2.18', # 주석이 필요한 경우 추가로 명시
        'distro==1.5.0',
        'Django==4.2.19',
        'docutils==0.16',
        #'ec2-hibinit-agent==1.0.8', # EC2 환경에서만 필요, 주석 처리
