...
*mkdocstrings-shell* follows the **sponsorware** release strategy, which means
...
*mkdocstrings-shell Insiders* is a private fork of *mkdocstrings-shell*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *mkdocstrings-shell*.
...
*mkdocstrings-shell* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *mkdocstrings-shell*,
...
<small>
  ...
  your profile and avatar to show your support for *mkdocstrings-shell*.
...
to use *mkdocstrings-shell* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *mkdocstrings-shell*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *mkdocstrings-shell
Insiders* precisely under the same terms as *mkdocstrings-shell*, which are given
