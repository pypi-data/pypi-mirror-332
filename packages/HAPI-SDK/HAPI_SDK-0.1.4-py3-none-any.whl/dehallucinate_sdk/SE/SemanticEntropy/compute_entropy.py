...
def compute_entropy(config: SEConfig, api_key, prompt, full_responses):
  ...
  if config.entailment_model == 'gpt-4':
    entailment_model = EntailmentGPT4(api_key)
  elif config.entailment_model == 'gpt-3.5':
    entailment_model = EntailmentGPT35(api_key)
  elif config.entailment_model == 'gpt-4-turbo':
    entailment_model = EntailmentGPT4Turbo(api_key)
  elif config.entailment_model == 'gpt-4o':
    entailment_model = EntailmentGPT4o(api_key)
  elif config.entailment_model == 'gpt-4o-mini':
    entailment_model = EntailmentGPT4oMini(api_key)
