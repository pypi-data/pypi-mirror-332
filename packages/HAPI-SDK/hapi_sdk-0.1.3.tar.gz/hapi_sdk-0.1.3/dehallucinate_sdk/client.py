...
class DeHallucinationClient:
    ...
    def semantic_entropy_check(self, sentence, original_prompt, tokens_raw, probs_raw):
        ...
        keyword_list = extract_keywords(inference_config.keyword_model, api_key, sentence)
        print(keyword_list)
            ...
            def process_hypothesis(i):
                ...
                for hallucination in hallucinated_keywords[i]:
                    ...
                    for j in range(se_config.num_generations):
                        predicted_answer, sample_logits, sample_tokens = self.generate_sentence(self, validation_prompt, sentence_max_length=60, temperature=inference_temperature, semantic_entropy=True)
                    ...
                    if (entropies["semantic_entropy"][0] > se_config.entropy_threshold) \
                            ...
                            and check_contradiction(inference_config.contradiction_model, api_key, hypothesis, sampled_responses, se_config.contradiction_num_samples)):
