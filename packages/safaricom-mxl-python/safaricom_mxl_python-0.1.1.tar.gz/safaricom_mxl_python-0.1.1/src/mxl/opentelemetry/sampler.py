...
from mxl.opentelemetry.options import DEFAULT_SAMPLE_RATE, MXLOptions
...
def configure_sampler(
    ...
    configured based on the sample_rate determined in MXLOptions.
    ...
    Args:
        options (MXLOptions): the MXLOptions containing
