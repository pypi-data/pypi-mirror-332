...
DEBUG = "DEBUG"
MXL_ENABLE_LOCAL_VISUALIZATIONS = "MXL_ENABLE_LOCAL_VISUALIZATIONS"
MXL_ENABLE_ADVANCED_NETWORK_CAPTURE = "MXL_ENABLE_ADVANCED_NETWORK_CAPTURE"
OTEL_SERVICE_VERSION = "OTEL_SERVICE_VERSION"
SAMPLE_RATE = "SAMPLE_RATE"

# HNY Credential Names
MXL_API_ENDPOINT = "MXL_API_ENDPOINT"
MXL_API_KEY = "MXL_API_KEY"
MXL_DATASET = "MXL_DATASET"
MXL_LOGS_APIKEY = "MXL_LOGS_APIKEY"
MXL_METRICS_APIKEY = "MXL_METRICS_APIKEY"
MXL_METRICS_DATASET = "MXL_METRICS_DATASET"
MXL_TRACES_APIKEY = "MXL_TRACES_APIKEY"

# Default values
DEFAULT_API_ENDPOINT = "http://mxl-otelcol.service-availability.apps.ocpthikadev01.safaricom.net"
...
INVALID_LOCAL_VIS_ERROR = (
    "Unable to parse "
    + "MXL_ENABLE_LOCAL_VISUALIZATIONS environment variable. "
    + "Defaulting to false."
)
INVALID_LOCAL_ADVANCED_NETWORK_CAPTURE_ERROR = (
    "Unable to parse "
    + "MXL_ENABLE_ADVANCED_NETWORK_CAPTURE environment variable. "
    + "Defaulting to false."
)
...
MISSING_API_KEY_ERROR = (
    ...
    + "MXL_API_KEY environment variable or apikey in the options"
    + "parameter."
)
MISSING_SERVICE_NAME_ERROR = (
    ...
    + "options parameter. If left unset, this will show up in MXL "
    + "as unknown_service:python"
)
MISSING_DATASET_ERROR = (
    "Missing dataset. Specify either "
    + "MXL_DATASET environment variable or dataset in the options "
    + "parameter."
)
...
class MXLOptions:
    """
    MXL Options used to configure the OpenTelemetry SDK.
    ...
    def __init__(
        ...
        self.traces_apikey = os.environ.get(
            MXL_TRACES_APIKEY,
            os.environ.get(MXL_API_KEY, (traces_apikey or apikey)),
        )
        ...
        self.metrics_apikey = os.environ.get(
            MXL_METRICS_APIKEY,
            os.environ.get(MXL_API_KEY, (metrics_apikey or apikey)),
        )
        if not self.traces_apikey:
            _logger.warning(MISSING_API_KEY_ERROR)
        ...
        self.logs_apikey = os.environ.get(
            MXL_LOGS_APIKEY,
            os.environ.get(MXL_API_KEY, (logs_apikey or apikey)),
        )
        ...
        self.endpoint = os.environ.get(MXL_API_ENDPOINT, endpoint)
        ...
        self.dataset = os.environ.get(MXL_DATASET, dataset)
        ...
        self.metrics_dataset = os.environ.get(MXL_METRICS_DATASET, metrics_dataset)

        self.enable_local_visualizations = parse_bool(
            MXL_ENABLE_LOCAL_VISUALIZATIONS,
            enable_local_visualizations,
            INVALID_LOCAL_VIS_ERROR,
        )

        self.enable_advanced_network_capture = parse_bool(
            MXL_ENABLE_ADVANCED_NETWORK_CAPTURE,
    ...
    def get_trace_headers(self):
        ...
        if self.dataset and is_classic(self.traces_apikey):
            headers["x-mxl-dataset"] = self.dataset
        return headers
    ...
    def get_metrics_headers(self):
        ...
        if self.metrics_dataset:
            headers["x-mxl-dataset"] = self.metrics_dataset
        return headers
