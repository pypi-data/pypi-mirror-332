...
class InstParam:
    ...
    def __str__(self) -> str:
        return f'<InstParam: wav_no={self.wav_no}, wav_loc_type={self.wav_dat_loc_type}, orig_key={self.original_key}, vol={self.volume}>'
...
class BRBNK(RevFile):
    ...
    def get_inst_param_direct(self, prg_no: (int | list[int])) -> (InstParam | list[InstParam] | None):
        """
        ...
        def get_inst_data_for_prg(prg: int) -> (InstParam | list[InstParam] | None):
