...
try:
    ...
    print_warning('BRWAV >> Encoding is not available')
...
class BRWAV(RevFile):
    ...
    def decode(self, out_path: str, *, return_wav: bool = False) -> (wave.Wave_read | None):
        """
        ...
        pcm_bytes = b''.join(struct.pack('<h', sample) for sample in samples)
