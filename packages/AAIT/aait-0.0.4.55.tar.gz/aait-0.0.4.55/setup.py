...
VERSION = "0.0.4.55"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
# Dépendances
INSTALL_REQUIRES = ["torch==2.2.2", "sentence-transformers==3.3.1", "gpt4all[cuda]", "sacremoses==0.1.1",
                    ...
                    "unidecode==1.3.8", "python-docx==1.1.2", "psutil"]
