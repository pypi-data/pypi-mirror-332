...
class BaseClient:
    ...
    def __init__(
        ...
        Args:
            ...
            client_secret (str, optional): The Service Account Client Secret for authentication. Defaults to None.
            token (str, optional): The access token for authentication. Defaults to None.
            timeout (int, optional): Request timeout in seconds. Defaults to 10.
            client_id (int, optional): The Client ID for RBAC . Defaults to 1.
            copilot_id (int, optional): Copilot ID for RBAC . Defaults to None.
    ...
    def get_token(self) -> None:
        ...
        try:
            response = self.session.post(
                token_endpoint, json=payload, timeout=self.timeout
            )
    ...
    def request_with_retry(
        ...
        try:
            ...
            if response.status_code == 401 and self.sa_client_id and self.sa_client_secret:
