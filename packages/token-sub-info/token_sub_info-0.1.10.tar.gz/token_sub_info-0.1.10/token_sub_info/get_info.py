...
from .exceptions.sub_exceptions.not_found_exceptions import ProfileIDNotFoundException
...
def get_profile_id(token: str, public_key: bytes, jwt_algorithm: str) -> list[UUID]:
    """
